...
//
#define STATUS_WAIT_0                           ((int32_t)0x00000000L) // winnt
...
//  STATUS_SUCCESS
//
#define STATUS_SUCCESS                   ((int32_t)0x00000000L)    // ntsubauth
...
//  STATUS_WAIT_1
//
#define STATUS_WAIT_1                    ((int32_t)0x00000001L)
...
//  STATUS_WAIT_2
//
#define STATUS_WAIT_2                    ((int32_t)0x00000002L)
...
//  STATUS_WAIT_3
//
#define STATUS_WAIT_3                    ((int32_t)0x00000003L)
...
//  STATUS_WAIT_63
//
#define STATUS_WAIT_63                   ((int32_t)0x0000003FL)
...
//
#define STATUS_ABANDONED                        ((int32_t)0x00000080L)
...
//
#define STATUS_ABANDONED_WAIT_0          ((int32_t)0x00000080L)    // winnt
...
//
#define STATUS_ABANDONED_WAIT_63         ((int32_t)0x000000BFL)
...
//  STATUS_USER_APC
//
#define STATUS_USER_APC                  ((int32_t)0x000000C0L)    // winnt
...
//
#define STATUS_ALREADY_COMPLETE          ((int32_t)0x000000FFL)
...
//  STATUS_KERNEL_APC
//
#define STATUS_KERNEL_APC                ((int32_t)0x00000100L)
...
//  STATUS_ALERTED
//
#define STATUS_ALERTED                   ((int32_t)0x00000101L)
...
//  STATUS_TIMEOUT
//
#define STATUS_TIMEOUT                   ((int32_t)0x00000102L)    // winnt
...
//
#define STATUS_PENDING                   ((int32_t)0x00000103L)    // winnt
...
//
#define STATUS_REPARSE                   ((int32_t)0x00000104L)
...
//
#define STATUS_MORE_ENTRIES              ((int32_t)0x00000105L)
...
//
#define STATUS_NOT_ALL_ASSIGNED          ((int32_t)0x00000106L)
...
//
#define STATUS_SOME_NOT_MAPPED           ((int32_t)0x00000107L)
...
//
#define STATUS_OPLOCK_BREAK_IN_PROGRESS  ((int32_t)0x00000108L)
...
//
#define STATUS_VOLUME_MOUNTED            ((int32_t)0x00000109L)
...
//
#define STATUS_RXACT_COMMITTED           ((int32_t)0x0000010AL)
...
//
#define STATUS_NOTIFY_CLEANUP            ((int32_t)0x0000010BL)
...
//
#define STATUS_NOTIFY_ENUM_DIR           ((int32_t)0x0000010CL)
...
//
#define STATUS_NO_QUOTAS_FOR_ACCOUNT     ((int32_t)0x0000010DL)
...
//
#define STATUS_PRIMARY_TRANSPORT_CONNECT_FAILED ((int32_t)0x0000010EL)
...
//
#define STATUS_PAGE_FAULT_TRANSITION     ((int32_t)0x00000110L)
...
//
#define STATUS_PAGE_FAULT_DEMAND_ZERO    ((int32_t)0x00000111L)
...
// Page fault was a demand zero fault.
//
#define STATUS_PAGE_FAULT_COPY_ON_WRITE  ((int32_t)0x00000112L)
...
// Page fault was a demand zero fault.
//
#define STATUS_PAGE_FAULT_GUARD_PAGE     ((int32_t)0x00000113L)
...
//
#define STATUS_PAGE_FAULT_PAGING_FILE    ((int32_t)0x00000114L)
...
//
#define STATUS_CACHE_PAGE_LOCKED         ((int32_t)0x00000115L)
...
//
#define STATUS_CRASH_DUMP                ((int32_t)0x00000116L)
...
//
#define STATUS_BUFFER_ALL_ZEROS          ((int32_t)0x00000117L)
...
// A reparse should be performed by the Object Manager since the name of the file resulted in a symbolic link.
//
#define STATUS_REPARSE_OBJECT            ((int32_t)0x00000118L)
...
//
#define STATUS_RESOURCE_REQUIREMENTS_CHANGED ((int32_t)0x00000119L)
...
//
#define STATUS_TRANSLATION_COMPLETE      ((int32_t)0x00000120L)
...
//
#define STATUS_DS_MEMBERSHIP_EVALUATED_LOCALLY ((int32_t)0x00000121L)
...
//
#define STATUS_NOTHING_TO_TERMINATE      ((int32_t)0x00000122L)
...
//
#define STATUS_PROCESS_NOT_IN_JOB        ((int32_t)0x00000123L)
...
//
#define STATUS_PROCESS_IN_JOB            ((int32_t)0x00000124L)
...
//
#define STATUS_VOLSNAP_HIBERNATE_READY   ((int32_t)0x00000125L)
...
//
#define STATUS_FSFILTER_OP_COMPLETED_SUCCESSFULLY ((int32_t)0x00000126L)
...
//
#define STATUS_INTERRUPT_VECTOR_ALREADY_CONNECTED ((int32_t)0x00000127L)
...
//
#define STATUS_INTERRUPT_STILL_CONNECTED ((int32_t)0x00000128L)
...
//
#define STATUS_PROCESS_CLONED            ((int32_t)0x00000129L)
...
//
#define STATUS_FILE_LOCKED_WITH_ONLY_READERS ((int32_t)0x0000012AL)
...
//
#define STATUS_FILE_LOCKED_WITH_WRITERS  ((int32_t)0x0000012BL)
...
//
#define STATUS_VALID_IMAGE_HASH          ((int32_t)0x0000012CL)
...
//
#define STATUS_VALID_CATALOG_HASH        ((int32_t)0x0000012DL)
...
//
#define STATUS_VALID_STRONG_CODE_HASH    ((int32_t)0x0000012EL)
...
//
#define STATUS_GHOSTED                   ((int32_t)0x0000012FL)
...
//
#define STATUS_DATA_OVERWRITTEN          ((int32_t)0x00000130L)
...
//
#define STATUS_RESOURCEMANAGER_READ_ONLY ((int32_t)0x00000202L)
...
//
#define STATUS_RING_PREVIOUSLY_EMPTY     ((int32_t)0x00000210L)
...
//
#define STATUS_RING_PREVIOUSLY_FULL      ((int32_t)0x00000211L)
...
//
#define STATUS_RING_PREVIOUSLY_ABOVE_QUOTA ((int32_t)0x00000212L)
...
//
#define STATUS_RING_NEWLY_EMPTY          ((int32_t)0x00000213L)
...
//
#define STATUS_RING_SIGNAL_OPPOSITE_ENDPOINT ((int32_t)0x00000214L)
...
//
#define STATUS_OPLOCK_SWITCHED_TO_NEW_HANDLE ((int32_t)0x00000215L)
...
//
#define STATUS_OPLOCK_HANDLE_CLOSED      ((int32_t)0x00000216L)
...
//
#define STATUS_WAIT_FOR_OPLOCK           ((int32_t)0x00000367L)
...
//
#define STATUS_REPARSE_GLOBAL            ((int32_t)0x00000368L)
...
//
#define DBG_EXCEPTION_HANDLED            ((int32_t)0x00010001L)    // winnt
...
// Debugger continued
//
#define DBG_CONTINUE                     ((int32_t)0x00010002L)    // winnt
...
//
#define STATUS_FLT_IO_COMPLETE           ((int32_t)0x001C0001L)
...
//
#define STATUS_OBJECT_NAME_EXISTS        ((int32_t)0x40000000L)
...
//
#define STATUS_THREAD_WAS_SUSPENDED      ((int32_t)0x40000001L)
...
//
#define STATUS_WORKING_SET_LIMIT_RANGE   ((int32_t)0x40000002L)
...
//
#define STATUS_IMAGE_NOT_AT_BASE         ((int32_t)0x40000003L)
...
//
#define STATUS_RXACT_STATE_CREATED       ((int32_t)0x40000004L)
...
//
#define STATUS_SEGMENT_NOTIFICATION      ((int32_t)0x40000005L)    // winnt
...
//
#define STATUS_LOCAL_USER_SESSION_KEY    ((int32_t)0x40000006L)
...
//
#define STATUS_BAD_CURRENT_DIRECTORY     ((int32_t)0x40000007L)
...
//
#define STATUS_SERIAL_MORE_WRITES        ((int32_t)0x40000008L)
...
//
#define STATUS_REGISTRY_RECOVERED        ((int32_t)0x40000009L)
...
//
#define STATUS_FT_READ_RECOVERY_FROM_BACKUP ((int32_t)0x4000000AL)
...
//
#define STATUS_FT_WRITE_RECOVERY         ((int32_t)0x4000000BL)
...
//
#define STATUS_SERIAL_COUNTER_TIMEOUT    ((int32_t)0x4000000CL)
...
//
#define STATUS_NULL_LM_PASSWORD          ((int32_t)0x4000000DL)
...
//
#define STATUS_IMAGE_MACHINE_TYPE_MISMATCH ((int32_t)0x4000000EL)
...
//
#define STATUS_RECEIVE_PARTIAL           ((int32_t)0x4000000FL)
...
//
#define STATUS_RECEIVE_EXPEDITED         ((int32_t)0x40000010L)
...
//
#define STATUS_RECEIVE_PARTIAL_EXPEDITED ((int32_t)0x40000011L)
...
//
#define STATUS_EVENT_DONE                ((int32_t)0x40000012L)
...
//
#define STATUS_EVENT_PENDING             ((int32_t)0x40000013L)
...
//
#define STATUS_CHECKING_FILE_SYSTEM      ((int32_t)0x40000014L)
...
// %hs
//
#define STATUS_FATAL_APP_EXIT            ((int32_t)0x40000015L)    // winnt
...
//
#define STATUS_PREDEFINED_HANDLE         ((int32_t)0x40000016L)
...
//
#define STATUS_WAS_UNLOCKED              ((int32_t)0x40000017L)
...
// %hs
//
#define STATUS_SERVICE_NOTIFICATION      ((int32_t)0x40000018L)
...
//
#define STATUS_WAS_LOCKED                ((int32_t)0x40000019L)
...
//
#define STATUS_LOG_HARD_ERROR            ((int32_t)0x4000001AL)
...
//
#define STATUS_ALREADY_WIN32             ((int32_t)0x4000001BL)
...
//
#define STATUS_WX86_UNSIMULATE           ((int32_t)0x4000001CL)
...
// Exception status code used by Win32 x86 emulation subsystem.
//
#define STATUS_WX86_CONTINUE             ((int32_t)0x4000001DL)
...
// Exception status code used by Win32 x86 emulation subsystem.
//
#define STATUS_WX86_SINGLE_STEP          ((int32_t)0x4000001EL)
...
// Exception status code used by Win32 x86 emulation subsystem.
//
#define STATUS_WX86_BREAKPOINT           ((int32_t)0x4000001FL)
...
// Exception status code used by Win32 x86 emulation subsystem.
//
#define STATUS_WX86_EXCEPTION_CONTINUE   ((int32_t)0x40000020L)
...
// Exception status code used by Win32 x86 emulation subsystem.
//
#define STATUS_WX86_EXCEPTION_LASTCHANCE ((int32_t)0x40000021L)
...
// Exception status code used by Win32 x86 emulation subsystem.
//
#define STATUS_WX86_EXCEPTION_CHAIN      ((int32_t)0x40000022L)
...
//
#define STATUS_IMAGE_MACHINE_TYPE_MISMATCH_EXE ((int32_t)0x40000023L)
...
//
#define STATUS_NO_YIELD_PERFORMED        ((int32_t)0x40000024L)
...
//
#define STATUS_TIMER_RESUME_IGNORED      ((int32_t)0x40000025L)
...
//
#define STATUS_ARBITRATION_UNHANDLED     ((int32_t)0x40000026L)
...
//
#define STATUS_CARDBUS_NOT_SUPPORTED     ((int32_t)0x40000027L)
...
// Exception status code used by Win32 x86 emulation subsystem.
//
#define STATUS_WX86_CREATEWX86TIB        ((int32_t)0x40000028L)
...
//
#define STATUS_MP_PROCESSOR_MISMATCH     ((int32_t)0x40000029L)
...
//
#define STATUS_HIBERNATED                ((int32_t)0x4000002AL)    
...
//
#define STATUS_RESUME_HIBERNATION        ((int32_t)0x4000002BL)    
...
//
#define STATUS_FIRMWARE_UPDATED          ((int32_t)0x4000002CL)
...
//
#define STATUS_DRIVERS_LEAKING_LOCKED_PAGES ((int32_t)0x4000002DL)
...
//
#define STATUS_MESSAGE_RETRIEVED         ((int32_t)0x4000002EL)
...
//
#define STATUS_SYSTEM_POWERSTATE_TRANSITION ((int32_t)0x4000002FL)    
...
//
#define STATUS_ALPC_CHECK_COMPLETION_LIST ((int32_t)0x40000030L)
...
//
#define STATUS_SYSTEM_POWERSTATE_COMPLEX_TRANSITION ((int32_t)0x40000031L)    
...
//
#define STATUS_ACCESS_AUDIT_BY_POLICY    ((int32_t)0x40000032L)    
...
//
#define STATUS_ABANDON_HIBERFILE         ((int32_t)0x40000033L)
...
//
#define STATUS_BIZRULES_NOT_ENABLED      ((int32_t)0x40000034L)
...
//
#define STATUS_FT_READ_FROM_COPY         ((int32_t)0x40000035L)
...
//
#define STATUS_IMAGE_AT_DIFFERENT_BASE   ((int32_t)0x40000036L)
...
//
#define STATUS_PATCH_DEFERRED            ((int32_t)0x40000037L)
...
//
#define DBG_REPLY_LATER                  ((int32_t)0x40010001L)    // winnt
...
//
#define DBG_UNABLE_TO_PROVIDE_HANDLE     ((int32_t)0x40010002L)
...
//
#define DBG_TERMINATE_THREAD             ((int32_t)0x40010003L)    // winnt
...
//
#define DBG_TERMINATE_PROCESS            ((int32_t)0x40010004L)    // winnt
...
//
#define DBG_CONTROL_C                    ((int32_t)0x40010005L)    // winnt
...
//
#define DBG_PRINTEXCEPTION_C             ((int32_t)0x40010006L)    // winnt
...
//
#define DBG_RIPEXCEPTION                 ((int32_t)0x40010007L)    // winnt
...
//
#define DBG_CONTROL_BREAK                ((int32_t)0x40010008L)    // winnt
...
//
#define DBG_COMMAND_EXCEPTION            ((int32_t)0x40010009L)    // winnt
...
// Debugger printed exception on control C.
//
#define DBG_PRINTEXCEPTION_WIDE_C        ((int32_t)0x4001000AL)    // winnt
...
//
#define STATUS_HEURISTIC_DAMAGE_POSSIBLE ((int32_t)0x40190001L)
...
//
#define STATUS_GUARD_PAGE_VIOLATION      ((int32_t)0x80000001L)    // winnt
...
//
#define STATUS_DATATYPE_MISALIGNMENT     ((int32_t)0x80000002L)    // winnt
...
//
#define STATUS_BREAKPOINT                ((int32_t)0x80000003L)    // winnt
...
//
#define STATUS_SINGLE_STEP               ((int32_t)0x80000004L)    // winnt
...
//
#define STATUS_BUFFER_OVERFLOW           ((int32_t)0x80000005L)
...
//
#define STATUS_NO_MORE_FILES             ((int32_t)0x80000006L)
...
//
#define STATUS_WAKE_SYSTEM_DEBUGGER      ((int32_t)0x80000007L)
...
//
#define STATUS_HANDLES_CLOSED            ((int32_t)0x8000000AL)
...
//
#define STATUS_NO_INHERITANCE            ((int32_t)0x8000000BL)
...
//
#define STATUS_GUID_SUBSTITUTION_MADE    ((int32_t)0x8000000CL)
...
//
#define STATUS_PARTIAL_COPY              ((int32_t)0x8000000DL)
...
//
#define STATUS_DEVICE_PAPER_EMPTY        ((int32_t)0x8000000EL)
...
//
#define STATUS_DEVICE_POWERED_OFF        ((int32_t)0x8000000FL)
...
//
#define STATUS_DEVICE_OFF_LINE           ((int32_t)0x80000010L)
...
//
#define STATUS_DEVICE_BUSY               ((int32_t)0x80000011L)
...
//
#define STATUS_NO_MORE_EAS               ((int32_t)0x80000012L)
...
//
#define STATUS_INVALID_EA_NAME           ((int32_t)0x80000013L)
...
//
#define STATUS_EA_LIST_INCONSISTENT      ((int32_t)0x80000014L)
...
//
#define STATUS_INVALID_EA_FLAG           ((int32_t)0x80000015L)
...
//
#define STATUS_VERIFY_REQUIRED           ((int32_t)0x80000016L)
...
//
#define STATUS_EXTRANEOUS_INFORMATION    ((int32_t)0x80000017L)
...
//
#define STATUS_RXACT_COMMIT_NECESSARY    ((int32_t)0x80000018L)
...
//
#define STATUS_NO_MORE_ENTRIES           ((int32_t)0x8000001AL)
...
//
#define STATUS_FILEMARK_DETECTED         ((int32_t)0x8000001BL)
...
//
#define STATUS_MEDIA_CHANGED             ((int32_t)0x8000001CL)
...
//
#define STATUS_BUS_RESET                 ((int32_t)0x8000001DL)
...
//
#define STATUS_END_OF_MEDIA              ((int32_t)0x8000001EL)
...
//
#define STATUS_BEGINNING_OF_MEDIA        ((int32_t)0x8000001FL)
...
// The media may have changed.
//
#define STATUS_MEDIA_CHECK               ((int32_t)0x80000020L)
...
//
#define STATUS_SETMARK_DETECTED          ((int32_t)0x80000021L)
...
//
#define STATUS_NO_DATA_DETECTED          ((int32_t)0x80000022L)
...
//
#define STATUS_REDIRECTOR_HAS_OPEN_HANDLES ((int32_t)0x80000023L)
...
//
#define STATUS_SERVER_HAS_OPEN_HANDLES   ((int32_t)0x80000024L)
...
//
#define STATUS_ALREADY_DISCONNECTED      ((int32_t)0x80000025L)
...
//
#define STATUS_LONGJUMP                  ((int32_t)0x80000026L)    // winnt
...
//
#define STATUS_CLEANER_CARTRIDGE_INSTALLED ((int32_t)0x80000027L)
...
//
#define STATUS_PLUGPLAY_QUERY_VETOED     ((int32_t)0x80000028L)
...
//
#define STATUS_UNWIND_CONSOLIDATE        ((int32_t)0x80000029L)    // winnt
...
//
#define STATUS_REGISTRY_HIVE_RECOVERED   ((int32_t)0x8000002AL)
...
//
#define STATUS_DLL_MIGHT_BE_INSECURE     ((int32_t)0x8000002BL)
...
//
#define STATUS_DLL_MIGHT_BE_INCOMPATIBLE ((int32_t)0x8000002CL)
...
//
#define STATUS_STOPPED_ON_SYMLINK        ((int32_t)0x8000002DL)
...
//
#define STATUS_CANNOT_GRANT_REQUESTED_OPLOCK ((int32_t)0x8000002EL)
...
//
#define STATUS_NO_ACE_CONDITION          ((int32_t)0x8000002FL)
...
//
#define STATUS_DEVICE_SUPPORT_IN_PROGRESS ((int32_t)0x80000030L)
...
//
#define STATUS_DEVICE_POWER_CYCLE_REQUIRED ((int32_t)0x80000031L)
...
//
#define STATUS_NO_WORK_DONE              ((int32_t)0x80000032L)
...
//
#define STATUS_RETURN_ADDRESS_HIJACK_ATTEMPT ((int32_t)0x80000033L)
...
//
#define DBG_EXCEPTION_NOT_HANDLED        ((int32_t)0x80010001L)    // winnt
...
//
#define STATUS_CLUSTER_NODE_ALREADY_UP   ((int32_t)0x80130001L)
...
//
#define STATUS_CLUSTER_NODE_ALREADY_DOWN ((int32_t)0x80130002L)
...
//
#define STATUS_CLUSTER_NETWORK_ALREADY_ONLINE ((int32_t)0x80130003L)
...
//
#define STATUS_CLUSTER_NETWORK_ALREADY_OFFLINE ((int32_t)0x80130004L)
...
//
#define STATUS_CLUSTER_NODE_ALREADY_MEMBER ((int32_t)0x80130005L)
...
//
#define STATUS_FLT_BUFFER_TOO_SMALL      ((int32_t)0x801C0001L)
...
//
#define STATUS_FVE_PARTIAL_METADATA      ((int32_t)0x80210001L)
...
//
#define STATUS_FVE_TRANSIENT_STATE       ((int32_t)0x80210002L)
...
//
#define STATUS_CLOUD_FILE_PROPERTY_BLOB_CHECKSUM_MISMATCH ((int32_t)0x8000CF00L)
...
//
#define STATUS_UNSUCCESSFUL              ((int32_t)0xC0000001L)
...
//
#define STATUS_NOT_IMPLEMENTED           ((int32_t)0xC0000002L)
...
//
#define STATUS_INVALID_INFO_CLASS        ((int32_t)0xC0000003L)    // ntsubauth
...
//
#define STATUS_INFO_LENGTH_MISMATCH      ((int32_t)0xC0000004L)
...
//
#define STATUS_ACCESS_VIOLATION          ((int32_t)0xC0000005L)    // winnt
...
//
#define STATUS_IN_PAGE_ERROR             ((int32_t)0xC0000006L)    // winnt
...
//
#define STATUS_PAGEFILE_QUOTA            ((int32_t)0xC0000007L)
...
//
#define STATUS_INVALID_HANDLE            ((int32_t)0xC0000008L)    // winnt
...
//
#define STATUS_BAD_INITIAL_STACK         ((int32_t)0xC0000009L)
...
//
#define STATUS_BAD_INITIAL_PC            ((int32_t)0xC000000AL)
...
//
#define STATUS_INVALID_CID               ((int32_t)0xC000000BL)
...
//
#define STATUS_TIMER_NOT_CANCELED        ((int32_t)0xC000000CL)
...
//
#define STATUS_INVALID_PARAMETER         ((int32_t)0xC000000DL)    // winnt
...
//
#define STATUS_NO_SUCH_DEVICE            ((int32_t)0xC000000EL)
...
//
#define STATUS_NO_SUCH_FILE              ((int32_t)0xC000000FL)
...
//
#define STATUS_INVALID_DEVICE_REQUEST    ((int32_t)0xC0000010L)
...
//
#define STATUS_END_OF_FILE               ((int32_t)0xC0000011L)
...
//
#define STATUS_WRONG_VOLUME              ((int32_t)0xC0000012L)
...
//
#define STATUS_NO_MEDIA_IN_DEVICE        ((int32_t)0xC0000013L)
...
//
#define STATUS_UNRECOGNIZED_MEDIA        ((int32_t)0xC0000014L)
...
//
#define STATUS_NONEXISTENT_SECTOR        ((int32_t)0xC0000015L)
...
//
#define STATUS_MORE_PROCESSING_REQUIRED  ((int32_t)0xC0000016L)
...
//
#define STATUS_NO_MEMORY                 ((int32_t)0xC0000017L)    // winnt
...
//
#define STATUS_CONFLICTING_ADDRESSES     ((int32_t)0xC0000018L)
...
//
#define STATUS_NOT_MAPPED_VIEW           ((int32_t)0xC0000019L)
...
//
#define STATUS_UNABLE_TO_FREE_VM         ((int32_t)0xC000001AL)
...
//
#define STATUS_UNABLE_TO_DELETE_SECTION  ((int32_t)0xC000001BL)
...
//
#define STATUS_INVALID_SYSTEM_SERVICE    ((int32_t)0xC000001CL)
...
//
#define STATUS_ILLEGAL_INSTRUCTION       ((int32_t)0xC000001DL)    // winnt
...
//
#define STATUS_INVALID_LOCK_SEQUENCE     ((int32_t)0xC000001EL)
...
//
#define STATUS_INVALID_VIEW_SIZE         ((int32_t)0xC000001FL)
...
//
#define STATUS_INVALID_FILE_FOR_SECTION  ((int32_t)0xC0000020L)
...
//
#define STATUS_ALREADY_COMMITTED         ((int32_t)0xC0000021L)
...
//
#define STATUS_ACCESS_DENIED             ((int32_t)0xC0000022L)
...
// The buffer is too small to contain the entry. No information has been written to the buffer.
//
#define STATUS_BUFFER_TOO_SMALL          ((int32_t)0xC0000023L)
...
//
#define STATUS_OBJECT_TYPE_MISMATCH      ((int32_t)0xC0000024L)
...
//
#define STATUS_NONCONTINUABLE_EXCEPTION  ((int32_t)0xC0000025L)    // winnt
...
//
#define STATUS_INVALID_DISPOSITION       ((int32_t)0xC0000026L)    // winnt
...
//
#define STATUS_UNWIND                    ((int32_t)0xC0000027L)
...
//
#define STATUS_BAD_STACK                 ((int32_t)0xC0000028L)
...
//
#define STATUS_INVALID_UNWIND_TARGET     ((int32_t)0xC0000029L)
...
//
#define STATUS_NOT_LOCKED                ((int32_t)0xC000002AL)
...
//
#define STATUS_PARITY_ERROR              ((int32_t)0xC000002BL)
...
//
#define STATUS_UNABLE_TO_DECOMMIT_VM     ((int32_t)0xC000002CL)
...
//
#define STATUS_NOT_COMMITTED             ((int32_t)0xC000002DL)
...
//
#define STATUS_INVALID_PORT_ATTRIBUTES   ((int32_t)0xC000002EL)
...
//
#define STATUS_PORT_MESSAGE_TOO_LONG     ((int32_t)0xC000002FL)
...
//
#define STATUS_INVALID_PARAMETER_MIX     ((int32_t)0xC0000030L)
...
//
#define STATUS_INVALID_QUOTA_LOWER       ((int32_t)0xC0000031L)
...
//
#define STATUS_DISK_CORRUPT_ERROR        ((int32_t)0xC0000032L)
...
// Object Name invalid.
//
#define STATUS_OBJECT_NAME_INVALID       ((int32_t)0xC0000033L)
...
//
#define STATUS_OBJECT_NAME_NOT_FOUND     ((int32_t)0xC0000034L)
...
//
#define STATUS_OBJECT_NAME_COLLISION     ((int32_t)0xC0000035L)
...
//
#define STATUS_PORT_DO_NOT_DISTURB       ((int32_t)0xC0000036L)
...
//
#define STATUS_PORT_DISCONNECTED         ((int32_t)0xC0000037L)
...
//
#define STATUS_DEVICE_ALREADY_ATTACHED   ((int32_t)0xC0000038L)
...
//
#define STATUS_OBJECT_PATH_INVALID       ((int32_t)0xC0000039L)
...
//
#define STATUS_OBJECT_PATH_NOT_FOUND     ((int32_t)0xC000003AL)
...
// Object Path Component was not a directory object.
//
#define STATUS_OBJECT_PATH_SYNTAX_BAD    ((int32_t)0xC000003BL)
...
//
#define STATUS_DATA_OVERRUN              ((int32_t)0xC000003CL)
...
//
#define STATUS_DATA_LATE_ERROR           ((int32_t)0xC000003DL)
...
//
#define STATUS_DATA_ERROR                ((int32_t)0xC000003EL)
...
//
#define STATUS_CRC_ERROR                 ((int32_t)0xC000003FL)
...
//
#define STATUS_SECTION_TOO_BIG           ((int32_t)0xC0000040L)
...
//
#define STATUS_PORT_CONNECTION_REFUSED   ((int32_t)0xC0000041L)
...
//
#define STATUS_INVALID_PORT_HANDLE       ((int32_t)0xC0000042L)
...
//
#define STATUS_SHARING_VIOLATION         ((int32_t)0xC0000043L)
...
//
#define STATUS_QUOTA_EXCEEDED            ((int32_t)0xC0000044L)
...
//
#define STATUS_INVALID_PAGE_PROTECTION   ((int32_t)0xC0000045L)
...
//
#define STATUS_MUTANT_NOT_OWNED          ((int32_t)0xC0000046L)
...
//
#define STATUS_SEMAPHORE_LIMIT_EXCEEDED  ((int32_t)0xC0000047L)
...
//
#define STATUS_PORT_ALREADY_SET          ((int32_t)0xC0000048L)
...
//
#define STATUS_SECTION_NOT_IMAGE         ((int32_t)0xC0000049L)
...
//
#define STATUS_SUSPEND_COUNT_EXCEEDED    ((int32_t)0xC000004AL)
...
//
#define STATUS_THREAD_IS_TERMINATING     ((int32_t)0xC000004BL)
...
//
#define STATUS_BAD_WORKING_SET_LIMIT     ((int32_t)0xC000004CL)
...
//
#define STATUS_INCOMPATIBLE_FILE_MAP     ((int32_t)0xC000004DL)
...
//
#define STATUS_SECTION_PROTECTION        ((int32_t)0xC000004EL)
...
//
#define STATUS_EAS_NOT_SUPPORTED         ((int32_t)0xC000004FL)
...
//
#define STATUS_EA_TOO_LARGE              ((int32_t)0xC0000050L)
...
//
#define STATUS_NONEXISTENT_EA_ENTRY      ((int32_t)0xC0000051L)
...
//
#define STATUS_NO_EAS_ON_FILE            ((int32_t)0xC0000052L)
...
//
#define STATUS_EA_CORRUPT_ERROR          ((int32_t)0xC0000053L)
...
//
#define STATUS_FILE_LOCK_CONFLICT        ((int32_t)0xC0000054L)
...
//
#define STATUS_LOCK_NOT_GRANTED          ((int32_t)0xC0000055L)
...
//
#define STATUS_DELETE_PENDING            ((int32_t)0xC0000056L)
...
//
#define STATUS_CTL_FILE_NOT_SUPPORTED    ((int32_t)0xC0000057L)
...
//
#define STATUS_UNKNOWN_REVISION          ((int32_t)0xC0000058L)
...
//
#define STATUS_REVISION_MISMATCH         ((int32_t)0xC0000059L)
...
//
#define STATUS_INVALID_OWNER             ((int32_t)0xC000005AL)
...
//
#define STATUS_INVALID_PRIMARY_GROUP     ((int32_t)0xC000005BL)
...
//
#define STATUS_NO_IMPERSONATION_TOKEN    ((int32_t)0xC000005CL)
...
//
#define STATUS_CANT_DISABLE_MANDATORY    ((int32_t)0xC000005DL)
...
//
#define STATUS_NO_LOGON_SERVERS          ((int32_t)0xC000005EL)
...
//
#define STATUS_NO_SUCH_LOGON_SESSION     ((int32_t)0xC000005FL)
...
//
#define STATUS_NO_SUCH_PRIVILEGE         ((int32_t)0xC0000060L)
...
//
#define STATUS_PRIVILEGE_NOT_HELD        ((int32_t)0xC0000061L)
...
//
#define STATUS_INVALID_ACCOUNT_NAME      ((int32_t)0xC0000062L)
...
//
#define STATUS_USER_EXISTS               ((int32_t)0xC0000063L)
...
//
#define STATUS_NO_SUCH_USER              ((int32_t)0xC0000064L)     // ntsubauth
...
//
#define STATUS_GROUP_EXISTS              ((int32_t)0xC0000065L)
...
//
#define STATUS_NO_SUCH_GROUP             ((int32_t)0xC0000066L)
...
//
#define STATUS_MEMBER_IN_GROUP           ((int32_t)0xC0000067L)
...
//
#define STATUS_MEMBER_NOT_IN_GROUP       ((int32_t)0xC0000068L)
...
//
#define STATUS_LAST_ADMIN                ((int32_t)0xC0000069L)
...
//
#define STATUS_WRONG_PASSWORD            ((int32_t)0xC000006AL)     // ntsubauth
...
//
#define STATUS_ILL_FORMED_PASSWORD       ((int32_t)0xC000006BL)
...
//
#define STATUS_PASSWORD_RESTRICTION      ((int32_t)0xC000006CL)     // ntsubauth
...
//
#define STATUS_LOGON_FAILURE             ((int32_t)0xC000006DL)     // ntsubauth
...
//
#define STATUS_ACCOUNT_RESTRICTION       ((int32_t)0xC000006EL)     // ntsubauth
...
//
#define STATUS_INVALID_LOGON_HOURS       ((int32_t)0xC000006FL)     // ntsubauth
...
//
#define STATUS_INVALID_WORKSTATION       ((int32_t)0xC0000070L)     // ntsubauth
...
//
#define STATUS_PASSWORD_EXPIRED          ((int32_t)0xC0000071L)     // ntsubauth
...
//
#define STATUS_ACCOUNT_DISABLED          ((int32_t)0xC0000072L)     // ntsubauth
...
//
#define STATUS_NONE_MAPPED               ((int32_t)0xC0000073L)
...
//
#define STATUS_TOO_MANY_LUIDS_REQUESTED  ((int32_t)0xC0000074L)
...
//
#define STATUS_LUIDS_EXHAUSTED           ((int32_t)0xC0000075L)
...
//
#define STATUS_INVALID_SUB_AUTHORITY     ((int32_t)0xC0000076L)
...
//
#define STATUS_INVALID_ACL               ((int32_t)0xC0000077L)
...
//
#define STATUS_INVALID_SID               ((int32_t)0xC0000078L)
...
//
#define STATUS_INVALID_SECURITY_DESCR    ((int32_t)0xC0000079L)
...
//
#define STATUS_PROCEDURE_NOT_FOUND       ((int32_t)0xC000007AL)
...
//
#define STATUS_INVALID_IMAGE_FORMAT      ((int32_t)0xC000007BL)
...
//
#define STATUS_NO_TOKEN                  ((int32_t)0xC000007CL)
...
//
#define STATUS_BAD_INHERITANCE_ACL       ((int32_t)0xC000007DL)
...
//
#define STATUS_RANGE_NOT_LOCKED          ((int32_t)0xC000007EL)
...
//
#define STATUS_DISK_FULL                 ((int32_t)0xC000007FL)
...
//
#define STATUS_SERVER_DISABLED           ((int32_t)0xC0000080L)
...
//
#define STATUS_SERVER_NOT_DISABLED       ((int32_t)0xC0000081L)
...
//
#define STATUS_TOO_MANY_GUIDS_REQUESTED  ((int32_t)0xC0000082L)
...
//
#define STATUS_GUIDS_EXHAUSTED           ((int32_t)0xC0000083L)
...
//
#define STATUS_INVALID_ID_AUTHORITY      ((int32_t)0xC0000084L)
...
//
#define STATUS_AGENTS_EXHAUSTED          ((int32_t)0xC0000085L)
...
//
#define STATUS_INVALID_VOLUME_LABEL      ((int32_t)0xC0000086L)
...
//
#define STATUS_SECTION_NOT_EXTENDED      ((int32_t)0xC0000087L)
...
//
#define STATUS_NOT_MAPPED_DATA           ((int32_t)0xC0000088L)
...
//
#define STATUS_RESOURCE_DATA_NOT_FOUND   ((int32_t)0xC0000089L)
...
//
#define STATUS_RESOURCE_TYPE_NOT_FOUND   ((int32_t)0xC000008AL)
...
//
#define STATUS_RESOURCE_NAME_NOT_FOUND   ((int32_t)0xC000008BL)
...
//
#define STATUS_ARRAY_BOUNDS_EXCEEDED     ((int32_t)0xC000008CL)    // winnt
...
//
#define STATUS_FLOAT_DENORMAL_OPERAND    ((int32_t)0xC000008DL)    // winnt
...
//
#define STATUS_FLOAT_DIVIDE_BY_ZERO      ((int32_t)0xC000008EL)    // winnt
...
//
#define STATUS_FLOAT_INEXACT_RESULT      ((int32_t)0xC000008FL)    // winnt
...
//
#define STATUS_FLOAT_INVALID_OPERATION   ((int32_t)0xC0000090L)    // winnt
...
//
#define STATUS_FLOAT_OVERFLOW            ((int32_t)0xC0000091L)    // winnt
...
//
#define STATUS_FLOAT_STACK_CHECK         ((int32_t)0xC0000092L)    // winnt
...
//
#define STATUS_FLOAT_UNDERFLOW           ((int32_t)0xC0000093L)    // winnt
...
//
#define STATUS_INTEGER_DIVIDE_BY_ZERO    ((int32_t)0xC0000094L)    // winnt
...
// Integer overflow.
//
#define STATUS_INTEGER_OVERFLOW          ((int32_t)0xC0000095L)    // winnt
...
//
#define STATUS_PRIVILEGED_INSTRUCTION    ((int32_t)0xC0000096L)    // winnt
...
//
#define STATUS_TOO_MANY_PAGING_FILES     ((int32_t)0xC0000097L)
...
//
#define STATUS_FILE_INVALID              ((int32_t)0xC0000098L)
...
//
#define STATUS_ALLOTTED_SPACE_EXCEEDED   ((int32_t)0xC0000099L)
...
//
#define STATUS_INSUFFICIENT_RESOURCES    ((int32_t)0xC000009AL)     // ntsubauth
...
//
#define STATUS_DFS_EXIT_PATH_FOUND       ((int32_t)0xC000009BL)
...
//
#define STATUS_DEVICE_DATA_ERROR         ((int32_t)0xC000009CL)
...
//
#define STATUS_DEVICE_NOT_CONNECTED      ((int32_t)0xC000009DL)
...
//
#define STATUS_DEVICE_POWER_FAILURE      ((int32_t)0xC000009EL)
...
//
#define STATUS_FREE_VM_NOT_AT_BASE       ((int32_t)0xC000009FL)
...
//
#define STATUS_MEMORY_NOT_ALLOCATED      ((int32_t)0xC00000A0L)
...
//
#define STATUS_WORKING_SET_QUOTA         ((int32_t)0xC00000A1L)
...
//
#define STATUS_MEDIA_WRITE_PROTECTED     ((int32_t)0xC00000A2L)
...
//
#define STATUS_DEVICE_NOT_READY          ((int32_t)0xC00000A3L)
...
//
#define STATUS_INVALID_GROUP_ATTRIBUTES  ((int32_t)0xC00000A4L)
...
//
#define STATUS_BAD_IMPERSONATION_LEVEL   ((int32_t)0xC00000A5L)
...
//
#define STATUS_CANT_OPEN_ANONYMOUS       ((int32_t)0xC00000A6L)
...
//
#define STATUS_BAD_VALIDATION_CLASS      ((int32_t)0xC00000A7L)
...
//
#define STATUS_BAD_TOKEN_TYPE            ((int32_t)0xC00000A8L)
...
// The type of a token object is inappropriate for its attempted use.
//
#define STATUS_BAD_MASTER_BOOT_RECORD    ((int32_t)0xC00000A9L)
...
//
#define STATUS_INSTRUCTION_MISALIGNMENT  ((int32_t)0xC00000AAL)
...
//
#define STATUS_INSTANCE_NOT_AVAILABLE    ((int32_t)0xC00000ABL)
...
//
#define STATUS_PIPE_NOT_AVAILABLE        ((int32_t)0xC00000ACL)
...
//
#define STATUS_INVALID_PIPE_STATE        ((int32_t)0xC00000ADL)
...
//
#define STATUS_PIPE_BUSY                 ((int32_t)0xC00000AEL)
...
//
#define STATUS_ILLEGAL_FUNCTION          ((int32_t)0xC00000AFL)
...
//
#define STATUS_PIPE_DISCONNECTED         ((int32_t)0xC00000B0L)
...
//
#define STATUS_PIPE_CLOSING              ((int32_t)0xC00000B1L)
...
//
#define STATUS_PIPE_CONNECTED            ((int32_t)0xC00000B2L)
...
//
#define STATUS_PIPE_LISTENING            ((int32_t)0xC00000B3L)
...
//
#define STATUS_INVALID_READ_MODE         ((int32_t)0xC00000B4L)
...
//
#define STATUS_IO_TIMEOUT                ((int32_t)0xC00000B5L)
...
//
#define STATUS_FILE_FORCED_CLOSED        ((int32_t)0xC00000B6L)
...
//
#define STATUS_PROFILING_NOT_STARTED     ((int32_t)0xC00000B7L)
...
//
#define STATUS_PROFILING_NOT_STOPPED     ((int32_t)0xC00000B8L)
...
//
#define STATUS_COULD_NOT_INTERPRET       ((int32_t)0xC00000B9L)
...
//
#define STATUS_FILE_IS_A_DIRECTORY       ((int32_t)0xC00000BAL)
...
//
#define STATUS_NOT_SUPPORTED             ((int32_t)0xC00000BBL)
...
//
#define STATUS_REMOTE_NOT_LISTENING      ((int32_t)0xC00000BCL)
...
//
#define STATUS_DUPLICATE_NAME            ((int32_t)0xC00000BDL)
...
//
#define STATUS_BAD_NETWORK_PATH          ((int32_t)0xC00000BEL)
...
// The network is busy.
//
#define STATUS_NETWORK_BUSY              ((int32_t)0xC00000BFL)
...
//
#define STATUS_DEVICE_DOES_NOT_EXIST     ((int32_t)0xC00000C0L)
...
//
#define STATUS_TOO_MANY_COMMANDS         ((int32_t)0xC00000C1L)
...
//
#define STATUS_ADAPTER_HARDWARE_ERROR    ((int32_t)0xC00000C2L)
...
//
#define STATUS_INVALID_NETWORK_RESPONSE  ((int32_t)0xC00000C3L)
...
//
#define STATUS_UNEXPECTED_NETWORK_ERROR  ((int32_t)0xC00000C4L)
...
//
#define STATUS_BAD_REMOTE_ADAPTER        ((int32_t)0xC00000C5L)
...
//
#define STATUS_PRINT_QUEUE_FULL          ((int32_t)0xC00000C6L)
...
//
#define STATUS_NO_SPOOL_SPACE            ((int32_t)0xC00000C7L)
...
//
#define STATUS_PRINT_CANCELLED           ((int32_t)0xC00000C8L)
...
//
#define STATUS_NETWORK_NAME_DELETED      ((int32_t)0xC00000C9L)
...
//
#define STATUS_NETWORK_ACCESS_DENIED     ((int32_t)0xC00000CAL)
...
//
#define STATUS_BAD_DEVICE_TYPE           ((int32_t)0xC00000CBL)
...
//
#define STATUS_BAD_NETWORK_NAME          ((int32_t)0xC00000CCL)
...
//
#define STATUS_TOO_MANY_NAMES            ((int32_t)0xC00000CDL)
...
//
#define STATUS_TOO_MANY_SESSIONS         ((int32_t)0xC00000CEL)
...
//
#define STATUS_SHARING_PAUSED            ((int32_t)0xC00000CFL)
...
//
#define STATUS_REQUEST_NOT_ACCEPTED      ((int32_t)0xC00000D0L)
...
//
#define STATUS_REDIRECTOR_PAUSED         ((int32_t)0xC00000D1L)
...
//
#define STATUS_NET_WRITE_FAULT           ((int32_t)0xC00000D2L)
...
//
#define STATUS_PROFILING_AT_LIMIT        ((int32_t)0xC00000D3L)
...
//
#define STATUS_NOT_SAME_DEVICE           ((int32_t)0xC00000D4L)
...
//
#define STATUS_FILE_RENAMED              ((int32_t)0xC00000D5L)
...
//
#define STATUS_VIRTUAL_CIRCUIT_CLOSED    ((int32_t)0xC00000D6L)
...
//
#define STATUS_NO_SECURITY_ON_OBJECT     ((int32_t)0xC00000D7L)
...
//
#define STATUS_CANT_WAIT                 ((int32_t)0xC00000D8L)
...
//
#define STATUS_PIPE_EMPTY                ((int32_t)0xC00000D9L)
...
//
#define STATUS_CANT_ACCESS_DOMAIN_INFO   ((int32_t)0xC00000DAL)
...
//
#define STATUS_CANT_TERMINATE_SELF       ((int32_t)0xC00000DBL)
...
//
#define STATUS_INVALID_SERVER_STATE      ((int32_t)0xC00000DCL)
...
//
#define STATUS_INVALID_DOMAIN_STATE      ((int32_t)0xC00000DDL)
...
//
#define STATUS_INVALID_DOMAIN_ROLE       ((int32_t)0xC00000DEL)
...
//
#define STATUS_NO_SUCH_DOMAIN            ((int32_t)0xC00000DFL)
...
//
#define STATUS_DOMAIN_EXISTS             ((int32_t)0xC00000E0L)
...
//
#define STATUS_DOMAIN_LIMIT_EXCEEDED     ((int32_t)0xC00000E1L)
...
//
#define STATUS_OPLOCK_NOT_GRANTED        ((int32_t)0xC00000E2L)
...
//
#define STATUS_INVALID_OPLOCK_PROTOCOL   ((int32_t)0xC00000E3L)
...
//
#define STATUS_INTERNAL_DB_CORRUPTION    ((int32_t)0xC00000E4L)
...
//
#define STATUS_INTERNAL_ERROR            ((int32_t)0xC00000E5L)
...
//
#define STATUS_GENERIC_NOT_MAPPED        ((int32_t)0xC00000E6L)
...
//
#define STATUS_BAD_DESCRIPTOR_FORMAT     ((int32_t)0xC00000E7L)
...
//
#define STATUS_INVALID_USER_BUFFER       ((int32_t)0xC00000E8L)
...
//
#define STATUS_UNEXPECTED_IO_ERROR       ((int32_t)0xC00000E9L)
...
//
#define STATUS_UNEXPECTED_MM_CREATE_ERR  ((int32_t)0xC00000EAL)
...
// If an MM error is returned which is not defined in the standard FsRtl filter, it is converted to one of the following errors which is guaranteed to be in the filter. In this case information is lost, however, the filter correctly handles the exception.
//
#define STATUS_UNEXPECTED_MM_MAP_ERROR   ((int32_t)0xC00000EBL)
...
// If an MM error is returned which is not defined in the standard FsRtl filter, it is converted to one of the following errors which is guaranteed to be in the filter. In this case information is lost, however, the filter correctly handles the exception.
//
#define STATUS_UNEXPECTED_MM_EXTEND_ERR  ((int32_t)0xC00000ECL)
...
//
#define STATUS_NOT_LOGON_PROCESS         ((int32_t)0xC00000EDL)
...
//
#define STATUS_LOGON_SESSION_EXISTS      ((int32_t)0xC00000EEL)
...
//
#define STATUS_INVALID_PARAMETER_1       ((int32_t)0xC00000EFL)
...
//
#define STATUS_INVALID_PARAMETER_2       ((int32_t)0xC00000F0L)
...
//
#define STATUS_INVALID_PARAMETER_3       ((int32_t)0xC00000F1L)
...
//
#define STATUS_INVALID_PARAMETER_4       ((int32_t)0xC00000F2L)
...
//
#define STATUS_INVALID_PARAMETER_5       ((int32_t)0xC00000F3L)
...
//
#define STATUS_INVALID_PARAMETER_6       ((int32_t)0xC00000F4L)
...
//
#define STATUS_INVALID_PARAMETER_7       ((int32_t)0xC00000F5L)
...
//
#define STATUS_INVALID_PARAMETER_8       ((int32_t)0xC00000F6L)
...
//
#define STATUS_INVALID_PARAMETER_9       ((int32_t)0xC00000F7L)
...
//
#define STATUS_INVALID_PARAMETER_10      ((int32_t)0xC00000F8L)
...
//
#define STATUS_INVALID_PARAMETER_11      ((int32_t)0xC00000F9L)
...
//
#define STATUS_INVALID_PARAMETER_12      ((int32_t)0xC00000FAL)
...
//
#define STATUS_REDIRECTOR_NOT_STARTED    ((int32_t)0xC00000FBL)
...
//
#define STATUS_REDIRECTOR_STARTED        ((int32_t)0xC00000FCL)
...
//
#define STATUS_STACK_OVERFLOW            ((int32_t)0xC00000FDL)    // winnt
...
//
#define STATUS_NO_SUCH_PACKAGE           ((int32_t)0xC00000FEL)
...
//
#define STATUS_BAD_FUNCTION_TABLE        ((int32_t)0xC00000FFL)
...
//
#define STATUS_VARIABLE_NOT_FOUND        ((int32_t)0xC0000100L)
...
//
#define STATUS_DIRECTORY_NOT_EMPTY       ((int32_t)0xC0000101L)
...
//
#define STATUS_FILE_CORRUPT_ERROR        ((int32_t)0xC0000102L)
...
//
#define STATUS_NOT_A_DIRECTORY           ((int32_t)0xC0000103L)
...
//
#define STATUS_BAD_LOGON_SESSION_STATE   ((int32_t)0xC0000104L)
...
//
#define STATUS_LOGON_SESSION_COLLISION   ((int32_t)0xC0000105L)
...
//
#define STATUS_NAME_TOO_LONG             ((int32_t)0xC0000106L)
...
//
#define STATUS_FILES_OPEN                ((int32_t)0xC0000107L)
...
//
#define STATUS_CONNECTION_IN_USE         ((int32_t)0xC0000108L)
...
//
#define STATUS_MESSAGE_NOT_FOUND         ((int32_t)0xC0000109L)
...
//
#define STATUS_INVALID_LOGON_TYPE        ((int32_t)0xC000010BL)
...
//
#define STATUS_NO_GUID_TRANSLATION       ((int32_t)0xC000010CL)
...
//
#define STATUS_CANNOT_IMPERSONATE        ((int32_t)0xC000010DL)
...
//
#define STATUS_IMAGE_ALREADY_LOADED      ((int32_t)0xC000010EL)
...
//
#define STATUS_ABIOS_NOT_PRESENT         ((int32_t)0xC000010FL)
...
//
#define STATUS_ABIOS_LID_NOT_EXIST       ((int32_t)0xC0000110L)
...
//
#define STATUS_ABIOS_LID_ALREADY_OWNED   ((int32_t)0xC0000111L)
...
//
#define STATUS_ABIOS_NOT_LID_OWNER       ((int32_t)0xC0000112L)
...
//
#define STATUS_ABIOS_INVALID_COMMAND     ((int32_t)0xC0000113L)
...
//
#define STATUS_ABIOS_INVALID_LID         ((int32_t)0xC0000114L)
...
//
#define STATUS_ABIOS_SELECTOR_NOT_AVAILABLE ((int32_t)0xC0000115L)
...
//
#define STATUS_ABIOS_INVALID_SELECTOR    ((int32_t)0xC0000116L)
...
//
#define STATUS_NO_LDT                    ((int32_t)0xC0000117L)
...
//
#define STATUS_INVALID_LDT_SIZE          ((int32_t)0xC0000118L)
...
//
#define STATUS_INVALID_LDT_OFFSET        ((int32_t)0xC0000119L)
...
//
#define STATUS_INVALID_LDT_DESCRIPTOR    ((int32_t)0xC000011AL)
...
//
#define STATUS_INVALID_IMAGE_NE_FORMAT   ((int32_t)0xC000011BL)
...
//
#define STATUS_RXACT_INVALID_STATE       ((int32_t)0xC000011CL)
...
//
#define STATUS_RXACT_COMMIT_FAILURE      ((int32_t)0xC000011DL)
...
//
#define STATUS_MAPPED_FILE_SIZE_ZERO     ((int32_t)0xC000011EL)
...
//
#define STATUS_TOO_MANY_OPENED_FILES     ((int32_t)0xC000011FL)
...
//
#define STATUS_CANCELLED                 ((int32_t)0xC0000120L)
...
//
#define STATUS_CANNOT_DELETE             ((int32_t)0xC0000121L)
...
//
#define STATUS_INVALID_COMPUTER_NAME     ((int32_t)0xC0000122L)
...
//
#define STATUS_FILE_DELETED              ((int32_t)0xC0000123L)
...
//
#define STATUS_SPECIAL_ACCOUNT           ((int32_t)0xC0000124L)
...
//
#define STATUS_SPECIAL_GROUP             ((int32_t)0xC0000125L)
...
//
#define STATUS_SPECIAL_USER              ((int32_t)0xC0000126L)
...
//
#define STATUS_MEMBERS_PRIMARY_GROUP     ((int32_t)0xC0000127L)
...
//
#define STATUS_FILE_CLOSED               ((int32_t)0xC0000128L)
...
//
#define STATUS_TOO_MANY_THREADS          ((int32_t)0xC0000129L)
...
//
#define STATUS_THREAD_NOT_IN_PROCESS     ((int32_t)0xC000012AL)
...
//
#define STATUS_TOKEN_ALREADY_IN_USE      ((int32_t)0xC000012BL)
...
//
#define STATUS_PAGEFILE_QUOTA_EXCEEDED   ((int32_t)0xC000012CL)
...
//
#define STATUS_COMMITMENT_LIMIT          ((int32_t)0xC000012DL)
...
//
#define STATUS_INVALID_IMAGE_LE_FORMAT   ((int32_t)0xC000012EL)
...
//
#define STATUS_INVALID_IMAGE_NOT_MZ      ((int32_t)0xC000012FL)
...
//
#define STATUS_INVALID_IMAGE_PROTECT     ((int32_t)0xC0000130L)
...
//
#define STATUS_INVALID_IMAGE_WIN_16      ((int32_t)0xC0000131L)
...
//
#define STATUS_LOGON_SERVER_CONFLICT     ((int32_t)0xC0000132L)
...
//
#define STATUS_TIME_DIFFERENCE_AT_DC     ((int32_t)0xC0000133L)
...
//
#define STATUS_SYNCHRONIZATION_REQUIRED  ((int32_t)0xC0000134L)
...
//
#define STATUS_DLL_NOT_FOUND             ((int32_t)0xC0000135L)    // winnt
...
//
#define STATUS_OPEN_FAILED               ((int32_t)0xC0000136L)
...
//
#define STATUS_IO_PRIVILEGE_FAILED       ((int32_t)0xC0000137L)
...
//
#define STATUS_ORDINAL_NOT_FOUND         ((int32_t)0xC0000138L)    // winnt
...
//
#define STATUS_ENTRYPOINT_NOT_FOUND      ((int32_t)0xC0000139L)    // winnt
...
//
#define STATUS_CONTROL_C_EXIT            ((int32_t)0xC000013AL)    // winnt
...
//
#define STATUS_LOCAL_DISCONNECT          ((int32_t)0xC000013BL)
...
//
#define STATUS_REMOTE_DISCONNECT         ((int32_t)0xC000013CL)
...
//
#define STATUS_REMOTE_RESOURCES          ((int32_t)0xC000013DL)
...
//
#define STATUS_LINK_FAILED               ((int32_t)0xC000013EL)
...
//
#define STATUS_LINK_TIMEOUT              ((int32_t)0xC000013FL)
...
//
#define STATUS_INVALID_CONNECTION        ((int32_t)0xC0000140L)
...
//
#define STATUS_INVALID_ADDRESS           ((int32_t)0xC0000141L)
...
//
#define STATUS_DLL_INIT_FAILED           ((int32_t)0xC0000142L)    // winnt
...
//
#define STATUS_MISSING_SYSTEMFILE        ((int32_t)0xC0000143L)
...
//
#define STATUS_UNHANDLED_EXCEPTION       ((int32_t)0xC0000144L)
...
//
#define STATUS_APP_INIT_FAILURE          ((int32_t)0xC0000145L)
...
//
#define STATUS_PAGEFILE_CREATE_FAILED    ((int32_t)0xC0000146L)
...
//
#define STATUS_NO_PAGEFILE               ((int32_t)0xC0000147L)
...
//
#define STATUS_INVALID_LEVEL             ((int32_t)0xC0000148L)
...
//
#define STATUS_WRONG_PASSWORD_CORE       ((int32_t)0xC0000149L)
...
//
#define STATUS_ILLEGAL_FLOAT_CONTEXT     ((int32_t)0xC000014AL)
...
//
#define STATUS_PIPE_BROKEN               ((int32_t)0xC000014BL)
...
//
#define STATUS_REGISTRY_CORRUPT          ((int32_t)0xC000014CL)
...
//
#define STATUS_REGISTRY_IO_FAILED        ((int32_t)0xC000014DL)
...
//
#define STATUS_NO_EVENT_PAIR             ((int32_t)0xC000014EL)
...
//
#define STATUS_UNRECOGNIZED_VOLUME       ((int32_t)0xC000014FL)
...
//
#define STATUS_SERIAL_NO_DEVICE_INITED   ((int32_t)0xC0000150L)
...
//
#define STATUS_NO_SUCH_ALIAS             ((int32_t)0xC0000151L)
...
//
#define STATUS_MEMBER_NOT_IN_ALIAS       ((int32_t)0xC0000152L)
...
//
#define STATUS_MEMBER_IN_ALIAS           ((int32_t)0xC0000153L)
...
//
#define STATUS_ALIAS_EXISTS              ((int32_t)0xC0000154L)
...
//
#define STATUS_LOGON_NOT_GRANTED         ((int32_t)0xC0000155L)
...
//
#define STATUS_TOO_MANY_SECRETS          ((int32_t)0xC0000156L)
...
//
#define STATUS_SECRET_TOO_LONG           ((int32_t)0xC0000157L)
...
//
#define STATUS_INTERNAL_DB_ERROR         ((int32_t)0xC0000158L)
...
//
#define STATUS_FULLSCREEN_MODE           ((int32_t)0xC0000159L)
...
//
#define STATUS_TOO_MANY_CONTEXT_IDS      ((int32_t)0xC000015AL)
...
//
#define STATUS_LOGON_TYPE_NOT_GRANTED    ((int32_t)0xC000015BL)
...
//
#define STATUS_NOT_REGISTRY_FILE         ((int32_t)0xC000015CL)
...
//
#define STATUS_NT_CROSS_ENCRYPTION_REQUIRED ((int32_t)0xC000015DL)
...
//
#define STATUS_DOMAIN_CTRLR_CONFIG_ERROR ((int32_t)0xC000015EL)
...
//
#define STATUS_FT_MISSING_MEMBER         ((int32_t)0xC000015FL)
...
//
#define STATUS_ILL_FORMED_SERVICE_ENTRY  ((int32_t)0xC0000160L)
...
//
#define STATUS_ILLEGAL_CHARACTER         ((int32_t)0xC0000161L)
...
//
#define STATUS_UNMAPPABLE_CHARACTER      ((int32_t)0xC0000162L)
...
//
#define STATUS_UNDEFINED_CHARACTER       ((int32_t)0xC0000163L)
...
//
#define STATUS_FLOPPY_VOLUME             ((int32_t)0xC0000164L)
...
//
#define STATUS_FLOPPY_ID_MARK_NOT_FOUND  ((int32_t)0xC0000165L)
...
//
#define STATUS_FLOPPY_WRONG_CYLINDER     ((int32_t)0xC0000166L)
...
//
#define STATUS_FLOPPY_UNKNOWN_ERROR      ((int32_t)0xC0000167L)
...
//
#define STATUS_FLOPPY_BAD_REGISTERS      ((int32_t)0xC0000168L)
...
//
#define STATUS_DISK_RECALIBRATE_FAILED   ((int32_t)0xC0000169L)
...
//
#define STATUS_DISK_OPERATION_FAILED     ((int32_t)0xC000016AL)
...
//
#define STATUS_DISK_RESET_FAILED         ((int32_t)0xC000016BL)
...
//
#define STATUS_SHARED_IRQ_BUSY           ((int32_t)0xC000016CL)
...
//
#define STATUS_FT_ORPHANING              ((int32_t)0xC000016DL)
...
//
#define STATUS_BIOS_FAILED_TO_CONNECT_INTERRUPT ((int32_t)0xC000016EL)
...
//
#define STATUS_PARTITION_FAILURE         ((int32_t)0xC0000172L)
...
//
#define STATUS_INVALID_BLOCK_LENGTH      ((int32_t)0xC0000173L)
...
//
#define STATUS_DEVICE_NOT_PARTITIONED    ((int32_t)0xC0000174L)
...
//
#define STATUS_UNABLE_TO_LOCK_MEDIA      ((int32_t)0xC0000175L)
...
// Unload media fails.
//
#define STATUS_UNABLE_TO_UNLOAD_MEDIA    ((int32_t)0xC0000176L)
...
//
#define STATUS_EOM_OVERFLOW              ((int32_t)0xC0000177L)
...
//
#define STATUS_NO_MEDIA                  ((int32_t)0xC0000178L)
...
//
#define STATUS_NO_SUCH_MEMBER            ((int32_t)0xC000017AL)
...
//
#define STATUS_INVALID_MEMBER            ((int32_t)0xC000017BL)
...
//
#define STATUS_KEY_DELETED               ((int32_t)0xC000017CL)
...
//
#define STATUS_NO_LOG_SPACE              ((int32_t)0xC000017DL)
...
//
#define STATUS_TOO_MANY_SIDS             ((int32_t)0xC000017EL)
...
//
#define STATUS_LM_CROSS_ENCRYPTION_REQUIRED ((int32_t)0xC000017FL)
...
//
#define STATUS_KEY_HAS_CHILDREN          ((int32_t)0xC0000180L)
...
//
#define STATUS_CHILD_MUST_BE_VOLATILE    ((int32_t)0xC0000181L)
...
//
#define STATUS_DEVICE_CONFIGURATION_ERROR ((int32_t)0xC0000182L)
...
//
#define STATUS_DRIVER_INTERNAL_ERROR     ((int32_t)0xC0000183L)
...
//
#define STATUS_INVALID_DEVICE_STATE      ((int32_t)0xC0000184L)
...
//
#define STATUS_IO_DEVICE_ERROR           ((int32_t)0xC0000185L)
...
//
#define STATUS_DEVICE_PROTOCOL_ERROR     ((int32_t)0xC0000186L)
...
// This operation is only allowed for the Primary Domain Controller of the domain.
//
#define STATUS_BACKUP_CONTROLLER         ((int32_t)0xC0000187L)
...
//
#define STATUS_LOG_FILE_FULL             ((int32_t)0xC0000188L)
...
//
#define STATUS_TOO_LATE                  ((int32_t)0xC0000189L)
...
//
#define STATUS_NO_TRUST_LSA_SECRET       ((int32_t)0xC000018AL)
...
//
#define STATUS_NO_TRUST_SAM_ACCOUNT      ((int32_t)0xC000018BL)
...
//
#define STATUS_TRUSTED_DOMAIN_FAILURE    ((int32_t)0xC000018CL)
...
//
#define STATUS_TRUSTED_RELATIONSHIP_FAILURE ((int32_t)0xC000018DL)
...
//
#define STATUS_EVENTLOG_FILE_CORRUPT     ((int32_t)0xC000018EL)
...
//
#define STATUS_EVENTLOG_CANT_START       ((int32_t)0xC000018FL)
...
//
#define STATUS_TRUST_FAILURE             ((int32_t)0xC0000190L)
...
//
#define STATUS_MUTANT_LIMIT_EXCEEDED     ((int32_t)0xC0000191L)
...
//
#define STATUS_NETLOGON_NOT_STARTED      ((int32_t)0xC0000192L)
...
//
#define STATUS_ACCOUNT_EXPIRED           ((int32_t)0xC0000193L)    // ntsubauth
...
//
#define STATUS_POSSIBLE_DEADLOCK         ((int32_t)0xC0000194L)
...
//
#define STATUS_NETWORK_CREDENTIAL_CONFLICT ((int32_t)0xC0000195L)
...
//
#define STATUS_REMOTE_SESSION_LIMIT      ((int32_t)0xC0000196L)
...
//
#define STATUS_EVENTLOG_FILE_CHANGED     ((int32_t)0xC0000197L)
...
//
#define STATUS_NOLOGON_INTERDOMAIN_TRUST_ACCOUNT ((int32_t)0xC0000198L)
...
//
#define STATUS_NOLOGON_WORKSTATION_TRUST_ACCOUNT ((int32_t)0xC0000199L)
...
//
#define STATUS_NOLOGON_SERVER_TRUST_ACCOUNT ((int32_t)0xC000019AL)
...
//
#define STATUS_DOMAIN_TRUST_INCONSISTENT ((int32_t)0xC000019BL)
...
//
#define STATUS_FS_DRIVER_REQUIRED        ((int32_t)0xC000019CL)
...
//
#define STATUS_IMAGE_ALREADY_LOADED_AS_DLL ((int32_t)0xC000019DL)
...
//
#define STATUS_INCOMPATIBLE_WITH_GLOBAL_SHORT_NAME_REGISTRY_SETTING ((int32_t)0xC000019EL)
...
//
#define STATUS_SHORT_NAMES_NOT_ENABLED_ON_VOLUME ((int32_t)0xC000019FL)
...
//
#define STATUS_SECURITY_STREAM_IS_INCONSISTENT ((int32_t)0xC00001A0L)
...
//
#define STATUS_INVALID_LOCK_RANGE        ((int32_t)0xC00001A1L)
...
//
#define STATUS_INVALID_ACE_CONDITION     ((int32_t)0xC00001A2L)
...
//
#define STATUS_IMAGE_SUBSYSTEM_NOT_PRESENT ((int32_t)0xC00001A3L)
...
//
#define STATUS_NOTIFICATION_GUID_ALREADY_DEFINED ((int32_t)0xC00001A4L)
...
//
#define STATUS_INVALID_EXCEPTION_HANDLER ((int32_t)0xC00001A5L)
...
//
#define STATUS_DUPLICATE_PRIVILEGES      ((int32_t)0xC00001A6L)
...
//
#define STATUS_NOT_ALLOWED_ON_SYSTEM_FILE ((int32_t)0xC00001A7L)
...
//
#define STATUS_REPAIR_NEEDED             ((int32_t)0xC00001A8L)
...
//
#define STATUS_QUOTA_NOT_ENABLED         ((int32_t)0xC00001A9L)
...
//
#define STATUS_NO_APPLICATION_PACKAGE    ((int32_t)0xC00001AAL)
...
//
#define STATUS_FILE_METADATA_OPTIMIZATION_IN_PROGRESS ((int32_t)0xC00001ABL)
...
//
#define STATUS_NOT_SAME_OBJECT           ((int32_t)0xC00001ACL)
...
//
#define STATUS_FATAL_MEMORY_EXHAUSTION   ((int32_t)0xC00001ADL)
...
//
#define STATUS_ERROR_PROCESS_NOT_IN_JOB  ((int32_t)0xC00001AEL)
...
//
#define STATUS_CPU_SET_INVALID           ((int32_t)0xC00001AFL)
...
//
#define STATUS_IO_DEVICE_INVALID_DATA    ((int32_t)0xC00001B0L)
...
//
#define STATUS_IO_UNALIGNED_WRITE        ((int32_t)0xC00001B1L)
...
//
#define STATUS_CONTROL_STACK_VIOLATION   ((int32_t)0xC00001B2L)    //winnt

//
//  Available range of int32_t codes
//
//
...
//
#define STATUS_NETWORK_OPEN_RESTRICTION  ((int32_t)0xC0000201L)
...
//
#define STATUS_NO_USER_SESSION_KEY       ((int32_t)0xC0000202L)
...
//
#define STATUS_USER_SESSION_DELETED      ((int32_t)0xC0000203L)
...
// image file.
//
#define STATUS_RESOURCE_LANG_NOT_FOUND   ((int32_t)0xC0000204L)
...
//
#define STATUS_INSUFF_SERVER_RESOURCES   ((int32_t)0xC0000205L)
...
//
#define STATUS_INVALID_BUFFER_SIZE       ((int32_t)0xC0000206L)
...
//
#define STATUS_INVALID_ADDRESS_COMPONENT ((int32_t)0xC0000207L)
...
//
#define STATUS_INVALID_ADDRESS_WILDCARD  ((int32_t)0xC0000208L)
...
//
#define STATUS_TOO_MANY_ADDRESSES        ((int32_t)0xC0000209L)
...
//
#define STATUS_ADDRESS_ALREADY_EXISTS    ((int32_t)0xC000020AL)
...
//
#define STATUS_ADDRESS_CLOSED            ((int32_t)0xC000020BL)
...
//
#define STATUS_CONNECTION_DISCONNECTED   ((int32_t)0xC000020CL)
...
//
#define STATUS_CONNECTION_RESET          ((int32_t)0xC000020DL)
...
//
#define STATUS_TOO_MANY_NODES            ((int32_t)0xC000020EL)
...
//
#define STATUS_TRANSACTION_ABORTED       ((int32_t)0xC000020FL)
...
//
#define STATUS_TRANSACTION_TIMED_OUT     ((int32_t)0xC0000210L)
...
//
#define STATUS_TRANSACTION_NO_RELEASE    ((int32_t)0xC0000211L)
...
//
#define STATUS_TRANSACTION_NO_MATCH      ((int32_t)0xC0000212L)
...
//
#define STATUS_TRANSACTION_RESPONDED     ((int32_t)0xC0000213L)
...
//
#define STATUS_TRANSACTION_INVALID_ID    ((int32_t)0xC0000214L)
...
//
#define STATUS_TRANSACTION_INVALID_TYPE  ((int32_t)0xC0000215L)
...
//
#define STATUS_NOT_SERVER_SESSION        ((int32_t)0xC0000216L)
...
//
#define STATUS_NOT_CLIENT_SESSION        ((int32_t)0xC0000217L)
...
//
#define STATUS_CANNOT_LOAD_REGISTRY_FILE ((int32_t)0xC0000218L)
...
//
#define STATUS_DEBUG_ATTACH_FAILED       ((int32_t)0xC0000219L)
...
//
#define STATUS_SYSTEM_PROCESS_TERMINATED ((int32_t)0xC000021AL)
...
//
#define STATUS_DATA_NOT_ACCEPTED         ((int32_t)0xC000021BL)
...
//
#define STATUS_NO_BROWSER_SERVERS_FOUND  ((int32_t)0xC000021CL)
...
//
#define STATUS_VDM_HARD_ERROR            ((int32_t)0xC000021DL)
...
//
#define STATUS_DRIVER_CANCEL_TIMEOUT     ((int32_t)0xC000021EL)
...
//
#define STATUS_REPLY_MESSAGE_MISMATCH    ((int32_t)0xC000021FL)
...
//
#define STATUS_MAPPED_ALIGNMENT          ((int32_t)0xC0000220L)
...
//
#define STATUS_IMAGE_CHECKSUM_MISMATCH   ((int32_t)0xC0000221L)
...
//
#define STATUS_LOST_WRITEBEHIND_DATA     ((int32_t)0xC0000222L)
...
//
#define STATUS_CLIENT_SERVER_PARAMETERS_INVALID ((int32_t)0xC0000223L)
...
//
#define STATUS_PASSWORD_MUST_CHANGE      ((int32_t)0xC0000224L)    // ntsubauth
...
//
#define STATUS_NOT_FOUND                 ((int32_t)0xC0000225L)
...
//
#define STATUS_NOT_TINY_STREAM           ((int32_t)0xC0000226L)
...
//
#define STATUS_RECOVERY_FAILURE          ((int32_t)0xC0000227L)
...
//
#define STATUS_STACK_OVERFLOW_READ       ((int32_t)0xC0000228L)
...
//
#define STATUS_FAIL_CHECK                ((int32_t)0xC0000229L)
...
//
#define STATUS_DUPLICATE_OBJECTID        ((int32_t)0xC000022AL)
...
//
#define STATUS_OBJECTID_EXISTS           ((int32_t)0xC000022BL)
...
//
#define STATUS_CONVERT_TO_LARGE          ((int32_t)0xC000022CL)
...
//
#define STATUS_RETRY                     ((int32_t)0xC000022DL)
...
//
#define STATUS_FOUND_OUT_OF_SCOPE        ((int32_t)0xC000022EL)
...
//
#define STATUS_ALLOCATE_BUCKET           ((int32_t)0xC000022FL)
...
//
#define STATUS_PROPSET_NOT_FOUND         ((int32_t)0xC0000230L)
...
//
#define STATUS_MARSHALL_OVERFLOW         ((int32_t)0xC0000231L)
...
//
#define STATUS_INVALID_VARIANT           ((int32_t)0xC0000232L)
...
//
#define STATUS_DOMAIN_CONTROLLER_NOT_FOUND ((int32_t)0xC0000233L)
...
//
#define STATUS_ACCOUNT_LOCKED_OUT        ((int32_t)0xC0000234L)    // ntsubauth
...
//
#define STATUS_HANDLE_NOT_CLOSABLE       ((int32_t)0xC0000235L)
...
//
#define STATUS_CONNECTION_REFUSED        ((int32_t)0xC0000236L)
...
//
#define STATUS_GRACEFUL_DISCONNECT       ((int32_t)0xC0000237L)
...
//
#define STATUS_ADDRESS_ALREADY_ASSOCIATED ((int32_t)0xC0000238L)
...
//
#define STATUS_ADDRESS_NOT_ASSOCIATED    ((int32_t)0xC0000239L)
...
//
#define STATUS_CONNECTION_INVALID        ((int32_t)0xC000023AL)
...
//
#define STATUS_CONNECTION_ACTIVE         ((int32_t)0xC000023BL)
...
//
#define STATUS_NETWORK_UNREACHABLE       ((int32_t)0xC000023CL)
...
//
#define STATUS_HOST_UNREACHABLE          ((int32_t)0xC000023DL)
...
//
#define STATUS_PROTOCOL_UNREACHABLE      ((int32_t)0xC000023EL)
...
//
#define STATUS_PORT_UNREACHABLE          ((int32_t)0xC000023FL)
...
//
#define STATUS_REQUEST_ABORTED           ((int32_t)0xC0000240L)
...
//
#define STATUS_CONNECTION_ABORTED        ((int32_t)0xC0000241L)
...
//
#define STATUS_BAD_COMPRESSION_BUFFER    ((int32_t)0xC0000242L)
...
//
#define STATUS_USER_MAPPED_FILE          ((int32_t)0xC0000243L)
...
//
#define STATUS_AUDIT_FAILED              ((int32_t)0xC0000244L)
...
//
#define STATUS_TIMER_RESOLUTION_NOT_SET  ((int32_t)0xC0000245L)
...
//
#define STATUS_CONNECTION_COUNT_LIMIT    ((int32_t)0xC0000246L)
...
//
#define STATUS_LOGIN_TIME_RESTRICTION    ((int32_t)0xC0000247L)
...
//
#define STATUS_LOGIN_WKSTA_RESTRICTION   ((int32_t)0xC0000248L)
...
//
#define STATUS_IMAGE_MP_UP_MISMATCH      ((int32_t)0xC0000249L)
...
//
#define STATUS_INSUFFICIENT_LOGON_INFO   ((int32_t)0xC0000250L)
...
//
#define STATUS_BAD_DLL_ENTRYPOINT        ((int32_t)0xC0000251L)
...
//
#define STATUS_BAD_SERVICE_ENTRYPOINT    ((int32_t)0xC0000252L)
...
//
#define STATUS_LPC_REPLY_LOST            ((int32_t)0xC0000253L)
...
//
#define STATUS_IP_ADDRESS_CONFLICT1      ((int32_t)0xC0000254L)
...
// There is an IP address conflict with another system on the network
//
#define STATUS_IP_ADDRESS_CONFLICT2      ((int32_t)0xC0000255L)
...
//
#define STATUS_REGISTRY_QUOTA_LIMIT      ((int32_t)0xC0000256L)
...
//
#define STATUS_PATH_NOT_COVERED          ((int32_t)0xC0000257L)
...
//
#define STATUS_NO_CALLBACK_ACTIVE        ((int32_t)0xC0000258L)
...
//
#define STATUS_LICENSE_QUOTA_EXCEEDED    ((int32_t)0xC0000259L)
...
//
#define STATUS_PWD_TOO_SHORT             ((int32_t)0xC000025AL)
...
//
#define STATUS_PWD_TOO_RECENT            ((int32_t)0xC000025BL)
...
//
#define STATUS_PWD_HISTORY_CONFLICT      ((int32_t)0xC000025CL)
...
//
#define STATUS_PLUGPLAY_NO_DEVICE        ((int32_t)0xC000025EL)
...
//
#define STATUS_UNSUPPORTED_COMPRESSION   ((int32_t)0xC000025FL)
...
//
#define STATUS_INVALID_HW_PROFILE        ((int32_t)0xC0000260L)
...
//
#define STATUS_INVALID_PLUGPLAY_DEVICE_PATH ((int32_t)0xC0000261L)
...
//
#define STATUS_DRIVER_ORDINAL_NOT_FOUND  ((int32_t)0xC0000262L)
...
//
#define STATUS_DRIVER_ENTRYPOINT_NOT_FOUND ((int32_t)0xC0000263L)
...
//
#define STATUS_RESOURCE_NOT_OWNED        ((int32_t)0xC0000264L)
...
//
#define STATUS_TOO_MANY_LINKS            ((int32_t)0xC0000265L)
...
//
#define STATUS_QUOTA_LIST_INCONSISTENT   ((int32_t)0xC0000266L)
...
//
#define STATUS_FILE_IS_OFFLINE           ((int32_t)0xC0000267L)
...
//
#define STATUS_EVALUATION_EXPIRATION     ((int32_t)0xC0000268L)
...
//
#define STATUS_ILLEGAL_DLL_RELOCATION    ((int32_t)0xC0000269L)
...
//
#define STATUS_LICENSE_VIOLATION         ((int32_t)0xC000026AL)
...
//
#define STATUS_DLL_INIT_FAILED_LOGOFF    ((int32_t)0xC000026BL)
...
//
#define STATUS_DRIVER_UNABLE_TO_LOAD     ((int32_t)0xC000026CL)
...
//
#define STATUS_DFS_UNAVAILABLE           ((int32_t)0xC000026DL)
...
//
#define STATUS_VOLUME_DISMOUNTED         ((int32_t)0xC000026EL)
...
//
#define STATUS_WX86_INTERNAL_ERROR       ((int32_t)0xC000026FL)
...
//
#define STATUS_WX86_FLOAT_STACK_CHECK    ((int32_t)0xC0000270L)
...
//
#define STATUS_VALIDATE_CONTINUE         ((int32_t)0xC0000271L)
...
//
#define STATUS_NO_MATCH                  ((int32_t)0xC0000272L)
...
//
#define STATUS_NO_MORE_MATCHES           ((int32_t)0xC0000273L)
...
//
#define STATUS_NOT_A_REPARSE_POINT       ((int32_t)0xC0000275L)
...
//
#define STATUS_IO_REPARSE_TAG_INVALID    ((int32_t)0xC0000276L)
...
//
#define STATUS_IO_REPARSE_TAG_MISMATCH   ((int32_t)0xC0000277L)
...
//
#define STATUS_IO_REPARSE_DATA_INVALID   ((int32_t)0xC0000278L)
...
//
#define STATUS_IO_REPARSE_TAG_NOT_HANDLED ((int32_t)0xC0000279L)
...
//
#define STATUS_PWD_TOO_LONG              ((int32_t)0xC000027AL)
...
//
#define STATUS_STOWED_EXCEPTION          ((int32_t)0xC000027BL)
...
// An application-internal exception has occurred.
//
#define STATUS_CONTEXT_STOWED_EXCEPTION  ((int32_t)0xC000027CL)
...
//
#define STATUS_REPARSE_POINT_NOT_RESOLVED ((int32_t)0xC0000280L)
...
//
#define STATUS_DIRECTORY_IS_A_REPARSE_POINT ((int32_t)0xC0000281L)
...
//
#define STATUS_RANGE_LIST_CONFLICT       ((int32_t)0xC0000282L)
...
//
#define STATUS_SOURCE_ELEMENT_EMPTY      ((int32_t)0xC0000283L)
...
//
#define STATUS_DESTINATION_ELEMENT_FULL  ((int32_t)0xC0000284L)
...
//
#define STATUS_ILLEGAL_ELEMENT_ADDRESS   ((int32_t)0xC0000285L)
...
//
#define STATUS_MAGAZINE_NOT_PRESENT      ((int32_t)0xC0000286L)
...
//
#define STATUS_REINITIALIZATION_NEEDED   ((int32_t)0xC0000287L)
...
//
#define STATUS_DEVICE_REQUIRES_CLEANING  ((int32_t)0x80000288L)
...
//
#define STATUS_DEVICE_DOOR_OPEN          ((int32_t)0x80000289L)
...
//
#define STATUS_ENCRYPTION_FAILED         ((int32_t)0xC000028AL)
...
//
#define STATUS_DECRYPTION_FAILED         ((int32_t)0xC000028BL)
...
//
#define STATUS_RANGE_NOT_FOUND           ((int32_t)0xC000028CL)
...
//
#define STATUS_NO_RECOVERY_POLICY        ((int32_t)0xC000028DL)
...
//
#define STATUS_NO_EFS                    ((int32_t)0xC000028EL)
...
//
#define STATUS_WRONG_EFS                 ((int32_t)0xC000028FL)
...
//
#define STATUS_NO_USER_KEYS              ((int32_t)0xC0000290L)
...
//
#define STATUS_FILE_NOT_ENCRYPTED        ((int32_t)0xC0000291L)
...
//
#define STATUS_NOT_EXPORT_FORMAT         ((int32_t)0xC0000292L)
...
//
#define STATUS_FILE_ENCRYPTED            ((int32_t)0xC0000293L)
...
//
#define STATUS_WAKE_SYSTEM               ((int32_t)0x40000294L)
...
//
#define STATUS_WMI_GUID_NOT_FOUND        ((int32_t)0xC0000295L)
...
//
#define STATUS_WMI_INSTANCE_NOT_FOUND    ((int32_t)0xC0000296L)
...
//
#define STATUS_WMI_ITEMID_NOT_FOUND      ((int32_t)0xC0000297L)
...
//
#define STATUS_WMI_TRY_AGAIN             ((int32_t)0xC0000298L)
...
//
#define STATUS_SHARED_POLICY             ((int32_t)0xC0000299L)
...
//
#define STATUS_POLICY_OBJECT_NOT_FOUND   ((int32_t)0xC000029AL)
...
//
#define STATUS_POLICY_ONLY_IN_DS         ((int32_t)0xC000029BL)
...
//
#define STATUS_VOLUME_NOT_UPGRADED       ((int32_t)0xC000029CL)
...
//
#define STATUS_REMOTE_STORAGE_NOT_ACTIVE ((int32_t)0xC000029DL)
...
//
#define STATUS_REMOTE_STORAGE_MEDIA_ERROR ((int32_t)0xC000029EL)
...
//
#define STATUS_NO_TRACKING_SERVICE       ((int32_t)0xC000029FL)
...
//
#define STATUS_SERVER_SID_MISMATCH       ((int32_t)0xC00002A0L)
...
//
#define STATUS_DS_NO_ATTRIBUTE_OR_VALUE  ((int32_t)0xC00002A1L)
...
//
#define STATUS_DS_INVALID_ATTRIBUTE_SYNTAX ((int32_t)0xC00002A2L)
...
//
#define STATUS_DS_ATTRIBUTE_TYPE_UNDEFINED ((int32_t)0xC00002A3L)
...
//
#define STATUS_DS_ATTRIBUTE_OR_VALUE_EXISTS ((int32_t)0xC00002A4L)
...
//
#define STATUS_DS_BUSY                   ((int32_t)0xC00002A5L)
...
//
#define STATUS_DS_UNAVAILABLE            ((int32_t)0xC00002A6L)
...
//
#define STATUS_DS_NO_RIDS_ALLOCATED      ((int32_t)0xC00002A7L)
...
//
#define STATUS_DS_NO_MORE_RIDS           ((int32_t)0xC00002A8L)
...
//
#define STATUS_DS_INCORRECT_ROLE_OWNER   ((int32_t)0xC00002A9L)
...
//
#define STATUS_DS_RIDMGR_INIT_ERROR      ((int32_t)0xC00002AAL)
...
//
#define STATUS_DS_OBJ_CLASS_VIOLATION    ((int32_t)0xC00002ABL)
...
//
#define STATUS_DS_CANT_ON_NON_LEAF       ((int32_t)0xC00002ACL)
...
//
#define STATUS_DS_CANT_ON_RDN            ((int32_t)0xC00002ADL)
...
//
#define STATUS_DS_CANT_MOD_OBJ_CLASS     ((int32_t)0xC00002AEL)
...
//
#define STATUS_DS_CROSS_DOM_MOVE_FAILED  ((int32_t)0xC00002AFL)
...
//
#define STATUS_DS_GC_NOT_AVAILABLE       ((int32_t)0xC00002B0L)
...
//
#define STATUS_DIRECTORY_SERVICE_REQUIRED ((int32_t)0xC00002B1L)
...
//
#define STATUS_REPARSE_ATTRIBUTE_CONFLICT ((int32_t)0xC00002B2L)
...
//
#define STATUS_CANT_ENABLE_DENY_ONLY     ((int32_t)0xC00002B3L)
...
//
#define STATUS_FLOAT_MULTIPLE_FAULTS     ((int32_t)0xC00002B4L)    // winnt
...
//
#define STATUS_FLOAT_MULTIPLE_TRAPS      ((int32_t)0xC00002B5L)    // winnt
...
//
#define STATUS_DEVICE_REMOVED            ((int32_t)0xC00002B6L)
...
//
#define STATUS_JOURNAL_DELETE_IN_PROGRESS ((int32_t)0xC00002B7L)
...
//
#define STATUS_JOURNAL_NOT_ACTIVE        ((int32_t)0xC00002B8L)
...
//
#define STATUS_NOINTERFACE               ((int32_t)0xC00002B9L)
...
//
#define STATUS_DS_RIDMGR_DISABLED        ((int32_t)0xC00002BAL)
...
//
#define STATUS_DS_ADMIN_LIMIT_EXCEEDED   ((int32_t)0xC00002C1L)
...
//
#define STATUS_DRIVER_FAILED_SLEEP       ((int32_t)0xC00002C2L)
...
//
#define STATUS_MUTUAL_AUTHENTICATION_FAILED ((int32_t)0xC00002C3L)
...
//
#define STATUS_CORRUPT_SYSTEM_FILE       ((int32_t)0xC00002C4L)
...
//
#define STATUS_DATATYPE_MISALIGNMENT_ERROR ((int32_t)0xC00002C5L)    
...
//
#define STATUS_WMI_READ_ONLY             ((int32_t)0xC00002C6L)
...
//
#define STATUS_WMI_SET_FAILURE           ((int32_t)0xC00002C7L)
...
//
#define STATUS_COMMITMENT_MINIMUM        ((int32_t)0xC00002C8L)
...
//
#define STATUS_REG_NAT_CONSUMPTION       ((int32_t)0xC00002C9L)    // winnt
...
//
#define STATUS_TRANSPORT_FULL            ((int32_t)0xC00002CAL)
...
//
#define STATUS_DS_SAM_INIT_FAILURE       ((int32_t)0xC00002CBL)
...
//
#define STATUS_ONLY_IF_CONNECTED         ((int32_t)0xC00002CCL)
...
//
#define STATUS_DS_SENSITIVE_GROUP_VIOLATION ((int32_t)0xC00002CDL)
...
//
#define STATUS_PNP_RESTART_ENUMERATION   ((int32_t)0xC00002CEL)
...
//
#define STATUS_JOURNAL_ENTRY_DELETED     ((int32_t)0xC00002CFL)
...
//
#define STATUS_DS_CANT_MOD_PRIMARYGROUPID ((int32_t)0xC00002D0L)
...
//
#define STATUS_SYSTEM_IMAGE_BAD_SIGNATURE ((int32_t)0xC00002D1L)
...
//
#define STATUS_PNP_REBOOT_REQUIRED       ((int32_t)0xC00002D2L)
...
//
#define STATUS_POWER_STATE_INVALID       ((int32_t)0xC00002D3L)
...
//
#define STATUS_DS_INVALID_GROUP_TYPE     ((int32_t)0xC00002D4L)
...
//
#define STATUS_DS_NO_NEST_GLOBALGROUP_IN_MIXEDDOMAIN ((int32_t)0xC00002D5L)
...
//
#define STATUS_DS_NO_NEST_LOCALGROUP_IN_MIXEDDOMAIN ((int32_t)0xC00002D6L)
...
//
#define STATUS_DS_GLOBAL_CANT_HAVE_LOCAL_MEMBER ((int32_t)0xC00002D7L)
...
//
#define STATUS_DS_GLOBAL_CANT_HAVE_UNIVERSAL_MEMBER ((int32_t)0xC00002D8L)
...
//
#define STATUS_DS_UNIVERSAL_CANT_HAVE_LOCAL_MEMBER ((int32_t)0xC00002D9L)
...
//
#define STATUS_DS_GLOBAL_CANT_HAVE_CROSSDOMAIN_MEMBER ((int32_t)0xC00002DAL)
...
//
#define STATUS_DS_LOCAL_CANT_HAVE_CROSSDOMAIN_LOCAL_MEMBER ((int32_t)0xC00002DBL)
...
//
#define STATUS_DS_HAVE_PRIMARY_MEMBERS   ((int32_t)0xC00002DCL)
...
//
#define STATUS_WMI_NOT_SUPPORTED         ((int32_t)0xC00002DDL)
...
//
#define STATUS_INSUFFICIENT_POWER        ((int32_t)0xC00002DEL)
...
//
#define STATUS_SAM_NEED_BOOTKEY_PASSWORD ((int32_t)0xC00002DFL)
...
//
#define STATUS_SAM_NEED_BOOTKEY_FLOPPY   ((int32_t)0xC00002E0L)
...
//
#define STATUS_DS_CANT_START             ((int32_t)0xC00002E1L)
...
// Please shutdown this system and reboot into Directory Services Restore Mode, check the event log for more detailed information.
//
#define STATUS_DS_INIT_FAILURE           ((int32_t)0xC00002E2L)
...
//
#define STATUS_SAM_INIT_FAILURE          ((int32_t)0xC00002E3L)
...
//
#define STATUS_DS_GC_REQUIRED            ((int32_t)0xC00002E4L)
...
//
#define STATUS_DS_LOCAL_MEMBER_OF_LOCAL_ONLY ((int32_t)0xC00002E5L)
...
//
#define STATUS_DS_NO_FPO_IN_UNIVERSAL_GROUPS ((int32_t)0xC00002E6L)
...
//
#define STATUS_DS_MACHINE_ACCOUNT_QUOTA_EXCEEDED ((int32_t)0xC00002E7L)
...
//
#define STATUS_MULTIPLE_FAULT_VIOLATION  ((int32_t)0xC00002E8L)
...
//
#define STATUS_CURRENT_DOMAIN_NOT_ALLOWED ((int32_t)0xC00002E9L)
...
//
#define STATUS_CANNOT_MAKE               ((int32_t)0xC00002EAL)
...
//
#define STATUS_SYSTEM_SHUTDOWN           ((int32_t)0xC00002EBL)
...
//
#define STATUS_DS_INIT_FAILURE_CONSOLE   ((int32_t)0xC00002ECL)
...
// Please click OK to shutdown the system. You can use the recovery console to diagnose the system further.
//
#define STATUS_DS_SAM_INIT_FAILURE_CONSOLE ((int32_t)0xC00002EDL)
...
//
#define STATUS_UNFINISHED_CONTEXT_DELETED ((int32_t)0xC00002EEL)
...
//
#define STATUS_NO_TGT_REPLY              ((int32_t)0xC00002EFL)
...
//
#define STATUS_OBJECTID_NOT_FOUND        ((int32_t)0xC00002F0L)
...
//
#define STATUS_NO_IP_ADDRESSES           ((int32_t)0xC00002F1L)
...
//
#define STATUS_WRONG_CREDENTIAL_HANDLE   ((int32_t)0xC00002F2L)
...
//
#define STATUS_CRYPTO_SYSTEM_INVALID     ((int32_t)0xC00002F3L)
...
//
#define STATUS_MAX_REFERRALS_EXCEEDED    ((int32_t)0xC00002F4L)
...
//
#define STATUS_MUST_BE_KDC               ((int32_t)0xC00002F5L)
...
//
#define STATUS_STRONG_CRYPTO_NOT_SUPPORTED ((int32_t)0xC00002F6L)
...
//
#define STATUS_TOO_MANY_PRINCIPALS       ((int32_t)0xC00002F7L)
...
//
#define STATUS_NO_PA_DATA                ((int32_t)0xC00002F8L)
...
//
#define STATUS_PKINIT_NAME_MISMATCH      ((int32_t)0xC00002F9L)
...
//
#define STATUS_SMARTCARD_LOGON_REQUIRED  ((int32_t)0xC00002FAL)
...
//
#define STATUS_KDC_INVALID_REQUEST       ((int32_t)0xC00002FBL)
...
//
#define STATUS_KDC_UNABLE_TO_REFER       ((int32_t)0xC00002FCL)
...
//
#define STATUS_KDC_UNKNOWN_ETYPE         ((int32_t)0xC00002FDL)
...
//
#define STATUS_SHUTDOWN_IN_PROGRESS      ((int32_t)0xC00002FEL)
...
//
#define STATUS_SERVER_SHUTDOWN_IN_PROGRESS ((int32_t)0xC00002FFL)
...
//
#define STATUS_NOT_SUPPORTED_ON_SBS      ((int32_t)0xC0000300L)
...
//
#define STATUS_WMI_GUID_DISCONNECTED     ((int32_t)0xC0000301L)
...
//
#define STATUS_WMI_ALREADY_DISABLED      ((int32_t)0xC0000302L)
...
//
#define STATUS_WMI_ALREADY_ENABLED       ((int32_t)0xC0000303L)
...
//
#define STATUS_MFT_TOO_FRAGMENTED        ((int32_t)0xC0000304L)
...
//
#define STATUS_COPY_PROTECTION_FAILURE   ((int32_t)0xC0000305L)
...
//
#define STATUS_CSS_AUTHENTICATION_FAILURE ((int32_t)0xC0000306L)
...
//
#define STATUS_CSS_KEY_NOT_PRESENT       ((int32_t)0xC0000307L)
...
//
#define STATUS_CSS_KEY_NOT_ESTABLISHED   ((int32_t)0xC0000308L)
...
//
#define STATUS_CSS_SCRAMBLED_SECTOR      ((int32_t)0xC0000309L)
...
//
#define STATUS_CSS_REGION_MISMATCH       ((int32_t)0xC000030AL)
...
//
#define STATUS_CSS_RESETS_EXHAUSTED      ((int32_t)0xC000030BL)
...
//
#define STATUS_PASSWORD_CHANGE_REQUIRED  ((int32_t)0xC000030CL)
...
//
#define STATUS_LOST_MODE_LOGON_RESTRICTION ((int32_t)0xC000030DL)
...
//
#define STATUS_PKINIT_FAILURE            ((int32_t)0xC0000320L)
...
//
#define STATUS_SMARTCARD_SUBSYSTEM_FAILURE ((int32_t)0xC0000321L)
...
//
#define STATUS_NO_KERB_KEY               ((int32_t)0xC0000322L)
...
//
#define STATUS_HOST_DOWN                 ((int32_t)0xC0000350L)
...
//
#define STATUS_UNSUPPORTED_PREAUTH       ((int32_t)0xC0000351L)
...
//
#define STATUS_EFS_ALG_BLOB_TOO_BIG      ((int32_t)0xC0000352L)
...
//
#define STATUS_PORT_NOT_SET              ((int32_t)0xC0000353L)
...
//
#define STATUS_DEBUGGER_INACTIVE         ((int32_t)0xC0000354L)
...
//
#define STATUS_DS_VERSION_CHECK_FAILURE  ((int32_t)0xC0000355L)
...
//
#define STATUS_AUDITING_DISABLED         ((int32_t)0xC0000356L)
...
//
#define STATUS_PRENT4_MACHINE_ACCOUNT    ((int32_t)0xC0000357L)
...
//
#define STATUS_DS_AG_CANT_HAVE_UNIVERSAL_MEMBER ((int32_t)0xC0000358L)
...
//
#define STATUS_INVALID_IMAGE_WIN_32      ((int32_t)0xC0000359L)
...
//
#define STATUS_INVALID_IMAGE_WIN_64      ((int32_t)0xC000035AL)
...
//
#define STATUS_BAD_BINDINGS              ((int32_t)0xC000035BL)
...
//
#define STATUS_NETWORK_SESSION_EXPIRED   ((int32_t)0xC000035CL)
...
//
#define STATUS_APPHELP_BLOCK             ((int32_t)0xC000035DL)
...
//
#define STATUS_ALL_SIDS_FILTERED         ((int32_t)0xC000035EL)
...
//
#define STATUS_NOT_SAFE_MODE_DRIVER      ((int32_t)0xC000035FL)
...
//
#define STATUS_ACCESS_DISABLED_BY_POLICY_DEFAULT ((int32_t)0xC0000361L)
...
//
#define STATUS_ACCESS_DISABLED_BY_POLICY_PATH ((int32_t)0xC0000362L)
...
//
#define STATUS_ACCESS_DISABLED_BY_POLICY_PUBLISHER ((int32_t)0xC0000363L)
...
//
#define STATUS_ACCESS_DISABLED_BY_POLICY_OTHER ((int32_t)0xC0000364L)
...
//
#define STATUS_FAILED_DRIVER_ENTRY       ((int32_t)0xC0000365L)
...
//
#define STATUS_DEVICE_ENUMERATION_ERROR  ((int32_t)0xC0000366L)
...
//
#define STATUS_MOUNT_POINT_NOT_RESOLVED  ((int32_t)0xC0000368L)
...
//
#define STATUS_INVALID_DEVICE_OBJECT_PARAMETER ((int32_t)0xC0000369L)
...
//
#define STATUS_MCA_OCCURED               ((int32_t)0xC000036AL)
...
//
#define STATUS_DRIVER_BLOCKED_CRITICAL   ((int32_t)0xC000036BL)
...
// Driver %2 has been blocked from loading.
//
#define STATUS_DRIVER_BLOCKED            ((int32_t)0xC000036CL)
...
//
#define STATUS_DRIVER_DATABASE_ERROR     ((int32_t)0xC000036DL)
...
//
#define STATUS_SYSTEM_HIVE_TOO_LARGE     ((int32_t)0xC000036EL)
...
//
#define STATUS_INVALID_IMPORT_OF_NON_DLL ((int32_t)0xC000036FL)
...
//
#define STATUS_DS_SHUTTING_DOWN          ((int32_t)0x40000370L)
...
//
#define STATUS_NO_SECRETS                ((int32_t)0xC0000371L)
...
// Access to %1 has been restricted by your Administrator by policy rule %2.
//
#define STATUS_ACCESS_DISABLED_NO_SAFER_UI_BY_POLICY ((int32_t)0xC0000372L)    
...
//
#define STATUS_FAILED_STACK_SWITCH       ((int32_t)0xC0000373L)
...
//
#define STATUS_HEAP_CORRUPTION           ((int32_t)0xC0000374L)    // winnt
...
//
#define STATUS_SMARTCARD_WRONG_PIN       ((int32_t)0xC0000380L)
...
//
#define STATUS_SMARTCARD_CARD_BLOCKED    ((int32_t)0xC0000381L)
...
//
#define STATUS_SMARTCARD_CARD_NOT_AUTHENTICATED ((int32_t)0xC0000382L)
...
//
#define STATUS_SMARTCARD_NO_CARD         ((int32_t)0xC0000383L)
...
//
#define STATUS_SMARTCARD_NO_KEY_CONTAINER ((int32_t)0xC0000384L)
...
//
#define STATUS_SMARTCARD_NO_CERTIFICATE  ((int32_t)0xC0000385L)
...
//
#define STATUS_SMARTCARD_NO_KEYSET       ((int32_t)0xC0000386L)
...
//
#define STATUS_SMARTCARD_IO_ERROR        ((int32_t)0xC0000387L)
...
//
#define STATUS_DOWNGRADE_DETECTED        ((int32_t)0xC0000388L)
...
//
#define STATUS_SMARTCARD_CERT_REVOKED    ((int32_t)0xC0000389L)
...
//
#define STATUS_ISSUING_CA_UNTRUSTED      ((int32_t)0xC000038AL)
...
//
#define STATUS_REVOCATION_OFFLINE_C      ((int32_t)0xC000038BL)
...
//
#define STATUS_PKINIT_CLIENT_FAILURE     ((int32_t)0xC000038CL)
...
//
#define STATUS_SMARTCARD_CERT_EXPIRED    ((int32_t)0xC000038DL)
...
//
#define STATUS_DRIVER_FAILED_PRIOR_UNLOAD ((int32_t)0xC000038EL)
...
//
#define STATUS_SMARTCARD_SILENT_CONTEXT  ((int32_t)0xC000038FL)
...
//
#define STATUS_PER_USER_TRUST_QUOTA_EXCEEDED ((int32_t)0xC0000401L)
...
//
#define STATUS_ALL_USER_TRUST_QUOTA_EXCEEDED ((int32_t)0xC0000402L)
...
//
#define STATUS_USER_DELETE_TRUST_QUOTA_EXCEEDED ((int32_t)0xC0000403L)
...
//
#define STATUS_DS_NAME_NOT_UNIQUE        ((int32_t)0xC0000404L)
...
//
#define STATUS_DS_DUPLICATE_ID_FOUND     ((int32_t)0xC0000405L)
...
//
#define STATUS_DS_GROUP_CONVERSION_ERROR ((int32_t)0xC0000406L)
...
//
#define STATUS_VOLSNAP_PREPARE_HIBERNATE ((int32_t)0xC0000407L)
...
//
#define STATUS_USER2USER_REQUIRED        ((int32_t)0xC0000408L)
...
//
#define STATUS_STACK_BUFFER_OVERRUN      ((int32_t)0xC0000409L)    // winnt
...
//
#define STATUS_NO_S4U_PROT_SUPPORT       ((int32_t)0xC000040AL)
...
//
#define STATUS_CROSSREALM_DELEGATION_FAILURE ((int32_t)0xC000040BL)
...
//
#define STATUS_REVOCATION_OFFLINE_KDC    ((int32_t)0xC000040CL)
...
//
#define STATUS_ISSUING_CA_UNTRUSTED_KDC  ((int32_t)0xC000040DL)
...
//
#define STATUS_KDC_CERT_EXPIRED          ((int32_t)0xC000040EL)
...
//
#define STATUS_KDC_CERT_REVOKED          ((int32_t)0xC000040FL)
...
//
#define STATUS_PARAMETER_QUOTA_EXCEEDED  ((int32_t)0xC0000410L)
...
//
#define STATUS_HIBERNATION_FAILURE       ((int32_t)0xC0000411L)
...
//
#define STATUS_DELAY_LOAD_FAILED         ((int32_t)0xC0000412L)
...
//
#define STATUS_AUTHENTICATION_FIREWALL_FAILED ((int32_t)0xC0000413L)
...
//
#define STATUS_VDM_DISALLOWED            ((int32_t)0xC0000414L)
...
//
#define STATUS_HUNG_DISPLAY_DRIVER_THREAD ((int32_t)0xC0000415L)
...
//
#define STATUS_INSUFFICIENT_RESOURCE_FOR_SPECIFIED_SHARED_SECTION_SIZE ((int32_t)0xC0000416L)
...
//
#define STATUS_INVALID_CRUNTIME_PARAMETER ((int32_t)0xC0000417L)    // winnt
...
//
#define STATUS_NTLM_BLOCKED              ((int32_t)0xC0000418L)
...
//
#define STATUS_DS_SRC_SID_EXISTS_IN_FOREST ((int32_t)0xC0000419L)
...
//
#define STATUS_DS_DOMAIN_NAME_EXISTS_IN_FOREST ((int32_t)0xC000041AL)
...
//
#define STATUS_DS_FLAT_NAME_EXISTS_IN_FOREST ((int32_t)0xC000041BL)
...
//
#define STATUS_INVALID_USER_PRINCIPAL_NAME ((int32_t)0xC000041CL)
...
//
#define STATUS_FATAL_USER_CALLBACK_EXCEPTION ((int32_t)0xC000041DL)
...
//
#define STATUS_ASSERTION_FAILURE         ((int32_t)0xC0000420L)    // winnt
...
//
#define STATUS_VERIFIER_STOP             ((int32_t)0xC0000421L)
...
//
#define STATUS_CALLBACK_POP_STACK        ((int32_t)0xC0000423L)
...
//
#define STATUS_INCOMPATIBLE_DRIVER_BLOCKED ((int32_t)0xC0000424L)
...
//
#define STATUS_HIVE_UNLOADED             ((int32_t)0xC0000425L)
...
//
#define STATUS_COMPRESSION_DISABLED      ((int32_t)0xC0000426L)
...
//
#define STATUS_FILE_SYSTEM_LIMITATION    ((int32_t)0xC0000427L)
...
//
#define STATUS_INVALID_IMAGE_HASH        ((int32_t)0xC0000428L)
...
//
#define STATUS_NOT_CAPABLE               ((int32_t)0xC0000429L)
...
//
#define STATUS_REQUEST_OUT_OF_SEQUENCE   ((int32_t)0xC000042AL)
...
//
#define STATUS_IMPLEMENTATION_LIMIT      ((int32_t)0xC000042BL)
...
//
#define STATUS_ELEVATION_REQUIRED        ((int32_t)0xC000042CL)
...
//
#define STATUS_NO_SECURITY_CONTEXT       ((int32_t)0xC000042DL)
...
//
#define STATUS_PKU2U_CERT_FAILURE        ((int32_t)0xC000042FL)
...
//
#define STATUS_BEYOND_VDL                ((int32_t)0xC0000432L)
...
//
#define STATUS_ENCOUNTERED_WRITE_IN_PROGRESS ((int32_t)0xC0000433L)
...
//
#define STATUS_PTE_CHANGED               ((int32_t)0xC0000434L)
...
//
#define STATUS_PURGE_FAILED              ((int32_t)0xC0000435L)
...
//
#define STATUS_CRED_REQUIRES_CONFIRMATION ((int32_t)0xC0000440L)
...
//
#define STATUS_CS_ENCRYPTION_INVALID_SERVER_RESPONSE ((int32_t)0xC0000441L)
...
//
#define STATUS_CS_ENCRYPTION_UNSUPPORTED_SERVER ((int32_t)0xC0000442L)
...
//
#define STATUS_CS_ENCRYPTION_EXISTING_ENCRYPTED_FILE ((int32_t)0xC0000443L)
...
//
#define STATUS_CS_ENCRYPTION_NEW_ENCRYPTED_FILE ((int32_t)0xC0000444L)
...
//
#define STATUS_CS_ENCRYPTION_FILE_NOT_CSE ((int32_t)0xC0000445L)
...
//
#define STATUS_INVALID_LABEL             ((int32_t)0xC0000446L)
...
//
#define STATUS_DRIVER_PROCESS_TERMINATED ((int32_t)0xC0000450L)
...
//
#define STATUS_AMBIGUOUS_SYSTEM_DEVICE   ((int32_t)0xC0000451L)
...
//
#define STATUS_SYSTEM_DEVICE_NOT_FOUND   ((int32_t)0xC0000452L)
...
//
#define STATUS_RESTART_BOOT_APPLICATION  ((int32_t)0xC0000453L)
...
//
#define STATUS_INSUFFICIENT_NVRAM_RESOURCES ((int32_t)0xC0000454L)    
...
//
#define STATUS_INVALID_SESSION           ((int32_t)0xC0000455L)
...
//
#define STATUS_THREAD_ALREADY_IN_SESSION ((int32_t)0xC0000456L)
...
//
#define STATUS_THREAD_NOT_IN_SESSION     ((int32_t)0xC0000457L)
...
//
#define STATUS_INVALID_WEIGHT            ((int32_t)0xC0000458L)
...
//
#define STATUS_REQUEST_PAUSED            ((int32_t)0xC0000459L)
...
//
#define STATUS_NO_RANGES_PROCESSED       ((int32_t)0xC0000460L)
...
//
#define STATUS_DISK_RESOURCES_EXHAUSTED  ((int32_t)0xC0000461L)
...
//
#define STATUS_NEEDS_REMEDIATION         ((int32_t)0xC0000462L)
...
//
#define STATUS_DEVICE_FEATURE_NOT_SUPPORTED ((int32_t)0xC0000463L)
...
//
#define STATUS_DEVICE_UNREACHABLE        ((int32_t)0xC0000464L)
...
//
#define STATUS_INVALID_TOKEN             ((int32_t)0xC0000465L)
...
//
#define STATUS_SERVER_UNAVAILABLE        ((int32_t)0xC0000466L)
...
//
#define STATUS_FILE_NOT_AVAILABLE        ((int32_t)0xC0000467L)
...
//
#define STATUS_DEVICE_INSUFFICIENT_RESOURCES ((int32_t)0xC0000468L)
...
//
#define STATUS_PACKAGE_UPDATING          ((int32_t)0xC0000469L)
...
//
#define STATUS_NOT_READ_FROM_COPY        ((int32_t)0xC000046AL)
...
//
#define STATUS_FT_WRITE_FAILURE          ((int32_t)0xC000046BL)
...
//
#define STATUS_FT_DI_SCAN_REQUIRED       ((int32_t)0xC000046CL)
...
//
#define STATUS_OBJECT_NOT_EXTERNALLY_BACKED ((int32_t)0xC000046DL)
...
//
#define STATUS_EXTERNAL_BACKING_PROVIDER_UNKNOWN ((int32_t)0xC000046EL)
...
//
#define STATUS_COMPRESSION_NOT_BENEFICIAL ((int32_t)0xC000046FL)
...
//
#define STATUS_DATA_CHECKSUM_ERROR       ((int32_t)0xC0000470L)
...
//
#define STATUS_INTERMIXED_KERNEL_EA_OPERATION ((int32_t)0xC0000471L)
...
//
#define STATUS_TRIM_READ_ZERO_NOT_SUPPORTED ((int32_t)0xC0000472L)
...
//
#define STATUS_TOO_MANY_SEGMENT_DESCRIPTORS ((int32_t)0xC0000473L)
...
//
#define STATUS_INVALID_OFFSET_ALIGNMENT  ((int32_t)0xC0000474L)
...
//
#define STATUS_INVALID_FIELD_IN_PARAMETER_LIST ((int32_t)0xC0000475L)
...
//
#define STATUS_OPERATION_IN_PROGRESS     ((int32_t)0xC0000476L)
...
//
#define STATUS_INVALID_INITIATOR_TARGET_PATH ((int32_t)0xC0000477L)
...
//
#define STATUS_SCRUB_DATA_DISABLED       ((int32_t)0xC0000478L)
...
//
#define STATUS_NOT_REDUNDANT_STORAGE     ((int32_t)0xC0000479L)
...
//
#define STATUS_RESIDENT_FILE_NOT_SUPPORTED ((int32_t)0xC000047AL)
...
//
#define STATUS_COMPRESSED_FILE_NOT_SUPPORTED ((int32_t)0xC000047BL)
...
//
#define STATUS_DIRECTORY_NOT_SUPPORTED   ((int32_t)0xC000047CL)
...
//
#define STATUS_IO_OPERATION_TIMEOUT      ((int32_t)0xC000047DL)
...
//
#define STATUS_SYSTEM_NEEDS_REMEDIATION  ((int32_t)0xC000047EL)
...
//
#define STATUS_APPX_INTEGRITY_FAILURE_CLR_NGEN ((int32_t)0xC000047FL)
...
//
#define STATUS_SHARE_UNAVAILABLE         ((int32_t)0xC0000480L)
...
//
#define STATUS_APISET_NOT_HOSTED         ((int32_t)0xC0000481L)
...
//
#define STATUS_APISET_NOT_PRESENT        ((int32_t)0xC0000482L)
...
//
#define STATUS_DEVICE_HARDWARE_ERROR     ((int32_t)0xC0000483L)
...
//
#define STATUS_FIRMWARE_SLOT_INVALID     ((int32_t)0xC0000484L)
...
//
#define STATUS_FIRMWARE_IMAGE_INVALID    ((int32_t)0xC0000485L)
...
//
#define STATUS_STORAGE_TOPOLOGY_ID_MISMATCH ((int32_t)0xC0000486L)
...
//
#define STATUS_WIM_NOT_BOOTABLE          ((int32_t)0xC0000487L)
...
//
#define STATUS_BLOCKED_BY_PARENTAL_CONTROLS ((int32_t)0xC0000488L)
...
//
#define STATUS_NEEDS_REGISTRATION        ((int32_t)0xC0000489L)
...
//
#define STATUS_QUOTA_ACTIVITY            ((int32_t)0xC000048AL)
...
//
#define STATUS_CALLBACK_INVOKE_INLINE    ((int32_t)0xC000048BL)
...
//
#define STATUS_BLOCK_TOO_MANY_REFERENCES ((int32_t)0xC000048CL)
...
//
#define STATUS_MARKED_TO_DISALLOW_WRITES ((int32_t)0xC000048DL)
...
//
#define STATUS_NETWORK_ACCESS_DENIED_EDP ((int32_t)0xC000048EL)
...
//
#define STATUS_ENCLAVE_FAILURE           ((int32_t)0xC000048FL)
...
//
#define STATUS_PNP_NO_COMPAT_DRIVERS     ((int32_t)0xC0000490L)
...
//
#define STATUS_PNP_DRIVER_PACKAGE_NOT_FOUND ((int32_t)0xC0000491L)
...
//
#define STATUS_PNP_DRIVER_CONFIGURATION_NOT_FOUND ((int32_t)0xC0000492L)
...
//
#define STATUS_PNP_DRIVER_CONFIGURATION_INCOMPLETE ((int32_t)0xC0000493L)
...
//
#define STATUS_PNP_FUNCTION_DRIVER_REQUIRED ((int32_t)0xC0000494L)
...
//
#define STATUS_PNP_DEVICE_CONFIGURATION_PENDING ((int32_t)0xC0000495L)
...
//
#define STATUS_DEVICE_HINT_NAME_BUFFER_TOO_SMALL ((int32_t)0xC0000496L)
...
//
#define STATUS_PACKAGE_NOT_AVAILABLE     ((int32_t)0xC0000497L)
...
//
#define STATUS_DEVICE_IN_MAINTENANCE     ((int32_t)0xC0000499L)
...
//
#define STATUS_NOT_SUPPORTED_ON_DAX      ((int32_t)0xC000049AL)
...
//
#define STATUS_FREE_SPACE_TOO_FRAGMENTED ((int32_t)0xC000049BL)
...
//
#define STATUS_DAX_MAPPING_EXISTS        ((int32_t)0xC000049CL)
...
//
#define STATUS_CHILD_PROCESS_BLOCKED     ((int32_t)0xC000049DL)
...
//
#define STATUS_STORAGE_LOST_DATA_PERSISTENCE ((int32_t)0xC000049EL)
...
//
#define STATUS_VRF_CFG_AND_IO_ENABLED    ((int32_t)0xC000049FL)
...
//
#define STATUS_PARTITION_TERMINATING     ((int32_t)0xC00004A0L)
...
//
#define STATUS_EXTERNAL_SYSKEY_NOT_SUPPORTED ((int32_t)0xC00004A1L)
...
//
#define STATUS_ENCLAVE_VIOLATION         ((int32_t)0xC00004A2L)    // winnt
...
//
#define STATUS_FILE_PROTECTED_UNDER_DPL  ((int32_t)0xC00004A3L)
...
//
#define STATUS_VOLUME_NOT_CLUSTER_ALIGNED ((int32_t)0xC00004A4L)
...
//
#define STATUS_NO_PHYSICALLY_ALIGNED_FREE_SPACE_FOUND ((int32_t)0xC00004A5L)
...
//
#define STATUS_APPX_FILE_NOT_ENCRYPTED   ((int32_t)0xC00004A6L)
...
//
#define STATUS_RWRAW_ENCRYPTED_FILE_NOT_ENCRYPTED ((int32_t)0xC00004A7L)
...
//
#define STATUS_RWRAW_ENCRYPTED_INVALID_EDATAINFO_FILEOFFSET ((int32_t)0xC00004A8L)
...
//
#define STATUS_RWRAW_ENCRYPTED_INVALID_EDATAINFO_FILERANGE ((int32_t)0xC00004A9L)
...
//
#define STATUS_RWRAW_ENCRYPTED_INVALID_EDATAINFO_PARAMETER ((int32_t)0xC00004AAL)
...
//
#define STATUS_FT_READ_FAILURE           ((int32_t)0xC00004ABL)
...
//
#define STATUS_PATCH_CONFLICT            ((int32_t)0xC00004ACL)
...
//
#define STATUS_STORAGE_RESERVE_ID_INVALID ((int32_t)0xC00004ADL)
...
//
#define STATUS_STORAGE_RESERVE_DOES_NOT_EXIST ((int32_t)0xC00004AEL)
...
//
#define STATUS_STORAGE_RESERVE_ALREADY_EXISTS ((int32_t)0xC00004AFL)
...
//
#define STATUS_STORAGE_RESERVE_NOT_EMPTY ((int32_t)0xC00004B0L)
...
//
#define STATUS_NOT_A_DAX_VOLUME          ((int32_t)0xC00004B1L)
...
//
#define STATUS_NOT_DAX_MAPPABLE          ((int32_t)0xC00004B2L)
...
//
#define STATUS_CASE_DIFFERING_NAMES_IN_DIR ((int32_t)0xC00004B3L)
...
//
#define STATUS_FILE_NOT_SUPPORTED        ((int32_t)0xC00004B4L)
...
//
#define STATUS_NOT_SUPPORTED_WITH_BTT    ((int32_t)0xC00004B5L)
...
//
#define STATUS_ENCRYPTION_DISABLED       ((int32_t)0xC00004B6L)
...
//
#define STATUS_ENCRYPTING_METADATA_DISALLOWED ((int32_t)0xC00004B7L)
...
//
#define STATUS_CANT_CLEAR_ENCRYPTION_FLAG ((int32_t)0xC00004B8L)
...
//
#define STATUS_UNSATISFIED_DEPENDENCIES  ((int32_t)0xC00004B9L)
...
//
#define STATUS_CASE_SENSITIVE_PATH       ((int32_t)0xC00004BAL)
...
//
#define STATUS_INVALID_TASK_NAME         ((int32_t)0xC0000500L)
...
//
#define STATUS_INVALID_TASK_INDEX        ((int32_t)0xC0000501L)
...
//
#define STATUS_THREAD_ALREADY_IN_TASK    ((int32_t)0xC0000502L)
...
//
#define STATUS_CALLBACK_BYPASS           ((int32_t)0xC0000503L)
...
//
#define STATUS_UNDEFINED_SCOPE           ((int32_t)0xC0000504L)
...
//
#define STATUS_INVALID_CAP               ((int32_t)0xC0000505L)
...
//
#define STATUS_NOT_GUI_PROCESS           ((int32_t)0xC0000506L)
...
//
#define STATUS_DEVICE_HUNG               ((int32_t)0xC0000507L)
...
//
#define STATUS_CONTAINER_ASSIGNED        ((int32_t)0xC0000508L)
...
//
#define STATUS_JOB_NO_CONTAINER          ((int32_t)0xC0000509L)
...
//
#define STATUS_DEVICE_UNRESPONSIVE       ((int32_t)0xC000050AL)
...
//
#define STATUS_REPARSE_POINT_ENCOUNTERED ((int32_t)0xC000050BL)
...
//
#define STATUS_ATTRIBUTE_NOT_PRESENT     ((int32_t)0xC000050CL)
...
//
#define STATUS_NOT_A_TIERED_VOLUME       ((int32_t)0xC000050DL)
...
//
#define STATUS_ALREADY_HAS_STREAM_ID     ((int32_t)0xC000050EL)
...
//
#define STATUS_JOB_NOT_EMPTY             ((int32_t)0xC000050FL)
...
//
#define STATUS_ALREADY_INITIALIZED       ((int32_t)0xC0000510L)
...
//
#define STATUS_ENCLAVE_NOT_TERMINATED    ((int32_t)0xC0000511L)
...
//
#define STATUS_ENCLAVE_IS_TERMINATING    ((int32_t)0xC0000512L)
...
//
#define STATUS_SMB1_NOT_AVAILABLE        ((int32_t)0xC0000513L)
...
//
#define STATUS_SMR_GARBAGE_COLLECTION_REQUIRED ((int32_t)0xC0000514L)
...
//
#define STATUS_INTERRUPTED               ((int32_t)0xC0000515L)    // winnt
...
//
#define STATUS_THREAD_NOT_RUNNING        ((int32_t)0xC0000516L)    // winnt
...
//
#define STATUS_FAIL_FAST_EXCEPTION       ((int32_t)0xC0000602L)
...
//
#define STATUS_IMAGE_CERT_REVOKED        ((int32_t)0xC0000603L)
...
//
#define STATUS_DYNAMIC_CODE_BLOCKED      ((int32_t)0xC0000604L)
...
//
#define STATUS_IMAGE_CERT_EXPIRED        ((int32_t)0xC0000605L)
...
//
#define STATUS_STRICT_CFG_VIOLATION      ((int32_t)0xC0000606L)
...
//
#define STATUS_SET_CONTEXT_DENIED        ((int32_t)0xC000060AL)
...
//
#define STATUS_CROSS_PARTITION_VIOLATION ((int32_t)0xC000060BL)
...
//
#define STATUS_PORT_CLOSED               ((int32_t)0xC0000700L)
...
//
#define STATUS_MESSAGE_LOST              ((int32_t)0xC0000701L)
...
//
#define STATUS_INVALID_MESSAGE           ((int32_t)0xC0000702L)
...
//
#define STATUS_REQUEST_CANCELED          ((int32_t)0xC0000703L)
...
//
#define STATUS_RECURSIVE_DISPATCH        ((int32_t)0xC0000704L)
...
//
#define STATUS_LPC_RECEIVE_BUFFER_EXPECTED ((int32_t)0xC0000705L)
...
//
#define STATUS_LPC_INVALID_CONNECTION_USAGE ((int32_t)0xC0000706L)
...
//
#define STATUS_LPC_REQUESTS_NOT_ALLOWED  ((int32_t)0xC0000707L)
...
//
#define STATUS_RESOURCE_IN_USE           ((int32_t)0xC0000708L)
...
//
#define STATUS_HARDWARE_MEMORY_ERROR     ((int32_t)0xC0000709L)
...
//
#define STATUS_THREADPOOL_HANDLE_EXCEPTION ((int32_t)0xC000070AL)
...
//
#define STATUS_THREADPOOL_SET_EVENT_ON_COMPLETION_FAILED ((int32_t)0xC000070BL)
...
//
#define STATUS_THREADPOOL_RELEASE_SEMAPHORE_ON_COMPLETION_FAILED ((int32_t)0xC000070CL)
...
//
#define STATUS_THREADPOOL_RELEASE_MUTEX_ON_COMPLETION_FAILED ((int32_t)0xC000070DL)
...
//
#define STATUS_THREADPOOL_FREE_LIBRARY_ON_COMPLETION_FAILED ((int32_t)0xC000070EL)
...
//
#define STATUS_THREADPOOL_RELEASED_DURING_OPERATION ((int32_t)0xC000070FL)
...
//
#define STATUS_CALLBACK_RETURNED_WHILE_IMPERSONATING ((int32_t)0xC0000710L)
...
//
#define STATUS_APC_RETURNED_WHILE_IMPERSONATING ((int32_t)0xC0000711L)
...
//
#define STATUS_PROCESS_IS_PROTECTED      ((int32_t)0xC0000712L)
...
//
#define STATUS_MCA_EXCEPTION             ((int32_t)0xC0000713L)
...
//
#define STATUS_CERTIFICATE_MAPPING_NOT_UNIQUE ((int32_t)0xC0000714L)
...
//
#define STATUS_SYMLINK_CLASS_DISABLED    ((int32_t)0xC0000715L)
...
//
#define STATUS_INVALID_IDN_NORMALIZATION ((int32_t)0xC0000716L)
...
// No mapping for the Unicode character exists in the target multi-byte code page.
//
#define STATUS_NO_UNICODE_TRANSLATION    ((int32_t)0xC0000717L)
...
//
#define STATUS_ALREADY_REGISTERED        ((int32_t)0xC0000718L)    //winnt
...
//
#define STATUS_CONTEXT_MISMATCH          ((int32_t)0xC0000719L)
...
//
#define STATUS_PORT_ALREADY_HAS_COMPLETION_LIST ((int32_t)0xC000071AL)
...
//
#define STATUS_CALLBACK_RETURNED_THREAD_PRIORITY ((int32_t)0xC000071BL)
...
//
#define STATUS_INVALID_THREAD            ((int32_t)0xC000071CL)
...
//
#define STATUS_CALLBACK_RETURNED_TRANSACTION ((int32_t)0xC000071DL)
...
//
#define STATUS_CALLBACK_RETURNED_LDR_LOCK ((int32_t)0xC000071EL)
...
//
#define STATUS_CALLBACK_RETURNED_LANG    ((int32_t)0xC000071FL)
...
//
#define STATUS_CALLBACK_RETURNED_PRI_BACK ((int32_t)0xC0000720L)
...
// This is unexpected, indicating that the callback missed restoring the priority.
//
#define STATUS_CALLBACK_RETURNED_THREAD_AFFINITY ((int32_t)0xC0000721L)
...
//
#define STATUS_LPC_HANDLE_COUNT_EXCEEDED ((int32_t)0xC0000722L)
...
//
#define STATUS_EXECUTABLE_MEMORY_WRITE   ((int32_t)0xC0000723L)
...
//
#define STATUS_KERNEL_EXECUTABLE_MEMORY_WRITE ((int32_t)0xC0000724L)
...
//
#define STATUS_ATTACHED_EXECUTABLE_MEMORY_WRITE ((int32_t)0xC0000725L)
...
//
#define STATUS_TRIGGERED_EXECUTABLE_MEMORY_WRITE ((int32_t)0xC0000726L)
...
//
#define STATUS_DISK_REPAIR_DISABLED      ((int32_t)0xC0000800L)
...
//
#define STATUS_DS_DOMAIN_RENAME_IN_PROGRESS ((int32_t)0xC0000801L)
...
//
#define STATUS_DISK_QUOTA_EXCEEDED       ((int32_t)0xC0000802L)
...
//
#define STATUS_DATA_LOST_REPAIR          ((int32_t)0x80000803L)
...
//
#define STATUS_CONTENT_BLOCKED           ((int32_t)0xC0000804L)
...
//
#define STATUS_BAD_CLUSTERS              ((int32_t)0xC0000805L)
...
//
#define STATUS_VOLUME_DIRTY              ((int32_t)0xC0000806L)
...
//
#define STATUS_DISK_REPAIR_REDIRECTED    ((int32_t)0x40000807L)
...
//
#define STATUS_DISK_REPAIR_UNSUCCESSFUL  ((int32_t)0xC0000808L)
...
//
#define STATUS_CORRUPT_LOG_OVERFULL      ((int32_t)0xC0000809L)
...
//
#define STATUS_CORRUPT_LOG_CORRUPTED     ((int32_t)0xC000080AL)
...
//
#define STATUS_CORRUPT_LOG_UNAVAILABLE   ((int32_t)0xC000080BL)
...
//
#define STATUS_CORRUPT_LOG_DELETED_FULL  ((int32_t)0xC000080CL)
...
//
#define STATUS_CORRUPT_LOG_CLEARED       ((int32_t)0xC000080DL)
...
//
#define STATUS_ORPHAN_NAME_EXHAUSTED     ((int32_t)0xC000080EL)
...
//
#define STATUS_PROACTIVE_SCAN_IN_PROGRESS ((int32_t)0xC000080FL)
...
//
#define STATUS_ENCRYPTED_IO_NOT_POSSIBLE ((int32_t)0xC0000810L)
...
//
#define STATUS_CORRUPT_LOG_UPLEVEL_RECORDS ((int32_t)0xC0000811L)
...
//
#define STATUS_FILE_CHECKED_OUT          ((int32_t)0xC0000901L)
...
//
#define STATUS_CHECKOUT_REQUIRED         ((int32_t)0xC0000902L)
...
//
#define STATUS_BAD_FILE_TYPE             ((int32_t)0xC0000903L)
...
//
#define STATUS_FILE_TOO_LARGE            ((int32_t)0xC0000904L)
...
//
#define STATUS_FORMS_AUTH_REQUIRED       ((int32_t)0xC0000905L)
...
//
#define STATUS_VIRUS_INFECTED            ((int32_t)0xC0000906L)
...
//
#define STATUS_VIRUS_DELETED             ((int32_t)0xC0000907L)
...
//
#define STATUS_BAD_MCFG_TABLE            ((int32_t)0xC0000908L)
...
//
#define STATUS_CANNOT_BREAK_OPLOCK       ((int32_t)0xC0000909L)
...
// Bad key.
//
#define STATUS_BAD_KEY                   ((int32_t)0xC000090AL)
...
// Bad data.
//
#define STATUS_BAD_DATA                  ((int32_t)0xC000090BL)
...
// Key does not exist.
//
#define STATUS_NO_KEY                    ((int32_t)0xC000090CL)
...
//
#define STATUS_FILE_HANDLE_REVOKED       ((int32_t)0xC0000910L)
...
// WOW Assertion Error.
//
#define STATUS_WOW_ASSERTION             ((int32_t)0xC0009898L)
...
//
#define STATUS_INVALID_SIGNATURE         ((int32_t)0xC000A000L)
...
//
#define STATUS_HMAC_NOT_SUPPORTED        ((int32_t)0xC000A001L)
...
//
#define STATUS_AUTH_TAG_MISMATCH         ((int32_t)0xC000A002L)
...
//
#define STATUS_INVALID_STATE_TRANSITION  ((int32_t)0xC000A003L)
...
//
#define STATUS_INVALID_KERNEL_INFO_VERSION ((int32_t)0xC000A004L)
...
//
#define STATUS_INVALID_PEP_INFO_VERSION  ((int32_t)0xC000A005L)
...
//
#define STATUS_HANDLE_REVOKED            ((int32_t)0xC000A006L)
...
//
#define STATUS_EOF_ON_GHOSTED_RANGE      ((int32_t)0xC000A007L)
...
//
#define STATUS_CC_NEEDS_CALLBACK_SECTION_DRAIN ((int32_t)0xC000A008L)
...
//
#define STATUS_IPSEC_QUEUE_OVERFLOW      ((int32_t)0xC000A010L)
...
//
#define STATUS_ND_QUEUE_OVERFLOW         ((int32_t)0xC000A011L)
...
//
#define STATUS_HOPLIMIT_EXCEEDED         ((int32_t)0xC000A012L)
...
//
#define STATUS_PROTOCOL_NOT_SUPPORTED    ((int32_t)0xC000A013L)
...
//
#define STATUS_FASTPATH_REJECTED         ((int32_t)0xC000A014L)
...
//
#define STATUS_LOST_WRITEBEHIND_DATA_NETWORK_DISCONNECTED ((int32_t)0xC000A080L)
...
//
#define STATUS_LOST_WRITEBEHIND_DATA_NETWORK_SERVER_ERROR ((int32_t)0xC000A081L)
...
//
#define STATUS_LOST_WRITEBEHIND_DATA_LOCAL_DISK_ERROR ((int32_t)0xC000A082L)
...
//
#define STATUS_XML_PARSE_ERROR           ((int32_t)0xC000A083L)
...
//
#define STATUS_XMLDSIG_ERROR             ((int32_t)0xC000A084L)
...
//
#define STATUS_WRONG_COMPARTMENT         ((int32_t)0xC000A085L)
...
//
#define STATUS_AUTHIP_FAILURE            ((int32_t)0xC000A086L)
...
//
#define STATUS_DS_OID_MAPPED_GROUP_CANT_HAVE_MEMBERS ((int32_t)0xC000A087L)
...
//
#define STATUS_DS_OID_NOT_FOUND          ((int32_t)0xC000A088L)
...
//
#define STATUS_INCORRECT_ACCOUNT_TYPE    ((int32_t)0xC000A089L)
...
//
#define STATUS_HASH_NOT_SUPPORTED        ((int32_t)0xC000A100L)
...
//
#define STATUS_HASH_NOT_PRESENT          ((int32_t)0xC000A101L)
...
//
#define STATUS_SECONDARY_IC_PROVIDER_NOT_REGISTERED ((int32_t)0xC000A121L)
...
//
#define STATUS_GPIO_CLIENT_INFORMATION_INVALID ((int32_t)0xC000A122L)
...
//
#define STATUS_GPIO_VERSION_NOT_SUPPORTED ((int32_t)0xC000A123L)
...
//
#define STATUS_GPIO_INVALID_REGISTRATION_PACKET ((int32_t)0xC000A124L)
...
//
#define STATUS_GPIO_OPERATION_DENIED     ((int32_t)0xC000A125L)
...
//
#define STATUS_GPIO_INCOMPATIBLE_CONNECT_MODE ((int32_t)0xC000A126L)
...
//
#define STATUS_GPIO_INTERRUPT_ALREADY_UNMASKED ((int32_t)0x8000A127L)
...
//
#define STATUS_CANNOT_SWITCH_RUNLEVEL    ((int32_t)0xC000A141L)
...
//
#define STATUS_INVALID_RUNLEVEL_SETTING  ((int32_t)0xC000A142L)
...
//
#define STATUS_RUNLEVEL_SWITCH_TIMEOUT   ((int32_t)0xC000A143L)
...
//
#define STATUS_SERVICES_FAILED_AUTOSTART ((int32_t)0x4000A144L)
...
//
#define STATUS_RUNLEVEL_SWITCH_AGENT_TIMEOUT ((int32_t)0xC000A145L)
...
//
#define STATUS_RUNLEVEL_SWITCH_IN_PROGRESS ((int32_t)0xC000A146L)
...
//
#define STATUS_NOT_APPCONTAINER          ((int32_t)0xC000A200L)
...
//
#define STATUS_NOT_SUPPORTED_IN_APPCONTAINER ((int32_t)0xC000A201L)
...
//
#define STATUS_INVALID_PACKAGE_SID_LENGTH ((int32_t)0xC000A202L)
...
//
#define STATUS_LPAC_ACCESS_DENIED        ((int32_t)0xC000A203L)
...
//
#define STATUS_ADMINLESS_ACCESS_DENIED   ((int32_t)0xC000A204L)
...
//
#define STATUS_APP_DATA_NOT_FOUND        ((int32_t)0xC000A281L)
...
//
#define STATUS_APP_DATA_EXPIRED          ((int32_t)0xC000A282L)
...
//
#define STATUS_APP_DATA_CORRUPT          ((int32_t)0xC000A283L)
...
//
#define STATUS_APP_DATA_LIMIT_EXCEEDED   ((int32_t)0xC000A284L)
...
//
#define STATUS_APP_DATA_REBOOT_REQUIRED  ((int32_t)0xC000A285L)
...
//
#define STATUS_OFFLOAD_READ_FLT_NOT_SUPPORTED ((int32_t)0xC000A2A1L)
...
//
#define STATUS_OFFLOAD_WRITE_FLT_NOT_SUPPORTED ((int32_t)0xC000A2A2L)
...
//
#define STATUS_OFFLOAD_READ_FILE_NOT_SUPPORTED ((int32_t)0xC000A2A3L)
...
//
#define STATUS_OFFLOAD_WRITE_FILE_NOT_SUPPORTED ((int32_t)0xC000A2A4L)
...
//
#define STATUS_WOF_WIM_HEADER_CORRUPT    ((int32_t)0xC000A2A5L)
...
//
#define STATUS_WOF_WIM_RESOURCE_TABLE_CORRUPT ((int32_t)0xC000A2A6L)
...
//
#define STATUS_WOF_FILE_RESOURCE_TABLE_CORRUPT ((int32_t)0xC000A2A7L)
...
//
#define STATUS_CIMFS_IMAGE_CORRUPT       ((int32_t)0xC000C001L)
...
//
#define STATUS_FILE_SYSTEM_VIRTUALIZATION_UNAVAILABLE ((int32_t)0xC000CE01L)
...
//
#define STATUS_FILE_SYSTEM_VIRTUALIZATION_METADATA_CORRUPT ((int32_t)0xC000CE02L)
...
//
#define STATUS_FILE_SYSTEM_VIRTUALIZATION_BUSY ((int32_t)0xC000CE03L)
...
//
#define STATUS_FILE_SYSTEM_VIRTUALIZATION_PROVIDER_UNKNOWN ((int32_t)0xC000CE04L)
...
//
#define STATUS_FILE_SYSTEM_VIRTUALIZATION_INVALID_OPERATION ((int32_t)0xC000CE05L)
...
//
#define STATUS_CLOUD_FILE_SYNC_ROOT_METADATA_CORRUPT ((int32_t)0xC000CF00L)
...
//
#define STATUS_CLOUD_FILE_PROVIDER_NOT_RUNNING ((int32_t)0xC000CF01L)
...
//
#define STATUS_CLOUD_FILE_METADATA_CORRUPT ((int32_t)0xC000CF02L)
...
//
#define STATUS_CLOUD_FILE_METADATA_TOO_LARGE ((int32_t)0xC000CF03L)
...
//
#define STATUS_CLOUD_FILE_PROPERTY_BLOB_TOO_LARGE ((int32_t)0x8000CF04L)
...
//
#define STATUS_CLOUD_FILE_TOO_MANY_PROPERTY_BLOBS ((int32_t)0x8000CF05L)
...
//
#define STATUS_CLOUD_FILE_PROPERTY_VERSION_NOT_SUPPORTED ((int32_t)0xC000CF06L)
...
//
#define STATUS_NOT_A_CLOUD_FILE          ((int32_t)0xC000CF07L)
...
//
#define STATUS_CLOUD_FILE_NOT_IN_SYNC    ((int32_t)0xC000CF08L)
...
//
#define STATUS_CLOUD_FILE_ALREADY_CONNECTED ((int32_t)0xC000CF09L)
...
//
#define STATUS_CLOUD_FILE_NOT_SUPPORTED  ((int32_t)0xC000CF0AL)
...
//
#define STATUS_CLOUD_FILE_INVALID_REQUEST ((int32_t)0xC000CF0BL)
...
//
#define STATUS_CLOUD_FILE_READ_ONLY_VOLUME ((int32_t)0xC000CF0CL)
...
//
#define STATUS_CLOUD_FILE_CONNECTED_PROVIDER_ONLY ((int32_t)0xC000CF0DL)
...
//
#define STATUS_CLOUD_FILE_VALIDATION_FAILED ((int32_t)0xC000CF0EL)
...
//
#define STATUS_CLOUD_FILE_AUTHENTICATION_FAILED ((int32_t)0xC000CF0FL)
...
//
#define STATUS_CLOUD_FILE_INSUFFICIENT_RESOURCES ((int32_t)0xC000CF10L)
...
//
#define STATUS_CLOUD_FILE_NETWORK_UNAVAILABLE ((int32_t)0xC000CF11L)
...
//
#define STATUS_CLOUD_FILE_UNSUCCESSFUL   ((int32_t)0xC000CF12L)
...
//
#define STATUS_CLOUD_FILE_NOT_UNDER_SYNC_ROOT ((int32_t)0xC000CF13L)
...
//
#define STATUS_CLOUD_FILE_IN_USE         ((int32_t)0xC000CF14L)
...
//
#define STATUS_CLOUD_FILE_PINNED         ((int32_t)0xC000CF15L)
...
//
#define STATUS_CLOUD_FILE_REQUEST_ABORTED ((int32_t)0xC000CF16L)
...
//
#define STATUS_CLOUD_FILE_PROPERTY_CORRUPT ((int32_t)0xC000CF17L)
...
//
#define STATUS_CLOUD_FILE_ACCESS_DENIED  ((int32_t)0xC000CF18L)
...
//
#define STATUS_CLOUD_FILE_INCOMPATIBLE_HARDLINKS ((int32_t)0xC000CF19L)
...
//
#define STATUS_CLOUD_FILE_PROPERTY_LOCK_CONFLICT ((int32_t)0xC000CF1AL)
...
//
#define STATUS_CLOUD_FILE_REQUEST_CANCELED ((int32_t)0xC000CF1BL)
...
//
#define STATUS_CLOUD_FILE_PROVIDER_TERMINATED ((int32_t)0xC000CF1DL)
...
//
#define STATUS_NOT_A_CLOUD_SYNC_ROOT     ((int32_t)0xC000CF1EL)
...
//
#define STATUS_CLOUD_FILE_REQUEST_TIMEOUT ((int32_t)0xC000CF1FL)
...
//
#define STATUS_CLOUD_FILE_DEHYDRATION_DISALLOWED ((int32_t)0xC000CF20L)
...
//
#define STATUS_FILE_SNAP_IN_PROGRESS     ((int32_t)0xC000F500L)
...
//
#define STATUS_FILE_SNAP_USER_SECTION_NOT_SUPPORTED ((int32_t)0xC000F501L)
...
//
#define STATUS_FILE_SNAP_MODIFY_NOT_SUPPORTED ((int32_t)0xC000F502L)
...
//
#define STATUS_FILE_SNAP_IO_NOT_COORDINATED ((int32_t)0xC000F503L)
...
//
#define STATUS_FILE_SNAP_UNEXPECTED_ERROR ((int32_t)0xC000F504L)
...
//
#define STATUS_FILE_SNAP_INVALID_PARAMETER ((int32_t)0xC000F505L)
...
//
#define DBG_NO_STATE_CHANGE              ((int32_t)0xC0010001L)
...
//
#define DBG_APP_NOT_IDLE                 ((int32_t)0xC0010002L)
...
//
#define RPC_NT_INVALID_STRING_BINDING    ((int32_t)0xC0020001L)
...
//
#define RPC_NT_WRONG_KIND_OF_BINDING     ((int32_t)0xC0020002L)
...
//
#define RPC_NT_INVALID_BINDING           ((int32_t)0xC0020003L)
...
//
#define RPC_NT_PROTSEQ_NOT_SUPPORTED     ((int32_t)0xC0020004L)
...
//
#define RPC_NT_INVALID_RPC_PROTSEQ       ((int32_t)0xC0020005L)
...
//
#define RPC_NT_INVALID_STRING_UUID       ((int32_t)0xC0020006L)
...
//
#define RPC_NT_INVALID_ENDPOINT_FORMAT   ((int32_t)0xC0020007L)
...
//
#define RPC_NT_INVALID_NET_ADDR          ((int32_t)0xC0020008L)
...
//
#define RPC_NT_NO_ENDPOINT_FOUND         ((int32_t)0xC0020009L)
...
//
#define RPC_NT_INVALID_TIMEOUT           ((int32_t)0xC002000AL)
...
//
#define RPC_NT_OBJECT_NOT_FOUND          ((int32_t)0xC002000BL)
...
//
#define RPC_NT_ALREADY_REGISTERED        ((int32_t)0xC002000CL)
...
//
#define RPC_NT_TYPE_ALREADY_REGISTERED   ((int32_t)0xC002000DL)
...
//
#define RPC_NT_ALREADY_LISTENING         ((int32_t)0xC002000EL)
...
//
#define RPC_NT_NO_PROTSEQS_REGISTERED    ((int32_t)0xC002000FL)
...
//
#define RPC_NT_NOT_LISTENING             ((int32_t)0xC0020010L)
...
//
#define RPC_NT_UNKNOWN_MGR_TYPE          ((int32_t)0xC0020011L)
...
//
#define RPC_NT_UNKNOWN_IF                ((int32_t)0xC0020012L)
...
//
#define RPC_NT_NO_BINDINGS               ((int32_t)0xC0020013L)
...
//
#define RPC_NT_NO_PROTSEQS               ((int32_t)0xC0020014L)
...
//
#define RPC_NT_CANT_CREATE_ENDPOINT      ((int32_t)0xC0020015L)
...
//
#define RPC_NT_OUT_OF_RESOURCES          ((int32_t)0xC0020016L)
...
//
#define RPC_NT_SERVER_UNAVAILABLE        ((int32_t)0xC0020017L)
...
//
#define RPC_NT_SERVER_TOO_BUSY           ((int32_t)0xC0020018L)
...
//
#define RPC_NT_INVALID_NETWORK_OPTIONS   ((int32_t)0xC0020019L)
...
//
#define RPC_NT_NO_CALL_ACTIVE            ((int32_t)0xC002001AL)
...
//
#define RPC_NT_CALL_FAILED               ((int32_t)0xC002001BL)
...
//
#define RPC_NT_CALL_FAILED_DNE           ((int32_t)0xC002001CL)
...
//
#define RPC_NT_PROTOCOL_ERROR            ((int32_t)0xC002001DL)
...
//
#define RPC_NT_UNSUPPORTED_TRANS_SYN     ((int32_t)0xC002001FL)
...
//
#define RPC_NT_UNSUPPORTED_TYPE          ((int32_t)0xC0020021L)
...
// The tag is invalid.
//
#define RPC_NT_INVALID_TAG               ((int32_t)0xC0020022L)
...
//
#define RPC_NT_INVALID_BOUND             ((int32_t)0xC0020023L)
...
//
#define RPC_NT_NO_ENTRY_NAME             ((int32_t)0xC0020024L)
...
//
#define RPC_NT_INVALID_NAME_SYNTAX       ((int32_t)0xC0020025L)
...
//
#define RPC_NT_UNSUPPORTED_NAME_SYNTAX   ((int32_t)0xC0020026L)
...
//
#define RPC_NT_UUID_NO_ADDRESS           ((int32_t)0xC0020028L)
...
//
#define RPC_NT_DUPLICATE_ENDPOINT        ((int32_t)0xC0020029L)
...
//
#define RPC_NT_UNKNOWN_AUTHN_TYPE        ((int32_t)0xC002002AL)
...
//
#define RPC_NT_MAX_CALLS_TOO_SMALL       ((int32_t)0xC002002BL)
...
//
#define RPC_NT_STRING_TOO_LONG           ((int32_t)0xC002002CL)
...
//
#define RPC_NT_PROTSEQ_NOT_FOUND         ((int32_t)0xC002002DL)
...
//
#define RPC_NT_PROCNUM_OUT_OF_RANGE      ((int32_t)0xC002002EL)
...
//
#define RPC_NT_BINDING_HAS_NO_AUTH       ((int32_t)0xC002002FL)
...
//
#define RPC_NT_UNKNOWN_AUTHN_SERVICE     ((int32_t)0xC0020030L)
...
//
#define RPC_NT_UNKNOWN_AUTHN_LEVEL       ((int32_t)0xC0020031L)
...
//
#define RPC_NT_INVALID_AUTH_IDENTITY     ((int32_t)0xC0020032L)
...
//
#define RPC_NT_UNKNOWN_AUTHZ_SERVICE     ((int32_t)0xC0020033L)
...
//
#define EPT_NT_INVALID_ENTRY             ((int32_t)0xC0020034L)
...
//
#define EPT_NT_CANT_PERFORM_OP           ((int32_t)0xC0020035L)
...
//
#define EPT_NT_NOT_REGISTERED            ((int32_t)0xC0020036L)
...
//
#define RPC_NT_NOTHING_TO_EXPORT         ((int32_t)0xC0020037L)
...
//
#define RPC_NT_INCOMPLETE_NAME           ((int32_t)0xC0020038L)
...
//
#define RPC_NT_INVALID_VERS_OPTION       ((int32_t)0xC0020039L)
...
//
#define RPC_NT_NO_MORE_MEMBERS           ((int32_t)0xC002003AL)
...
//
#define RPC_NT_NOT_ALL_OBJS_UNEXPORTED   ((int32_t)0xC002003BL)
...
//
#define RPC_NT_INTERFACE_NOT_FOUND       ((int32_t)0xC002003CL)
...
//
#define RPC_NT_ENTRY_ALREADY_EXISTS      ((int32_t)0xC002003DL)
...
//
#define RPC_NT_ENTRY_NOT_FOUND           ((int32_t)0xC002003EL)
...
//
#define RPC_NT_NAME_SERVICE_UNAVAILABLE  ((int32_t)0xC002003FL)
...
//
#define RPC_NT_INVALID_NAF_ID            ((int32_t)0xC0020040L)
...
//
#define RPC_NT_CANNOT_SUPPORT            ((int32_t)0xC0020041L)
...
//
#define RPC_NT_NO_CONTEXT_AVAILABLE      ((int32_t)0xC0020042L)
...
//
#define RPC_NT_INTERNAL_ERROR            ((int32_t)0xC0020043L)
...
//
#define RPC_NT_ZERO_DIVIDE               ((int32_t)0xC0020044L)
...
//
#define RPC_NT_ADDRESS_ERROR             ((int32_t)0xC0020045L)
...
//
#define RPC_NT_FP_DIV_ZERO               ((int32_t)0xC0020046L)
...
//
#define RPC_NT_FP_UNDERFLOW              ((int32_t)0xC0020047L)
...
//
#define RPC_NT_FP_OVERFLOW               ((int32_t)0xC0020048L)
...
//
#define RPC_NT_NO_MORE_ENTRIES           ((int32_t)0xC0030001L)
...
//
#define RPC_NT_SS_CHAR_TRANS_OPEN_FAIL   ((int32_t)0xC0030002L)
...
//
#define RPC_NT_SS_CHAR_TRANS_SHORT_FILE  ((int32_t)0xC0030003L)
...
//
#define RPC_NT_SS_IN_NULL_CONTEXT        ((int32_t)0xC0030004L)
...
//
#define RPC_NT_SS_CONTEXT_MISMATCH       ((int32_t)0xC0030005L)
...
//
#define RPC_NT_SS_CONTEXT_DAMAGED        ((int32_t)0xC0030006L)
...
//
#define RPC_NT_SS_HANDLES_MISMATCH       ((int32_t)0xC0030007L)
...
//
#define RPC_NT_SS_CANNOT_GET_CALL_HANDLE ((int32_t)0xC0030008L)
...
//
#define RPC_NT_NULL_REF_POINTER          ((int32_t)0xC0030009L)
...
//
#define RPC_NT_ENUM_VALUE_OUT_OF_RANGE   ((int32_t)0xC003000AL)
...
//
#define RPC_NT_BYTE_COUNT_TOO_SMALL      ((int32_t)0xC003000BL)
...
//
#define RPC_NT_BAD_STUB_DATA             ((int32_t)0xC003000CL)
...
//
#define RPC_NT_CALL_IN_PROGRESS          ((int32_t)0xC0020049L)
...
//
#define RPC_NT_NO_MORE_BINDINGS          ((int32_t)0xC002004AL)
...
//
#define RPC_NT_GROUP_MEMBER_NOT_FOUND    ((int32_t)0xC002004BL)
...
//
#define EPT_NT_CANT_CREATE               ((int32_t)0xC002004CL)
...
//
#define RPC_NT_INVALID_OBJECT            ((int32_t)0xC002004DL)
...
//
#define RPC_NT_NO_INTERFACES             ((int32_t)0xC002004FL)
...
//
#define RPC_NT_CALL_CANCELLED            ((int32_t)0xC0020050L)
...
//
#define RPC_NT_BINDING_INCOMPLETE        ((int32_t)0xC0020051L)
...
//
#define RPC_NT_COMM_FAILURE              ((int32_t)0xC0020052L)
...
//
#define RPC_NT_UNSUPPORTED_AUTHN_LEVEL   ((int32_t)0xC0020053L)
...
//
#define RPC_NT_NO_PRINC_NAME             ((int32_t)0xC0020054L)
...
//
#define RPC_NT_NOT_RPC_ERROR             ((int32_t)0xC0020055L)
...
//
#define RPC_NT_UUID_LOCAL_ONLY           ((int32_t)0x40020056L)
...
//
#define RPC_NT_SEC_PKG_ERROR             ((int32_t)0xC0020057L)
...
//
#define RPC_NT_NOT_CANCELLED             ((int32_t)0xC0020058L)
...
//
#define RPC_NT_INVALID_ES_ACTION         ((int32_t)0xC0030059L)
...
//
#define RPC_NT_WRONG_ES_VERSION          ((int32_t)0xC003005AL)
...
//
#define RPC_NT_WRONG_STUB_VERSION        ((int32_t)0xC003005BL)
...
//
#define RPC_NT_INVALID_PIPE_OBJECT       ((int32_t)0xC003005CL)
...
//
#define RPC_NT_INVALID_PIPE_OPERATION    ((int32_t)0xC003005DL)
...
//
#define RPC_NT_WRONG_PIPE_VERSION        ((int32_t)0xC003005EL)
...
//
#define RPC_NT_PIPE_CLOSED               ((int32_t)0xC003005FL)
...
//
#define RPC_NT_PIPE_DISCIPLINE_ERROR     ((int32_t)0xC0030060L)
...
//
#define RPC_NT_PIPE_EMPTY                ((int32_t)0xC0030061L)
...
//
#define RPC_NT_INVALID_ASYNC_HANDLE      ((int32_t)0xC0020062L)
...
//
#define RPC_NT_INVALID_ASYNC_CALL        ((int32_t)0xC0020063L)
...
//
#define RPC_NT_PROXY_ACCESS_DENIED       ((int32_t)0xC0020064L)
...
//
#define RPC_NT_COOKIE_AUTH_FAILED        ((int32_t)0xC0020065L)
...
//
#define RPC_NT_SEND_INCOMPLETE           ((int32_t)0x400200AFL)
...
//
#define STATUS_ACPI_INVALID_OPCODE       ((int32_t)0xC0140001L)
...
//
#define STATUS_ACPI_STACK_OVERFLOW       ((int32_t)0xC0140002L)
...
//
#define STATUS_ACPI_ASSERT_FAILED        ((int32_t)0xC0140003L)
...
//
#define STATUS_ACPI_INVALID_INDEX        ((int32_t)0xC0140004L)
...
//
#define STATUS_ACPI_INVALID_ARGUMENT     ((int32_t)0xC0140005L)
...
//
#define STATUS_ACPI_FATAL                ((int32_t)0xC0140006L)
...
//
#define STATUS_ACPI_INVALID_SUPERNAME    ((int32_t)0xC0140007L)
...
//
#define STATUS_ACPI_INVALID_ARGTYPE      ((int32_t)0xC0140008L)
...
//
#define STATUS_ACPI_INVALID_OBJTYPE      ((int32_t)0xC0140009L)
...
//
#define STATUS_ACPI_INVALID_TARGETTYPE   ((int32_t)0xC014000AL)
...
//
#define STATUS_ACPI_INCORRECT_ARGUMENT_COUNT ((int32_t)0xC014000BL)
...
//
#define STATUS_ACPI_ADDRESS_NOT_MAPPED   ((int32_t)0xC014000CL)
...
//
#define STATUS_ACPI_INVALID_EVENTTYPE    ((int32_t)0xC014000DL)
...
//
#define STATUS_ACPI_HANDLER_COLLISION    ((int32_t)0xC014000EL)
...
//
#define STATUS_ACPI_INVALID_DATA         ((int32_t)0xC014000FL)
...
//
#define STATUS_ACPI_INVALID_REGION       ((int32_t)0xC0140010L)
...
//
#define STATUS_ACPI_INVALID_ACCESS_SIZE  ((int32_t)0xC0140011L)
...
//
#define STATUS_ACPI_ACQUIRE_GLOBAL_LOCK  ((int32_t)0xC0140012L)
...
//
#define STATUS_ACPI_ALREADY_INITIALIZED  ((int32_t)0xC0140013L)
...
//
#define STATUS_ACPI_NOT_INITIALIZED      ((int32_t)0xC0140014L)
...
//
#define STATUS_ACPI_INVALID_MUTEX_LEVEL  ((int32_t)0xC0140015L)
...
//
#define STATUS_ACPI_MUTEX_NOT_OWNED      ((int32_t)0xC0140016L)
...
//
#define STATUS_ACPI_MUTEX_NOT_OWNER      ((int32_t)0xC0140017L)
...
//
#define STATUS_ACPI_RS_ACCESS            ((int32_t)0xC0140018L)
...
//
#define STATUS_ACPI_INVALID_TABLE        ((int32_t)0xC0140019L)
...
//
#define STATUS_ACPI_REG_HANDLER_FAILED   ((int32_t)0xC0140020L)
...
//
#define STATUS_ACPI_POWER_REQUEST_FAILED ((int32_t)0xC0140021L)
...
//
#define STATUS_CTX_WINSTATION_NAME_INVALID ((int32_t)0xC00A0001L)
...
//
#define STATUS_CTX_INVALID_PD            ((int32_t)0xC00A0002L)
...
//
#define STATUS_CTX_PD_NOT_FOUND          ((int32_t)0xC00A0003L)
...
//
#define STATUS_CTX_CDM_CONNECT           ((int32_t)0x400A0004L)
...
//
#define STATUS_CTX_CDM_DISCONNECT        ((int32_t)0x400A0005L)
...
//
#define STATUS_CTX_CLOSE_PENDING         ((int32_t)0xC00A0006L)
...
//
#define STATUS_CTX_NO_OUTBUF             ((int32_t)0xC00A0007L)
...
//
#define STATUS_CTX_MODEM_INF_NOT_FOUND   ((int32_t)0xC00A0008L)
...
//
#define STATUS_CTX_INVALID_MODEMNAME     ((int32_t)0xC00A0009L)
...
//
#define STATUS_CTX_RESPONSE_ERROR        ((int32_t)0xC00A000AL)
...
//
#define STATUS_CTX_MODEM_RESPONSE_TIMEOUT ((int32_t)0xC00A000BL)
...
//
#define STATUS_CTX_MODEM_RESPONSE_NO_CARRIER ((int32_t)0xC00A000CL)
...
//
#define STATUS_CTX_MODEM_RESPONSE_NO_DIALTONE ((int32_t)0xC00A000DL)
...
//
#define STATUS_CTX_MODEM_RESPONSE_BUSY   ((int32_t)0xC00A000EL)
...
//
#define STATUS_CTX_MODEM_RESPONSE_VOICE  ((int32_t)0xC00A000FL)
...
//
#define STATUS_CTX_TD_ERROR              ((int32_t)0xC00A0010L)
...
//
#define STATUS_CTX_LICENSE_CLIENT_INVALID ((int32_t)0xC00A0012L)
...
//
#define STATUS_CTX_LICENSE_NOT_AVAILABLE ((int32_t)0xC00A0013L)
...
//
#define STATUS_CTX_LICENSE_EXPIRED       ((int32_t)0xC00A0014L)
...
//
#define STATUS_CTX_WINSTATION_NOT_FOUND  ((int32_t)0xC00A0015L)
...
//
#define STATUS_CTX_WINSTATION_NAME_COLLISION ((int32_t)0xC00A0016L)
...
//
#define STATUS_CTX_WINSTATION_BUSY       ((int32_t)0xC00A0017L)
...
//
#define STATUS_CTX_BAD_VIDEO_MODE        ((int32_t)0xC00A0018L)
...
//
#define STATUS_CTX_GRAPHICS_INVALID      ((int32_t)0xC00A0022L)
...
//
#define STATUS_CTX_NOT_CONSOLE           ((int32_t)0xC00A0024L)
...
//
#define STATUS_CTX_CLIENT_QUERY_TIMEOUT  ((int32_t)0xC00A0026L)
...
//
#define STATUS_CTX_CONSOLE_DISCONNECT    ((int32_t)0xC00A0027L)
...
//
#define STATUS_CTX_CONSOLE_CONNECT       ((int32_t)0xC00A0028L)
...
//
#define STATUS_CTX_SHADOW_DENIED         ((int32_t)0xC00A002AL)
...
//
#define STATUS_CTX_WINSTATION_ACCESS_DENIED ((int32_t)0xC00A002BL)
...
//
#define STATUS_CTX_INVALID_WD            ((int32_t)0xC00A002EL)
...
//
#define STATUS_CTX_WD_NOT_FOUND          ((int32_t)0xC00A002FL)
...
//
#define STATUS_CTX_SHADOW_INVALID        ((int32_t)0xC00A0030L)
...
//
#define STATUS_CTX_SHADOW_DISABLED       ((int32_t)0xC00A0031L)
...
//
#define STATUS_RDP_PROTOCOL_ERROR        ((int32_t)0xC00A0032L)
...
//
#define STATUS_CTX_CLIENT_LICENSE_NOT_SET ((int32_t)0xC00A0033L)
...
// Click OK to continue.
//
#define STATUS_CTX_CLIENT_LICENSE_IN_USE ((int32_t)0xC00A0034L)
...
//
#define STATUS_CTX_SHADOW_ENDED_BY_MODE_CHANGE ((int32_t)0xC00A0035L)
...
//
#define STATUS_CTX_SHADOW_NOT_RUNNING    ((int32_t)0xC00A0036L)
...
//
#define STATUS_CTX_LOGON_DISABLED        ((int32_t)0xC00A0037L)
...
// Client IP: %2.
//
#define STATUS_CTX_SECURITY_LAYER_ERROR  ((int32_t)0xC00A0038L)
...
//
#define STATUS_TS_INCOMPATIBLE_SESSIONS  ((int32_t)0xC00A0039L)
...
//
#define STATUS_TS_VIDEO_SUBSYSTEM_ERROR  ((int32_t)0xC00A003AL)
...
//
#define STATUS_PNP_BAD_MPS_TABLE         ((int32_t)0xC0040035L)
...
//
#define STATUS_PNP_TRANSLATION_FAILED    ((int32_t)0xC0040036L)
...
//
#define STATUS_PNP_IRQ_TRANSLATION_FAILED ((int32_t)0xC0040037L)
...
//
#define STATUS_PNP_INVALID_ID            ((int32_t)0xC0040038L)
...
//
#define STATUS_IO_REISSUE_AS_CACHED      ((int32_t)0xC0040039L)
...
//
#define STATUS_MUI_FILE_NOT_FOUND        ((int32_t)0xC00B0001L)
...
//
#define STATUS_MUI_INVALID_FILE          ((int32_t)0xC00B0002L)
...
//
#define STATUS_MUI_INVALID_RC_CONFIG     ((int32_t)0xC00B0003L)
...
//
#define STATUS_MUI_INVALID_LOCALE_NAME   ((int32_t)0xC00B0004L)
...
//
#define STATUS_MUI_INVALID_ULTIMATEFALLBACK_NAME ((int32_t)0xC00B0005L)
...
//
#define STATUS_MUI_FILE_NOT_LOADED       ((int32_t)0xC00B0006L)
...
//
#define STATUS_RESOURCE_ENUM_USER_STOP   ((int32_t)0xC00B0007L)
...
#define FILTER_FLT_int32_t_FROM_HRESULT(x) ((int32_t) (((x) & 0xC0007FFF) | (FACILITY_FILTER_MANAGER << 16) | 0x40000000))
...
//
#define STATUS_FLT_NO_HANDLER_DEFINED    ((int32_t)0xC01C0001L)
...
//
#define STATUS_FLT_CONTEXT_ALREADY_DEFINED ((int32_t)0xC01C0002L)
...
//
#define STATUS_FLT_INVALID_ASYNCHRONOUS_REQUEST ((int32_t)0xC01C0003L)
...
//
#define STATUS_FLT_DISALLOW_FAST_IO      ((int32_t)0xC01C0004L)
...
//
#define STATUS_FLT_INVALID_NAME_REQUEST  ((int32_t)0xC01C0005L)
...
//
#define STATUS_FLT_NOT_SAFE_TO_POST_OPERATION ((int32_t)0xC01C0006L)
...
//
#define STATUS_FLT_NOT_INITIALIZED       ((int32_t)0xC01C0007L)
...
//
#define STATUS_FLT_FILTER_NOT_READY      ((int32_t)0xC01C0008L)
...
//
#define STATUS_FLT_POST_OPERATION_CLEANUP ((int32_t)0xC01C0009L)
...
//
#define STATUS_FLT_INTERNAL_ERROR        ((int32_t)0xC01C000AL)
...
//
#define STATUS_FLT_DELETING_OBJECT       ((int32_t)0xC01C000BL)
...
//
#define STATUS_FLT_MUST_BE_NONPAGED_POOL ((int32_t)0xC01C000CL)
...
//
#define STATUS_FLT_DUPLICATE_ENTRY       ((int32_t)0xC01C000DL)
...
//
#define STATUS_FLT_CBDQ_DISABLED         ((int32_t)0xC01C000EL)
...
//
#define STATUS_FLT_DO_NOT_ATTACH         ((int32_t)0xC01C000FL)
...
//
#define STATUS_FLT_DO_NOT_DETACH         ((int32_t)0xC01C0010L)
...
//
#define STATUS_FLT_INSTANCE_ALTITUDE_COLLISION ((int32_t)0xC01C0011L)
...
//
#define STATUS_FLT_INSTANCE_NAME_COLLISION ((int32_t)0xC01C0012L)
...
//
#define STATUS_FLT_FILTER_NOT_FOUND      ((int32_t)0xC01C0013L)
...
//
#define STATUS_FLT_VOLUME_NOT_FOUND      ((int32_t)0xC01C0014L)
...
//
#define STATUS_FLT_INSTANCE_NOT_FOUND    ((int32_t)0xC01C0015L)
...
//
#define STATUS_FLT_CONTEXT_ALLOCATION_NOT_FOUND ((int32_t)0xC01C0016L)
...
//
#define STATUS_FLT_INVALID_CONTEXT_REGISTRATION ((int32_t)0xC01C0017L)
...
//
#define STATUS_FLT_NAME_CACHE_MISS       ((int32_t)0xC01C0018L)
...
//
#define STATUS_FLT_NO_DEVICE_OBJECT      ((int32_t)0xC01C0019L)
...
//
#define STATUS_FLT_VOLUME_ALREADY_MOUNTED ((int32_t)0xC01C001AL)
...
//
#define STATUS_FLT_ALREADY_ENLISTED      ((int32_t)0xC01C001BL)
...
//
#define STATUS_FLT_CONTEXT_ALREADY_LINKED ((int32_t)0xC01C001CL)
...
//
#define STATUS_FLT_NO_WAITER_FOR_REPLY   ((int32_t)0xC01C0020L)
...
//
#define STATUS_FLT_REGISTRATION_BUSY     ((int32_t)0xC01C0023L)
...
//
#define STATUS_SXS_SECTION_NOT_FOUND     ((int32_t)0xC0150001L)
...
//
#define STATUS_SXS_CANT_GEN_ACTCTX       ((int32_t)0xC0150002L)
...
//
#define STATUS_SXS_INVALID_ACTCTXDATA_FORMAT ((int32_t)0xC0150003L)
...
//
#define STATUS_SXS_ASSEMBLY_NOT_FOUND    ((int32_t)0xC0150004L)
...
//
#define STATUS_SXS_MANIFEST_FORMAT_ERROR ((int32_t)0xC0150005L)
...
//
#define STATUS_SXS_MANIFEST_PARSE_ERROR  ((int32_t)0xC0150006L)
...
//
#define STATUS_SXS_ACTIVATION_CONTEXT_DISABLED ((int32_t)0xC0150007L)
...
//
#define STATUS_SXS_KEY_NOT_FOUND         ((int32_t)0xC0150008L)
...
//
#define STATUS_SXS_VERSION_CONFLICT      ((int32_t)0xC0150009L)
...
//
#define STATUS_SXS_WRONG_SECTION_TYPE    ((int32_t)0xC015000AL)
...
//
#define STATUS_SXS_THREAD_QUERIES_DISABLED ((int32_t)0xC015000BL)
...
//
#define STATUS_SXS_ASSEMBLY_MISSING      ((int32_t)0xC015000CL)
...
//
#define STATUS_SXS_RELEASE_ACTIVATION_CONTEXT ((int32_t)0x4015000DL)
...
//
#define STATUS_SXS_PROCESS_DEFAULT_ALREADY_SET ((int32_t)0xC015000EL)
...
//
#define STATUS_SXS_EARLY_DEACTIVATION    ((int32_t)0xC015000FL)    // winnt
...
//
#define STATUS_SXS_INVALID_DEACTIVATION  ((int32_t)0xC0150010L)    // winnt
...
//
#define STATUS_SXS_MULTIPLE_DEACTIVATION ((int32_t)0xC0150011L)
...
//
#define STATUS_SXS_SYSTEM_DEFAULT_ACTIVATION_CONTEXT_EMPTY ((int32_t)0xC0150012L)
...
//
#define STATUS_SXS_PROCESS_TERMINATION_REQUESTED ((int32_t)0xC0150013L)
...
//
#define STATUS_SXS_CORRUPT_ACTIVATION_STACK ((int32_t)0xC0150014L)
...
//
#define STATUS_SXS_CORRUPTION            ((int32_t)0xC0150015L)
...
//
#define STATUS_SXS_INVALID_IDENTITY_ATTRIBUTE_VALUE ((int32_t)0xC0150016L)
...
//
#define STATUS_SXS_INVALID_IDENTITY_ATTRIBUTE_NAME ((int32_t)0xC0150017L)
...
//
#define STATUS_SXS_IDENTITY_DUPLICATE_ATTRIBUTE ((int32_t)0xC0150018L)
...
//
#define STATUS_SXS_IDENTITY_PARSE_ERROR  ((int32_t)0xC0150019L)
...
//
#define STATUS_SXS_COMPONENT_STORE_CORRUPT ((int32_t)0xC015001AL)
...
//
#define STATUS_SXS_FILE_HASH_MISMATCH    ((int32_t)0xC015001BL)
...
//
#define STATUS_SXS_MANIFEST_IDENTITY_SAME_BUT_CONTENTS_DIFFERENT ((int32_t)0xC015001CL)
...
//
#define STATUS_SXS_IDENTITIES_DIFFERENT  ((int32_t)0xC015001DL)
...
//
#define STATUS_SXS_ASSEMBLY_IS_NOT_A_DEPLOYMENT ((int32_t)0xC015001EL)
...
//
#define STATUS_SXS_FILE_NOT_PART_OF_ASSEMBLY ((int32_t)0xC015001FL)
...
//
#define STATUS_ADVANCED_INSTALLER_FAILED ((int32_t)0xC0150020L)
...
//
#define STATUS_XML_ENCODING_MISMATCH     ((int32_t)0xC0150021L)
...
//
#define STATUS_SXS_MANIFEST_TOO_BIG      ((int32_t)0xC0150022L)
...
//
#define STATUS_SXS_SETTING_NOT_REGISTERED ((int32_t)0xC0150023L)
...
//
#define STATUS_SXS_TRANSACTION_CLOSURE_INCOMPLETE ((int32_t)0xC0150024L)
...
//
#define STATUS_SMI_PRIMITIVE_INSTALLER_FAILED ((int32_t)0xC0150025L)
...
//
#define STATUS_GENERIC_COMMAND_FAILED    ((int32_t)0xC0150026L)
...
//
#define STATUS_SXS_FILE_HASH_MISSING     ((int32_t)0xC0150027L)
...
//
#define STATUS_CLUSTER_INVALID_NODE      ((int32_t)0xC0130001L)
...
//
#define STATUS_CLUSTER_NODE_EXISTS       ((int32_t)0xC0130002L)
...
//
#define STATUS_CLUSTER_JOIN_IN_PROGRESS  ((int32_t)0xC0130003L)
...
//
#define STATUS_CLUSTER_NODE_NOT_FOUND    ((int32_t)0xC0130004L)
...
//
#define STATUS_CLUSTER_LOCAL_NODE_NOT_FOUND ((int32_t)0xC0130005L)
...
//
#define STATUS_CLUSTER_NETWORK_EXISTS    ((int32_t)0xC0130006L)
...
//
#define STATUS_CLUSTER_NETWORK_NOT_FOUND ((int32_t)0xC0130007L)
...
//
#define STATUS_CLUSTER_NETINTERFACE_EXISTS ((int32_t)0xC0130008L)
...
//
#define STATUS_CLUSTER_NETINTERFACE_NOT_FOUND ((int32_t)0xC0130009L)
...
//
#define STATUS_CLUSTER_INVALID_REQUEST   ((int32_t)0xC013000AL)
...
//
#define STATUS_CLUSTER_INVALID_NETWORK_PROVIDER ((int32_t)0xC013000BL)
...
//
#define STATUS_CLUSTER_NODE_DOWN         ((int32_t)0xC013000CL)
...
//
#define STATUS_CLUSTER_NODE_UNREACHABLE  ((int32_t)0xC013000DL)
...
//
#define STATUS_CLUSTER_NODE_NOT_MEMBER   ((int32_t)0xC013000EL)
...
//
#define STATUS_CLUSTER_JOIN_NOT_IN_PROGRESS ((int32_t)0xC013000FL)
...
//
#define STATUS_CLUSTER_INVALID_NETWORK   ((int32_t)0xC0130010L)
...
//
#define STATUS_CLUSTER_NO_NET_ADAPTERS   ((int32_t)0xC0130011L)
...
//
#define STATUS_CLUSTER_NODE_UP           ((int32_t)0xC0130012L)
...
//
#define STATUS_CLUSTER_NODE_PAUSED       ((int32_t)0xC0130013L)
...
//
#define STATUS_CLUSTER_NODE_NOT_PAUSED   ((int32_t)0xC0130014L)
...
//
#define STATUS_CLUSTER_NO_SECURITY_CONTEXT ((int32_t)0xC0130015L)
...
//
#define STATUS_CLUSTER_NETWORK_NOT_INTERNAL ((int32_t)0xC0130016L)
...
//
#define STATUS_CLUSTER_POISONED          ((int32_t)0xC0130017L)
...
//
#define STATUS_CLUSTER_NON_CSV_PATH      ((int32_t)0xC0130018L)
...
//
#define STATUS_CLUSTER_CSV_VOLUME_NOT_LOCAL ((int32_t)0xC0130019L)
...
//
#define STATUS_CLUSTER_CSV_READ_OPLOCK_BREAK_IN_PROGRESS ((int32_t)0xC0130020L)
...
//
#define STATUS_CLUSTER_CSV_AUTO_PAUSE_ERROR ((int32_t)0xC0130021L)
...
//
#define STATUS_CLUSTER_CSV_REDIRECTED    ((int32_t)0xC0130022L)
...
//
#define STATUS_CLUSTER_CSV_NOT_REDIRECTED ((int32_t)0xC0130023L)
...
//
#define STATUS_CLUSTER_CSV_VOLUME_DRAINING ((int32_t)0xC0130024L)
...
//
#define STATUS_CLUSTER_CSV_SNAPSHOT_CREATION_IN_PROGRESS ((int32_t)0xC0130025L)
...
//
#define STATUS_CLUSTER_CSV_VOLUME_DRAINING_SUCCEEDED_DOWNLEVEL ((int32_t)0xC0130026L)
...
//
#define STATUS_CLUSTER_CSV_NO_SNAPSHOTS  ((int32_t)0xC0130027L)
...
//
#define STATUS_CSV_IO_PAUSE_TIMEOUT      ((int32_t)0xC0130028L)
...
//
#define STATUS_CLUSTER_CSV_INVALID_HANDLE ((int32_t)0xC0130029L)
...
//
#define STATUS_CLUSTER_CSV_SUPPORTED_ONLY_ON_COORDINATOR ((int32_t)0xC0130030L)
...
//
#define STATUS_CLUSTER_CAM_TICKET_REPLAY_DETECTED ((int32_t)0xC0130031L)
...
//
#define STATUS_TRANSACTIONAL_CONFLICT    ((int32_t)0xC0190001L)
...
//
#define STATUS_INVALID_TRANSACTION       ((int32_t)0xC0190002L)
...
//
#define STATUS_TRANSACTION_NOT_ACTIVE    ((int32_t)0xC0190003L)
...
//
#define STATUS_TM_INITIALIZATION_FAILED  ((int32_t)0xC0190004L)
...
//
#define STATUS_RM_NOT_ACTIVE             ((int32_t)0xC0190005L)
...
//
#define STATUS_RM_METADATA_CORRUPT       ((int32_t)0xC0190006L)
...
//
#define STATUS_TRANSACTION_NOT_JOINED    ((int32_t)0xC0190007L)
...
//
#define STATUS_DIRECTORY_NOT_RM          ((int32_t)0xC0190008L)
...
//
#define STATUS_COULD_NOT_RESIZE_LOG      ((int32_t)0x80190009L)
...
//
#define STATUS_TRANSACTIONS_UNSUPPORTED_REMOTE ((int32_t)0xC019000AL)
...
//
#define STATUS_LOG_RESIZE_INVALID_SIZE   ((int32_t)0xC019000BL)
...
//
#define STATUS_REMOTE_FILE_VERSION_MISMATCH ((int32_t)0xC019000CL)
...
//
#define STATUS_CRM_PROTOCOL_ALREADY_EXISTS ((int32_t)0xC019000FL)
...
//
#define STATUS_TRANSACTION_PROPAGATION_FAILED ((int32_t)0xC0190010L)
...
//
#define STATUS_CRM_PROTOCOL_NOT_FOUND    ((int32_t)0xC0190011L)
...
//
#define STATUS_TRANSACTION_SUPERIOR_EXISTS ((int32_t)0xC0190012L)
...
//
#define STATUS_TRANSACTION_REQUEST_NOT_VALID ((int32_t)0xC0190013L)
...
//
#define STATUS_TRANSACTION_NOT_REQUESTED ((int32_t)0xC0190014L)
...
//
#define STATUS_TRANSACTION_ALREADY_ABORTED ((int32_t)0xC0190015L)
...
//
#define STATUS_TRANSACTION_ALREADY_COMMITTED ((int32_t)0xC0190016L)
...
//
#define STATUS_TRANSACTION_INVALID_MARSHALL_BUFFER ((int32_t)0xC0190017L)
...
//
#define STATUS_CURRENT_TRANSACTION_NOT_VALID ((int32_t)0xC0190018L)
...
//
#define STATUS_LOG_GROWTH_FAILED         ((int32_t)0xC0190019L)
...
//
#define STATUS_OBJECT_NO_LONGER_EXISTS   ((int32_t)0xC0190021L)
...
//
#define STATUS_STREAM_MINIVERSION_NOT_FOUND ((int32_t)0xC0190022L)
...
//
#define STATUS_STREAM_MINIVERSION_NOT_VALID ((int32_t)0xC0190023L)
...
//
#define STATUS_MINIVERSION_INACCESSIBLE_FROM_SPECIFIED_TRANSACTION ((int32_t)0xC0190024L)
...
//
#define STATUS_CANT_OPEN_MINIVERSION_WITH_MODIFY_INTENT ((int32_t)0xC0190025L)
...
//
#define STATUS_CANT_CREATE_MORE_STREAM_MINIVERSIONS ((int32_t)0xC0190026L)
...
//
#define STATUS_HANDLE_NO_LONGER_VALID    ((int32_t)0xC0190028L)
...
//
#define STATUS_NO_TXF_METADATA           ((int32_t)0x80190029L)
...
//
#define STATUS_LOG_CORRUPTION_DETECTED   ((int32_t)0xC0190030L)
...
//
#define STATUS_CANT_RECOVER_WITH_HANDLE_OPEN ((int32_t)0x80190031L)
...
//
#define STATUS_RM_DISCONNECTED           ((int32_t)0xC0190032L)
...
//
#define STATUS_ENLISTMENT_NOT_SUPERIOR   ((int32_t)0xC0190033L)
...
//
#define STATUS_RECOVERY_NOT_NEEDED       ((int32_t)0x40190034L)
...
//
#define STATUS_RM_ALREADY_STARTED        ((int32_t)0x40190035L)
...
//
#define STATUS_FILE_IDENTITY_NOT_PERSISTENT ((int32_t)0xC0190036L)
...
//
#define STATUS_CANT_BREAK_TRANSACTIONAL_DEPENDENCY ((int32_t)0xC0190037L)
...
//
#define STATUS_CANT_CROSS_RM_BOUNDARY    ((int32_t)0xC0190038L)
...
//
#define STATUS_TXF_DIR_NOT_EMPTY         ((int32_t)0xC0190039L)
...
//
#define STATUS_INDOUBT_TRANSACTIONS_EXIST ((int32_t)0xC019003AL)
...
//
#define STATUS_TM_VOLATILE               ((int32_t)0xC019003BL)
...
//
#define STATUS_ROLLBACK_TIMER_EXPIRED    ((int32_t)0xC019003CL)
...
//
#define STATUS_TXF_ATTRIBUTE_CORRUPT     ((int32_t)0xC019003DL)
...
//
#define STATUS_EFS_NOT_ALLOWED_IN_TRANSACTION ((int32_t)0xC019003EL)
...
//
#define STATUS_TRANSACTIONAL_OPEN_NOT_ALLOWED ((int32_t)0xC019003FL)
...
//
#define STATUS_TRANSACTED_MAPPING_UNSUPPORTED_REMOTE ((int32_t)0xC0190040L)
...
//
#define STATUS_TXF_METADATA_ALREADY_PRESENT ((int32_t)0x80190041L)
...
//
#define STATUS_TRANSACTION_SCOPE_CALLBACKS_NOT_SET ((int32_t)0x80190042L)
...
//
#define STATUS_TRANSACTION_REQUIRED_PROMOTION ((int32_t)0xC0190043L)
...
//
#define STATUS_CANNOT_EXECUTE_FILE_IN_TRANSACTION ((int32_t)0xC0190044L)
...
//
#define STATUS_TRANSACTIONS_NOT_FROZEN   ((int32_t)0xC0190045L)
...
//
#define STATUS_TRANSACTION_FREEZE_IN_PROGRESS ((int32_t)0xC0190046L)
...
//
#define STATUS_NOT_SNAPSHOT_VOLUME       ((int32_t)0xC0190047L)
...
//
#define STATUS_NO_SAVEPOINT_WITH_OPEN_FILES ((int32_t)0xC0190048L)
...
//
#define STATUS_SPARSE_NOT_ALLOWED_IN_TRANSACTION ((int32_t)0xC0190049L)
...
//
#define STATUS_TM_IDENTITY_MISMATCH      ((int32_t)0xC019004AL)
...
//
#define STATUS_FLOATED_SECTION           ((int32_t)0xC019004BL)
...
//
#define STATUS_CANNOT_ACCEPT_TRANSACTED_WORK ((int32_t)0xC019004CL)
...
//
#define STATUS_CANNOT_ABORT_TRANSACTIONS ((int32_t)0xC019004DL)
...
//
#define STATUS_TRANSACTION_NOT_FOUND     ((int32_t)0xC019004EL)
...
//
#define STATUS_RESOURCEMANAGER_NOT_FOUND ((int32_t)0xC019004FL)
...
//
#define STATUS_ENLISTMENT_NOT_FOUND      ((int32_t)0xC0190050L)
...
//
#define STATUS_TRANSACTIONMANAGER_NOT_FOUND ((int32_t)0xC0190051L)
...
//
#define STATUS_TRANSACTIONMANAGER_NOT_ONLINE ((int32_t)0xC0190052L)
...
//
#define STATUS_TRANSACTIONMANAGER_RECOVERY_NAME_COLLISION ((int32_t)0xC0190053L)
...
//
#define STATUS_TRANSACTION_NOT_ROOT      ((int32_t)0xC0190054L)
...
//
#define STATUS_TRANSACTION_OBJECT_EXPIRED ((int32_t)0xC0190055L)
...
//
#define STATUS_COMPRESSION_NOT_ALLOWED_IN_TRANSACTION ((int32_t)0xC0190056L)
...
//
#define STATUS_TRANSACTION_RESPONSE_NOT_ENLISTED ((int32_t)0xC0190057L)
...
//
#define STATUS_TRANSACTION_RECORD_TOO_LONG ((int32_t)0xC0190058L)
...
//
#define STATUS_NO_LINK_TRACKING_IN_TRANSACTION ((int32_t)0xC0190059L)
...
//
#define STATUS_OPERATION_NOT_SUPPORTED_IN_TRANSACTION ((int32_t)0xC019005AL)
...
//
#define STATUS_TRANSACTION_INTEGRITY_VIOLATED ((int32_t)0xC019005BL)
...
//
#define STATUS_TRANSACTIONMANAGER_IDENTITY_MISMATCH ((int32_t)0xC019005CL)
...
//
#define STATUS_RM_CANNOT_BE_FROZEN_FOR_SNAPSHOT ((int32_t)0xC019005DL)
...
//
#define STATUS_TRANSACTION_MUST_WRITETHROUGH ((int32_t)0xC019005EL)
...
//
#define STATUS_TRANSACTION_NO_SUPERIOR   ((int32_t)0xC019005FL)
...
//
#define STATUS_EXPIRED_HANDLE            ((int32_t)0xC0190060L)
...
//
#define STATUS_TRANSACTION_NOT_ENLISTED  ((int32_t)0xC0190061L)
...
//
#define STATUS_LOG_SECTOR_INVALID        ((int32_t)0xC01A0001L)
...
//
#define STATUS_LOG_SECTOR_PARITY_INVALID ((int32_t)0xC01A0002L)
...
//
#define STATUS_LOG_SECTOR_REMAPPED       ((int32_t)0xC01A0003L)
...
//
#define STATUS_LOG_BLOCK_INCOMPLETE      ((int32_t)0xC01A0004L)
...
//
#define STATUS_LOG_INVALID_RANGE         ((int32_t)0xC01A0005L)
...
//
#define STATUS_LOG_BLOCKS_EXHAUSTED      ((int32_t)0xC01A0006L)
...
//
#define STATUS_LOG_READ_CONTEXT_INVALID  ((int32_t)0xC01A0007L)
...
//
#define STATUS_LOG_RESTART_INVALID       ((int32_t)0xC01A0008L)
...
//
#define STATUS_LOG_BLOCK_VERSION         ((int32_t)0xC01A0009L)
...
//
#define STATUS_LOG_BLOCK_INVALID         ((int32_t)0xC01A000AL)
...
//
#define STATUS_LOG_READ_MODE_INVALID     ((int32_t)0xC01A000BL)
...
//
#define STATUS_LOG_NO_RESTART            ((int32_t)0x401A000CL)
...
//
#define STATUS_LOG_METADATA_CORRUPT      ((int32_t)0xC01A000DL)
...
//
#define STATUS_LOG_METADATA_INVALID      ((int32_t)0xC01A000EL)
...
//
#define STATUS_LOG_METADATA_INCONSISTENT ((int32_t)0xC01A000FL)
...
//
#define STATUS_LOG_RESERVATION_INVALID   ((int32_t)0xC01A0010L)
...
//
#define STATUS_LOG_CANT_DELETE           ((int32_t)0xC01A0011L)
...
//
#define STATUS_LOG_CONTAINER_LIMIT_EXCEEDED ((int32_t)0xC01A0012L)
...
//
#define STATUS_LOG_START_OF_LOG          ((int32_t)0xC01A0013L)
...
//
#define STATUS_LOG_POLICY_ALREADY_INSTALLED ((int32_t)0xC01A0014L)
...
//
#define STATUS_LOG_POLICY_NOT_INSTALLED  ((int32_t)0xC01A0015L)
...
//
#define STATUS_LOG_POLICY_INVALID        ((int32_t)0xC01A0016L)
...
//
#define STATUS_LOG_POLICY_CONFLICT       ((int32_t)0xC01A0017L)
...
//
#define STATUS_LOG_PINNED_ARCHIVE_TAIL   ((int32_t)0xC01A0018L)
...
//
#define STATUS_LOG_RECORD_NONEXISTENT    ((int32_t)0xC01A0019L)
...
//
#define STATUS_LOG_RECORDS_RESERVED_INVALID ((int32_t)0xC01A001AL)
...
//
#define STATUS_LOG_SPACE_RESERVED_INVALID ((int32_t)0xC01A001BL)
...
//
#define STATUS_LOG_TAIL_INVALID          ((int32_t)0xC01A001CL)
...
//
#define STATUS_LOG_FULL                  ((int32_t)0xC01A001DL)
...
//
#define STATUS_LOG_MULTIPLEXED           ((int32_t)0xC01A001EL)
...
//
#define STATUS_LOG_DEDICATED             ((int32_t)0xC01A001FL)
...
//
#define STATUS_LOG_ARCHIVE_NOT_IN_PROGRESS ((int32_t)0xC01A0020L)
...
//
#define STATUS_LOG_ARCHIVE_IN_PROGRESS   ((int32_t)0xC01A0021L)
...
//
#define STATUS_LOG_EPHEMERAL             ((int32_t)0xC01A0022L)
...
//
#define STATUS_LOG_NOT_ENOUGH_CONTAINERS ((int32_t)0xC01A0023L)
...
//
#define STATUS_LOG_CLIENT_ALREADY_REGISTERED ((int32_t)0xC01A0024L)
...
//
#define STATUS_LOG_CLIENT_NOT_REGISTERED ((int32_t)0xC01A0025L)
...
//
#define STATUS_LOG_FULL_HANDLER_IN_PROGRESS ((int32_t)0xC01A0026L)
...
//
#define STATUS_LOG_CONTAINER_READ_FAILED ((int32_t)0xC01A0027L)
...
//
#define STATUS_LOG_CONTAINER_WRITE_FAILED ((int32_t)0xC01A0028L)
...
//
#define STATUS_LOG_CONTAINER_OPEN_FAILED ((int32_t)0xC01A0029L)
...
//
#define STATUS_LOG_CONTAINER_STATE_INVALID ((int32_t)0xC01A002AL)
...
//
#define STATUS_LOG_STATE_INVALID         ((int32_t)0xC01A002BL)
...
//
#define STATUS_LOG_PINNED                ((int32_t)0xC01A002CL)
...
//
#define STATUS_LOG_METADATA_FLUSH_FAILED ((int32_t)0xC01A002DL)
...
//
#define STATUS_LOG_INCONSISTENT_SECURITY ((int32_t)0xC01A002EL)
...
//
#define STATUS_LOG_APPENDED_FLUSH_FAILED ((int32_t)0xC01A002FL)
...
//
#define STATUS_LOG_PINNED_RESERVATION    ((int32_t)0xC01A0030L)
...
//
#define STATUS_VIDEO_HUNG_DISPLAY_DRIVER_THREAD ((int32_t)0xC01B00EAL)
...
//
#define STATUS_VIDEO_HUNG_DISPLAY_DRIVER_THREAD_RECOVERED ((int32_t)0x801B00EBL)
...
//
#define STATUS_VIDEO_DRIVER_DEBUG_REPORT_REQUEST ((int32_t)0x401B00ECL)
...
//
#define STATUS_MONITOR_NO_DESCRIPTOR     ((int32_t)0xC01D0001L)
...
//
#define STATUS_MONITOR_UNKNOWN_DESCRIPTOR_FORMAT ((int32_t)0xC01D0002L)
...
//
#define STATUS_MONITOR_INVALID_DESCRIPTOR_CHECKSUM ((int32_t)0xC01D0003L)
...
//
#define STATUS_MONITOR_INVALID_STANDARD_TIMING_BLOCK ((int32_t)0xC01D0004L)
...
//
#define STATUS_MONITOR_WMI_DATABLOCK_REGISTRATION_FAILED ((int32_t)0xC01D0005L)
...
//
#define STATUS_MONITOR_INVALID_SERIAL_NUMBER_MONDSC_BLOCK ((int32_t)0xC01D0006L)
...
//
#define STATUS_MONITOR_INVALID_USER_FRIENDLY_MONDSC_BLOCK ((int32_t)0xC01D0007L)
...
//
#define STATUS_MONITOR_NO_MORE_DESCRIPTOR_DATA ((int32_t)0xC01D0008L)
...
//
#define STATUS_MONITOR_INVALID_DETAILED_TIMING_BLOCK ((int32_t)0xC01D0009L)
...
//
#define STATUS_MONITOR_INVALID_MANUFACTURE_DATE ((int32_t)0xC01D000AL)
...
//
#define STATUS_GRAPHICS_NOT_EXCLUSIVE_MODE_OWNER ((int32_t)0xC01E0000L)
...
//
#define STATUS_GRAPHICS_INSUFFICIENT_DMA_BUFFER ((int32_t)0xC01E0001L)
...
//
#define STATUS_GRAPHICS_INVALID_DISPLAY_ADAPTER ((int32_t)0xC01E0002L)
...
//
#define STATUS_GRAPHICS_ADAPTER_WAS_RESET ((int32_t)0xC01E0003L)
...
//
#define STATUS_GRAPHICS_INVALID_DRIVER_MODEL ((int32_t)0xC01E0004L)
...
//
#define STATUS_GRAPHICS_PRESENT_MODE_CHANGED ((int32_t)0xC01E0005L)
...
//
#define STATUS_GRAPHICS_PRESENT_OCCLUDED ((int32_t)0xC01E0006L)
...
//
#define STATUS_GRAPHICS_PRESENT_DENIED   ((int32_t)0xC01E0007L)
...
//
#define STATUS_GRAPHICS_CANNOTCOLORCONVERT ((int32_t)0xC01E0008L)
...
//
#define STATUS_GRAPHICS_DRIVER_MISMATCH  ((int32_t)0xC01E0009L)
...
//
#define STATUS_GRAPHICS_PARTIAL_DATA_POPULATED ((int32_t)0x401E000AL)
...
//
#define STATUS_GRAPHICS_PRESENT_REDIRECTION_DISABLED ((int32_t)0xC01E000BL)
...
//
#define STATUS_GRAPHICS_PRESENT_UNOCCLUDED ((int32_t)0xC01E000CL)
...
//
#define STATUS_GRAPHICS_WINDOWDC_NOT_AVAILABLE ((int32_t)0xC01E000DL)
...
//
#define STATUS_GRAPHICS_WINDOWLESS_PRESENT_DISABLED ((int32_t)0xC01E000EL)
...
//
#define STATUS_GRAPHICS_PRESENT_INVALID_WINDOW ((int32_t)0xC01E000FL)
...
//
#define STATUS_GRAPHICS_PRESENT_BUFFER_NOT_BOUND ((int32_t)0xC01E0010L)
...
//
#define STATUS_GRAPHICS_VAIL_STATE_CHANGED ((int32_t)0xC01E0011L)
...
//
#define STATUS_GRAPHICS_INDIRECT_DISPLAY_ABANDON_SWAPCHAIN ((int32_t)0xC01E0012L)
...
//
#define STATUS_GRAPHICS_INDIRECT_DISPLAY_DEVICE_STOPPED ((int32_t)0xC01E0013L)
...
//
#define STATUS_GRAPHICS_NO_VIDEO_MEMORY  ((int32_t)0xC01E0100L)
...
//
#define STATUS_GRAPHICS_CANT_LOCK_MEMORY ((int32_t)0xC01E0101L)
...
//
#define STATUS_GRAPHICS_ALLOCATION_BUSY  ((int32_t)0xC01E0102L)
...
//
#define STATUS_GRAPHICS_TOO_MANY_REFERENCES ((int32_t)0xC01E0103L)
...
//
#define STATUS_GRAPHICS_TRY_AGAIN_LATER  ((int32_t)0xC01E0104L)
...
//
#define STATUS_GRAPHICS_TRY_AGAIN_NOW    ((int32_t)0xC01E0105L)
...
//
#define STATUS_GRAPHICS_ALLOCATION_INVALID ((int32_t)0xC01E0106L)
...
//
#define STATUS_GRAPHICS_UNSWIZZLING_APERTURE_UNAVAILABLE ((int32_t)0xC01E0107L)
...
//
#define STATUS_GRAPHICS_UNSWIZZLING_APERTURE_UNSUPPORTED ((int32_t)0xC01E0108L)
...
//
#define STATUS_GRAPHICS_CANT_EVICT_PINNED_ALLOCATION ((int32_t)0xC01E0109L)
...
//
#define STATUS_GRAPHICS_INVALID_ALLOCATION_USAGE ((int32_t)0xC01E0110L)
...
//
#define STATUS_GRAPHICS_CANT_RENDER_LOCKED_ALLOCATION ((int32_t)0xC01E0111L)
...
//
#define STATUS_GRAPHICS_ALLOCATION_CLOSED ((int32_t)0xC01E0112L)
...
//
#define STATUS_GRAPHICS_INVALID_ALLOCATION_INSTANCE ((int32_t)0xC01E0113L)
...
//
#define STATUS_GRAPHICS_INVALID_ALLOCATION_HANDLE ((int32_t)0xC01E0114L)
...
//
#define STATUS_GRAPHICS_WRONG_ALLOCATION_DEVICE ((int32_t)0xC01E0115L)
...
//
#define STATUS_GRAPHICS_ALLOCATION_CONTENT_LOST ((int32_t)0xC01E0116L)
...
//
#define STATUS_GRAPHICS_GPU_EXCEPTION_ON_DEVICE ((int32_t)0xC01E0200L)
...
//
#define STATUS_GRAPHICS_SKIP_ALLOCATION_PREPARATION ((int32_t)0x401E0201L)
...
//
#define STATUS_GRAPHICS_INVALID_VIDPN_TOPOLOGY ((int32_t)0xC01E0300L)
...
//
#define STATUS_GRAPHICS_VIDPN_TOPOLOGY_NOT_SUPPORTED ((int32_t)0xC01E0301L)
...
//
#define STATUS_GRAPHICS_VIDPN_TOPOLOGY_CURRENTLY_NOT_SUPPORTED ((int32_t)0xC01E0302L)
...
//
#define STATUS_GRAPHICS_INVALID_VIDPN    ((int32_t)0xC01E0303L)
...
//
#define STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE ((int32_t)0xC01E0304L)
...
//
#define STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET ((int32_t)0xC01E0305L)
...
//
#define STATUS_GRAPHICS_VIDPN_MODALITY_NOT_SUPPORTED ((int32_t)0xC01E0306L)
...
//
#define STATUS_GRAPHICS_MODE_NOT_PINNED  ((int32_t)0x401E0307L)
...
//
#define STATUS_GRAPHICS_INVALID_VIDPN_SOURCEMODESET ((int32_t)0xC01E0308L)
...
//
#define STATUS_GRAPHICS_INVALID_VIDPN_TARGETMODESET ((int32_t)0xC01E0309L)
...
//
#define STATUS_GRAPHICS_INVALID_FREQUENCY ((int32_t)0xC01E030AL)
...
//
#define STATUS_GRAPHICS_INVALID_ACTIVE_REGION ((int32_t)0xC01E030BL)
...
//
#define STATUS_GRAPHICS_INVALID_TOTAL_REGION ((int32_t)0xC01E030CL)
...
//
#define STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE_MODE ((int32_t)0xC01E0310L)
...
//
#define STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET_MODE ((int32_t)0xC01E0311L)
...
//
#define STATUS_GRAPHICS_PINNED_MODE_MUST_REMAIN_IN_SET ((int32_t)0xC01E0312L)
...
//
#define STATUS_GRAPHICS_PATH_ALREADY_IN_TOPOLOGY ((int32_t)0xC01E0313L)
...
//
#define STATUS_GRAPHICS_MODE_ALREADY_IN_MODESET ((int32_t)0xC01E0314L)
...
//
#define STATUS_GRAPHICS_INVALID_VIDEOPRESENTSOURCESET ((int32_t)0xC01E0315L)
...
//
#define STATUS_GRAPHICS_INVALID_VIDEOPRESENTTARGETSET ((int32_t)0xC01E0316L)
...
//
#define STATUS_GRAPHICS_SOURCE_ALREADY_IN_SET ((int32_t)0xC01E0317L)
...
//
#define STATUS_GRAPHICS_TARGET_ALREADY_IN_SET ((int32_t)0xC01E0318L)
...
//
#define STATUS_GRAPHICS_INVALID_VIDPN_PRESENT_PATH ((int32_t)0xC01E0319L)
...
//
#define STATUS_GRAPHICS_NO_RECOMMENDED_VIDPN_TOPOLOGY ((int32_t)0xC01E031AL)
...
//
#define STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGESET ((int32_t)0xC01E031BL)
...
//
#define STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE ((int32_t)0xC01E031CL)
...
//
#define STATUS_GRAPHICS_FREQUENCYRANGE_NOT_IN_SET ((int32_t)0xC01E031DL)
...
//
#define STATUS_GRAPHICS_NO_PREFERRED_MODE ((int32_t)0x401E031EL)
...
//
#define STATUS_GRAPHICS_FREQUENCYRANGE_ALREADY_IN_SET ((int32_t)0xC01E031FL)
...
//
#define STATUS_GRAPHICS_STALE_MODESET    ((int32_t)0xC01E0320L)
...
//
#define STATUS_GRAPHICS_INVALID_MONITOR_SOURCEMODESET ((int32_t)0xC01E0321L)
...
//
#define STATUS_GRAPHICS_INVALID_MONITOR_SOURCE_MODE ((int32_t)0xC01E0322L)
...
//
#define STATUS_GRAPHICS_NO_RECOMMENDED_FUNCTIONAL_VIDPN ((int32_t)0xC01E0323L)
...
//
#define STATUS_GRAPHICS_MODE_ID_MUST_BE_UNIQUE ((int32_t)0xC01E0324L)
...
//
#define STATUS_GRAPHICS_EMPTY_ADAPTER_MONITOR_MODE_SUPPORT_INTERSECTION ((int32_t)0xC01E0325L)
...
//
#define STATUS_GRAPHICS_VIDEO_PRESENT_TARGETS_LESS_THAN_SOURCES ((int32_t)0xC01E0326L)
...
//
#define STATUS_GRAPHICS_PATH_NOT_IN_TOPOLOGY ((int32_t)0xC01E0327L)
...
//
#define STATUS_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_SOURCE ((int32_t)0xC01E0328L)
...
//
#define STATUS_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_TARGET ((int32_t)0xC01E0329L)
...
//
#define STATUS_GRAPHICS_INVALID_MONITORDESCRIPTORSET ((int32_t)0xC01E032AL)
...
//
#define STATUS_GRAPHICS_INVALID_MONITORDESCRIPTOR ((int32_t)0xC01E032BL)
...
//
#define STATUS_GRAPHICS_MONITORDESCRIPTOR_NOT_IN_SET ((int32_t)0xC01E032CL)
...
//
#define STATUS_GRAPHICS_MONITORDESCRIPTOR_ALREADY_IN_SET ((int32_t)0xC01E032DL)
...
//
#define STATUS_GRAPHICS_MONITORDESCRIPTOR_ID_MUST_BE_UNIQUE ((int32_t)0xC01E032EL)
...
//
#define STATUS_GRAPHICS_INVALID_VIDPN_TARGET_SUBSET_TYPE ((int32_t)0xC01E032FL)
...
//
#define STATUS_GRAPHICS_RESOURCES_NOT_RELATED ((int32_t)0xC01E0330L)
...
//
#define STATUS_GRAPHICS_SOURCE_ID_MUST_BE_UNIQUE ((int32_t)0xC01E0331L)
...
//
#define STATUS_GRAPHICS_TARGET_ID_MUST_BE_UNIQUE ((int32_t)0xC01E0332L)
...
//
#define STATUS_GRAPHICS_NO_AVAILABLE_VIDPN_TARGET ((int32_t)0xC01E0333L)
...
//
#define STATUS_GRAPHICS_MONITOR_COULD_NOT_BE_ASSOCIATED_WITH_ADAPTER ((int32_t)0xC01E0334L)
...
//
#define STATUS_GRAPHICS_NO_VIDPNMGR      ((int32_t)0xC01E0335L)
...
//
#define STATUS_GRAPHICS_NO_ACTIVE_VIDPN  ((int32_t)0xC01E0336L)
...
//
#define STATUS_GRAPHICS_STALE_VIDPN_TOPOLOGY ((int32_t)0xC01E0337L)
...
//
#define STATUS_GRAPHICS_MONITOR_NOT_CONNECTED ((int32_t)0xC01E0338L)
...
//
#define STATUS_GRAPHICS_SOURCE_NOT_IN_TOPOLOGY ((int32_t)0xC01E0339L)
...
//
#define STATUS_GRAPHICS_INVALID_PRIMARYSURFACE_SIZE ((int32_t)0xC01E033AL)
...
//
#define STATUS_GRAPHICS_INVALID_VISIBLEREGION_SIZE ((int32_t)0xC01E033BL)
...
//
#define STATUS_GRAPHICS_INVALID_STRIDE   ((int32_t)0xC01E033CL)
...
//
#define STATUS_GRAPHICS_INVALID_PIXELFORMAT ((int32_t)0xC01E033DL)
...
//
#define STATUS_GRAPHICS_INVALID_COLORBASIS ((int32_t)0xC01E033EL)
...
//
#define STATUS_GRAPHICS_INVALID_PIXELVALUEACCESSMODE ((int32_t)0xC01E033FL)
...
//
#define STATUS_GRAPHICS_TARGET_NOT_IN_TOPOLOGY ((int32_t)0xC01E0340L)
...
//
#define STATUS_GRAPHICS_NO_DISPLAY_MODE_MANAGEMENT_SUPPORT ((int32_t)0xC01E0341L)
...
//
#define STATUS_GRAPHICS_VIDPN_SOURCE_IN_USE ((int32_t)0xC01E0342L)
...
//
#define STATUS_GRAPHICS_CANT_ACCESS_ACTIVE_VIDPN ((int32_t)0xC01E0343L)
...
//
#define STATUS_GRAPHICS_INVALID_PATH_IMPORTANCE_ORDINAL ((int32_t)0xC01E0344L)
...
//
#define STATUS_GRAPHICS_INVALID_PATH_CONTENT_GEOMETRY_TRANSFORMATION ((int32_t)0xC01E0345L)
...
//
#define STATUS_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_SUPPORTED ((int32_t)0xC01E0346L)
...
//
#define STATUS_GRAPHICS_INVALID_GAMMA_RAMP ((int32_t)0xC01E0347L)
...
//
#define STATUS_GRAPHICS_GAMMA_RAMP_NOT_SUPPORTED ((int32_t)0xC01E0348L)
...
//
#define STATUS_GRAPHICS_MULTISAMPLING_NOT_SUPPORTED ((int32_t)0xC01E0349L)
...
//
#define STATUS_GRAPHICS_MODE_NOT_IN_MODESET ((int32_t)0xC01E034AL)
...
//
#define STATUS_GRAPHICS_DATASET_IS_EMPTY ((int32_t)0x401E034BL)
...
//
#define STATUS_GRAPHICS_NO_MORE_ELEMENTS_IN_DATASET ((int32_t)0x401E034CL)
...
//
#define STATUS_GRAPHICS_INVALID_VIDPN_TOPOLOGY_RECOMMENDATION_REASON ((int32_t)0xC01E034DL)
...
//
#define STATUS_GRAPHICS_INVALID_PATH_CONTENT_TYPE ((int32_t)0xC01E034EL)
...
//
#define STATUS_GRAPHICS_INVALID_COPYPROTECTION_TYPE ((int32_t)0xC01E034FL)
...
//
#define STATUS_GRAPHICS_UNASSIGNED_MODESET_ALREADY_EXISTS ((int32_t)0xC01E0350L)
...
//
#define STATUS_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_PINNED ((int32_t)0x401E0351L)
...
//
#define STATUS_GRAPHICS_INVALID_SCANLINE_ORDERING ((int32_t)0xC01E0352L)
...
//
#define STATUS_GRAPHICS_TOPOLOGY_CHANGES_NOT_ALLOWED ((int32_t)0xC01E0353L)
...
//
#define STATUS_GRAPHICS_NO_AVAILABLE_IMPORTANCE_ORDINALS ((int32_t)0xC01E0354L)
...
//
#define STATUS_GRAPHICS_INCOMPATIBLE_PRIVATE_FORMAT ((int32_t)0xC01E0355L)
...
//
#define STATUS_GRAPHICS_INVALID_MODE_PRUNING_ALGORITHM ((int32_t)0xC01E0356L)
...
//
#define STATUS_GRAPHICS_INVALID_MONITOR_CAPABILITY_ORIGIN ((int32_t)0xC01E0357L)
...
//
#define STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE_CONSTRAINT ((int32_t)0xC01E0358L)
...
//
#define STATUS_GRAPHICS_MAX_NUM_PATHS_REACHED ((int32_t)0xC01E0359L)
...
//
#define STATUS_GRAPHICS_CANCEL_VIDPN_TOPOLOGY_AUGMENTATION ((int32_t)0xC01E035AL)
...
//
#define STATUS_GRAPHICS_INVALID_CLIENT_TYPE ((int32_t)0xC01E035BL)
...
//
#define STATUS_GRAPHICS_CLIENTVIDPN_NOT_SET ((int32_t)0xC01E035CL)
...
//
#define STATUS_GRAPHICS_SPECIFIED_CHILD_ALREADY_CONNECTED ((int32_t)0xC01E0400L)    
...
//
#define STATUS_GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED ((int32_t)0xC01E0401L)    
...
//
#define STATUS_GRAPHICS_UNKNOWN_CHILD_STATUS ((int32_t)0x401E042FL)
...
//
#define STATUS_GRAPHICS_NOT_A_LINKED_ADAPTER ((int32_t)0xC01E0430L)
...
//
#define STATUS_GRAPHICS_LEADLINK_NOT_ENUMERATED ((int32_t)0xC01E0431L)
...
//
#define STATUS_GRAPHICS_CHAINLINKS_NOT_ENUMERATED ((int32_t)0xC01E0432L)
...
//
#define STATUS_GRAPHICS_ADAPTER_CHAIN_NOT_READY ((int32_t)0xC01E0433L)
...
//
#define STATUS_GRAPHICS_CHAINLINKS_NOT_STARTED ((int32_t)0xC01E0434L)
...
//
#define STATUS_GRAPHICS_CHAINLINKS_NOT_POWERED_ON ((int32_t)0xC01E0435L)
...
//
#define STATUS_GRAPHICS_INCONSISTENT_DEVICE_LINK_STATE ((int32_t)0xC01E0436L)
...
//
#define STATUS_GRAPHICS_LEADLINK_START_DEFERRED ((int32_t)0x401E0437L)
...
//
#define STATUS_GRAPHICS_NOT_POST_DEVICE_DRIVER ((int32_t)0xC01E0438L)
...
//
#define STATUS_GRAPHICS_POLLING_TOO_FREQUENTLY ((int32_t)0x401E0439L)
...
//
#define STATUS_GRAPHICS_START_DEFERRED   ((int32_t)0x401E043AL)
...
//
#define STATUS_GRAPHICS_ADAPTER_ACCESS_NOT_EXCLUDED ((int32_t)0xC01E043BL)
...
//
#define STATUS_GRAPHICS_DEPENDABLE_CHILD_STATUS ((int32_t)0x401E043CL)
...
//
#define STATUS_GRAPHICS_OPM_NOT_SUPPORTED ((int32_t)0xC01E0500L)    
...
//
#define STATUS_GRAPHICS_COPP_NOT_SUPPORTED ((int32_t)0xC01E0501L)    
...
//
#define STATUS_GRAPHICS_UAB_NOT_SUPPORTED ((int32_t)0xC01E0502L)    
...
//
#define STATUS_GRAPHICS_OPM_INVALID_ENCRYPTED_PARAMETERS ((int32_t)0xC01E0503L)    
...
//
#define STATUS_GRAPHICS_OPM_NO_PROTECTED_OUTPUTS_EXIST ((int32_t)0xC01E0505L)
...
//
#define STATUS_GRAPHICS_OPM_INTERNAL_ERROR ((int32_t)0xC01E050BL)
...
//
#define STATUS_GRAPHICS_OPM_INVALID_HANDLE ((int32_t)0xC01E050CL)
...
//
#define STATUS_GRAPHICS_PVP_INVALID_CERTIFICATE_LENGTH ((int32_t)0xC01E050EL)
...
//
#define STATUS_GRAPHICS_OPM_SPANNING_MODE_ENABLED ((int32_t)0xC01E050FL)
...
//
#define STATUS_GRAPHICS_OPM_THEATER_MODE_ENABLED ((int32_t)0xC01E0510L)
...
//
#define STATUS_GRAPHICS_PVP_HFS_FAILED   ((int32_t)0xC01E0511L)
...
//
#define STATUS_GRAPHICS_OPM_INVALID_SRM  ((int32_t)0xC01E0512L)
...
//
#define STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_HDCP ((int32_t)0xC01E0513L)
...
//
#define STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_ACP ((int32_t)0xC01E0514L)
...
//
#define STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_CGMSA ((int32_t)0xC01E0515L)
...
//
#define STATUS_GRAPHICS_OPM_HDCP_SRM_NEVER_SET ((int32_t)0xC01E0516L)
...
//
#define STATUS_GRAPHICS_OPM_RESOLUTION_TOO_HIGH ((int32_t)0xC01E0517L)
...
//
#define STATUS_GRAPHICS_OPM_ALL_HDCP_HARDWARE_ALREADY_IN_USE ((int32_t)0xC01E0518L)
...
//
#define STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_NO_LONGER_EXISTS ((int32_t)0xC01E051AL)
...
//
#define STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_DOES_NOT_HAVE_COPP_SEMANTICS ((int32_t)0xC01E051CL)
...
//
#define STATUS_GRAPHICS_OPM_INVALID_INFORMATION_REQUEST ((int32_t)0xC01E051DL)
...
//
#define STATUS_GRAPHICS_OPM_DRIVER_INTERNAL_ERROR ((int32_t)0xC01E051EL)
...
//
#define STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_DOES_NOT_HAVE_OPM_SEMANTICS ((int32_t)0xC01E051FL)
...
//
#define STATUS_GRAPHICS_OPM_SIGNALING_NOT_SUPPORTED ((int32_t)0xC01E0520L)
...
//
#define STATUS_GRAPHICS_OPM_INVALID_CONFIGURATION_REQUEST ((int32_t)0xC01E0521L)
...
//
#define STATUS_GRAPHICS_I2C_NOT_SUPPORTED ((int32_t)0xC01E0580L)    
...
//
#define STATUS_GRAPHICS_I2C_DEVICE_DOES_NOT_EXIST ((int32_t)0xC01E0581L)    
...
//
#define STATUS_GRAPHICS_I2C_ERROR_TRANSMITTING_DATA ((int32_t)0xC01E0582L)    
...
//
#define STATUS_GRAPHICS_I2C_ERROR_RECEIVING_DATA ((int32_t)0xC01E0583L)    
...
//
#define STATUS_GRAPHICS_DDCCI_VCP_NOT_SUPPORTED ((int32_t)0xC01E0584L)    
...
//
#define STATUS_GRAPHICS_DDCCI_INVALID_DATA ((int32_t)0xC01E0585L)    
...
//
#define STATUS_GRAPHICS_DDCCI_MONITOR_RETURNED_INVALID_TIMING_STATUS_BYTE ((int32_t)0xC01E0586L)
...
//
#define STATUS_GRAPHICS_DDCCI_INVALID_CAPABILITIES_STRING ((int32_t)0xC01E0587L)
...
// An internal error caused an operation to fail.
//
#define STATUS_GRAPHICS_MCA_INTERNAL_ERROR ((int32_t)0xC01E0588L)
...
//
#define STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_COMMAND ((int32_t)0xC01E0589L)
...
//
#define STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_LENGTH ((int32_t)0xC01E058AL)
...
//
#define STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_CHECKSUM ((int32_t)0xC01E058BL)
...
//
#define STATUS_GRAPHICS_INVALID_PHYSICAL_MONITOR_HANDLE ((int32_t)0xC01E058CL)
...
//
#define STATUS_GRAPHICS_MONITOR_NO_LONGER_EXISTS ((int32_t)0xC01E058DL)
...
//
#define STATUS_GRAPHICS_ONLY_CONSOLE_SESSION_SUPPORTED ((int32_t)0xC01E05E0L)
...
//
#define STATUS_GRAPHICS_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME ((int32_t)0xC01E05E1L)
...
//
#define STATUS_GRAPHICS_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP ((int32_t)0xC01E05E2L)
...
//
#define STATUS_GRAPHICS_MIRRORING_DEVICES_NOT_SUPPORTED ((int32_t)0xC01E05E3L)
...
//
#define STATUS_GRAPHICS_INVALID_POINTER  ((int32_t)0xC01E05E4L)
...
//
#define STATUS_GRAPHICS_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE ((int32_t)0xC01E05E5L)
...
//
#define STATUS_GRAPHICS_PARAMETER_ARRAY_TOO_SMALL ((int32_t)0xC01E05E6L)
...
// An internal error caused an operation to fail.
//
#define STATUS_GRAPHICS_INTERNAL_ERROR   ((int32_t)0xC01E05E7L)
...
//
#define STATUS_GRAPHICS_SESSION_TYPE_CHANGE_IN_PROGRESS ((int32_t)0xC01E05E8L)
...
//
#define STATUS_FVE_LOCKED_VOLUME         ((int32_t)0xC0210000L)
...
//
#define STATUS_FVE_NOT_ENCRYPTED         ((int32_t)0xC0210001L)
...
//
#define STATUS_FVE_BAD_INFORMATION       ((int32_t)0xC0210002L)
...
//
#define STATUS_FVE_TOO_SMALL             ((int32_t)0xC0210003L)
...
//
#define STATUS_FVE_FAILED_WRONG_FS       ((int32_t)0xC0210004L)
...
//
#define STATUS_FVE_BAD_PARTITION_SIZE    ((int32_t)0xC0210005L)
...
//
#define STATUS_FVE_FS_NOT_EXTENDED       ((int32_t)0xC0210006L)
...
//
#define STATUS_FVE_FS_MOUNTED            ((int32_t)0xC0210007L)
...
//
#define STATUS_FVE_NO_LICENSE            ((int32_t)0xC0210008L)
...
//
#define STATUS_FVE_ACTION_NOT_ALLOWED    ((int32_t)0xC0210009L)
...
//
#define STATUS_FVE_BAD_DATA              ((int32_t)0xC021000AL)
...
//
#define STATUS_FVE_VOLUME_NOT_BOUND      ((int32_t)0xC021000BL)
...
//
#define STATUS_FVE_NOT_DATA_VOLUME       ((int32_t)0xC021000CL)
...
//
#define STATUS_FVE_CONV_READ_ERROR       ((int32_t)0xC021000DL)
...
//
#define STATUS_FVE_CONV_WRITE_ERROR      ((int32_t)0xC021000EL)
...
//
#define STATUS_FVE_OVERLAPPED_UPDATE     ((int32_t)0xC021000FL)
...
//
#define STATUS_FVE_FAILED_SECTOR_SIZE    ((int32_t)0xC0210010L)
...
//
#define STATUS_FVE_FAILED_AUTHENTICATION ((int32_t)0xC0210011L)
...
//
#define STATUS_FVE_NOT_OS_VOLUME         ((int32_t)0xC0210012L)
...
//
#define STATUS_FVE_KEYFILE_NOT_FOUND     ((int32_t)0xC0210013L)
...
//
#define STATUS_FVE_KEYFILE_INVALID       ((int32_t)0xC0210014L)
...
//
#define STATUS_FVE_KEYFILE_NO_VMK        ((int32_t)0xC0210015L)
...
//
#define STATUS_FVE_TPM_DISABLED          ((int32_t)0xC0210016L)
...
//
#define STATUS_FVE_TPM_SRK_AUTH_NOT_ZERO ((int32_t)0xC0210017L)
...
//
#define STATUS_FVE_TPM_INVALID_PCR       ((int32_t)0xC0210018L)
...
//
#define STATUS_FVE_TPM_NO_VMK            ((int32_t)0xC0210019L)
...
//
#define STATUS_FVE_PIN_INVALID           ((int32_t)0xC021001AL)
...
//
#define STATUS_FVE_AUTH_INVALID_APPLICATION ((int32_t)0xC021001BL)
...
//
#define STATUS_FVE_AUTH_INVALID_CONFIG   ((int32_t)0xC021001CL)
...
//
#define STATUS_FVE_DEBUGGER_ENABLED      ((int32_t)0xC021001DL)
...
//
#define STATUS_FVE_DRY_RUN_FAILED        ((int32_t)0xC021001EL)
...
//
#define STATUS_FVE_BAD_METADATA_POINTER  ((int32_t)0xC021001FL)
...
//
#define STATUS_FVE_OLD_METADATA_COPY     ((int32_t)0xC0210020L)
...
//
#define STATUS_FVE_REBOOT_REQUIRED       ((int32_t)0xC0210021L)
...
//
#define STATUS_FVE_RAW_ACCESS            ((int32_t)0xC0210022L)
...
//
#define STATUS_FVE_RAW_BLOCKED           ((int32_t)0xC0210023L)
...
//
#define STATUS_FVE_NO_AUTOUNLOCK_MASTER_KEY ((int32_t)0xC0210024L)
...
//
#define STATUS_FVE_MOR_FAILED            ((int32_t)0xC0210025L)
...
//
#define STATUS_FVE_NO_FEATURE_LICENSE    ((int32_t)0xC0210026L)
...
//
#define STATUS_FVE_POLICY_USER_DISABLE_RDV_NOT_ALLOWED ((int32_t)0xC0210027L)
...
//
#define STATUS_FVE_CONV_RECOVERY_FAILED  ((int32_t)0xC0210028L)
...
//
#define STATUS_FVE_VIRTUALIZED_SPACE_TOO_BIG ((int32_t)0xC0210029L)
...
//
#define STATUS_FVE_INVALID_DATUM_TYPE    ((int32_t)0xC021002AL)
...
//
#define STATUS_FVE_VOLUME_TOO_SMALL      ((int32_t)0xC0210030L)
...
//
#define STATUS_FVE_ENH_PIN_INVALID       ((int32_t)0xC0210031L)
...
//
#define STATUS_FVE_FULL_ENCRYPTION_NOT_ALLOWED_ON_TP_STORAGE ((int32_t)0xC0210032L)
...
//
#define STATUS_FVE_WIPE_NOT_ALLOWED_ON_TP_STORAGE ((int32_t)0xC0210033L)
...
//
#define STATUS_FVE_NOT_ALLOWED_ON_CSV_STACK ((int32_t)0xC0210034L)
...
//
#define STATUS_FVE_NOT_ALLOWED_ON_CLUSTER ((int32_t)0xC0210035L)
...
//
#define STATUS_FVE_NOT_ALLOWED_TO_UPGRADE_WHILE_CONVERTING ((int32_t)0xC0210036L)
...
//
#define STATUS_FVE_WIPE_CANCEL_NOT_APPLICABLE ((int32_t)0xC0210037L)
...
//
#define STATUS_FVE_EDRIVE_DRY_RUN_FAILED ((int32_t)0xC0210038L)
...
//
#define STATUS_FVE_SECUREBOOT_DISABLED   ((int32_t)0xC0210039L)
...
//
#define STATUS_FVE_SECUREBOOT_CONFIG_CHANGE ((int32_t)0xC021003AL)
...
//
#define STATUS_FVE_DEVICE_LOCKEDOUT      ((int32_t)0xC021003BL)
...
//
#define STATUS_FVE_VOLUME_EXTEND_PREVENTS_EOW_DECRYPT ((int32_t)0xC021003CL)
...
//
#define STATUS_FVE_NOT_DE_VOLUME         ((int32_t)0xC021003DL)
...
//
#define STATUS_FVE_PROTECTION_DISABLED   ((int32_t)0xC021003EL)
...
//
#define STATUS_FVE_PROTECTION_CANNOT_BE_DISABLED ((int32_t)0xC021003FL)
...
//
#define STATUS_FVE_OSV_KSR_NOT_ALLOWED   ((int32_t)0xC0210040L)
...
//
#define STATUS_FWP_CALLOUT_NOT_FOUND     ((int32_t)0xC0220001L)
...
//
#define STATUS_FWP_CONDITION_NOT_FOUND   ((int32_t)0xC0220002L)
...
//
#define STATUS_FWP_FILTER_NOT_FOUND      ((int32_t)0xC0220003L)
...
//
#define STATUS_FWP_LAYER_NOT_FOUND       ((int32_t)0xC0220004L)
...
//
#define STATUS_FWP_PROVIDER_NOT_FOUND    ((int32_t)0xC0220005L)
...
//
#define STATUS_FWP_PROVIDER_CONTEXT_NOT_FOUND ((int32_t)0xC0220006L)
...
//
#define STATUS_FWP_SUBLAYER_NOT_FOUND    ((int32_t)0xC0220007L)
...
//
#define STATUS_FWP_NOT_FOUND             ((int32_t)0xC0220008L)
...
//
#define STATUS_FWP_ALREADY_EXISTS        ((int32_t)0xC0220009L)
...
//
#define STATUS_FWP_IN_USE                ((int32_t)0xC022000AL)
...
//
#define STATUS_FWP_DYNAMIC_SESSION_IN_PROGRESS ((int32_t)0xC022000BL)
...
//
#define STATUS_FWP_WRONG_SESSION         ((int32_t)0xC022000CL)
...
//
#define STATUS_FWP_NO_TXN_IN_PROGRESS    ((int32_t)0xC022000DL)
...
//
#define STATUS_FWP_TXN_IN_PROGRESS       ((int32_t)0xC022000EL)
...
//
#define STATUS_FWP_TXN_ABORTED           ((int32_t)0xC022000FL)
...
//
#define STATUS_FWP_SESSION_ABORTED       ((int32_t)0xC0220010L)
...
//
#define STATUS_FWP_INCOMPATIBLE_TXN      ((int32_t)0xC0220011L)
...
//
#define STATUS_FWP_TIMEOUT               ((int32_t)0xC0220012L)
...
//
#define STATUS_FWP_NET_EVENTS_DISABLED   ((int32_t)0xC0220013L)
...
//
#define STATUS_FWP_INCOMPATIBLE_LAYER    ((int32_t)0xC0220014L)
...
//
#define STATUS_FWP_KM_CLIENTS_ONLY       ((int32_t)0xC0220015L)
...
//
#define STATUS_FWP_LIFETIME_MISMATCH     ((int32_t)0xC0220016L)
...
//
#define STATUS_FWP_BUILTIN_OBJECT        ((int32_t)0xC0220017L)
...
//
#define STATUS_FWP_TOO_MANY_CALLOUTS     ((int32_t)0xC0220018L)
...
//
#define STATUS_FWP_NOTIFICATION_DROPPED  ((int32_t)0xC0220019L)
...
//
#define STATUS_FWP_TRAFFIC_MISMATCH      ((int32_t)0xC022001AL)
...
//
#define STATUS_FWP_INCOMPATIBLE_SA_STATE ((int32_t)0xC022001BL)
...
//
#define STATUS_FWP_NULL_POINTER          ((int32_t)0xC022001CL)
...
//
#define STATUS_FWP_INVALID_ENUMERATOR    ((int32_t)0xC022001DL)
...
//
#define STATUS_FWP_INVALID_FLAGS         ((int32_t)0xC022001EL)
...
//
#define STATUS_FWP_INVALID_NET_MASK      ((int32_t)0xC022001FL)
...
//
#define STATUS_FWP_INVALID_RANGE         ((int32_t)0xC0220020L)
...
//
#define STATUS_FWP_INVALID_INTERVAL      ((int32_t)0xC0220021L)
...
//
#define STATUS_FWP_ZERO_LENGTH_ARRAY     ((int32_t)0xC0220022L)
...
//
#define STATUS_FWP_NULL_DISPLAY_NAME     ((int32_t)0xC0220023L)
...
//
#define STATUS_FWP_INVALID_ACTION_TYPE   ((int32_t)0xC0220024L)
...
//
#define STATUS_FWP_INVALID_WEIGHT        ((int32_t)0xC0220025L)
...
//
#define STATUS_FWP_MATCH_TYPE_MISMATCH   ((int32_t)0xC0220026L)
...
//
#define STATUS_FWP_TYPE_MISMATCH         ((int32_t)0xC0220027L)
...
//
#define STATUS_FWP_OUT_OF_BOUNDS         ((int32_t)0xC0220028L)
...
//
#define STATUS_FWP_RESERVED              ((int32_t)0xC0220029L)
...
//
#define STATUS_FWP_DUPLICATE_CONDITION   ((int32_t)0xC022002AL)
...
//
#define STATUS_FWP_DUPLICATE_KEYMOD      ((int32_t)0xC022002BL)
...
//
#define STATUS_FWP_ACTION_INCOMPATIBLE_WITH_LAYER ((int32_t)0xC022002CL)
...
//
#define STATUS_FWP_ACTION_INCOMPATIBLE_WITH_SUBLAYER ((int32_t)0xC022002DL)
...
//
#define STATUS_FWP_CONTEXT_INCOMPATIBLE_WITH_LAYER ((int32_t)0xC022002EL)
...
//
#define STATUS_FWP_CONTEXT_INCOMPATIBLE_WITH_CALLOUT ((int32_t)0xC022002FL)
...
//
#define STATUS_FWP_INCOMPATIBLE_AUTH_METHOD ((int32_t)0xC0220030L)
...
//
#define STATUS_FWP_INCOMPATIBLE_DH_GROUP ((int32_t)0xC0220031L)
...
//
#define STATUS_FWP_EM_NOT_SUPPORTED      ((int32_t)0xC0220032L)
...
//
#define STATUS_FWP_NEVER_MATCH           ((int32_t)0xC0220033L)
...
//
#define STATUS_FWP_PROVIDER_CONTEXT_MISMATCH ((int32_t)0xC0220034L)
...
//
#define STATUS_FWP_INVALID_PARAMETER     ((int32_t)0xC0220035L)
...
//
#define STATUS_FWP_TOO_MANY_SUBLAYERS    ((int32_t)0xC0220036L)
...
//
#define STATUS_FWP_CALLOUT_NOTIFICATION_FAILED ((int32_t)0xC0220037L)
...
//
#define STATUS_FWP_INVALID_AUTH_TRANSFORM ((int32_t)0xC0220038L)
...
//
#define STATUS_FWP_INVALID_CIPHER_TRANSFORM ((int32_t)0xC0220039L)
...
//
#define STATUS_FWP_INCOMPATIBLE_CIPHER_TRANSFORM ((int32_t)0xC022003AL)
...
//
#define STATUS_FWP_INVALID_TRANSFORM_COMBINATION ((int32_t)0xC022003BL)
...
//
#define STATUS_FWP_DUPLICATE_AUTH_METHOD ((int32_t)0xC022003CL)
...
//
#define STATUS_FWP_INVALID_TUNNEL_ENDPOINT ((int32_t)0xC022003DL)
...
//
#define STATUS_FWP_L2_DRIVER_NOT_READY   ((int32_t)0xC022003EL)
...
//
#define STATUS_FWP_KEY_DICTATOR_ALREADY_REGISTERED ((int32_t)0xC022003FL)
...
//
#define STATUS_FWP_KEY_DICTATION_INVALID_KEYING_MATERIAL ((int32_t)0xC0220040L)
...
//
#define STATUS_FWP_CONNECTIONS_DISABLED  ((int32_t)0xC0220041L)
...
//
#define STATUS_FWP_INVALID_DNS_NAME      ((int32_t)0xC0220042L)
...
//
#define STATUS_FWP_STILL_ON              ((int32_t)0xC0220043L)
...
//
#define STATUS_FWP_IKEEXT_NOT_RUNNING    ((int32_t)0xC0220044L)
...
//
#define STATUS_FWP_TCPIP_NOT_READY       ((int32_t)0xC0220100L)
...
//
#define STATUS_FWP_INJECT_HANDLE_CLOSING ((int32_t)0xC0220101L)
...
//
#define STATUS_FWP_INJECT_HANDLE_STALE   ((int32_t)0xC0220102L)
...
//
#define STATUS_FWP_CANNOT_PEND           ((int32_t)0xC0220103L)
...
//
#define STATUS_FWP_DROP_NOICMP           ((int32_t)0xC0220104L)
...
//
#define STATUS_NDIS_CLOSING              ((int32_t)0xC0230002L)
...
//
#define STATUS_NDIS_BAD_VERSION          ((int32_t)0xC0230004L)
...
//
#define STATUS_NDIS_BAD_CHARACTERISTICS  ((int32_t)0xC0230005L)
...
//
#define STATUS_NDIS_ADAPTER_NOT_FOUND    ((int32_t)0xC0230006L)
...
//
#define STATUS_NDIS_OPEN_FAILED          ((int32_t)0xC0230007L)
...
//
#define STATUS_NDIS_DEVICE_FAILED        ((int32_t)0xC0230008L)
...
//
#define STATUS_NDIS_MULTICAST_FULL       ((int32_t)0xC0230009L)
...
//
#define STATUS_NDIS_MULTICAST_EXISTS     ((int32_t)0xC023000AL)
...
//
#define STATUS_NDIS_MULTICAST_NOT_FOUND  ((int32_t)0xC023000BL)
...
//
#define STATUS_NDIS_REQUEST_ABORTED      ((int32_t)0xC023000CL)
...
//
#define STATUS_NDIS_RESET_IN_PROGRESS    ((int32_t)0xC023000DL)
...
//
#define STATUS_NDIS_NOT_SUPPORTED        ((int32_t)0xC02300BBL)
...
//
#define STATUS_NDIS_INVALID_PACKET       ((int32_t)0xC023000FL)
...
//
#define STATUS_NDIS_ADAPTER_NOT_READY    ((int32_t)0xC0230011L)
...
//
#define STATUS_NDIS_INVALID_LENGTH       ((int32_t)0xC0230014L)
...
//
#define STATUS_NDIS_INVALID_DATA         ((int32_t)0xC0230015L)
...
//
#define STATUS_NDIS_BUFFER_TOO_SHORT     ((int32_t)0xC0230016L)
...
//
#define STATUS_NDIS_INVALID_OID          ((int32_t)0xC0230017L)
...
//
#define STATUS_NDIS_ADAPTER_REMOVED      ((int32_t)0xC0230018L)
...
//
#define STATUS_NDIS_UNSUPPORTED_MEDIA    ((int32_t)0xC0230019L)
...
//
#define STATUS_NDIS_GROUP_ADDRESS_IN_USE ((int32_t)0xC023001AL)
...
//
#define STATUS_NDIS_FILE_NOT_FOUND       ((int32_t)0xC023001BL)
...
//
#define STATUS_NDIS_ERROR_READING_FILE   ((int32_t)0xC023001CL)
...
//
#define STATUS_NDIS_ALREADY_MAPPED       ((int32_t)0xC023001DL)
...
//
#define STATUS_NDIS_RESOURCE_CONFLICT    ((int32_t)0xC023001EL)
...
//
#define STATUS_NDIS_MEDIA_DISCONNECTED   ((int32_t)0xC023001FL)
...
//
#define STATUS_NDIS_INVALID_ADDRESS      ((int32_t)0xC0230022L)
...
// The specified request is not a valid operation for the target device.
//
#define STATUS_NDIS_INVALID_DEVICE_REQUEST ((int32_t)0xC0230010L)
...
//
#define STATUS_NDIS_PAUSED               ((int32_t)0xC023002AL)
...
//
#define STATUS_NDIS_INTERFACE_NOT_FOUND  ((int32_t)0xC023002BL)
...
//
#define STATUS_NDIS_UNSUPPORTED_REVISION ((int32_t)0xC023002CL)
...
//
#define STATUS_NDIS_INVALID_PORT         ((int32_t)0xC023002DL)
...
//
#define STATUS_NDIS_INVALID_PORT_STATE   ((int32_t)0xC023002EL)
...
//
#define STATUS_NDIS_LOW_POWER_STATE      ((int32_t)0xC023002FL)
...
//
#define STATUS_NDIS_REINIT_REQUIRED      ((int32_t)0xC0230030L)
...
//
#define STATUS_NDIS_NO_QUEUES            ((int32_t)0xC0230031L)
...
//
#define STATUS_NDIS_DOT11_AUTO_CONFIG_ENABLED ((int32_t)0xC0232000L)
...
//
#define STATUS_NDIS_DOT11_MEDIA_IN_USE   ((int32_t)0xC0232001L)
...
//
#define STATUS_NDIS_DOT11_POWER_STATE_INVALID ((int32_t)0xC0232002L)
...
//
#define STATUS_NDIS_PM_WOL_PATTERN_LIST_FULL ((int32_t)0xC0232003L)
...
//
#define STATUS_NDIS_PM_PROTOCOL_OFFLOAD_LIST_FULL ((int32_t)0xC0232004L)
...
//
#define STATUS_NDIS_DOT11_AP_CHANNEL_CURRENTLY_NOT_AVAILABLE ((int32_t)0xC0232005L)
...
//
#define STATUS_NDIS_DOT11_AP_BAND_CURRENTLY_NOT_AVAILABLE ((int32_t)0xC0232006L)
...
//
#define STATUS_NDIS_DOT11_AP_CHANNEL_NOT_ALLOWED ((int32_t)0xC0232007L)
...
//
#define STATUS_NDIS_DOT11_AP_BAND_NOT_ALLOWED ((int32_t)0xC0232008L)
...
//
#define STATUS_NDIS_INDICATION_REQUIRED  ((int32_t)0x40230001L)
...
//
#define STATUS_NDIS_OFFLOAD_POLICY       ((int32_t)0xC023100FL)
...
//
#define STATUS_NDIS_OFFLOAD_CONNECTION_REJECTED ((int32_t)0xC0231012L)
...
//
#define STATUS_NDIS_OFFLOAD_PATH_REJECTED ((int32_t)0xC0231013L)
...
//
#define STATUS_TPM_ERROR_MASK            ((int32_t)0xC0290000L)
...
//
#define STATUS_TPM_AUTHFAIL              ((int32_t)0xC0290001L)
...
//
#define STATUS_TPM_BADINDEX              ((int32_t)0xC0290002L)
...
//
#define STATUS_TPM_BAD_PARAMETER         ((int32_t)0xC0290003L)
...
//
#define STATUS_TPM_AUDITFAILURE          ((int32_t)0xC0290004L)
...
//
#define STATUS_TPM_CLEAR_DISABLED        ((int32_t)0xC0290005L)
...
//
#define STATUS_TPM_DEACTIVATED           ((int32_t)0xC0290006L)
...
//
#define STATUS_TPM_DISABLED              ((int32_t)0xC0290007L)
...
//
#define STATUS_TPM_DISABLED_CMD          ((int32_t)0xC0290008L)
...
//
#define STATUS_TPM_FAIL                  ((int32_t)0xC0290009L)
...
//
#define STATUS_TPM_BAD_ORDINAL           ((int32_t)0xC029000AL)
...
//
#define STATUS_TPM_INSTALL_DISABLED      ((int32_t)0xC029000BL)
...
//
#define STATUS_TPM_INVALID_KEYHANDLE     ((int32_t)0xC029000CL)
...
//
#define STATUS_TPM_KEYNOTFOUND           ((int32_t)0xC029000DL)
...
//
#define STATUS_TPM_INAPPROPRIATE_ENC     ((int32_t)0xC029000EL)
...
//
#define STATUS_TPM_MIGRATEFAIL           ((int32_t)0xC029000FL)
...
//
#define STATUS_TPM_INVALID_PCR_INFO      ((int32_t)0xC0290010L)
...
//
#define STATUS_TPM_NOSPACE               ((int32_t)0xC0290011L)
...
//
#define STATUS_TPM_NOSRK                 ((int32_t)0xC0290012L)
...
//
#define STATUS_TPM_NOTSEALED_BLOB        ((int32_t)0xC0290013L)
...
//
#define STATUS_TPM_OWNER_SET             ((int32_t)0xC0290014L)
...
//
#define STATUS_TPM_RESOURCES             ((int32_t)0xC0290015L)
...
//
#define STATUS_TPM_SHORTRANDOM           ((int32_t)0xC0290016L)
...
//
#define STATUS_TPM_SIZE                  ((int32_t)0xC0290017L)
...
//
#define STATUS_TPM_WRONGPCRVAL           ((int32_t)0xC0290018L)
...
//
#define STATUS_TPM_BAD_PARAM_SIZE        ((int32_t)0xC0290019L)
...
//
#define STATUS_TPM_SHA_THREAD            ((int32_t)0xC029001AL)
...
//
#define STATUS_TPM_SHA_ERROR             ((int32_t)0xC029001BL)
...
//
#define STATUS_TPM_FAILEDSELFTEST        ((int32_t)0xC029001CL)
...
//
#define STATUS_TPM_AUTH2FAIL             ((int32_t)0xC029001DL)
...
//
#define STATUS_TPM_BADTAG                ((int32_t)0xC029001EL)
...
//
#define STATUS_TPM_IOERROR               ((int32_t)0xC029001FL)
...
//
#define STATUS_TPM_ENCRYPT_ERROR         ((int32_t)0xC0290020L)
...
//
#define STATUS_TPM_DECRYPT_ERROR         ((int32_t)0xC0290021L)
...
//
#define STATUS_TPM_INVALID_AUTHHANDLE    ((int32_t)0xC0290022L)
...
//
#define STATUS_TPM_NO_ENDORSEMENT        ((int32_t)0xC0290023L)
...
//
#define STATUS_TPM_INVALID_KEYUSAGE      ((int32_t)0xC0290024L)
...
//
#define STATUS_TPM_WRONG_ENTITYTYPE      ((int32_t)0xC0290025L)
...
//
#define STATUS_TPM_INVALID_POSTINIT      ((int32_t)0xC0290026L)
...
//
#define STATUS_TPM_INAPPROPRIATE_SIG     ((int32_t)0xC0290027L)
...
//
#define STATUS_TPM_BAD_KEY_PROPERTY      ((int32_t)0xC0290028L)
...
//
#define STATUS_TPM_BAD_MIGRATION         ((int32_t)0xC0290029L)
...
//
#define STATUS_TPM_BAD_SCHEME            ((int32_t)0xC029002AL)
...
//
#define STATUS_TPM_BAD_DATASIZE          ((int32_t)0xC029002BL)
...
//
#define STATUS_TPM_BAD_MODE              ((int32_t)0xC029002CL)
...
//
#define STATUS_TPM_BAD_PRESENCE          ((int32_t)0xC029002DL)
...
//
#define STATUS_TPM_BAD_VERSION           ((int32_t)0xC029002EL)
...
//
#define STATUS_TPM_NO_WRAP_TRANSPORT     ((int32_t)0xC029002FL)
...
//
#define STATUS_TPM_AUDITFAIL_UNSUCCESSFUL ((int32_t)0xC0290030L)
...
//
#define STATUS_TPM_AUDITFAIL_SUCCESSFUL  ((int32_t)0xC0290031L)
...
//
#define STATUS_TPM_NOTRESETABLE          ((int32_t)0xC0290032L)
...
//
#define STATUS_TPM_NOTLOCAL              ((int32_t)0xC0290033L)
...
//
#define STATUS_TPM_BAD_TYPE              ((int32_t)0xC0290034L)
...
//
#define STATUS_TPM_INVALID_RESOURCE      ((int32_t)0xC0290035L)
...
//
#define STATUS_TPM_NOTFIPS               ((int32_t)0xC0290036L)
...
//
#define STATUS_TPM_INVALID_FAMILY        ((int32_t)0xC0290037L)
...
//
#define STATUS_TPM_NO_NV_PERMISSION      ((int32_t)0xC0290038L)
...
//
#define STATUS_TPM_REQUIRES_SIGN         ((int32_t)0xC0290039L)
...
//
#define STATUS_TPM_KEY_NOTSUPPORTED      ((int32_t)0xC029003AL)
...
//
#define STATUS_TPM_AUTH_CONFLICT         ((int32_t)0xC029003BL)
...
//
#define STATUS_TPM_AREA_LOCKED           ((int32_t)0xC029003CL)
...
//
#define STATUS_TPM_BAD_LOCALITY          ((int32_t)0xC029003DL)
...
//
#define STATUS_TPM_READ_ONLY             ((int32_t)0xC029003EL)
...
//
#define STATUS_TPM_PER_NOWRITE           ((int32_t)0xC029003FL)
...
//
#define STATUS_TPM_FAMILYCOUNT           ((int32_t)0xC0290040L)
...
//
#define STATUS_TPM_WRITE_LOCKED          ((int32_t)0xC0290041L)
...
//
#define STATUS_TPM_BAD_ATTRIBUTES        ((int32_t)0xC0290042L)
...
//
#define STATUS_TPM_INVALID_STRUCTURE     ((int32_t)0xC0290043L)
...
//
#define STATUS_TPM_KEY_OWNER_CONTROL     ((int32_t)0xC0290044L)
...
//
#define STATUS_TPM_BAD_COUNTER           ((int32_t)0xC0290045L)
...
//
#define STATUS_TPM_NOT_FULLWRITE         ((int32_t)0xC0290046L)
...
//
#define STATUS_TPM_CONTEXT_GAP           ((int32_t)0xC0290047L)
...
//
#define STATUS_TPM_MAXNVWRITES           ((int32_t)0xC0290048L)
...
//
#define STATUS_TPM_NOOPERATOR            ((int32_t)0xC0290049L)
...
//
#define STATUS_TPM_RESOURCEMISSING       ((int32_t)0xC029004AL)
...
//
#define STATUS_TPM_DELEGATE_LOCK         ((int32_t)0xC029004BL)
...
//
#define STATUS_TPM_DELEGATE_FAMILY       ((int32_t)0xC029004CL)
...
//
#define STATUS_TPM_DELEGATE_ADMIN        ((int32_t)0xC029004DL)
...
//
#define STATUS_TPM_TRANSPORT_NOTEXCLUSIVE ((int32_t)0xC029004EL)
...
//
#define STATUS_TPM_OWNER_CONTROL         ((int32_t)0xC029004FL)
...
//
#define STATUS_TPM_DAA_RESOURCES         ((int32_t)0xC0290050L)
...
//
#define STATUS_TPM_DAA_INPUT_DATA0       ((int32_t)0xC0290051L)
...
//
#define STATUS_TPM_DAA_INPUT_DATA1       ((int32_t)0xC0290052L)
...
//
#define STATUS_TPM_DAA_ISSUER_SETTINGS   ((int32_t)0xC0290053L)
...
//
#define STATUS_TPM_DAA_TPM_SETTINGS      ((int32_t)0xC0290054L)
...
//
#define STATUS_TPM_DAA_STAGE             ((int32_t)0xC0290055L)
...
//
#define STATUS_TPM_DAA_ISSUER_VALIDITY   ((int32_t)0xC0290056L)
...
//
#define STATUS_TPM_DAA_WRONG_W           ((int32_t)0xC0290057L)
...
//
#define STATUS_TPM_BAD_HANDLE            ((int32_t)0xC0290058L)
...
//
#define STATUS_TPM_BAD_DELEGATE          ((int32_t)0xC0290059L)
...
//
#define STATUS_TPM_BADCONTEXT            ((int32_t)0xC029005AL)
...
//
#define STATUS_TPM_TOOMANYCONTEXTS       ((int32_t)0xC029005BL)
...
//
#define STATUS_TPM_MA_TICKET_SIGNATURE   ((int32_t)0xC029005CL)
...
//
#define STATUS_TPM_MA_DESTINATION        ((int32_t)0xC029005DL)
...
//
#define STATUS_TPM_MA_SOURCE             ((int32_t)0xC029005EL)
...
//
#define STATUS_TPM_MA_AUTHORITY          ((int32_t)0xC029005FL)
...
//
#define STATUS_TPM_PERMANENTEK           ((int32_t)0xC0290061L)
...
//
#define STATUS_TPM_BAD_SIGNATURE         ((int32_t)0xC0290062L)
...
//
#define STATUS_TPM_NOCONTEXTSPACE        ((int32_t)0xC0290063L)
...
//
#define STATUS_TPM_20_E_ASYMMETRIC       ((int32_t)0xC0290081L)
...
//
#define STATUS_TPM_20_E_ATTRIBUTES       ((int32_t)0xC0290082L)
...
//
#define STATUS_TPM_20_E_HASH             ((int32_t)0xC0290083L)
...
//
#define STATUS_TPM_20_E_VALUE            ((int32_t)0xC0290084L)
...
//
#define STATUS_TPM_20_E_HIERARCHY        ((int32_t)0xC0290085L)
...
//
#define STATUS_TPM_20_E_KEY_SIZE         ((int32_t)0xC0290087L)
...
//
#define STATUS_TPM_20_E_MGF              ((int32_t)0xC0290088L)
...
//
#define STATUS_TPM_20_E_MODE             ((int32_t)0xC0290089L)
...
//
#define STATUS_TPM_20_E_TYPE             ((int32_t)0xC029008AL)
...
//
#define STATUS_TPM_20_E_HANDLE           ((int32_t)0xC029008BL)
...
//
#define STATUS_TPM_20_E_KDF              ((int32_t)0xC029008CL)
...
//
#define STATUS_TPM_20_E_RANGE            ((int32_t)0xC029008DL)
...
//
#define STATUS_TPM_20_E_AUTH_FAIL        ((int32_t)0xC029008EL)
...
//
#define STATUS_TPM_20_E_NONCE            ((int32_t)0xC029008FL)
...
//
#define STATUS_TPM_20_E_PP               ((int32_t)0xC0290090L)
...
//
#define STATUS_TPM_20_E_SCHEME           ((int32_t)0xC0290092L)
...
//
#define STATUS_TPM_20_E_SIZE             ((int32_t)0xC0290095L)
...
//
#define STATUS_TPM_20_E_SYMMETRIC        ((int32_t)0xC0290096L)
...
//
#define STATUS_TPM_20_E_TAG              ((int32_t)0xC0290097L)
...
//
#define STATUS_TPM_20_E_SELECTOR         ((int32_t)0xC0290098L)
...
//
#define STATUS_TPM_20_E_INSUFFICIENT     ((int32_t)0xC029009AL)
...
//
#define STATUS_TPM_20_E_SIGNATURE        ((int32_t)0xC029009BL)
...
//
#define STATUS_TPM_20_E_KEY              ((int32_t)0xC029009CL)
...
//
#define STATUS_TPM_20_E_POLICY_FAIL      ((int32_t)0xC029009DL)
...
//
#define STATUS_TPM_20_E_INTEGRITY        ((int32_t)0xC029009FL)
...
//
#define STATUS_TPM_20_E_TICKET           ((int32_t)0xC02900A0L)
...
//
#define STATUS_TPM_20_E_RESERVED_BITS    ((int32_t)0xC02900A1L)
...
//
#define STATUS_TPM_20_E_BAD_AUTH         ((int32_t)0xC02900A2L)
...
//
#define STATUS_TPM_20_E_EXPIRED          ((int32_t)0xC02900A3L)
...
//
#define STATUS_TPM_20_E_POLICY_CC        ((int32_t)0xC02900A4L)
...
//
#define STATUS_TPM_20_E_BINDING          ((int32_t)0xC02900A5L)
...
//
#define STATUS_TPM_20_E_CURVE            ((int32_t)0xC02900A6L)
...
//
#define STATUS_TPM_20_E_ECC_POINT        ((int32_t)0xC02900A7L)
...
//
#define STATUS_TPM_20_E_INITIALIZE       ((int32_t)0xC0290100L)
...
//
#define STATUS_TPM_20_E_FAILURE          ((int32_t)0xC0290101L)
...
//
#define STATUS_TPM_20_E_SEQUENCE         ((int32_t)0xC0290103L)
...
//
#define STATUS_TPM_20_E_PRIVATE          ((int32_t)0xC029010BL)
...
// TPM 2.0: TPM_RC_HMAC.
//
#define STATUS_TPM_20_E_HMAC             ((int32_t)0xC0290119L)
...
//
#define STATUS_TPM_20_E_DISABLED         ((int32_t)0xC0290120L)
...
//
#define STATUS_TPM_20_E_EXCLUSIVE        ((int32_t)0xC0290121L)
...
//
#define STATUS_TPM_20_E_ECC_CURVE        ((int32_t)0xC0290123L)
...
//
#define STATUS_TPM_20_E_AUTH_TYPE        ((int32_t)0xC0290124L)
...
//
#define STATUS_TPM_20_E_AUTH_MISSING     ((int32_t)0xC0290125L)
...
//
#define STATUS_TPM_20_E_POLICY           ((int32_t)0xC0290126L)
...
//
#define STATUS_TPM_20_E_PCR              ((int32_t)0xC0290127L)
...
//
#define STATUS_TPM_20_E_PCR_CHANGED      ((int32_t)0xC0290128L)
...
//
#define STATUS_TPM_20_E_UPGRADE          ((int32_t)0xC029012DL)
...
//
#define STATUS_TPM_20_E_TOO_MANY_CONTEXTS ((int32_t)0xC029012EL)
...
//
#define STATUS_TPM_20_E_AUTH_UNAVAILABLE ((int32_t)0xC029012FL)
...
//
#define STATUS_TPM_20_E_REBOOT           ((int32_t)0xC0290130L)
...
//
#define STATUS_TPM_20_E_UNBALANCED       ((int32_t)0xC0290131L)
...
//
#define STATUS_TPM_20_E_COMMAND_SIZE     ((int32_t)0xC0290142L)
...
//
#define STATUS_TPM_20_E_COMMAND_CODE     ((int32_t)0xC0290143L)
...
//
#define STATUS_TPM_20_E_AUTHSIZE         ((int32_t)0xC0290144L)
...
//
#define STATUS_TPM_20_E_AUTH_CONTEXT     ((int32_t)0xC0290145L)
...
//
#define STATUS_TPM_20_E_NV_RANGE         ((int32_t)0xC0290146L)
...
//
#define STATUS_TPM_20_E_NV_SIZE          ((int32_t)0xC0290147L)
...
//
#define STATUS_TPM_20_E_NV_LOCKED        ((int32_t)0xC0290148L)
...
//
#define STATUS_TPM_20_E_NV_AUTHORIZATION ((int32_t)0xC0290149L)
...
//
#define STATUS_TPM_20_E_NV_UNINITIALIZED ((int32_t)0xC029014AL)
...
//
#define STATUS_TPM_20_E_NV_SPACE         ((int32_t)0xC029014BL)
...
//
#define STATUS_TPM_20_E_NV_DEFINED       ((int32_t)0xC029014CL)
...
//
#define STATUS_TPM_20_E_BAD_CONTEXT      ((int32_t)0xC0290150L)
...
//
#define STATUS_TPM_20_E_CPHASH           ((int32_t)0xC0290151L)
...
//
#define STATUS_TPM_20_E_PARENT           ((int32_t)0xC0290152L)
...
//
#define STATUS_TPM_20_E_NEEDS_TEST       ((int32_t)0xC0290153L)
...
//
#define STATUS_TPM_20_E_NO_RESULT        ((int32_t)0xC0290154L)
...
//
#define STATUS_TPM_20_E_SENSITIVE        ((int32_t)0xC0290155L)
...
//
#define STATUS_TPM_COMMAND_BLOCKED       ((int32_t)0xC0290400L)
...
//
#define STATUS_TPM_INVALID_HANDLE        ((int32_t)0xC0290401L)
...
//
#define STATUS_TPM_DUPLICATE_VHANDLE     ((int32_t)0xC0290402L)
...
//
#define STATUS_TPM_EMBEDDED_COMMAND_BLOCKED ((int32_t)0xC0290403L)
...
//
#define STATUS_TPM_EMBEDDED_COMMAND_UNSUPPORTED ((int32_t)0xC0290404L)
...
//
#define STATUS_TPM_RETRY                 ((int32_t)0xC0290800L)
...
//
#define STATUS_TPM_NEEDS_SELFTEST        ((int32_t)0xC0290801L)
...
//
#define STATUS_TPM_DOING_SELFTEST        ((int32_t)0xC0290802L)
...
//
#define STATUS_TPM_DEFEND_LOCK_RUNNING   ((int32_t)0xC0290803L)
...
//
#define STATUS_TPM_COMMAND_CANCELED      ((int32_t)0xC0291001L)
...
//
#define STATUS_TPM_TOO_MANY_CONTEXTS     ((int32_t)0xC0291002L)
...
//
#define STATUS_TPM_NOT_FOUND             ((int32_t)0xC0291003L)
...
//
#define STATUS_TPM_ACCESS_DENIED         ((int32_t)0xC0291004L)
...
// The caller does not have the appropriate rights to perform the requested operation.
//
#define STATUS_TPM_INSUFFICIENT_BUFFER   ((int32_t)0xC0291005L)
...
//
#define STATUS_TPM_PPI_FUNCTION_UNSUPPORTED ((int32_t)0xC0291006L)
...
//
#define STATUS_PCP_ERROR_MASK            ((int32_t)0xC0292000L)
...
//
#define STATUS_PCP_DEVICE_NOT_READY      ((int32_t)0xC0292001L)
...
//
#define STATUS_PCP_INVALID_HANDLE        ((int32_t)0xC0292002L)
...
//
#define STATUS_PCP_INVALID_PARAMETER     ((int32_t)0xC0292003L)
...
//
#define STATUS_PCP_FLAG_NOT_SUPPORTED    ((int32_t)0xC0292004L)
...
//
#define STATUS_PCP_NOT_SUPPORTED         ((int32_t)0xC0292005L)
...
//
#define STATUS_PCP_BUFFER_TOO_SMALL      ((int32_t)0xC0292006L)
...
//
#define STATUS_PCP_INTERNAL_ERROR        ((int32_t)0xC0292007L)
...
//
#define STATUS_PCP_AUTHENTICATION_FAILED ((int32_t)0xC0292008L)
...
//
#define STATUS_PCP_AUTHENTICATION_IGNORED ((int32_t)0xC0292009L)
...
//
#define STATUS_PCP_POLICY_NOT_FOUND      ((int32_t)0xC029200AL)
...
//
#define STATUS_PCP_PROFILE_NOT_FOUND     ((int32_t)0xC029200BL)
...
//
#define STATUS_PCP_VALIDATION_FAILED     ((int32_t)0xC029200CL)
...
//
#define STATUS_PCP_DEVICE_NOT_FOUND      ((int32_t)0xC029200DL)
...
//
#define STATUS_PCP_WRONG_PARENT          ((int32_t)0xC029200EL)
...
//
#define STATUS_PCP_KEY_NOT_LOADED        ((int32_t)0xC029200FL)
...
//
#define STATUS_PCP_NO_KEY_CERTIFICATION  ((int32_t)0xC0292010L)
...
//
#define STATUS_PCP_KEY_NOT_FINALIZED     ((int32_t)0xC0292011L)
...
//
#define STATUS_PCP_ATTESTATION_CHALLENGE_NOT_SET ((int32_t)0xC0292012L)
...
//
#define STATUS_PCP_NOT_PCR_BOUND         ((int32_t)0xC0292013L)
...
//
#define STATUS_PCP_KEY_ALREADY_FINALIZED ((int32_t)0xC0292014L)
...
//
#define STATUS_PCP_KEY_USAGE_POLICY_NOT_SUPPORTED ((int32_t)0xC0292015L)
...
//
#define STATUS_PCP_KEY_USAGE_POLICY_INVALID ((int32_t)0xC0292016L)
...
//
#define STATUS_PCP_SOFT_KEY_ERROR        ((int32_t)0xC0292017L)
...
//
#define STATUS_PCP_KEY_NOT_AUTHENTICATED ((int32_t)0xC0292018L)
...
//
#define STATUS_PCP_KEY_NOT_AIK           ((int32_t)0xC0292019L)
...
//
#define STATUS_PCP_KEY_NOT_SIGNING_KEY   ((int32_t)0xC029201AL)
...
//
#define STATUS_PCP_LOCKED_OUT            ((int32_t)0xC029201BL)
...
//
#define STATUS_PCP_CLAIM_TYPE_NOT_SUPPORTED ((int32_t)0xC029201CL)
...
//
#define STATUS_PCP_TPM_VERSION_NOT_SUPPORTED ((int32_t)0xC029201DL)
...
//
#define STATUS_PCP_BUFFER_LENGTH_MISMATCH ((int32_t)0xC029201EL)
...
//
#define STATUS_PCP_IFX_RSA_KEY_CREATION_BLOCKED ((int32_t)0xC029201FL)
...
//
#define STATUS_PCP_TICKET_MISSING        ((int32_t)0xC0292020L)
...
//
#define STATUS_PCP_RAW_POLICY_NOT_SUPPORTED ((int32_t)0xC0292021L)
...
//
#define STATUS_PCP_KEY_HANDLE_INVALIDATED ((int32_t)0xC0292022L)
...
//
#define STATUS_PCP_UNSUPPORTED_PSS_SALT  ((int32_t)0x40292023L)
...
//
#define STATUS_RTPM_CONTEXT_CONTINUE     ((int32_t)0x00293000L)
...
//
#define STATUS_RTPM_CONTEXT_COMPLETE     ((int32_t)0x00293001L)
...
//
#define STATUS_RTPM_NO_RESULT            ((int32_t)0xC0293002L)
...
//
#define STATUS_RTPM_PCR_READ_INCOMPLETE  ((int32_t)0xC0293003L)
...
//
#define STATUS_RTPM_INVALID_CONTEXT      ((int32_t)0xC0293004L)
...
//
#define STATUS_RTPM_UNSUPPORTED_CMD      ((int32_t)0xC0293005L)
...
//
#define STATUS_TPM_ZERO_EXHAUST_ENABLED  ((int32_t)0xC0294000L)
...
//
#define STATUS_HV_INVALID_HYPERCALL_CODE ((int32_t)0xC0350002L)
...
//
#define STATUS_HV_INVALID_HYPERCALL_INPUT ((int32_t)0xC0350003L)
...
//
#define STATUS_HV_INVALID_ALIGNMENT      ((int32_t)0xC0350004L)
...
//
#define STATUS_HV_INVALID_PARAMETER      ((int32_t)0xC0350005L)
...
//
#define STATUS_HV_ACCESS_DENIED          ((int32_t)0xC0350006L)
...
//
#define STATUS_HV_INVALID_PARTITION_STATE ((int32_t)0xC0350007L)
...
//
#define STATUS_HV_OPERATION_DENIED       ((int32_t)0xC0350008L)
...
//
#define STATUS_HV_UNKNOWN_PROPERTY       ((int32_t)0xC0350009L)
...
//
#define STATUS_HV_PROPERTY_VALUE_OUT_OF_RANGE ((int32_t)0xC035000AL)
...
//
#define STATUS_HV_INSUFFICIENT_MEMORY    ((int32_t)0xC035000BL)
...
//
#define STATUS_HV_PARTITION_TOO_DEEP     ((int32_t)0xC035000CL)
...
//
#define STATUS_HV_INVALID_PARTITION_ID   ((int32_t)0xC035000DL)
...
//
#define STATUS_HV_INVALID_VP_INDEX       ((int32_t)0xC035000EL)
...
//
#define STATUS_HV_INVALID_PORT_ID        ((int32_t)0xC0350011L)
...
//
#define STATUS_HV_INVALID_CONNECTION_ID  ((int32_t)0xC0350012L)
...
//
#define STATUS_HV_INSUFFICIENT_BUFFERS   ((int32_t)0xC0350013L)
...
//
#define STATUS_HV_NOT_ACKNOWLEDGED       ((int32_t)0xC0350014L)
...
//
#define STATUS_HV_INVALID_VP_STATE       ((int32_t)0xC0350015L)
...
//
#define STATUS_HV_ACKNOWLEDGED           ((int32_t)0xC0350016L)
...
//
#define STATUS_HV_INVALID_SAVE_RESTORE_STATE ((int32_t)0xC0350017L)
...
//
#define STATUS_HV_INVALID_SYNIC_STATE    ((int32_t)0xC0350018L)
...
//
#define STATUS_HV_OBJECT_IN_USE          ((int32_t)0xC0350019L)
...
//
#define STATUS_HV_INVALID_PROXIMITY_DOMAIN_INFO ((int32_t)0xC035001AL)
...
//
#define STATUS_HV_NO_DATA                ((int32_t)0xC035001BL)
...
//
#define STATUS_HV_INACTIVE               ((int32_t)0xC035001CL)
...
//
#define STATUS_HV_NO_RESOURCES           ((int32_t)0xC035001DL)
...
//
#define STATUS_HV_FEATURE_UNAVAILABLE    ((int32_t)0xC035001EL)
...
//
#define STATUS_HV_INSUFFICIENT_BUFFER    ((int32_t)0xC0350033L)
...
//
#define STATUS_HV_INSUFFICIENT_DEVICE_DOMAINS ((int32_t)0xC0350038L)
...
//
#define STATUS_HV_CPUID_FEATURE_VALIDATION_ERROR ((int32_t)0xC035003CL)
...
//
#define STATUS_HV_CPUID_XSAVE_FEATURE_VALIDATION_ERROR ((int32_t)0xC035003DL)
...
//
#define STATUS_HV_PROCESSOR_STARTUP_TIMEOUT ((int32_t)0xC035003EL)
...
//
#define STATUS_HV_SMX_ENABLED            ((int32_t)0xC035003FL)
...
//
#define STATUS_HV_INVALID_LP_INDEX       ((int32_t)0xC0350041L)
...
//
#define STATUS_HV_INVALID_REGISTER_VALUE ((int32_t)0xC0350050L)
...
//
#define STATUS_HV_INVALID_VTL_STATE      ((int32_t)0xC0350051L)
...
//
#define STATUS_HV_NX_NOT_DETECTED        ((int32_t)0xC0350055L)
...
//
#define STATUS_HV_INVALID_DEVICE_ID      ((int32_t)0xC0350057L)
...
//
#define STATUS_HV_INVALID_DEVICE_STATE   ((int32_t)0xC0350058L)
...
//
#define STATUS_HV_PENDING_PAGE_REQUESTS  ((int32_t)0x00350059L)
...
//
#define STATUS_HV_PAGE_REQUEST_INVALID   ((int32_t)0xC0350060L)
...
//
#define STATUS_HV_INVALID_CPU_GROUP_ID   ((int32_t)0xC035006FL)
...
//
#define STATUS_HV_INVALID_CPU_GROUP_STATE ((int32_t)0xC0350070L)
...
//
#define STATUS_HV_OPERATION_FAILED       ((int32_t)0xC0350071L)
...
//
#define STATUS_HV_NOT_ALLOWED_WITH_NESTED_VIRT_ACTIVE ((int32_t)0xC0350072L)
...
//
#define STATUS_HV_INSUFFICIENT_ROOT_MEMORY ((int32_t)0xC0350073L)
...
//
#define STATUS_HV_EVENT_BUFFER_ALREADY_FREED ((int32_t)0xC0350074L)
...
//
#define STATUS_HV_INSUFFICIENT_CONTIGUOUS_MEMORY ((int32_t)0xC0350075L)
...
//
#define STATUS_HV_NOT_PRESENT            ((int32_t)0xC0351000L)
...
//
#define STATUS_VID_DUPLICATE_HANDLER     ((int32_t)0xC0370001L)
...
//
#define STATUS_VID_TOO_MANY_HANDLERS     ((int32_t)0xC0370002L)
...
//
#define STATUS_VID_QUEUE_FULL            ((int32_t)0xC0370003L)
...
//
#define STATUS_VID_HANDLER_NOT_PRESENT   ((int32_t)0xC0370004L)
...
//
#define STATUS_VID_INVALID_OBJECT_NAME   ((int32_t)0xC0370005L)
...
//
#define STATUS_VID_PARTITION_NAME_TOO_LONG ((int32_t)0xC0370006L)
...
//
#define STATUS_VID_MESSAGE_QUEUE_NAME_TOO_LONG ((int32_t)0xC0370007L)
...
//
#define STATUS_VID_PARTITION_ALREADY_EXISTS ((int32_t)0xC0370008L)
...
//
#define STATUS_VID_PARTITION_DOES_NOT_EXIST ((int32_t)0xC0370009L)
...
//
#define STATUS_VID_PARTITION_NAME_NOT_FOUND ((int32_t)0xC037000AL)
...
//
#define STATUS_VID_MESSAGE_QUEUE_ALREADY_EXISTS ((int32_t)0xC037000BL)
...
//
#define STATUS_VID_EXCEEDED_MBP_ENTRY_MAP_LIMIT ((int32_t)0xC037000CL)
...
//
#define STATUS_VID_MB_STILL_REFERENCED   ((int32_t)0xC037000DL)
...
//
#define STATUS_VID_CHILD_GPA_PAGE_SET_CORRUPTED ((int32_t)0xC037000EL)
...
//
#define STATUS_VID_INVALID_NUMA_SETTINGS ((int32_t)0xC037000FL)
...
//
#define STATUS_VID_INVALID_NUMA_NODE_INDEX ((int32_t)0xC0370010L)
...
//
#define STATUS_VID_NOTIFICATION_QUEUE_ALREADY_ASSOCIATED ((int32_t)0xC0370011L)
...
//
#define STATUS_VID_INVALID_MEMORY_BLOCK_HANDLE ((int32_t)0xC0370012L)
...
//
#define STATUS_VID_PAGE_RANGE_OVERFLOW   ((int32_t)0xC0370013L)
...
//
#define STATUS_VID_INVALID_MESSAGE_QUEUE_HANDLE ((int32_t)0xC0370014L)
...
//
#define STATUS_VID_INVALID_GPA_RANGE_HANDLE ((int32_t)0xC0370015L)
...
//
#define STATUS_VID_NO_MEMORY_BLOCK_NOTIFICATION_QUEUE ((int32_t)0xC0370016L)
...
// 
//
#define STATUS_VID_MEMORY_BLOCK_LOCK_COUNT_EXCEEDED ((int32_t)0xC0370017L)
...
//
#define STATUS_VID_INVALID_PPM_HANDLE    ((int32_t)0xC0370018L)
...
//
#define STATUS_VID_MBPS_ARE_LOCKED       ((int32_t)0xC0370019L)
...
//
#define STATUS_VID_MESSAGE_QUEUE_CLOSED  ((int32_t)0xC037001AL)
...
//
#define STATUS_VID_VIRTUAL_PROCESSOR_LIMIT_EXCEEDED ((int32_t)0xC037001BL)
...
//
#define STATUS_VID_STOP_PENDING          ((int32_t)0xC037001CL)
...
//
#define STATUS_VID_INVALID_PROCESSOR_STATE ((int32_t)0xC037001DL)
...
//
#define STATUS_VID_EXCEEDED_KM_CONTEXT_COUNT_LIMIT ((int32_t)0xC037001EL)
...
//
#define STATUS_VID_KM_INTERFACE_ALREADY_INITIALIZED ((int32_t)0xC037001FL)
...
//
#define STATUS_VID_MB_PROPERTY_ALREADY_SET_RESET ((int32_t)0xC0370020L)
...
//
#define STATUS_VID_MMIO_RANGE_DESTROYED  ((int32_t)0xC0370021L)
...
//
#define STATUS_VID_INVALID_CHILD_GPA_PAGE_SET ((int32_t)0xC0370022L)
...
//
#define STATUS_VID_RESERVE_PAGE_SET_IS_BEING_USED ((int32_t)0xC0370023L)
...
//
#define STATUS_VID_RESERVE_PAGE_SET_TOO_SMALL ((int32_t)0xC0370024L)
...
//
#define STATUS_VID_MBP_ALREADY_LOCKED_USING_RESERVED_PAGE ((int32_t)0xC0370025L)
...
//
#define STATUS_VID_MBP_COUNT_EXCEEDED_LIMIT ((int32_t)0xC0370026L)
...
//
#define STATUS_VID_SAVED_STATE_CORRUPT   ((int32_t)0xC0370027L)
...
//
#define STATUS_VID_SAVED_STATE_UNRECOGNIZED_ITEM ((int32_t)0xC0370028L)
...
//
#define STATUS_VID_SAVED_STATE_INCOMPATIBLE ((int32_t)0xC0370029L)
...
//
#define STATUS_VID_VTL_ACCESS_DENIED     ((int32_t)0xC037002AL)
...
//
#define STATUS_VID_REMOTE_NODE_PARENT_GPA_PAGES_USED ((int32_t)0x80370001L)
...
//
#define STATUS_IPSEC_BAD_SPI             ((int32_t)0xC0360001L)
...
//
#define STATUS_IPSEC_SA_LIFETIME_EXPIRED ((int32_t)0xC0360002L)
...
//
#define STATUS_IPSEC_WRONG_SA            ((int32_t)0xC0360003L)
...
//
#define STATUS_IPSEC_REPLAY_CHECK_FAILED ((int32_t)0xC0360004L)
...
//
#define STATUS_IPSEC_INVALID_PACKET      ((int32_t)0xC0360005L)
...
//
#define STATUS_IPSEC_INTEGRITY_CHECK_FAILED ((int32_t)0xC0360006L)
...
//
#define STATUS_IPSEC_CLEAR_TEXT_DROP     ((int32_t)0xC0360007L)
...
//
#define STATUS_IPSEC_AUTH_FIREWALL_DROP  ((int32_t)0xC0360008L)
...
//
#define STATUS_IPSEC_THROTTLE_DROP       ((int32_t)0xC0360009L)
...
//
#define STATUS_IPSEC_DOSP_BLOCK          ((int32_t)0xC0368000L)
...
//
#define STATUS_IPSEC_DOSP_RECEIVED_MULTICAST ((int32_t)0xC0368001L)
...
//
#define STATUS_IPSEC_DOSP_INVALID_PACKET ((int32_t)0xC0368002L)
...
//
#define STATUS_IPSEC_DOSP_STATE_LOOKUP_FAILED ((int32_t)0xC0368003L)
...
//
#define STATUS_IPSEC_DOSP_MAX_ENTRIES    ((int32_t)0xC0368004L)
...
//
#define STATUS_IPSEC_DOSP_KEYMOD_NOT_ALLOWED ((int32_t)0xC0368005L)
...
//
#define STATUS_IPSEC_DOSP_MAX_PER_IP_RATELIMIT_QUEUES ((int32_t)0xC0368006L)
...
//
#define STATUS_VOLMGR_INCOMPLETE_REGENERATION ((int32_t)0x80380001L)
...
//
#define STATUS_VOLMGR_INCOMPLETE_DISK_MIGRATION ((int32_t)0x80380002L)
...
//
#define STATUS_VOLMGR_DATABASE_FULL      ((int32_t)0xC0380001L)
...
//
#define STATUS_VOLMGR_DISK_CONFIGURATION_CORRUPTED ((int32_t)0xC0380002L)
...
//
#define STATUS_VOLMGR_DISK_CONFIGURATION_NOT_IN_SYNC ((int32_t)0xC0380003L)
...
//
#define STATUS_VOLMGR_PACK_CONFIG_UPDATE_FAILED ((int32_t)0xC0380004L)
...
//
#define STATUS_VOLMGR_DISK_CONTAINS_NON_SIMPLE_VOLUME ((int32_t)0xC0380005L)
...
//
#define STATUS_VOLMGR_DISK_DUPLICATE     ((int32_t)0xC0380006L)
...
//
#define STATUS_VOLMGR_DISK_DYNAMIC       ((int32_t)0xC0380007L)
...
//
#define STATUS_VOLMGR_DISK_ID_INVALID    ((int32_t)0xC0380008L)
...
//
#define STATUS_VOLMGR_DISK_INVALID       ((int32_t)0xC0380009L)
...
//
#define STATUS_VOLMGR_DISK_LAST_VOTER    ((int32_t)0xC038000AL)
...
//
#define STATUS_VOLMGR_DISK_LAYOUT_INVALID ((int32_t)0xC038000BL)
...
//
#define STATUS_VOLMGR_DISK_LAYOUT_NON_BASIC_BETWEEN_BASIC_PARTITIONS ((int32_t)0xC038000CL)
...
//
#define STATUS_VOLMGR_DISK_LAYOUT_NOT_CYLINDER_ALIGNED ((int32_t)0xC038000DL)
...
//
#define STATUS_VOLMGR_DISK_LAYOUT_PARTITIONS_TOO_SMALL ((int32_t)0xC038000EL)
...
//
#define STATUS_VOLMGR_DISK_LAYOUT_PRIMARY_BETWEEN_LOGICAL_PARTITIONS ((int32_t)0xC038000FL)
...
//
#define STATUS_VOLMGR_DISK_LAYOUT_TOO_MANY_PARTITIONS ((int32_t)0xC0380010L)
...
//
#define STATUS_VOLMGR_DISK_MISSING       ((int32_t)0xC0380011L)
...
//
#define STATUS_VOLMGR_DISK_NOT_EMPTY     ((int32_t)0xC0380012L)
...
//
#define STATUS_VOLMGR_DISK_NOT_ENOUGH_SPACE ((int32_t)0xC0380013L)
...
//
#define STATUS_VOLMGR_DISK_REVECTORING_FAILED ((int32_t)0xC0380014L)
...
//
#define STATUS_VOLMGR_DISK_SECTOR_SIZE_INVALID ((int32_t)0xC0380015L)
...
//
#define STATUS_VOLMGR_DISK_SET_NOT_CONTAINED ((int32_t)0xC0380016L)
...
//
#define STATUS_VOLMGR_DISK_USED_BY_MULTIPLE_MEMBERS ((int32_t)0xC0380017L)
...
//
#define STATUS_VOLMGR_DISK_USED_BY_MULTIPLE_PLEXES ((int32_t)0xC0380018L)
...
//
#define STATUS_VOLMGR_DYNAMIC_DISK_NOT_SUPPORTED ((int32_t)0xC0380019L)
...
//
#define STATUS_VOLMGR_EXTENT_ALREADY_USED ((int32_t)0xC038001AL)
...
//
#define STATUS_VOLMGR_EXTENT_NOT_CONTIGUOUS ((int32_t)0xC038001BL)
...
//
#define STATUS_VOLMGR_EXTENT_NOT_IN_PUBLIC_REGION ((int32_t)0xC038001CL)
...
//
#define STATUS_VOLMGR_EXTENT_NOT_SECTOR_ALIGNED ((int32_t)0xC038001DL)
...
//
#define STATUS_VOLMGR_EXTENT_OVERLAPS_EBR_PARTITION ((int32_t)0xC038001EL)
...
//
#define STATUS_VOLMGR_EXTENT_VOLUME_LENGTHS_DO_NOT_MATCH ((int32_t)0xC038001FL)
...
//
#define STATUS_VOLMGR_FAULT_TOLERANT_NOT_SUPPORTED ((int32_t)0xC0380020L)
...
//
#define STATUS_VOLMGR_INTERLEAVE_LENGTH_INVALID ((int32_t)0xC0380021L)
...
//
#define STATUS_VOLMGR_MAXIMUM_REGISTERED_USERS ((int32_t)0xC0380022L)
...
//
#define STATUS_VOLMGR_MEMBER_IN_SYNC     ((int32_t)0xC0380023L)
...
//
#define STATUS_VOLMGR_MEMBER_INDEX_DUPLICATE ((int32_t)0xC0380024L)
...
//
#define STATUS_VOLMGR_MEMBER_INDEX_INVALID ((int32_t)0xC0380025L)
...
//
#define STATUS_VOLMGR_MEMBER_MISSING     ((int32_t)0xC0380026L)
...
//
#define STATUS_VOLMGR_MEMBER_NOT_DETACHED ((int32_t)0xC0380027L)
...
//
#define STATUS_VOLMGR_MEMBER_REGENERATING ((int32_t)0xC0380028L)
...
//
#define STATUS_VOLMGR_ALL_DISKS_FAILED   ((int32_t)0xC0380029L)
...
//
#define STATUS_VOLMGR_NO_REGISTERED_USERS ((int32_t)0xC038002AL)
...
//
#define STATUS_VOLMGR_NO_SUCH_USER       ((int32_t)0xC038002BL)
...
//
#define STATUS_VOLMGR_NOTIFICATION_RESET ((int32_t)0xC038002CL)
...
//
#define STATUS_VOLMGR_NUMBER_OF_MEMBERS_INVALID ((int32_t)0xC038002DL)
...
//
#define STATUS_VOLMGR_NUMBER_OF_PLEXES_INVALID ((int32_t)0xC038002EL)
...
//
#define STATUS_VOLMGR_PACK_DUPLICATE     ((int32_t)0xC038002FL)
...
//
#define STATUS_VOLMGR_PACK_ID_INVALID    ((int32_t)0xC0380030L)
...
//
#define STATUS_VOLMGR_PACK_INVALID       ((int32_t)0xC0380031L)
...
//
#define STATUS_VOLMGR_PACK_NAME_INVALID  ((int32_t)0xC0380032L)
...
//
#define STATUS_VOLMGR_PACK_OFFLINE       ((int32_t)0xC0380033L)
...
//
#define STATUS_VOLMGR_PACK_HAS_QUORUM    ((int32_t)0xC0380034L)
...
//
#define STATUS_VOLMGR_PACK_WITHOUT_QUORUM ((int32_t)0xC0380035L)
...
//
#define STATUS_VOLMGR_PARTITION_STYLE_INVALID ((int32_t)0xC0380036L)
...
//
#define STATUS_VOLMGR_PARTITION_UPDATE_FAILED ((int32_t)0xC0380037L)
...
//
#define STATUS_VOLMGR_PLEX_IN_SYNC       ((int32_t)0xC0380038L)
...
//
#define STATUS_VOLMGR_PLEX_INDEX_DUPLICATE ((int32_t)0xC0380039L)
...
//
#define STATUS_VOLMGR_PLEX_INDEX_INVALID ((int32_t)0xC038003AL)
...
//
#define STATUS_VOLMGR_PLEX_LAST_ACTIVE   ((int32_t)0xC038003BL)
...
//
#define STATUS_VOLMGR_PLEX_MISSING       ((int32_t)0xC038003CL)
...
//
#define STATUS_VOLMGR_PLEX_REGENERATING  ((int32_t)0xC038003DL)
...
//
#define STATUS_VOLMGR_PLEX_TYPE_INVALID  ((int32_t)0xC038003EL)
...
//
#define STATUS_VOLMGR_PLEX_NOT_RAID5     ((int32_t)0xC038003FL)
...
//
#define STATUS_VOLMGR_PLEX_NOT_SIMPLE    ((int32_t)0xC0380040L)
...
//
#define STATUS_VOLMGR_STRUCTURE_SIZE_INVALID ((int32_t)0xC0380041L)
...
//
#define STATUS_VOLMGR_TOO_MANY_NOTIFICATION_REQUESTS ((int32_t)0xC0380042L)
...
//
#define STATUS_VOLMGR_TRANSACTION_IN_PROGRESS ((int32_t)0xC0380043L)
...
//
#define STATUS_VOLMGR_UNEXPECTED_DISK_LAYOUT_CHANGE ((int32_t)0xC0380044L)
...
//
#define STATUS_VOLMGR_VOLUME_CONTAINS_MISSING_DISK ((int32_t)0xC0380045L)
...
//
#define STATUS_VOLMGR_VOLUME_ID_INVALID  ((int32_t)0xC0380046L)
...
//
#define STATUS_VOLMGR_VOLUME_LENGTH_INVALID ((int32_t)0xC0380047L)
...
//
#define STATUS_VOLMGR_VOLUME_LENGTH_NOT_SECTOR_SIZE_MULTIPLE ((int32_t)0xC0380048L)
...
//
#define STATUS_VOLMGR_VOLUME_NOT_MIRRORED ((int32_t)0xC0380049L)
...
//
#define STATUS_VOLMGR_VOLUME_NOT_RETAINED ((int32_t)0xC038004AL)
...
//
#define STATUS_VOLMGR_VOLUME_OFFLINE     ((int32_t)0xC038004BL)
...
//
#define STATUS_VOLMGR_VOLUME_RETAINED    ((int32_t)0xC038004CL)
...
//
#define STATUS_VOLMGR_NUMBER_OF_EXTENTS_INVALID ((int32_t)0xC038004DL)
...
//
#define STATUS_VOLMGR_DIFFERENT_SECTOR_SIZE ((int32_t)0xC038004EL)
...
//
#define STATUS_VOLMGR_BAD_BOOT_DISK      ((int32_t)0xC038004FL)
...
//
#define STATUS_VOLMGR_PACK_CONFIG_OFFLINE ((int32_t)0xC0380050L)
...
//
#define STATUS_VOLMGR_PACK_CONFIG_ONLINE ((int32_t)0xC0380051L)
...
//
#define STATUS_VOLMGR_NOT_PRIMARY_PACK   ((int32_t)0xC0380052L)
...
//
#define STATUS_VOLMGR_PACK_LOG_UPDATE_FAILED ((int32_t)0xC0380053L)
...
//
#define STATUS_VOLMGR_NUMBER_OF_DISKS_IN_PLEX_INVALID ((int32_t)0xC0380054L)
...
//
#define STATUS_VOLMGR_NUMBER_OF_DISKS_IN_MEMBER_INVALID ((int32_t)0xC0380055L)
...
//
#define STATUS_VOLMGR_VOLUME_MIRRORED    ((int32_t)0xC0380056L)
...
//
#define STATUS_VOLMGR_PLEX_NOT_SIMPLE_SPANNED ((int32_t)0xC0380057L)
...
//
#define STATUS_VOLMGR_NO_VALID_LOG_COPIES ((int32_t)0xC0380058L)
...
//
#define STATUS_VOLMGR_PRIMARY_PACK_PRESENT ((int32_t)0xC0380059L)
...
//
#define STATUS_VOLMGR_NUMBER_OF_DISKS_INVALID ((int32_t)0xC038005AL)
...
//
#define STATUS_VOLMGR_MIRROR_NOT_SUPPORTED ((int32_t)0xC038005BL)
...
//
#define STATUS_VOLMGR_RAID5_NOT_SUPPORTED ((int32_t)0xC038005CL)
...
//
#define STATUS_BCD_NOT_ALL_ENTRIES_IMPORTED ((int32_t)0x80390001L)
...
//
#define STATUS_BCD_TOO_MANY_ELEMENTS     ((int32_t)0xC0390002L)
...
//
#define STATUS_BCD_NOT_ALL_ENTRIES_SYNCHRONIZED ((int32_t)0x80390003L)
...
//
#define STATUS_VHD_DRIVE_FOOTER_MISSING  ((int32_t)0xC03A0001L)
...
//
#define STATUS_VHD_DRIVE_FOOTER_CHECKSUM_MISMATCH ((int32_t)0xC03A0002L)
...
//
#define STATUS_VHD_DRIVE_FOOTER_CORRUPT  ((int32_t)0xC03A0003L)
...
//
#define STATUS_VHD_FORMAT_UNKNOWN        ((int32_t)0xC03A0004L)
...
//
#define STATUS_VHD_FORMAT_UNSUPPORTED_VERSION ((int32_t)0xC03A0005L)
...
//
#define STATUS_VHD_SPARSE_HEADER_CHECKSUM_MISMATCH ((int32_t)0xC03A0006L)
...
//
#define STATUS_VHD_SPARSE_HEADER_UNSUPPORTED_VERSION ((int32_t)0xC03A0007L)
...
//
#define STATUS_VHD_SPARSE_HEADER_CORRUPT ((int32_t)0xC03A0008L)
...
//
#define STATUS_VHD_BLOCK_ALLOCATION_FAILURE ((int32_t)0xC03A0009L)
...
//
#define STATUS_VHD_BLOCK_ALLOCATION_TABLE_CORRUPT ((int32_t)0xC03A000AL)
...
//
#define STATUS_VHD_INVALID_BLOCK_SIZE    ((int32_t)0xC03A000BL)
...
//
#define STATUS_VHD_BITMAP_MISMATCH       ((int32_t)0xC03A000CL)
...
//
#define STATUS_VHD_PARENT_VHD_NOT_FOUND  ((int32_t)0xC03A000DL)
...
//
#define STATUS_VHD_CHILD_PARENT_ID_MISMATCH ((int32_t)0xC03A000EL)
...
//
#define STATUS_VHD_CHILD_PARENT_TIMESTAMP_MISMATCH ((int32_t)0xC03A000FL)
...
//
#define STATUS_VHD_METADATA_READ_FAILURE ((int32_t)0xC03A0010L)
...
//
#define STATUS_VHD_METADATA_WRITE_FAILURE ((int32_t)0xC03A0011L)
...
//
#define STATUS_VHD_INVALID_SIZE          ((int32_t)0xC03A0012L)
...
//
#define STATUS_VHD_INVALID_FILE_SIZE     ((int32_t)0xC03A0013L)
...
//
#define STATUS_VIRTDISK_PROVIDER_NOT_FOUND ((int32_t)0xC03A0014L)
...
//
#define STATUS_VIRTDISK_NOT_VIRTUAL_DISK ((int32_t)0xC03A0015L)
...
//
#define STATUS_VHD_PARENT_VHD_ACCESS_DENIED ((int32_t)0xC03A0016L)
...
//
#define STATUS_VHD_CHILD_PARENT_SIZE_MISMATCH ((int32_t)0xC03A0017L)
...
//
#define STATUS_VHD_DIFFERENCING_CHAIN_CYCLE_DETECTED ((int32_t)0xC03A0018L)
...
//
#define STATUS_VHD_DIFFERENCING_CHAIN_ERROR_IN_PARENT ((int32_t)0xC03A0019L)
...
//
#define STATUS_VIRTUAL_DISK_LIMITATION   ((int32_t)0xC03A001AL)
...
//
#define STATUS_VHD_INVALID_TYPE          ((int32_t)0xC03A001BL)
...
//
#define STATUS_VHD_INVALID_STATE         ((int32_t)0xC03A001CL)
...
//
#define STATUS_VIRTDISK_UNSUPPORTED_DISK_SECTOR_SIZE ((int32_t)0xC03A001DL)
...
//
#define STATUS_VIRTDISK_DISK_ALREADY_OWNED ((int32_t)0xC03A001EL)
...
//
#define STATUS_VIRTDISK_DISK_ONLINE_AND_WRITABLE ((int32_t)0xC03A001FL)
...
//
#define STATUS_CTLOG_TRACKING_NOT_INITIALIZED ((int32_t)0xC03A0020L)
...
//
#define STATUS_CTLOG_LOGFILE_SIZE_EXCEEDED_MAXSIZE ((int32_t)0xC03A0021L)
...
//
#define STATUS_CTLOG_VHD_CHANGED_OFFLINE ((int32_t)0xC03A0022L)
...
//
#define STATUS_CTLOG_INVALID_TRACKING_STATE ((int32_t)0xC03A0023L)
...
//
#define STATUS_CTLOG_INCONSISTENT_TRACKING_FILE ((int32_t)0xC03A0024L)
...
//
#define STATUS_VHD_METADATA_FULL         ((int32_t)0xC03A0028L)
...
//
#define STATUS_VHD_INVALID_CHANGE_TRACKING_ID ((int32_t)0xC03A0029L)
...
//
#define STATUS_VHD_CHANGE_TRACKING_DISABLED ((int32_t)0xC03A002AL)
...
//
#define STATUS_VHD_MISSING_CHANGE_TRACKING_INFORMATION ((int32_t)0xC03A0030L)
...
//
#define STATUS_VHD_RESIZE_WOULD_TRUNCATE_DATA ((int32_t)0xC03A0031L)
...
//
#define STATUS_VHD_COULD_NOT_COMPUTE_MINIMUM_VIRTUAL_SIZE ((int32_t)0xC03A0032L)
...
//
#define STATUS_VHD_ALREADY_AT_OR_BELOW_MINIMUM_VIRTUAL_SIZE ((int32_t)0xC03A0033L)
...
//
#define STATUS_QUERY_STORAGE_ERROR       ((int32_t)0x803A0001L)
...
//
#define STATUS_GDI_HANDLE_LEAK           ((int32_t)0x803F0001L)
...
//
#define STATUS_RKF_KEY_NOT_FOUND         ((int32_t)0xC0400001L)
...
//
#define STATUS_RKF_DUPLICATE_KEY         ((int32_t)0xC0400002L)
...
//
#define STATUS_RKF_BLOB_FULL             ((int32_t)0xC0400003L)
...
//
#define STATUS_RKF_STORE_FULL            ((int32_t)0xC0400004L)
...
//
#define STATUS_RKF_FILE_BLOCKED          ((int32_t)0xC0400005L)
...
//
#define STATUS_RKF_ACTIVE_KEY            ((int32_t)0xC0400006L)
...
//
#define STATUS_RDBSS_RESTART_OPERATION   ((int32_t)0xC0410001L)
...
//
#define STATUS_RDBSS_CONTINUE_OPERATION  ((int32_t)0xC0410002L)
...
//
#define STATUS_RDBSS_POST_OPERATION      ((int32_t)0xC0410003L)
...
//
#define STATUS_RDBSS_RETRY_LOOKUP        ((int32_t)0xC0410004L)
...
//
#define STATUS_BTH_ATT_INVALID_HANDLE    ((int32_t)0xC0420001L)
...
//
#define STATUS_BTH_ATT_READ_NOT_PERMITTED ((int32_t)0xC0420002L)
...
//
#define STATUS_BTH_ATT_WRITE_NOT_PERMITTED ((int32_t)0xC0420003L)
...
//
#define STATUS_BTH_ATT_INVALID_PDU       ((int32_t)0xC0420004L)
...
//
#define STATUS_BTH_ATT_INSUFFICIENT_AUTHENTICATION ((int32_t)0xC0420005L)
...
//
#define STATUS_BTH_ATT_REQUEST_NOT_SUPPORTED ((int32_t)0xC0420006L)
...
//
#define STATUS_BTH_ATT_INVALID_OFFSET    ((int32_t)0xC0420007L)
...
//
#define STATUS_BTH_ATT_INSUFFICIENT_AUTHORIZATION ((int32_t)0xC0420008L)
...
//
#define STATUS_BTH_ATT_PREPARE_QUEUE_FULL ((int32_t)0xC0420009L)
...
//
#define STATUS_BTH_ATT_ATTRIBUTE_NOT_FOUND ((int32_t)0xC042000AL)
...
//
#define STATUS_BTH_ATT_ATTRIBUTE_NOT_LONG ((int32_t)0xC042000BL)
...
//
#define STATUS_BTH_ATT_INSUFFICIENT_ENCRYPTION_KEY_SIZE ((int32_t)0xC042000CL)
...
//
#define STATUS_BTH_ATT_INVALID_ATTRIBUTE_VALUE_LENGTH ((int32_t)0xC042000DL)
...
//
#define STATUS_BTH_ATT_UNLIKELY          ((int32_t)0xC042000EL)
...
//
#define STATUS_BTH_ATT_INSUFFICIENT_ENCRYPTION ((int32_t)0xC042000FL)
...
//
#define STATUS_BTH_ATT_UNSUPPORTED_GROUP_TYPE ((int32_t)0xC0420010L)
...
//
#define STATUS_BTH_ATT_INSUFFICIENT_RESOURCES ((int32_t)0xC0420011L)
...
//
#define STATUS_BTH_ATT_UNKNOWN_ERROR     ((int32_t)0xC0421000L)
...
//
#define STATUS_SECUREBOOT_ROLLBACK_DETECTED ((int32_t)0xC0430001L)
...
//
#define STATUS_SECUREBOOT_POLICY_VIOLATION ((int32_t)0xC0430002L)
...
//
#define STATUS_SECUREBOOT_INVALID_POLICY ((int32_t)0xC0430003L)
...
//
#define STATUS_SECUREBOOT_POLICY_PUBLISHER_NOT_FOUND ((int32_t)0xC0430004L)
...
//
#define STATUS_SECUREBOOT_POLICY_NOT_SIGNED ((int32_t)0xC0430005L)
...
//
#define STATUS_SECUREBOOT_NOT_ENABLED    ((int32_t)0x80430006L)
...
//
#define STATUS_SECUREBOOT_FILE_REPLACED  ((int32_t)0xC0430007L)
...
//
#define STATUS_SECUREBOOT_POLICY_NOT_AUTHORIZED ((int32_t)0xC0430008L)
...
//
#define STATUS_SECUREBOOT_POLICY_UNKNOWN ((int32_t)0xC0430009L)
...
//
#define STATUS_SECUREBOOT_POLICY_MISSING_ANTIROLLBACKVERSION ((int32_t)0xC043000AL)
...
//
#define STATUS_SECUREBOOT_PLATFORM_ID_MISMATCH ((int32_t)0xC043000BL)
...
//
#define STATUS_SECUREBOOT_POLICY_ROLLBACK_DETECTED ((int32_t)0xC043000CL)
...
//
#define STATUS_SECUREBOOT_POLICY_UPGRADE_MISMATCH ((int32_t)0xC043000DL)
...
//
#define STATUS_SECUREBOOT_REQUIRED_POLICY_FILE_MISSING ((int32_t)0xC043000EL)
...
//
#define STATUS_SECUREBOOT_NOT_BASE_POLICY ((int32_t)0xC043000FL)
...
//
#define STATUS_SECUREBOOT_NOT_SUPPLEMENTAL_POLICY ((int32_t)0xC0430010L)
...
//
#define STATUS_PLATFORM_MANIFEST_NOT_AUTHORIZED ((int32_t)0xC0EB0001L)
...
//
#define STATUS_PLATFORM_MANIFEST_INVALID ((int32_t)0xC0EB0002L)
...
//
#define STATUS_PLATFORM_MANIFEST_FILE_NOT_AUTHORIZED ((int32_t)0xC0EB0003L)
...
//
#define STATUS_PLATFORM_MANIFEST_CATALOG_NOT_AUTHORIZED ((int32_t)0xC0EB0004L)
...
//
#define STATUS_PLATFORM_MANIFEST_BINARY_ID_NOT_FOUND ((int32_t)0xC0EB0005L)
...
//
#define STATUS_PLATFORM_MANIFEST_NOT_ACTIVE ((int32_t)0xC0EB0006L)
...
//
#define STATUS_PLATFORM_MANIFEST_NOT_SIGNED ((int32_t)0xC0EB0007L)
...
//
#define STATUS_SYSTEM_INTEGRITY_ROLLBACK_DETECTED ((int32_t)0xC0E90001L)
...
//
#define STATUS_SYSTEM_INTEGRITY_POLICY_VIOLATION ((int32_t)0xC0E90002L)
...
//
#define STATUS_SYSTEM_INTEGRITY_INVALID_POLICY ((int32_t)0xC0E90003L)
...
//
#define STATUS_SYSTEM_INTEGRITY_POLICY_NOT_SIGNED ((int32_t)0xC0E90004L)
...
//
#define STATUS_SYSTEM_INTEGRITY_TOO_MANY_POLICIES ((int32_t)0xC0E90005L)
...
//
#define STATUS_SYSTEM_INTEGRITY_SUPPLEMENTAL_POLICY_NOT_AUTHORIZED ((int32_t)0xC0E90006L)
...
//
#define STATUS_NO_APPLICABLE_APP_LICENSES_FOUND ((int32_t)0xC0EA0001L)
...
//
#define STATUS_CLIP_LICENSE_NOT_FOUND    ((int32_t)0xC0EA0002L)
...
//
#define STATUS_CLIP_DEVICE_LICENSE_MISSING ((int32_t)0xC0EA0003L)
...
//
#define STATUS_CLIP_LICENSE_INVALID_SIGNATURE ((int32_t)0xC0EA0004L)
...
//
#define STATUS_CLIP_KEYHOLDER_LICENSE_MISSING_OR_INVALID ((int32_t)0xC0EA0005L)
...
//
#define STATUS_CLIP_LICENSE_EXPIRED      ((int32_t)0xC0EA0006L)
...
//
#define STATUS_CLIP_LICENSE_SIGNED_BY_UNKNOWN_SOURCE ((int32_t)0xC0EA0007L)
...
//
#define STATUS_CLIP_LICENSE_NOT_SIGNED   ((int32_t)0xC0EA0008L)
...
//
#define STATUS_CLIP_LICENSE_HARDWARE_ID_OUT_OF_TOLERANCE ((int32_t)0xC0EA0009L)
...
//
#define STATUS_CLIP_LICENSE_DEVICE_ID_MISMATCH ((int32_t)0xC0EA000AL)
...
//
#define STATUS_AUDIO_ENGINE_NODE_NOT_FOUND ((int32_t)0xC0440001L)
...
//
#define STATUS_HDAUDIO_EMPTY_CONNECTION_LIST ((int32_t)0xC0440002L)
...
//
#define STATUS_HDAUDIO_CONNECTION_LIST_NOT_SUPPORTED ((int32_t)0xC0440003L)
...
//
#define STATUS_HDAUDIO_NO_LOGICAL_DEVICES_CREATED ((int32_t)0xC0440004L)
...
//
#define STATUS_HDAUDIO_NULL_LINKED_LIST_ENTRY ((int32_t)0xC0440005L)
...
//
#define STATUS_SPACES_REPAIRED           ((int32_t)0x00E70000L)
...
//
#define STATUS_SPACES_PAUSE              ((int32_t)0x00E70001L)
...
//
#define STATUS_SPACES_COMPLETE           ((int32_t)0x00E70002L)
...
//
#define STATUS_SPACES_REDIRECT           ((int32_t)0x00E70003L)
...
//
#define STATUS_SPACES_FAULT_DOMAIN_TYPE_INVALID ((int32_t)0xC0E70001L)
...
//
#define STATUS_SPACES_RESILIENCY_TYPE_INVALID ((int32_t)0xC0E70003L)
...
//
#define STATUS_SPACES_DRIVE_SECTOR_SIZE_INVALID ((int32_t)0xC0E70004L)
...
//
#define STATUS_SPACES_DRIVE_REDUNDANCY_INVALID ((int32_t)0xC0E70006L)
...
//
#define STATUS_SPACES_NUMBER_OF_DATA_COPIES_INVALID ((int32_t)0xC0E70007L)
...
//
#define STATUS_SPACES_INTERLEAVE_LENGTH_INVALID ((int32_t)0xC0E70009L)
...
//
#define STATUS_SPACES_NUMBER_OF_COLUMNS_INVALID ((int32_t)0xC0E7000AL)
...
//
#define STATUS_SPACES_NOT_ENOUGH_DRIVES  ((int32_t)0xC0E7000BL)
...
//
#define STATUS_SPACES_EXTENDED_ERROR     ((int32_t)0xC0E7000CL)
...
//
#define STATUS_SPACES_PROVISIONING_TYPE_INVALID ((int32_t)0xC0E7000DL)
...
//
#define STATUS_SPACES_ALLOCATION_SIZE_INVALID ((int32_t)0xC0E7000EL)
...
//
#define STATUS_SPACES_ENCLOSURE_AWARE_INVALID ((int32_t)0xC0E7000FL)
...
//
#define STATUS_SPACES_WRITE_CACHE_SIZE_INVALID ((int32_t)0xC0E70010L)
...
//
#define STATUS_SPACES_NUMBER_OF_GROUPS_INVALID ((int32_t)0xC0E70011L)
...
//
#define STATUS_SPACES_DRIVE_OPERATIONAL_STATE_INVALID ((int32_t)0xC0E70012L)
...
//
#define STATUS_SPACES_UPDATE_COLUMN_STATE ((int32_t)0xC0E70013L)
...
//
#define STATUS_SPACES_MAP_REQUIRED       ((int32_t)0xC0E70014L)
...
//
#define STATUS_SPACES_UNSUPPORTED_VERSION ((int32_t)0xC0E70015L)
...
//
#define STATUS_SPACES_CORRUPT_METADATA   ((int32_t)0xC0E70016L)
...
// The DRT is full.
//
#define STATUS_SPACES_DRT_FULL           ((int32_t)0xC0E70017L)
...
//
#define STATUS_SPACES_INCONSISTENCY      ((int32_t)0xC0E70018L)
...
//
#define STATUS_SPACES_LOG_NOT_READY      ((int32_t)0xC0E70019L)
...
//
#define STATUS_SPACES_NO_REDUNDANCY      ((int32_t)0xC0E7001AL)
...
//
#define STATUS_SPACES_DRIVE_NOT_READY    ((int32_t)0xC0E7001BL)
...
//
#define STATUS_SPACES_DRIVE_SPLIT        ((int32_t)0xC0E7001CL)
...
//
#define STATUS_SPACES_DRIVE_LOST_DATA    ((int32_t)0xC0E7001DL)
...
//
#define STATUS_SPACES_ENTRY_INCOMPLETE   ((int32_t)0xC0E7001EL)
...
//
#define STATUS_SPACES_ENTRY_INVALID      ((int32_t)0xC0E7001FL)
...
//
#define STATUS_SPACES_MARK_DIRTY         ((int32_t)0xC0E70020L)
...
//
#define STATUS_VOLSNAP_BOOTFILE_NOT_VALID ((int32_t)0xC0500003L)
...
//
#define STATUS_VOLSNAP_ACTIVATION_TIMEOUT ((int32_t)0xC0500004L)
...
//
#define STATUS_IO_PREEMPTED              ((int32_t)0xC0510001L)
...
//
#define STATUS_SVHDX_ERROR_STORED        ((int32_t)0xC05C0000L)
...
//
#define STATUS_SVHDX_ERROR_NOT_AVAILABLE ((int32_t)0xC05CFF00L)
...
//
#define STATUS_SVHDX_UNIT_ATTENTION_AVAILABLE ((int32_t)0xC05CFF01L)
...
//
#define STATUS_SVHDX_UNIT_ATTENTION_CAPACITY_DATA_CHANGED ((int32_t)0xC05CFF02L)
...
//
#define STATUS_SVHDX_UNIT_ATTENTION_RESERVATIONS_PREEMPTED ((int32_t)0xC05CFF03L)
...
//
#define STATUS_SVHDX_UNIT_ATTENTION_RESERVATIONS_RELEASED ((int32_t)0xC05CFF04L)
...
//
#define STATUS_SVHDX_UNIT_ATTENTION_REGISTRATIONS_PREEMPTED ((int32_t)0xC05CFF05L)
...
//
#define STATUS_SVHDX_UNIT_ATTENTION_OPERATING_DEFINITION_CHANGED ((int32_t)0xC05CFF06L)
...
//
#define STATUS_SVHDX_RESERVATION_CONFLICT ((int32_t)0xC05CFF07L)
...
//
#define STATUS_SVHDX_WRONG_FILE_TYPE     ((int32_t)0xC05CFF08L)
...
//
#define STATUS_SVHDX_VERSION_MISMATCH    ((int32_t)0xC05CFF09L)
...
//
#define STATUS_VHD_SHARED                ((int32_t)0xC05CFF0AL)
...
//
#define STATUS_SVHDX_NO_INITIATOR        ((int32_t)0xC05CFF0BL)
...
//
#define STATUS_VHDSET_BACKING_STORAGE_NOT_FOUND ((int32_t)0xC05CFF0CL)
...
//
#define STATUS_SMB_NO_PREAUTH_INTEGRITY_HASH_OVERLAP ((int32_t)0xC05D0000L)
...
//
#define STATUS_SMB_BAD_CLUSTER_DIALECT   ((int32_t)0xC05D0001L)
...
//
#define STATUS_SMB_GUEST_LOGON_BLOCKED   ((int32_t)0xC05D0002L)
...
//
#define STATUS_SECCORE_INVALID_COMMAND   ((int32_t)0xC0E80000L)
...
//
#define STATUS_VSM_NOT_INITIALIZED       ((int32_t)0xC0450000L)
...
//
#define STATUS_VSM_DMA_PROTECTION_NOT_IN_USE ((int32_t)0xC0450001L)
...
//
#define STATUS_APPEXEC_CONDITION_NOT_SATISFIED ((int32_t)0xC0EC0000L)
...
//
#define STATUS_APPEXEC_HANDLE_INVALIDATED ((int32_t)0xC0EC0001L)
...
//
#define STATUS_APPEXEC_INVALID_HOST_GENERATION ((int32_t)0xC0EC0002L)
...
//
#define STATUS_APPEXEC_UNEXPECTED_PROCESS_REGISTRATION ((int32_t)0xC0EC0003L)
...
//
#define STATUS_APPEXEC_INVALID_HOST_STATE ((int32_t)0xC0EC0004L)
...
//
#define STATUS_APPEXEC_NO_DONOR          ((int32_t)0xC0EC0005L)
...
//
#define STATUS_APPEXEC_HOST_ID_MISMATCH  ((int32_t)0xC0EC0006L)
...
//
#define STATUS_APPEXEC_UNKNOWN_USER      ((int32_t)0xC0EC0007L)
...
//
#define STATUS_QUIC_HANDSHAKE_FAILURE    ((int32_t)0xC0240000L)
...
//
#define STATUS_QUIC_VER_NEG_FAILURE      ((int32_t)0xC0240001L)
...
#define CODEINTEGRITY_OPTION_ENABLED                        0x1     // g_CiOptions & 2  &&  no debugger
#define CODEINTEGRITY_OPTION_TESTSIGN                       0x2     // g_CiOptions & 8
...
#define CODEINTEGRITY_OPTION_DEBUGMODE_ENABLED              0x80    // KdSettings
#define CODEINTEGRITY_OPTION_FLIGHT_BUILD                   0x100   // ??????
#define CODEINTEGRITY_OPTION_FLIGHTING_ENABLED              0x200   // ??????
#define CODEINTEGRITY_OPTION_HVCI_KMCI_ENABLED              0x400   // g_CiOptions & 0x800
#define CODEINTEGRITY_OPTION_HVCI_KMCI_AUDITMODE_ENABLED    0x800   // g_DevMode & 0x100
#define CODEINTEGRITY_OPTION_HVCI_KMCI_STRICTMODE_ENABLED   0x1000  // g_CiOptions & 0x10000
#define CODEINTEGRITY_OPTION_HVCI_IUM_ENABLED               0x2000  // g_CiOptions & 0x4000
#define CODEINTEGRITY_OPTION_TESTSIGN_DISABLED              0x4000  // !( g_CiOptions & 4 )
#define CODEINTEGRITY_OPTION_WHQL_ENFORCEMENT_ENABLED       0x8000  // !( g_CiOptions & 8 ) && CipWhqlEnforcementEnabled
#define CODEINTEGRITY_OPTION_FLAG_200000                    0x10000 // ( g_CiOptions & 0x200000 )

#define LDRP_STATIC_LINK                        0x00000002 // Not confirmed
#define LDRP_IMAGE_DLL                          0x00000004 // Not confirmed
#define LDRP_SHIMENG_SUPPRESSED_ENTRY           0x00000008 // Not confirmed
#define LDRP_IMAGE_INTEGRITY_FORCED             0x00000020 // Not confirmed
#define LDRP_LOAD_IN_PROGRESS                   0x00001000 // Not confirmed
#define LDRP_UNLOAD_IN_PROGRESS                 0x00002000 // Not confirmed
#define LDRP_ENTRY_PROCESSED                    0x00004000 // Not confirmed
#define LDRP_ENTRY_INSERTED                     0x00008000 // Not confirmed
#define LDRP_CURRENT_LOAD                       0x00010000 // Not confirmed
#define LDRP_FAILED_BUILTIN_LOAD                0x00020000 // Not confirmed
#define LDRP_DONT_CALL_FOR_THREADS              0x00040000 // Not confirmed
#define LDRP_PROCESS_ATTACH_CALLED              0x00080000 // Not confirmed
#define LDRP_DEBUG_SYMBOLS_LOADED               0x00100000 // Not confirmed
#define LDRP_IMAGE_NOT_AT_BASE                  0x00200000 // Not confirmed
#define LDRP_SYSTEM_MAPPED                      0x01000000
#define LDRP_IMAGE_VERIFYING                    0x02000000
#define LDRP_DRIVER_DEPENDENT_DLL               0x04000000
#define LDRP_ENTRY_NATIVE                       0x08000000 // Not confirmed
#define LDRP_REDIRECTED                         0x10000000 // Not confirmed
#define LDRP_SESSION_MAPPED                     0x20000000
#define LDRP_MM_LOADED                          0x40000000
#define LDRP_COMPAT_DATABASE_PROCESSED          0x80000000 // Not confirmed

#define LDRP_SIGNING_LEVEL_UNCHECKED     0x0
#define LDRP_SIGNING_LEVEL_UNSIGNED      0x1
#define LDRP_SIGNING_LEVEL_ENTERPRISE    0x2
#define LDRP_SIGNING_LEVEL_AUTHENTICODE  0x4
#define LDRP_SIGNING_LEVEL_STORE         0x6
#define LDRP_SIGNING_LEVEL_ANTIMALWARE   0x7
#define LDRP_SIGNING_LEVEL_MICROSOFT     0x8
#define LDRP_SIGNING_LEVEL_DYNAMICCODE   0xB
#define LDRP_SIGNING_LEVEL_WINDOWS       0xC
#define LDRP_SIGNING_LEVEL_WINDOWS_PPL   0xD
#define LDRP_SIGNING_LEVEL_WINDOWS_TCB   0xE
...
// Kernel feature bits.
//
#define KF_V86_VIS      0x00000001ull
#define KF_RDTSC        0x00000002ull
#define KF_CR4          0x00000004ull
#define KF_CMOV         0x00000008ull
#define KF_GLOBAL_PAGE  0x00000010ull
#define KF_LARGE_PAGE   0x00000020ull
#define KF_MTRR         0x00000040ull
#define KF_CMPXCHG8B    0x00000080ull
#define KF_MMX          0x00000100ull
#define KF_WORKING_PTE  0x00000200ull
#define KF_PAT          0x00000400ull
#define KF_FXSR         0x00000800ull
#define KF_FAST_SYSCALL 0x00001000ull
#define KF_XMMI         0x00002000ull
#define KF_3DNOW        0x00004000ull
#define KF_AMDK6MTRR    0x00008000ull
#define KF_XMMI64       0x00010000ull
#define KF_DTS          0x00020000ull
#define KF_SMT          0x00040000ull

// KSPIN_LOCK_QUEUE_NUMBER
//
#define LockQueueVacbLock          0x4
#define LockQueueMasterLock        0x5
#define LockQueueNonPagedPoolLock  0x6
#define LockQueueIoCancelLock      0x7
#define LockQueueWorkQueueLock     0x8
#define LockQueueIoVpbLock         0x9
#define LockQueueIoDatabaseLock    0xA
#define LockQueueIoCompletionLock  0xB
#define LockQueueNtfsStructLock    0xC
#define LockQueueAfdWorkQueueLock  0xD
#define LockQueueBcbLock           0xE
...
#define LOCK_QUEUE_WAIT                 0x1ull

#define VadNone								 0x0
#define VadDevicePhysicalMemory			 0x1
#define VadImageMap							 0x2
#define VadAwe									 0x3
#define VadWriteWatch						 0x4
#define VadLargePages						 0x5
#define VadRotatePhysical					 0x6
#define VadLargePageSection				 0x7
...
#define FILE_DISPOSITION_IGNORE_READONLY_ATTRIBUTE	0x00000010	//Allows read - only files to be deleted.For more information, see the Remarks section below.
...
#define IOCTL_NVME_PASS_THROUGH             CTL_CODE(0xF000u, 0xA02, METHOD_BUFFERED, FILE_ANY_ACCESS)
