...
#include "mdt/opm_connector_type_t.hpp"
...
#include "magic/opm_interface_3_t.start.hpp"
namespace dxgk
{
    // [struct _DXGK_OPM_INTERFACE_3]
    // => WDK 10 (NV)
    //
    struct opm_interface_3_t                                                                                                  
    {                                                                                                                         
        ...
        using dxgkddi_opm_create_protected_output_nonlocal_display_t =   sdk::function<int32_t(void*, enum dxgk::mdt::opm_video_output_semantics_t, uint64_t, struct dxgk::mdt::opm_actual_output_format_t*, uint64_t, enum dxgk::mdt::opm_connector_type_t, void**)>*;                                                       
        using dxgk_ddi_opm_create_protected_output_non_local_display_t = dxgkddi_opm_create_protected_output_nonlocal_display_t ;                                                       
        ...
        _m14 dxgk_ddi_opm_create_protected_output_non_local_display_t  dxgk_ddi_opm_create_protected_output_non_local_display;  //{ +0x0068    } | .DxgkDdiOPMCreateProtectedOutputNonLocalDisplay
        _m15 sdk::function<int32_t(void*, uint32_t, void*)>*           dxgk_ddi_opm_set_srm_list;                               //{ +0x0070    } | .DxgkDdiOPMSetSrmList
        _m16 sdk::function<int32_t(void*, uint32_t*, void*)>*          dxgk_ddi_opm_get_srm_list_version;                       //{ +0x0078    } | .DxgkDdiOPMGetSrmListVersion
                                                                                                                              
        SDK_NONVOL_PROPERTIES( "_DXGK_OPM_INTERFACE_3.$", 0x0, false, 0xafb052a57813fda5 );                                                       
        SDK_FIXED_SIZE( opm_interface_3_t, 0x80 );                                                                            
    };                                                                                                                        
};
#include "magic/opm_interface_3_t.end.hpp"
SDK_VERIFY( struct dxgk::opm_interface_3_t, 0x80 );
