...
#include "multiplane_overlay_y_cb_cr_flags_t.hpp"
...
#include "magic/multiplane_overlay_attributes_t.start.hpp"
namespace dxgk
{
    // [struct _DXGK_MULTIPLANE_OVERLAY_ATTRIBUTES]
    // => WDK 10 (NV)
    //
    struct multiplane_overlay_attributes_t                                            
    {                                                                                 
        ...
        _m07 struct dxgk::multiplane_overlay_y_cb_cr_flags_t  y_cb_cr_flags;            //{ +0x0040    } | .YCbCrFlags
        ...
        SDK_NONVOL_PROPERTIES( "_DXGK_MULTIPLANE_OVERLAY_ATTRIBUTES.$", 0x0, false, 0x3521aca77a70ded6 );                        
        SDK_FIXED_SIZE( multiplane_overlay_attributes_t, 0x58 );                        
    };                                                                                
};
#include "magic/multiplane_overlay_attributes_t.end.hpp"
SDK_VERIFY( struct dxgk::multiplane_overlay_attributes_t, 0x58 );
