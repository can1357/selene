...
#include "magic/opm_interface_2_t.start.hpp"
namespace dxgk
{
    // [struct _DXGK_OPM_INTERFACE_2]
    // => WDK 10 (NV)
    //
    struct opm_interface_2_t                                                                                                  
    {                                                                                                                         
        ...
        SDK_NONVOL_PROPERTIES( "_DXGK_OPM_INTERFACE_2.$", 0x0, false, 0xd56d52519ce88aa2 );                                                       
        SDK_FIXED_SIZE( opm_interface_2_t, 0x70 );                                                                            
    };                                                                                                                        
};
#include "magic/opm_interface_2_t.end.hpp"
SDK_VERIFY( struct dxgk::opm_interface_2_t, 0x70 );
