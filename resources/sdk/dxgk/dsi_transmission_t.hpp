...
#include "dsi_packet_t.hpp"

#include "magic/dsi_transmission_t.start.hpp"
namespace dxgk
{
    // [struct _DXGK_DSI_TRANSMISSION]
    // => WDK 10 (NV)
    //
    ...
    {                                                                             
        ...
        _m12 sdk::array<struct dxgk::dsi_packet_t, 1> packets;                      //{ +0x0010    } | .Packets
                                                                                  
        SDK_NONVOL_PROPERTIES( "_DXGK_DSI_TRANSMISSION.$", 0x0, false, 0x241546b6842d13e4 );                            
        SDK_FIXED_SIZE( dsi_transmission_t, 0x20 );                               
    };                                                                            
};
#include "magic/dsi_transmission_t.end.hpp"
SDK_VERIFY( struct dxgk::dsi_transmission_t, 0x20 );
