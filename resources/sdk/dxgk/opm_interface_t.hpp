...
#include "magic/opm_interface_t.start.hpp"
namespace dxgk
{
    // [struct _DXGK_OPM_INTERFACE]
    // => WDK 10 (NV)
    //
    struct opm_interface_t                                                                                          
    {                                                                                                               
        ...
        SDK_NONVOL_PROPERTIES( "_DXGK_OPM_INTERFACE.$", 0x0, false, 0xcc23f4d0fc56677f );                                                  
        SDK_FIXED_SIZE( opm_interface_t, 0x68 );                                                                    
    };                                                                                                              
};
#include "magic/opm_interface_t.end.hpp"
SDK_VERIFY( struct dxgk::opm_interface_t, 0x68 );
