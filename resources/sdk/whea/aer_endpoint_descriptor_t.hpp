...
#include "../nt/aer_endpoint_descriptor_flags_t.hpp"

#include "magic/aer_endpoint_descriptor_t.start.hpp"
namespace whea
{
    // [struct _WHEA_AER_ENDPOINT_DESCRIPTOR]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct aer_endpoint_descriptor_t                                                
    {                                                                               
        ...
        _m05 union nt::aer_endpoint_descriptor_flags_t flags;                         //{ +0x000e    +0x000e    +0x000e    +0x000e    +0x000e    } | .Flags
        ...
        SDK_NONVOL_PROPERTIES( "_WHEA_AER_ENDPOINT_DESCRIPTOR.$", 0x20, true, 0x33b8e39ce61d88e3 );                             
        SDK_FIXED_SIZE( aer_endpoint_descriptor_t, 0x20 );                             
    };                                                                              
};
#include "magic/aer_endpoint_descriptor_t.end.hpp"
SDK_VERIFY( struct whea::aer_endpoint_descriptor_t, 0x20 );
