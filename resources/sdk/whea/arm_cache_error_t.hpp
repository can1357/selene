...
#include "arm_cache_error_valid_bits_t.hpp"

#include "magic/arm_cache_error_t.start.hpp"
namespace whea
{
    // [struct _WHEA_ARM_CACHE_ERROR]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct arm_cache_error_t                                                    
    {                                                                           
        // WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                          
        //                                                                      
        _m00 union whea::arm_cache_error_valid_bits_t validation_bit;             //{ +0x0000    +0x0000    +0x0000    +0x0000    +0x0000    } | .ValidationBit
        ...
        SDK_NONVOL_PROPERTIES( "_WHEA_ARM_CACHE_ERROR.$", 0xc, true, 0x1f91525bb35e57aa );                          
        SDK_FIXED_SIZE( arm_cache_error_t, 0xc );                               
    };                                                                          
};
#include "magic/arm_cache_error_t.end.hpp"
SDK_VERIFY( struct whea::arm_cache_error_t, 0xc );
