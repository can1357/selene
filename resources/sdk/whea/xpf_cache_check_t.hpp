...
#include "magic/xpf_cache_check_t.start.hpp"
namespace whea
{
    // [union _WHEA_XPF_CACHE_CHECK]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    union xpf_cache_check_t                           
    {                                                 
        ...
        _m17 uint64_t xpf_cache_check;                  //{ +0x0000    +0x0000    +0x0000    +0x0000    +0x0000    } | .XpfCacheCheck
                                                      
        SDK_NONVOL_PROPERTIES( "_WHEA_XPF_CACHE_CHECK.$", 0x8, true, 0xf793e5792d58c5ce );                                
        SDK_FIXED_SIZE( xpf_cache_check_t, 0x8 );                                
    };                                                
};
#include "magic/xpf_cache_check_t.end.hpp"
SDK_VERIFY( union whea::xpf_cache_check_t, 0x8 );
