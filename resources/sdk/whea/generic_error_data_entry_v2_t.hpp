...
#include "magic/generic_error_data_entry_v2_t.start.hpp"
namespace whea
{
    // [struct _WHEA_GENERIC_ERROR_DATA_ENTRY_V2]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct generic_error_data_entry_v2_t                   
    {                                                      
        ...
        _m08 union whea::timestamp_t     timestamp;          //{ +0x0040    +0x0040    +0x0040    +0x0040    +0x0040    } | .Timestamp
        _m09 sdk::array<uint8_t, 1>      data;               //{ +0x0048    +0x0048    +0x0048    +0x0048    +0x0048    } | .Data
                                                           
        SDK_NONVOL_PROPERTIES( "_WHEA_GENERIC_ERROR_DATA_ENTRY_V2.$", 0x49, true, 0x8a5bd564b522d9cf );                  
        SDK_FIXED_SIZE( generic_error_data_entry_v2_t, 0x49 );                  
    };                                                     
};
#include "magic/generic_error_data_entry_v2_t.end.hpp"
SDK_VERIFY( struct whea::generic_error_data_entry_v2_t, 0x49 );
