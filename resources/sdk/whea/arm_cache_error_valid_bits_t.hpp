...
#include "magic/arm_cache_error_valid_bits_t.start.hpp"
namespace whea
{
    // [union _WHEA_ARM_CACHE_ERROR_VALID_BITS]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    union arm_cache_error_valid_bits_t          
    {                                           
        ...
        SDK_NONVOL_PROPERTIES( "_WHEA_ARM_CACHE_ERROR_VALID_BITS.$", 0x2, true, 0xc765aa356d40d88a );                          
        SDK_FIXED_SIZE( arm_cache_error_valid_bits_t, 0x2 );                          
    };                                          
};
#include "magic/arm_cache_error_valid_bits_t.end.hpp"
SDK_VERIFY( union whea::arm_cache_error_valid_bits_t, 0x2 );
