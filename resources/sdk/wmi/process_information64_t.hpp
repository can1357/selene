...
#include "magic/process_information64_t.start.hpp"
namespace wmi
{
    // [struct _WMI_PROCESS_INFORMATION64]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct process_information64_t         
    {                                      
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                     
        //                                 
        _m00 uint64_t unique_process_key64;  //{ +0x0000    +0x0000    +0x0000    +0x0000    } | .UniqueProcessKey64
        ...
        SDK_MAGIC_PROPERTIES( "_WMI_PROCESS_INFORMATION64.$", 0x28, true, 0x8adc7db06b702bfc );                     
        SDK_FIXED_SIZE( process_information64_t, 0x28 );                     
    };                                     
};
#include "magic/process_information64_t.end.hpp"
SDK_VERIFY( struct wmi::process_information64_t, 0x28 );
