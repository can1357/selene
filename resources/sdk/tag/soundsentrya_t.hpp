...
#include "magic/soundsentrya_t.start.hpp"
namespace tag
{
    // [struct tagSOUNDSENTRYA]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct soundsentrya_t                         
    {                                             
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                            
        //                                        
        ...
        _m10 char*    lpsz_windows_effect_dll;      //{ +0x0028    +0x0028    +0x0028    +0x0028    } | .lpszWindowsEffectDLL
        _m11 uint32_t i_windows_effect_ordinal;     //{ +0x0030    +0x0030    +0x0030    +0x0030    } | .iWindowsEffectOrdinal
                                                  
        SDK_MAGIC_PROPERTIES( "tagSOUNDSENTRYA.$", 0x38, true, 0x91e1369a1f96752a );                            
        SDK_FIXED_SIZE( soundsentrya_t, 0x38 );                            
    };                                            
};
#include "magic/soundsentrya_t.end.hpp"
SDK_VERIFY( struct tag::soundsentrya_t, 0x38 );
