...
#include "magic/emrtransparentblt_t.start.hpp"
namespace tag
{
    // [struct tagEMRTRANSPARENTBLT]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct emrtransparentblt_t                   
    {                                            
        ...
        SDK_NONVOL_PROPERTIES( "tagEMRTRANSPARENTBLT.$", 0x6c, true, 0x2afcff54df92d1e1 );                
        SDK_FIXED_SIZE( emrtransparentblt_t, 0x6c );                
    };                                           
};
#include "magic/emrtransparentblt_t.end.hpp"
SDK_VERIFY( struct tag::emrtransparentblt_t, 0x6c );
