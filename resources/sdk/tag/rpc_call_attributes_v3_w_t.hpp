...
#include "rpc_call_client_locality_t.hpp"

namespace rpc { struct call_local_address_v1_t; }

#include "magic/rpc_call_attributes_v3_w_t.start.hpp"
namespace tag
{
    // [struct tagRPC_CALL_ATTRIBUTES_V3_W]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct rpc_call_attributes_v3_w_t                                                 
    {                                                                                 
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                                    
        //                                                                            
        ...
        _m03 uint16_t*                            server_principal_name;                //{ +0x0010    +0x0010    +0x0010    +0x0010    } | .ServerPrincipalName
        _m04 uint32_t                             client_principal_name_buffer_length;  //{ +0x0018    +0x0018    +0x0018    +0x0018    } | .ClientPrincipalNameBufferLength
        _m05 uint16_t*                            client_principal_name;                //{ +0x0020    +0x0020    +0x0020    +0x0020    } | .ClientPrincipalName
        ...
        _m11 enum tag::rpc_call_client_locality_t is_client_local;                      //{ +0x003c    +0x003c    +0x003c    +0x003c    } | .IsClientLocal
        ...
        _m18 uint32_t                             client_identifier_buffer_length;      //{ +0x006c    +0x006c    +0x006c    +0x006c    } | .ClientIdentifierBufferLength
        _m19 uint8_t*                             client_identifier;                    //{ +0x0070    +0x0070    +0x0070    +0x0070    } | .ClientIdentifier
                                                                                      
        SDK_MAGIC_PROPERTIES( "tagRPC_CALL_ATTRIBUTES_V3_W.$", 0x78, true, 0x2322f02f13b8877d );                                    
        SDK_FIXED_SIZE( rpc_call_attributes_v3_w_t, 0x78 );                                    
    };                                                                                
};
#include "magic/rpc_call_attributes_v3_w_t.end.hpp"
SDK_VERIFY( struct tag::rpc_call_attributes_v3_w_t, 0x78 );
