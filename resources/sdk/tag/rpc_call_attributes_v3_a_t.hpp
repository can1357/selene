...
#include "magic/rpc_call_attributes_v3_a_t.start.hpp"
namespace tag
{
    // [struct tagRPC_CALL_ATTRIBUTES_V3_A]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct rpc_call_attributes_v3_a_t                                                 
    {                                                                                 
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                                    
        //                                                                            
        ...
        SDK_MAGIC_PROPERTIES( "tagRPC_CALL_ATTRIBUTES_V3_A.$", 0x78, true, 0x736485f19a757396 );                                    
        SDK_FIXED_SIZE( rpc_call_attributes_v3_a_t, 0x78 );                                    
    };                                                                                
};
#include "magic/rpc_call_attributes_v3_a_t.end.hpp"
SDK_VERIFY( struct tag::rpc_call_attributes_v3_a_t, 0x78 );
