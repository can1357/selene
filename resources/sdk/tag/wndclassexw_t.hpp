...
#include "magic/wndclassexw_t.start.hpp"
namespace tag
{
    // [struct tagWNDCLASSEXW]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct wndclassexw_t                              
    {                                                 
        ...
        _m09 const wchar_t*           lpsz_menu_name;   //{ +0x0038    +0x0038    +0x0038    +0x0038    } | .lpszMenuName
        _m10 const wchar_t*           lpsz_class_name;  //{ +0x0040    +0x0040    +0x0040    +0x0040    } | .lpszClassName
        _m11 struct win::hicon_t*     h_icon_sm;        //{ +0x0048    +0x0048    +0x0048    +0x0048    } | .hIconSm
                                                      
        SDK_MAGIC_PROPERTIES( "tagWNDCLASSEXW.$", 0x50, true, 0x7376daf7fd668a76 );                
        SDK_FIXED_SIZE( wndclassexw_t, 0x50 );                
    };                                                
};
#include "magic/wndclassexw_t.end.hpp"
SDK_VERIFY( struct tag::wndclassexw_t, 0x50 );
