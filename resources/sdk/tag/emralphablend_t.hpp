...
#include "magic/emralphablend_t.start.hpp"
namespace tag
{
    // [struct tagEMRALPHABLEND]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct emralphablend_t                       
    {                                            
        ...
        SDK_NONVOL_PROPERTIES( "tagEMRALPHABLEND.$", 0x6c, true, 0x4d0b9a25900d3856 );                
        SDK_FIXED_SIZE( emralphablend_t, 0x6c );                
    };                                           
};
#include "magic/emralphablend_t.end.hpp"
SDK_VERIFY( struct tag::emralphablend_t, 0x6c );
