...
#include "magic/rpc_call_attributes_v2_w_t.start.hpp"
namespace tag
{
    // [struct tagRPC_CALL_ATTRIBUTES_V2_W]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct rpc_call_attributes_v2_w_t                                                 
    {                                                                                 
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                                    
        //                                                                            
        ...
        SDK_MAGIC_PROPERTIES( "tagRPC_CALL_ATTRIBUTES_V2_W.$", 0x70, true, 0x5d61ee34adb5315f );                                    
        SDK_FIXED_SIZE( rpc_call_attributes_v2_w_t, 0x70 );                                    
    };                                                                                
};
#include "magic/rpc_call_attributes_v2_w_t.end.hpp"
SDK_VERIFY( struct tag::rpc_call_attributes_v2_w_t, 0x70 );
