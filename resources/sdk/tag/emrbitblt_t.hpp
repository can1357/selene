...
#include "magic/emrbitblt_t.start.hpp"
namespace tag
{
    // [struct tagEMRBITBLT]
    ...
    {                                            
        ...
        SDK_NONVOL_PROPERTIES( "tagEMRBITBLT.$", 0x64, true, 0xe4c1f52dec8905d8 );                
        SDK_FIXED_SIZE( emrbitblt_t, 0x64 );                
    };                                           
};
#include "magic/emrbitblt_t.end.hpp"
SDK_VERIFY( struct tag::emrbitblt_t, 0x64 );
