...
#include "magic/wndclassw_t.start.hpp"
namespace tag
{
    // [struct tagWNDCLASSW]
    ...
    {                                                 
        ...
        _m08 const wchar_t*           lpsz_menu_name;   //{ +0x0038    +0x0038    +0x0038    +0x0038    } | .lpszMenuName
        _m09 const wchar_t*           lpsz_class_name;  //{ +0x0040    +0x0040    +0x0040    +0x0040    } | .lpszClassName
                                                      
        SDK_MAGIC_PROPERTIES( "tagWNDCLASSW.$", 0x48, true, 0xe8697c50c328b4ff );                
        SDK_FIXED_SIZE( wndclassw_t, 0x48 );                
    };                                                
};
#include "magic/wndclassw_t.end.hpp"
SDK_VERIFY( struct tag::wndclassw_t, 0x48 );
