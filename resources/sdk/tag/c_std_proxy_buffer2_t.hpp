...
#include "magic/c_std_proxy_buffer2_t.start.hpp"
namespace tag
{
    // [struct tagCStdProxyBuffer2]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct c_std_proxy_buffer2_t                                              
    {                                                                         
        ...
        _m05 struct win::i_unknown_t*                     p_base_proxy;         //{ +0x0028    +0x0028    +0x0028    +0x0028    } | .pBaseProxy
        ...
        SDK_MAGIC_PROPERTIES( "tagCStdProxyBuffer2.$", 0x68, true, 0x52f068a17cd89e30 );                    
        SDK_FIXED_SIZE( c_std_proxy_buffer2_t, 0x68 );                        
    };                                                                        
};
#include "magic/c_std_proxy_buffer2_t.end.hpp"
SDK_VERIFY( struct tag::c_std_proxy_buffer2_t, 0x68 );
