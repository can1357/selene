...
#include "oxid_info_t.hpp"
#include "../win/midl_i_local_object_exporter_0007_t.hpp"

#include "magic/custom_priv_resolver_info_t.start.hpp"
namespace tag
{
    ...
    {                                                            
        ...
        SDK_MAGIC_PROPERTIES( "tagCustomPrivResolverInfo.$", 0xc8, true, 0xae646b7c9e7191f1 );                     
        SDK_DYNAMIC_SIZE( custom_priv_resolver_info_t );                     
    };                                                           
};
#include "magic/custom_priv_resolver_info_t.end.hpp"
