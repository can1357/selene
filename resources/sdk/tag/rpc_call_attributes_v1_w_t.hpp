...
#include "magic/rpc_call_attributes_v1_w_t.start.hpp"
namespace tag
{
    // [struct tagRPC_CALL_ATTRIBUTES_V1_W]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct rpc_call_attributes_v1_w_t                      
    {                                                      
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                                    
        //                                                 
        ...
        SDK_MAGIC_PROPERTIES( "tagRPC_CALL_ATTRIBUTES_V1_W.$", 0x38, true, 0xbd2ee3e791990999 );                                    
        SDK_FIXED_SIZE( rpc_call_attributes_v1_w_t, 0x38 );                                    
    };                                                     
};
#include "magic/rpc_call_attributes_v1_w_t.end.hpp"
SDK_VERIFY( struct tag::rpc_call_attributes_v1_w_t, 0x38 );
