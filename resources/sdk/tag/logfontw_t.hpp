...
#include "magic/logfontw_t.start.hpp"
namespace tag
{
    // [struct tagLOGFONTW]
    ...
    {                                                    
        ...
        _m13 sdk::array<wchar_t, 32> lf_face_name;         //{ +0x001c    +0x001c    +0x001c    +0x001c    +0x001c    } | .lfFaceName
                                                         
        SDK_NONVOL_PROPERTIES( "tagLOGFONTW.$", 0x5c, true, 0x8e635b15de1081f2 );                    
        SDK_FIXED_SIZE( logfontw_t, 0x5c );                    
    };                                                   
};
#include "magic/logfontw_t.end.hpp"
SDK_VERIFY( struct tag::logfontw_t, 0x5c );
