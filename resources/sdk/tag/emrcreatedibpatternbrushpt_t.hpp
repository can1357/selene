...
#include "magic/emrcreatedibpatternbrushpt_t.start.hpp"
namespace tag
{
    // [struct tagEMRCREATEDIBPATTERNBRUSHPT]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct emrcreatedibpatternbrushpt_t 
    {                                   
        ...
        SDK_NONVOL_PROPERTIES( "tagEMRCREATEDIBPATTERNBRUSHPT.$", 0x20, true, 0x6b6124399598b280 );         
        SDK_FIXED_SIZE( emrcreatedibpatternbrushpt_t, 0x20 );         
    };                                  
};
#include "magic/emrcreatedibpatternbrushpt_t.end.hpp"
SDK_VERIFY( struct tag::emrcreatedibpatternbrushpt_t, 0x20 );
