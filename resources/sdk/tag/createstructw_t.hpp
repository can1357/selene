...
#include "magic/createstructw_t.start.hpp"
namespace tag
{
    ...
    {                                                  
        ...
        _m09 const wchar_t*           lpsz_name;         //{ +0x0038    +0x0038    +0x0038    +0x0038    } | .lpszName
        _m10 const wchar_t*           lpsz_class;        //{ +0x0040    +0x0040    +0x0040    +0x0040    } | .lpszClass
        _m11 uint32_t                 dw_ex_style;       //{ +0x0048    +0x0048    +0x0048    +0x0048    } | .dwExStyle
                                                       
        SDK_MAGIC_PROPERTIES( "tagCREATESTRUCTW.$", 0x50, true, 0xad1b81ac1b70761e );                 
        SDK_FIXED_SIZE( createstructw_t, 0x50 );                 
    };                                                 
};
#include "magic/createstructw_t.end.hpp"
SDK_VERIFY( struct tag::createstructw_t, 0x50 );
