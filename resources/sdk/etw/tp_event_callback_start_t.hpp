...
#include "magic/tp_event_callback_start_t.start.hpp"
namespace etw
{
    // [struct _ETW_TP_EVENT_CALLBACK_START]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct tp_event_callback_start_t                           
    {                                                          
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                
        //                                                     
        ...
        SDK_MAGIC_PROPERTIES( "_ETW_TP_EVENT_CALLBACK_START.$", 0x48, true, 0x921766ca1bdae60f );                
        SDK_FIXED_SIZE( tp_event_callback_start_t, 0x48 );                
    };                                                         
};
#include "magic/tp_event_callback_start_t.end.hpp"
SDK_VERIFY( struct etw::tp_event_callback_start_t, 0x48 );
