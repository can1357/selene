...
#include "dma_transaction_configure_channel_t.hpp"
#include "dma_transaction_transfer_complete_t.hpp"
#include "dma_transaction_program_or_reserve_dma_t.hpp"

namespace nt { struct kthread_t; }
namespace nt { struct mdl_t;     }

#include "magic/dma_system_transaction_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    //
    class dma_system_transaction_t                                                                 
    {                                                                                              
        ...
        {                                                                                          
            ...
            SDK_MAGIC_PROPERTIES( "FxDmaSystemTransaction.m_ObjectFlagsByName.$", 0x2, true, 0x1999af75076fca93 );                                                  
        ...
        {                                                                                          
            ...
            SDK_MAGIC_PROPERTIES( "FxDmaSystemTransaction.m_TransferState.$", 0x10, true, 0x6c3ff5e11495e795 );                                                    
        ...
        _m054 class fx::dma_transaction_configure_channel_t           m_configure_channel_function;  //{ +0x0138    +0x0138    +0x0138    +0x0138    } | .m_ConfigureChannelFunction
        _m055 void*                                                   m_configure_channel_context;   //{ +0x0140    +0x0140    +0x0140    +0x0140    } | .m_ConfigureChannelContext
        _m056 class fx::dma_transaction_transfer_complete_t           m_transfer_complete_function;  //{ +0x0148    +0x0148    +0x0148    +0x0148    } | .m_TransferCompleteFunction
        _m057 void*                                                   m_transfer_complete_context;   //{ +0x0150    +0x0150    +0x0150    +0x0150    } | .m_TransferCompleteContext
                                                                                                   
        SDK_MAGIC_PROPERTIES( "FxDmaSystemTransaction.$", 0x158, true, 0xe961c92a8711d508 );                             
        SDK_FIXED_SIZE( dma_system_transaction_t, 0x158 );                                         
    };                                                                                             
};
#include "magic/dma_system_transaction_t.end.hpp"
SDK_VERIFY( struct fx::dma_system_transaction_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( struct fx::dma_system_transaction_t::u4_m_transfer_state_t, 0x10 );
SDK_VERIFY( class fx::dma_system_transaction_t, 0x158 );
