...
#include "magic/io_target_self_t.start.hpp"
namespace fx
{
    class device_t;
    class driver_t;
    ...
    {                                                                 
        ...
        {                                                             
            ...
            SDK_MAGIC_PROPERTIES( "FxIoTargetSelf.m_ObjectFlagsByName.$", 0x2, true, 0xd2240ddd71fbbbea );                                            
        ...
        _m043 class fx::io_queue_t*            m_dispatch_queue;        //{ +0x0158    +0x0158    +0x0158    +0x0158    } | .m_DispatchQueue
                                                                      
        SDK_MAGIC_PROPERTIES( "FxIoTargetSelf.$", 0x160, true, 0x37c4f4d220db491f );                       
        SDK_FIXED_SIZE( io_target_self_t, 0x160 );                       
    };                                                                
};
#include "magic/io_target_self_t.end.hpp"
SDK_VERIFY( struct fx::io_target_self_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::io_target_self_t, 0x160 );
