...
#include "device_pwr_requirement_machine_state_history_t.hpp"

#include "magic/device_pwr_requirement_machine_t.start.hpp"
namespace fx
{
    class pkg_pnp_t;
    struct cr_event_t;
    ...
    {                                                                 
        ...
        {                                                             
            ...
            SDK_MAGIC_PROPERTIES( "FxDevicePwrRequirementMachine.m_QueueFlagsByName.$", 0x1, true, 0xb8ad1850ec9ee0b5 );                                           
        ...
        using m_queue_t =              sdk::array<enum fx::device_pwr_requirement_events_t, 8>;                          
        using m_states_t =             union fx::device_pwr_requirement_machine_state_history_t;                          
        ...
        _m18 class fx::pox_interface_t*     m_pox_interface;            //{ +0x0090    +0x0090    +0x0090    +0x0090    } | .m_PoxInterface
        _m19 uint8_t                        m_current_state;            //{ +0x0098    +0x0098    +0x0098    +0x0098    } | .m_CurrentState
        _m20 m_queue_t                      m_queue;                    //{ +0x009c    +0x009c    +0x009c    +0x009c    } | .m_Queue
        _m21 m_states_t                     m_states;                   //{ +0x00bc    +0x00bc    +0x00bc    +0x00bc    } | .m_States
                                                                      
        SDK_MAGIC_PROPERTIES( "FxDevicePwrRequirementMachine.$", 0xc8, true, 0x1ac056db7fdac457 );                          
        SDK_FIXED_SIZE( device_pwr_requirement_machine_t, 0xc8 );                          
    };                                                                
};
#include "magic/device_pwr_requirement_machine_t.end.hpp"
SDK_VERIFY( struct fx::device_pwr_requirement_machine_t::u0_m_queue_flags_by_name_t, 0x1 );
SDK_VERIFY( class fx::device_pwr_requirement_machine_t, 0xc8 );
