...
namespace fx
{
    ...
    {                                                                 
        ...
        {                                                             
            ...
            SDK_MAGIC_PROPERTIES( "FxEventQueue.m_QueueFlagsByName.$", 0x1, true, 0xb1eeb46003e006e0 );                                           
        ...
        SDK_MAGIC_PROPERTIES( "FxEventQueue.$", 0x68, true, 0x2fdefc98cc9ee61b );                          
        SDK_FIXED_SIZE( event_queue_t, 0x68 );                          
    };                                                                
};
#include "magic/event_queue_t.end.hpp"
SDK_VERIFY( struct fx::event_queue_t::u0_m_queue_flags_by_name_t, 0x1 );
SDK_VERIFY( struct fx::event_queue_t, 0x68 );
