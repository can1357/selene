...
namespace fx
{
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxSpinLock.m_ObjectFlagsByName.$", 0x2, true, 0xf09e903a9f10a71f );                                            
        ...
        //                                                           
        _m00 class mx::lock_t                 m_spin_lock;             //{ +0x0030    +0x0068    +0x0030    +0x0068    +0x0030    +0x0068    +0x0030    +0x0068    } | .m_SpinLock
                                                                     
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                       
        //                                                           
        _m01 uint16_t                         m_type;                  //{ +0x0008    +0x0008    +0x0008    +0x0008    } | .m_Type
        _m02 uint16_t                         m_object_size;           //{ +0x000a    +0x000a    +0x000a    +0x000a    } | .m_ObjectSize
        _m03 int32_t                          m_refcnt;                //{ +0x000c    +0x000c    +0x000c    +0x000c    } | .m_Refcnt
        _m04 struct fx::driver_globals_t*     m_globals;               //{ +0x0010    +0x0010    +0x0010    +0x0010    } | .m_Globals
        _m05 uint16_t                         m_object_flags;          //{ +0x0018    +0x0018    +0x0018    +0x0018    } | .m_ObjectFlags
        _m15 u0_m_object_flags_by_name_t      m_object_flags_by_name;  //{ +0x0018    +0x0018    +0x0018    +0x0018    } | .m_ObjectFlagsByName
        _m16 uint16_t                         m_object_state;          //{ +0x001a    +0x001a    +0x001a    +0x001a    } | .m_ObjectState
        _m17 nt::list_entry_t                 m_child_list_head;       //{ +0x0020    +0x0020    +0x0020    +0x0020    } | .m_ChildListHead
        ...
        _m23 uint8_t                          m_irql;                  //{ +0x0078    +0x0078    +0x0078    +0x0078    } | .m_Irql
        _m24 uint8_t                          m_interrupt_lock;        //{ +0x0079    +0x0079    +0x0079    +0x0079    } | .m_InterruptLock
                                                                     
        SDK_MAGIC_PROPERTIES( "FxSpinLock.$", 0x80, true, 0xa0eeec76459e591d );                       
        SDK_FIXED_SIZE( spin_lock_t, 0x80 );                         
    };                                                               
};
#include "magic/spin_lock_t.end.hpp"
SDK_VERIFY( struct fx::spin_lock_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::spin_lock_t, 0x80 );
