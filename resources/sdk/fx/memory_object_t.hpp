...
#include "magic/memory_object_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxMemoryObject.m_ObjectFlagsByName.$", 0x2, true, 0x3b7b680fba9944f4 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxMemoryObject.$", 0x78, true, 0x456509bbda5c5496 );                       
        SDK_FIXED_SIZE( memory_object_t, 0x78 );                       
    };                                                               
};
#include "magic/memory_object_t.end.hpp"
SDK_VERIFY( struct fx::memory_object_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::memory_object_t, 0x78 );
