...
#include "pnp_device_eject_t.hpp"
...
#include "pnp_device_set_lock_t.hpp"
...
#include "power_device_enable_wake_at_bus_t.hpp"
#include "pnp_device_usage_notification_ex_t.hpp"
#include "power_device_disable_wake_at_bus_t.hpp"
#include "pnp_device_d0_exit_pre_hw_disabled_t.hpp"
#include "pnp_device_d0_entry_post_hw_enabled_t.hpp"
#include "pnp_device_resource_requirements_query_t.hpp"
...
#include "magic/pkg_pdo_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                                                         
        ...
        {                                                                                                     
            ...
            SDK_MAGIC_PROPERTIES( "FxPkgPdo.m_ObjectFlagsByName.$", 0x2, true, 0xf1f450856b448b06 );                                                                     
        ...
        using m_device_resource_requirements_query_t =      class fx::pnp_device_resource_requirements_query_t;                                                
        ...
        _m097 struct nt::single_list_entry_t                  m_device_text_head;                               //{ +0x0618    +0x0698    +0x0698    +0x0698    } | .m_DeviceTextHead
        _m098 uint32_t                                        m_default_locale;                                 //{ +0x0620    +0x06a0    +0x06a0    +0x06a0    } | .m_DefaultLocale
        _m099 struct fx::device_description_entry_t*          m_description;                                    //{ +0x0628    +0x06a8    +0x06a8    +0x06a8    } | .m_Description
        _m100 class fx::child_list_t*                         m_owning_child_list;                              //{ +0x0630    +0x06b0    +0x06b0    +0x06b0    } | .m_OwningChildList
        _m101 class fx::pnp_device_resources_query_t          m_device_resources_query;                         //{ +0x0638    +0x06b8    +0x06b8    +0x06b8    } | .m_DeviceResourcesQuery
        _m102 m_device_resource_requirements_query_t          m_device_resource_requirements_query;             //{ +0x0640    +0x06c0    +0x06c0    +0x06c0    } | .m_DeviceResourceRequirementsQuery
        _m103 class fx::pnp_device_eject_t                    m_device_eject;                                   //{ +0x0648    +0x06c8    +0x06c8    +0x06c8    } | .m_DeviceEject
        _m104 class fx::pnp_device_set_lock_t                 m_device_set_lock;                                //{ +0x0650    +0x06d0    +0x06d0    +0x06d0    } | .m_DeviceSetLock
        _m105 class fx::power_device_enable_wake_at_bus_t     m_device_enable_wake_at_bus;                      //{ +0x0658    +0x06d8    +0x06d8    +0x06d8    } | .m_DeviceEnableWakeAtBus
        _m106 class fx::power_device_disable_wake_at_bus_t    m_device_disable_wake_at_bus;                     //{ +0x0660    +0x06e0    +0x06e0    +0x06e0    } | .m_DeviceDisableWakeAtBus
        _m107 class fx::pnp_device_reported_missing_t         m_device_reported_missing;                        //{ +0x0668    +0x06e8    +0x06e8    +0x06e8    } | .m_DeviceReportedMissing
        _m108 uint8_t                                         m_raw_ok;                                         //{ +0x0670    +0x06f0    +0x06f0    +0x06f0    } | .m_RawOK
        _m109 uint8_t                                         m_static;                                         //{ +0x0671    +0x06f1    +0x06f1    +0x06f1    } | .m_Static
        _m110 uint8_t                                         m_added_to_static_list;                           //{ +0x0672    +0x06f2    +0x06f2    +0x06f2    } | .m_AddedToStaticList
        _m111 uint8_t                                         m_allow_forward_request_to_parent;                //{ +0x0673    +0x06f3    +0x06f3    +0x06f3    } | .m_AllowForwardRequestToParent
        _m112 wchar_t*                                        m_device_id;                                      //{ +0x0678    +0x06f8    +0x06f8    +0x06f8    } | .m_DeviceID
        _m113 wchar_t*                                        m_instance_id;                                    //{ +0x0680    +0x0700    +0x0700    +0x0700    } | .m_InstanceID
        _m114 wchar_t*                                        m_hardware_i_ds;                                  //{ +0x0688    +0x0708    +0x0708    +0x0708    } | .m_HardwareIDs
        _m115 wchar_t*                                        m_compatible_i_ds;                                //{ +0x0690    +0x0710    +0x0710    +0x0710    } | .m_CompatibleIDs
        _m116 wchar_t*                                        m_container_id;                                   //{ +0x0698    +0x0718    +0x0718    +0x0718    } | .m_ContainerID
        _m117 wchar_t*                                        m_i_ds_allocation;                                //{ +0x06a0    +0x0720    +0x0720    +0x0720    } | .m_IDsAllocation
        _m118 class fx::related_device_list_t*                m_ejection_device_list;                           //{ +0x06a8    +0x0728    +0x0728    +0x0728    } | .m_EjectionDeviceList
        _m119 class mx::event_t*                              m_device_eject_processed;                         //{ +0x06b0    +0x0730    +0x0730    +0x0730    } | .m_DeviceEjectProcessed
        _m120 uint8_t                                         m_can_be_deleted;                                 //{ +0x06b8    +0x0738    +0x0738    +0x0738    } | .m_CanBeDeleted
        _m121 uint8_t                                         m_enable_wake_at_bus_invoked;                     //{ +0x06b9    +0x0739    +0x0739    +0x0739    } | .m_EnableWakeAtBusInvoked
                                                                                                              
        // Windows 10 v2004, Windows 11, Windows 10 v20H2                                                     
        //                                                                                                    
        _m122 union fx::pnp_state_t                           m_pnp_state;                                      //{ +0x0078    +0x0078    +0x0078    } | .m_PnpState
        _m123 union fx::pnp_caps_t                            m_pnp_caps;                                       //{ +0x007c    +0x007c    +0x007c    } | .m_PnpCaps
        _m124 class fx::companion_target_t*                   m_companion_target;                               //{ +0x03e8    +0x03e8    +0x03e8    } | .m_CompanionTarget
        _m125 int32_t                                         m_companion_target_status;                        //{ +0x03f0    +0x03f0    +0x03f0    } | .m_CompanionTargetStatus
        _m126 class fx::system_work_item_t*                   m_set_device_failed_attempt_restart_work_item;    //{ +0x0498    +0x0498    +0x0498    } | .m_SetDeviceFailedAttemptRestartWorkItem
        _m127 struct wdf::sleep_study_interface_t*            m_sleep_study;                                    //{ +0x04c8    +0x04c8    +0x04c8    } | .m_SleepStudy
        _m128 volatile int32_t                                m_sleep_study_power_ref_io_count;                 //{ +0x04d0    +0x04d0    +0x04d0    } | .m_SleepStudyPowerRefIoCount
        _m129 uint8_t                                         m_sleep_study_track_references;                   //{ +0x04d4    +0x04d4    +0x04d4    } | .m_SleepStudyTrackReferences
        _m130 class fx::pnp_device_d0_entry_post_hw_enabled_t m_device_d0_entry_post_hardware_enabled;          //{ +0x05a8    +0x05a8    +0x05a8    } | .m_DeviceD0EntryPostHardwareEnabled
        _m131 class fx::pnp_device_d0_exit_pre_hw_disabled_t  m_device_d0_exit_pre_hardware_disabled;           //{ +0x05d0    +0x05d0    +0x05d0    } | .m_DeviceD0ExitPreHardwareDisabled
        _m132 uint8_t                                         m_has_power_dependency_on_parent;                 //{ +0x06f4    +0x06f4    +0x06f4    } | .m_HasPowerDependencyOnParent
                                                                                                              
        // Windows 10 v1607                                                                                   
        //                                                                                                    
        _m133 union fx::pnp_state_and_caps_t                  m_pnp_state_and_caps;                             //{ +0x0078    } | .m_PnpStateAndCaps
                                                                                                              
        SDK_MAGIC_PROPERTIES( "FxPkgPdo.$", 0x740, true, 0x4fc0bfb645b85b54 );                                                
        SDK_DYNAMIC_SIZE( pkg_pdo_t );                                                                        
    };                                                                                                        
};
#include "magic/pkg_pdo_t.end.hpp"
SDK_VERIFY( struct fx::pkg_pdo_t::u0_m_object_flags_by_name_t, 0x2 );
