...
namespace fx
{
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxObject.m_ObjectFlagsByName.$", 0x2, true, 0xe75b7edacc1a4476 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxObject.$", 0x68, true, 0x649652a7df2f1fa9 );                       
        SDK_FIXED_SIZE( object_t, 0x68 );                            
    };                                                               
};
#include "magic/object_t.end.hpp"
SDK_VERIFY( struct fx::object_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::object_t, 0x68 );
