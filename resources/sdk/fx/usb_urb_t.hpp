...
#include "magic/usb_urb_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxUsbUrb.m_ObjectFlagsByName.$", 0x2, true, 0x9faaaedae551d526 );                                            
        ...
        _m25 struct wdf::usbd_handle_t*       m_usbd_handle;           //{ +0x0080    +0x0080    +0x0080    +0x0080    } | .m_USBDHandle
                                                                     
        SDK_MAGIC_PROPERTIES( "FxUsbUrb.$", 0x88, true, 0x6c6fafc91d3482d );                       
        SDK_FIXED_SIZE( usb_urb_t, 0x88 );                           
    };                                                               
};
#include "magic/usb_urb_t.end.hpp"
SDK_VERIFY( struct fx::usb_urb_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::usb_urb_t, 0x88 );
