...
#include "magic/io_queue_io_resume_t.start.hpp"
namespace fx
{
    class callback_lock_t;

    // [class FxIoQueueIoResume]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class io_queue_io_resume_t                          
    {                                                   
        ...
        SDK_MAGIC_PROPERTIES( "FxIoQueueIoResume.$", 0x10, true, 0xb6157acc460a1fa6 );                
        SDK_FIXED_SIZE( io_queue_io_resume_t, 0x10 );                
    };                                                  
};
#include "magic/io_queue_io_resume_t.end.hpp"
SDK_VERIFY( class fx::io_queue_io_resume_t, 0x10 );
