...
#include "magic/cm_res_list_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxCmResList.m_ObjectFlagsByName.$", 0x2, true, 0xe95d616ef0d4048b );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxCmResList.$", 0x98, true, 0xa3188f81f1a3bea1 );                       
        SDK_FIXED_SIZE( cm_res_list_t, 0x98 );                       
    };                                                               
};
#include "magic/cm_res_list_t.end.hpp"
SDK_VERIFY( struct fx::cm_res_list_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::cm_res_list_t, 0x98 );
