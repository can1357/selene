...
namespace fx
{
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxFileObject.m_ObjectFlagsByName.$", 0x2, true, 0x6b580af0e6c5518d );                                            
        ...
        _m24 class mx::file_object_t          m_file_object;           //{ +0x0080    +0x0080    +0x0080    +0x0080    } | .m_FileObject
        _m25 void*                            m_pkg_context;           //{ +0x0088    +0x0088    +0x0088    +0x0088    } | .m_PkgContext
        _m26 nt::list_entry_t                 m_link;                  //{ +0x0090    +0x0090    +0x0090    +0x0090    } | .m_Link
                                                                     
        SDK_MAGIC_PROPERTIES( "FxFileObject.$", 0xa0, true, 0x684e2602967b95c2 );                       
        SDK_FIXED_SIZE( file_object_t, 0xa0 );                       
    };                                                               
};
#include "magic/file_object_t.end.hpp"
SDK_VERIFY( struct fx::file_object_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::file_object_t, 0xa0 );
