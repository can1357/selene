...
#include "magic/resource_io_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxResourceIo.m_ObjectFlagsByName.$", 0x2, true, 0xdfea1ddc27fc2052 );                                            
        ...
        _m23 struct io::resource_descriptor_t m_descriptor;            //{ +0x0068    +0x0068    +0x0068    +0x0068    } | .m_Descriptor
        _m24 struct io::resource_descriptor_t m_descriptor_clone;      //{ +0x0088    +0x0088    +0x0088    +0x0088    } | .m_DescriptorClone
                                                                     
        SDK_MAGIC_PROPERTIES( "FxResourceIo.$", 0xa8, true, 0xe58e79d7256ec076 );                       
        SDK_FIXED_SIZE( resource_io_t, 0xa8 );                       
    };                                                               
};
#include "magic/resource_io_t.end.hpp"
SDK_VERIFY( struct fx::resource_io_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::resource_io_t, 0xa8 );
