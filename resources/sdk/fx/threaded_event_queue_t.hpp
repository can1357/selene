...
#include "magic/threaded_event_queue_t.start.hpp"
namespace fx
{
    class pkg_pnp_t;
    struct cr_event_t;
    ...
    {                                                                 
        ...
        {                                                             
            ...
            SDK_MAGIC_PROPERTIES( "FxThreadedEventQueue.m_QueueFlagsByName.$", 0x1, true, 0x67d565be17b39f33 );                                           
        ...
        SDK_MAGIC_PROPERTIES( "FxThreadedEventQueue.$", 0x90, true, 0x1db1e91863c32fd0 );                          
        SDK_FIXED_SIZE( threaded_event_queue_t, 0x90 );                          
    };                                                                
};
#include "magic/threaded_event_queue_t.end.hpp"
SDK_VERIFY( struct fx::threaded_event_queue_t::u0_m_queue_flags_by_name_t, 0x1 );
SDK_VERIFY( struct fx::threaded_event_queue_t, 0x90 );
