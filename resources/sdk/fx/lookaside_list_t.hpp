...
namespace fx
{
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxLookasideList.m_ObjectFlagsByName.$", 0x2, true, 0x103e608bd26fb215 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxLookasideList.$", 0xb8, true, 0xd1633ea048f33227 );                       
        SDK_FIXED_SIZE( lookaside_list_t, 0xb8 );                       
    };                                                               
};
#include "magic/lookaside_list_t.end.hpp"
SDK_VERIFY( struct fx::lookaside_list_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::lookaside_list_t, 0xb8 );
