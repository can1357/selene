...
namespace mx { class paged_lock_t; }

#include "magic/reg_key_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxRegKey.m_ObjectFlagsByName.$", 0x2, true, 0xebcb1589ebfadf1b );                                            
            SDK_FIXED_SIZE( u0_m_object_flags_by_name_t, 0x2 );                                            
        };                                                           
                                                                     
        // Windows 10 v1607, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                       
        //                                                           
        _m00 struct fx::driver_globals_t*     m_globals;               //{ +0x0010    +0x0078    +0x0010    +0x0010    +0x0010    } | .m_Globals
        ...
        _m23 class mx::paged_lock_t*          m_lock;                  //{ +0x0068    +0x0068    +0x0068    +0x0068    } | .m_Lock
        _m24 void*                            m_key;                   //{ +0x0070    +0x0070    +0x0070    +0x0070    } | .m_Key
                                                                     
        SDK_MAGIC_PROPERTIES( "FxRegKey.$", 0x78, true, 0x511658f25886ce49 );                       
        SDK_DYNAMIC_SIZE( reg_key_t );                               
    };                                                               
};
#include "magic/reg_key_t.end.hpp"
SDK_VERIFY( struct fx::reg_key_t::u0_m_object_flags_by_name_t, 0x2 );
