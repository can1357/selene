...
#include "magic/wmi_instance_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxWmiInstance.m_ObjectFlagsByName.$", 0x2, true, 0xddc3914218f55f2d );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxWmiInstance.$", 0x90, true, 0xbe77e5728b5c5516 );                       
        SDK_FIXED_SIZE( wmi_instance_t, 0x90 );                       
    };                                                               
};
#include "magic/wmi_instance_t.end.hpp"
SDK_VERIFY( struct fx::wmi_instance_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::wmi_instance_t, 0x90 );
