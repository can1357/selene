...
#include "magic/io_target_t.start.hpp"
namespace fx
{
    class device_t;
    class driver_t;
    ...
    {                                                                 
        ...
        {                                                             
            ...
            SDK_MAGIC_PROPERTIES( "FxIoTarget.m_ObjectFlagsByName.$", 0x2, true, 0xc333cf55983a3450 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxIoTarget.$", 0x158, true, 0x33f89c05f6a9334a );                       
        SDK_FIXED_SIZE( io_target_t, 0x158 );                         
    };                                                                
};
#include "magic/io_target_t.end.hpp"
SDK_VERIFY( struct fx::io_target_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::io_target_t, 0x158 );
