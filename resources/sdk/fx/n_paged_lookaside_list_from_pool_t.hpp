...
#include "magic/n_paged_lookaside_list_from_pool_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    //
    class n_paged_lookaside_list_from_pool_t                           
    {                                                                  
        ...
        {                                                              
            ...
            SDK_MAGIC_PROPERTIES( "FxNPagedLookasideListFromPool.m_ObjectFlagsByName.$", 0x2, true, 0x9b3513d65f533547 );                                            
        ...
        _m28 struct nt::npaged_lookaside_list_t m_pool_lookaside;        //{ +0x0140    +0x0140    +0x0140    +0x0140    } | .m_PoolLookaside
                                                                       
        SDK_MAGIC_PROPERTIES( "FxNPagedLookasideListFromPool.$", 0x1c0, true, 0x5f004543fd35eea6 );                       
        SDK_FIXED_SIZE( n_paged_lookaside_list_from_pool_t, 0x1c0 );                       
    };                                                                 
};
#include "magic/n_paged_lookaside_list_from_pool_t.end.hpp"
SDK_VERIFY( struct fx::n_paged_lookaside_list_from_pool_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::n_paged_lookaside_list_from_pool_t, 0x1c0 );
