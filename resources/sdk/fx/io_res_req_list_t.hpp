...
#include "magic/io_res_req_list_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxIoResReqList.m_ObjectFlagsByName.$", 0x2, true, 0x1f99aaf6bb79576c );                                            
        ...
        _m28 uint32_t                         m_slot_number;           //{ +0x0098    +0x0098    +0x0098    +0x0098    } | .m_SlotNumber
        _m29 enum nt::interface_type_t        m_interface_type;        //{ +0x009c    +0x009c    +0x009c    +0x009c    } | .m_InterfaceType
                                                                     
        SDK_MAGIC_PROPERTIES( "FxIoResReqList.$", 0xa0, true, 0xa8115b93272b6ae1 );                       
        SDK_FIXED_SIZE( io_res_req_list_t, 0xa0 );                       
    };                                                               
};
#include "magic/io_res_req_list_t.end.hpp"
SDK_VERIFY( struct fx::io_res_req_list_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::io_res_req_list_t, 0xa0 );
