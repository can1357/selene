...
namespace wdf { struct wdfdpc_t; }

#include "magic/dpc_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                           
        ...
        {                                                                       
            ...
            SDK_MAGIC_PROPERTIES( "FxDpc.m_ObjectFlagsByName.$", 0x2, true, 0x12ec07207430963 );                                            
        ...
        _m24 struct nt::kdpc_t                           m_dpc;                   //{ +0x0078    +0x0078    +0x0078    +0x0078    } | .m_Dpc
        _m25 class fx::object_t*                         m_object;                //{ +0x00b8    +0x00b8    +0x00b8    +0x00b8    } | .m_Object
        _m26 class fx::callback_lock_t*                  m_callback_lock;         //{ +0x00c0    +0x00c0    +0x00c0    +0x00c0    } | .m_CallbackLock
        _m27 class fx::object_t*                         m_callback_lock_object;  //{ +0x00c8    +0x00c8    +0x00c8    +0x00c8    } | .m_CallbackLockObject
        _m28 sdk::function<void(struct wdf::wdfdpc_t*)>* m_callback;              //{ +0x00d0    +0x00d0    +0x00d0    +0x00d0    } | .m_Callback
        _m29 uint8_t                                     m_running_down;          //{ +0x00d8    +0x00d8    +0x00d8    +0x00d8    } | .m_RunningDown
                                                                                
        SDK_MAGIC_PROPERTIES( "FxDpc.$", 0xe0, true, 0xcad06da6da69a23f );                       
        SDK_FIXED_SIZE( dpc_t, 0xe0 );                                          
    };                                                                          
};
#include "magic/dpc_t.end.hpp"
SDK_VERIFY( struct fx::dpc_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::dpc_t, 0xe0 );
