...
#include "magic/non_paged_object_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxNonPagedObject.m_ObjectFlagsByName.$", 0x2, true, 0xf4c26ebf77aed215 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxNonPagedObject.$", 0x78, true, 0x652301a2c811fd90 );                       
        SDK_FIXED_SIZE( non_paged_object_t, 0x78 );                       
    };                                                               
};
#include "magic/non_paged_object_t.end.hpp"
SDK_VERIFY( struct fx::non_paged_object_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::non_paged_object_t, 0x78 );
