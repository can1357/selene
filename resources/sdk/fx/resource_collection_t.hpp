...
#include "magic/resource_collection_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    // [class FxResourceCollection]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class resource_collection_t                                      
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxResourceCollection.m_ObjectFlagsByName.$", 0x2, true, 0x2cc4074681d3a96c );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxResourceCollection.$", 0x98, true, 0x96731191d3a23713 );                       
        SDK_FIXED_SIZE( resource_collection_t, 0x98 );                       
    };                                                               
};
#include "magic/resource_collection_t.end.hpp"
SDK_VERIFY( struct fx::resource_collection_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::resource_collection_t, 0x98 );
