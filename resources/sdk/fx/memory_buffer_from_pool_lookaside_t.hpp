...
#include "magic/memory_buffer_from_pool_lookaside_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    //
    class memory_buffer_from_pool_lookaside_t                        
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxMemoryBufferFromPoolLookaside.m_ObjectFlagsByName.$", 0x2, true, 0xdd83e9a1b1ad0760 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxMemoryBufferFromPoolLookaside.$", 0x88, true, 0x7f73a172e069edae );                       
        SDK_FIXED_SIZE( memory_buffer_from_pool_lookaside_t, 0x88 );                       
    };                                                               
};
#include "magic/memory_buffer_from_pool_lookaside_t.end.hpp"
SDK_VERIFY( struct fx::memory_buffer_from_pool_lookaside_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::memory_buffer_from_pool_lookaside_t, 0x88 );
