...
#include "magic/request_memory_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxRequestMemory.m_ObjectFlagsByName.$", 0x2, true, 0x80fa5bf85e467191 );                                            
        ...
        _m24 void*                            m_p_buffer;              //{ +0x0078    +0x0078    +0x0078    +0x0078    } | .m_pBuffer
        _m25 class fx::request_t*             m_request;               //{ +0x0080    +0x0080    +0x0080    +0x0080    } | .m_Request
        _m26 struct nt::mdl_t*                m_mdl;                   //{ +0x0088    +0x0088    +0x0088    +0x0088    } | .m_Mdl
        _m27 uint16_t                         m_flags;                 //{ +0x0090    +0x0090    +0x0090    +0x0090    } | .m_Flags
                                                                     
        SDK_MAGIC_PROPERTIES( "FxRequestMemory.$", 0x98, true, 0x41d48eff43a7b51 );                       
        SDK_FIXED_SIZE( request_memory_t, 0x98 );                       
    };                                                               
};
#include "magic/request_memory_t.end.hpp"
SDK_VERIFY( struct fx::request_memory_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::request_memory_t, 0x98 );
