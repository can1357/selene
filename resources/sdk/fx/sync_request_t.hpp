...
#include "magic/sync_request_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                                       
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxSyncRequest.m_ObjectFlagsByName.$", 0x2, true, 0x3f92c7cf7e7b0781 );                                                         
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxSyncRequest.m_TargetFlagsByName.$", 0x1, true, 0xf8782a57ccede891 );                                                         
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxSyncRequest.m_VeriferFlagsByName.$", 0x2, true, 0xfa0ae32159d7814a );                                                                  
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxSyncRequest.m_RequestBaseFlagsByName.$", 0x1, true, 0xd17ec8c1f3d0ccf6 );                                                         
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxSyncRequest.m_RequestBaseStaticFlagsByName.$", 0x1, true, 0xc4fded6fe3841339 );                                                        
        ...
        _m075 struct fx::cr_event_t                     m_destroyed_event;                    //{ +0x00f8    +0x00f8    +0x00f8    +0x00f8    } | .m_DestroyedEvent
        _m076 class fx::request_base_t*                 m_true_request;                       //{ +0x0118    +0x0118    +0x0118    +0x0118    } | .m_TrueRequest
        _m077 uint8_t                                   m_clear_context_on_destroy;           //{ +0x0120    +0x0120    +0x0120    +0x0120    } | .m_ClearContextOnDestroy
                                                                                            
        SDK_MAGIC_PROPERTIES( "FxSyncRequest.$", 0x130, true, 0x7eca2d5367381d24 );                                    
        SDK_FIXED_SIZE( sync_request_t, 0x130 );                                            
    };                                                                                      
};
#include "magic/sync_request_t.end.hpp"
SDK_VERIFY( struct fx::sync_request_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( struct fx::sync_request_t::u4_m_target_flags_by_name_t, 0x1 );
SDK_VERIFY( struct fx::sync_request_t::u8_m_verifer_flags_by_name_t, 0x2 );
SDK_VERIFY( struct fx::sync_request_t::u12_m_request_base_flags_by_name_t, 0x1 );
SDK_VERIFY( struct fx::sync_request_t::u16_m_request_base_static_flags_by_name_t, 0x1 );
SDK_VERIFY( class fx::sync_request_t, 0x130 );
