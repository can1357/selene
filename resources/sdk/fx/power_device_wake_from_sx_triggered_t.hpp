...
#include "magic/power_device_wake_from_sx_triggered_t.start.hpp"
namespace fx
{
    class pkg_pnp_t;

    // [class FxPowerDeviceWakeFromSxTriggered]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class power_device_wake_from_sx_triggered_t                             
    {                                                                       
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                
        //                                                                  
        ...
        SDK_MAGIC_PROPERTIES( "FxPowerDeviceWakeFromSxTriggered.$", 0x28, true, 0xed5eed8646ebb296 );                
        SDK_DYNAMIC_SIZE( power_device_wake_from_sx_triggered_t );                
    };                                                                      
};
#include "magic/power_device_wake_from_sx_triggered_t.end.hpp"
