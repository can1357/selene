...
#include "pnp_device_remove_added_resources_t.hpp"
#include "pnp_device_d0_exit_pre_hw_disabled_t.hpp"
#include "pnp_device_d0_entry_post_hw_enabled_t.hpp"
#include "pnp_device_filter_resource_requirements_t.hpp"
#include "../wdf/reenumerate_self_interface_standard_t.hpp"
...
#include "magic/pkg_fdo_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                                                          
        ...
        {                                                                                                      
            ...
            SDK_MAGIC_PROPERTIES( "FxPkgFdo.m_ObjectFlagsByName.$", 0x2, true, 0x6d05fc5bb3240c1 );                                                                      
        ...
        using reenumerate_self_interface_standard_t =          struct wdf::reenumerate_self_interface_standard_t;                                                 
        using m_device_filter_add_resource_requirements_t =    class fx::pnp_device_filter_resource_requirements_t;                                                 
        using m_device_filter_remove_resource_requirements_t = class fx::pnp_device_filter_resource_requirements_t;                                                 
        ...
        _m097 class fx::child_list_t*                         m_default_device_list;                             //{ +0x0618    +0x0698    +0x0698    +0x0698    } | .m_DefaultDeviceList
        _m098 class fx::child_list_t*                         m_static_device_list;                              //{ +0x0620    +0x06a0    +0x06a0    +0x06a0    } | .m_StaticDeviceList
        _m099 class fx::io_target_t*                          m_default_target;                                  //{ +0x0628    +0x06a8    +0x06a8    +0x06a8    } | .m_DefaultTarget
        _m100 class fx::io_target_self_t*                     m_self_target;                                     //{ +0x0630    +0x06b0    +0x06b0    +0x06b0    } | .m_SelfTarget
        _m101 reenumerate_self_interface_standard_t           m_surprise_remove_and_reenumerate_self_interface;  //{ +0x0638    +0x06b8    +0x06b8    +0x06b8    } | .m_SurpriseRemoveAndReenumerateSelfInterface
        _m102 m_device_filter_add_resource_requirements_t     m_device_filter_add_resource_requirements;         //{ +0x0668    +0x06e0    +0x06e0    +0x06e0    } | .m_DeviceFilterAddResourceRequirements
        _m103 m_device_filter_remove_resource_requirements_t  m_device_filter_remove_resource_requirements;      //{ +0x0670    +0x06e8    +0x06e8    +0x06e8    } | .m_DeviceFilterRemoveResourceRequirements
        _m104 class fx::pnp_device_remove_added_resources_t   m_device_remove_added_resources;                   //{ +0x0678    +0x06f0    +0x06f0    +0x06f0    } | .m_DeviceRemoveAddedResources
        _m105 uint8_t                                         m_filter;                                          //{ +0x0680    +0x06f8    +0x06f8    +0x06f8    } | .m_Filter
                                                                                                               
        // Windows 10 v2004, Windows 11, Windows 10 v20H2                                                      
        //                                                                                                     
        _m106 union fx::pnp_state_t                           m_pnp_state;                                       //{ +0x0078    +0x0078    +0x0078    } | .m_PnpState
        _m107 union fx::pnp_caps_t                            m_pnp_caps;                                        //{ +0x007c    +0x007c    +0x007c    } | .m_PnpCaps
        _m108 class fx::companion_target_t*                   m_companion_target;                                //{ +0x03e8    +0x03e8    +0x03e8    } | .m_CompanionTarget
        _m109 int32_t                                         m_companion_target_status;                         //{ +0x03f0    +0x03f0    +0x03f0    } | .m_CompanionTargetStatus
        _m110 class fx::system_work_item_t*                   m_set_device_failed_attempt_restart_work_item;     //{ +0x0498    +0x0498    +0x0498    } | .m_SetDeviceFailedAttemptRestartWorkItem
        _m111 struct wdf::sleep_study_interface_t*            m_sleep_study;                                     //{ +0x04c8    +0x04c8    +0x04c8    } | .m_SleepStudy
        _m112 volatile int32_t                                m_sleep_study_power_ref_io_count;                  //{ +0x04d0    +0x04d0    +0x04d0    } | .m_SleepStudyPowerRefIoCount
        _m113 uint8_t                                         m_sleep_study_track_references;                    //{ +0x04d4    +0x04d4    +0x04d4    } | .m_SleepStudyTrackReferences
        _m114 class fx::pnp_device_d0_entry_post_hw_enabled_t m_device_d0_entry_post_hardware_enabled;           //{ +0x05a8    +0x05a8    +0x05a8    } | .m_DeviceD0EntryPostHardwareEnabled
        _m115 class fx::pnp_device_d0_exit_pre_hw_disabled_t  m_device_d0_exit_pre_hardware_disabled;            //{ +0x05d0    +0x05d0    +0x05d0    } | .m_DeviceD0ExitPreHardwareDisabled
                                                                                                               
        // Windows 10 v1607                                                                                    
        //                                                                                                     
        _m116 union fx::pnp_state_and_caps_t                  m_pnp_state_and_caps;                              //{ +0x0078    } | .m_PnpStateAndCaps
        _m117 class fx::system_work_item_t*                   m_surprise_remove_and_reenumerate_self_work_item;  //{ +0x0660    } | .m_SurpriseRemoveAndReenumerateSelfWorkItem
                                                                                                               
        SDK_MAGIC_PROPERTIES( "FxPkgFdo.$", 0x700, true, 0x2e0059de4a902d2c );                                                 
        SDK_DYNAMIC_SIZE( pkg_fdo_t );                                                                         
    };                                                                                                         
};
#include "magic/pkg_fdo_t.end.hpp"
SDK_VERIFY( struct fx::pkg_fdo_t::u0_m_object_flags_by_name_t, 0x2 );
