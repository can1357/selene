...
#include "../wdf/urb_control_transfer_t.hpp"
...
#include "magic/usb_device_control_context_t.start.hpp"
namespace fx
{
    // [struct FxUsbDeviceControlContext]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct usb_device_control_context_t                                      
    {                                                                        
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                    
        //                                                                   
        ...
        _m05 struct wdf::urb_control_transfer_t          m_urb_legacy;         //{ +0x0088    +0x0088    +0x0088    +0x0088    } | .m_UrbLegacy
        _m06 struct wdf::urb_control_transfer_t*         m_urb;                //{ +0x0110    +0x0110    +0x0110    +0x0110    } | .m_Urb
        _m07 struct nt::mdl_t*                           m_partial_mdl;        //{ +0x0118    +0x0118    +0x0118    +0x0118    } | .m_PartialMdl
        _m08 uint8_t                                     m_unlock_pages;       //{ +0x0120    +0x0120    +0x0120    +0x0120    } | .m_UnlockPages
                                                                             
        SDK_MAGIC_PROPERTIES( "FxUsbDeviceControlContext.$", 0x128, true, 0xf8479eaccf4e9cd5 );                    
        SDK_FIXED_SIZE( usb_device_control_context_t, 0x128 );                    
    };                                                                       
};
#include "magic/usb_device_control_context_t.end.hpp"
SDK_VERIFY( struct fx::usb_device_control_context_t, 0x128 );
