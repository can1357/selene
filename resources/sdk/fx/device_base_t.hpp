...
#include "magic/device_base_t.start.hpp"
namespace fx
{
    class device_t;
    class driver_t;
    ...
    {                                                                          
        ...
        {                                                                      
            ...
            SDK_MAGIC_PROPERTIES( "FxDeviceBase.m_ObjectFlagsByName.$", 0x2, true, 0x9100a419690a3bab );                                                     
        ...
        _m24 class fx::dispose_list_t*         m_dispose_list;                   //{ +0x0080    +0x0080    +0x0080    +0x0080    } | .m_DisposeList
        _m25 class fx::driver_t*               m_driver;                         //{ +0x0088    +0x0088    +0x0088    +0x0088    } | .m_Driver
        _m26 class mx::device_object_t         m_device_object;                  //{ +0x0090    +0x0090    +0x0090    +0x0090    } | .m_DeviceObject
        _m27 class mx::device_object_t         m_attached_device;                //{ +0x0098    +0x0098    +0x0098    +0x0098    } | .m_AttachedDevice
        _m28 class mx::device_object_t         m_physical_device;                //{ +0x00a0    +0x00a0    +0x00a0    +0x00a0    } | .m_PhysicalDevice
        _m29 class fx::callback_lock_t*        m_callback_lock_ptr;              //{ +0x00a8    +0x00a8    +0x00a8    +0x00a8    } | .m_CallbackLockPtr
        _m30 class fx::object_t*               m_callback_lock_object_ptr;       //{ +0x00b0    +0x00b0    +0x00b0    +0x00b0    } | .m_CallbackLockObjectPtr
        _m31 enum wdf::execution_level_t       m_execution_level;                //{ +0x00b8    +0x00b8    +0x00b8    +0x00b8    } | .m_ExecutionLevel
        _m32 enum wdf::synchronization_scope_t m_synchronization_scope;          //{ +0x00bc    +0x00bc    +0x00bc    +0x00bc    } | .m_SynchronizationScope
        _m33 int32_t                           m_dma_packet_transaction_status;  //{ +0x00c0    +0x00c0    +0x00c0    +0x00c0    } | .m_DmaPacketTransactionStatus
                                                                               
        SDK_MAGIC_PROPERTIES( "FxDeviceBase.$", 0xc8, true, 0x32917671696aeb4c );                                
        SDK_FIXED_SIZE( device_base_t, 0xc8 );                                 
    };                                                                         
};
#include "magic/device_base_t.end.hpp"
SDK_VERIFY( struct fx::device_base_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::device_base_t, 0xc8 );
