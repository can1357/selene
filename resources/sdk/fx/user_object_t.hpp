...
#include "magic/user_object_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxUserObject.m_ObjectFlagsByName.$", 0x2, true, 0xee1e102e4cb0c195 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxUserObject.$", 0x78, true, 0xdfee5445c91f5ec8 );                       
        SDK_FIXED_SIZE( user_object_t, 0x78 );                       
    };                                                               
};
#include "magic/user_object_t.end.hpp"
SDK_VERIFY( struct fx::user_object_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::user_object_t, 0x78 );
