...
#include "magic/pnp_device_d0_exit_t.start.hpp"
namespace fx
{
    class pkg_pnp_t;

    // [class FxPnpDeviceD0Exit]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class pnp_device_d0_exit_t                              
    {                                                       
        ...
        _m04 enum wdf::power_device_state_t m_target_state;   //{ +0x0028    +0x0028    +0x0028    +0x0028    } | .m_TargetState
                                                            
        SDK_MAGIC_PROPERTIES( "FxPnpDeviceD0Exit.$", 0x30, true, 0x7d7a7ed6850f4d6d );                
        SDK_FIXED_SIZE( pnp_device_d0_exit_t, 0x30 );                
    };                                                      
};
#include "magic/pnp_device_d0_exit_t.end.hpp"
SDK_VERIFY( class fx::pnp_device_d0_exit_t, 0x30 );
