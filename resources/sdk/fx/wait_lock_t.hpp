...
#include "magic/wait_lock_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxWaitLock.m_ObjectFlagsByName.$", 0x2, true, 0x1c4addb7c3fa2276 );                                            
        ...
        _m23 class mx::event_t                m_event;                 //{ +0x0068    +0x0068    +0x0068    +0x0068    } | .m_Event
        _m24 struct nt::kthread_t*            m_owning_thread;         //{ +0x0088    +0x0088    +0x0088    +0x0088    } | .m_OwningThread
                                                                     
        SDK_MAGIC_PROPERTIES( "FxWaitLock.$", 0x90, true, 0xba21e8b399a84d76 );                       
        SDK_FIXED_SIZE( wait_lock_t, 0x90 );                         
    };                                                               
};
#include "magic/wait_lock_t.end.hpp"
SDK_VERIFY( struct fx::wait_lock_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::wait_lock_t, 0x90 );
