...
#include "magic/dma_transaction_base_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                    
        ...
        {                                                                
            ...
            SDK_MAGIC_PROPERTIES( "FxDmaTransactionBase.m_ObjectFlagsByName.$", 0x2, true, 0xa8c7f148ab1ae332 );                                               
        ...
        SDK_MAGIC_PROPERTIES( "FxDmaTransactionBase.$", 0x100, true, 0xdc1dedbde828d4f3 );                          
        SDK_FIXED_SIZE( dma_transaction_base_t, 0x100 );                          
    };                                                                   
};
#include "magic/dma_transaction_base_t.end.hpp"
SDK_VERIFY( struct fx::dma_transaction_base_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::dma_transaction_base_t, 0x100 );
