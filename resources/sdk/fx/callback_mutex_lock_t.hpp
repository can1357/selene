...
#include "magic/callback_mutex_lock_t.start.hpp"
namespace fx
{
    ...
    {                                                       
        ...
        _m05 class mx::paged_lock_t       m_lock;             //{ +0x0030    +0x0030    +0x0030    +0x0030    } | .m_Lock
                                                            
        SDK_MAGIC_PROPERTIES( "FxCallbackMutexLock.$", 0x70, true, 0x1bcfffd7e5256697 );                  
        SDK_FIXED_SIZE( callback_mutex_lock_t, 0x70 );                  
    };                                                      
};
#include "magic/callback_mutex_lock_t.end.hpp"
SDK_VERIFY( class fx::callback_mutex_lock_t, 0x70 );
