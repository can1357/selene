...
#include "magic/pnp_device_release_hardware_t.start.hpp"
namespace fx
{
    class pkg_pnp_t;

    // [class FxPnpDeviceReleaseHardware]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class pnp_device_release_hardware_t                         
    {                                                           
        ...
        _m04 struct wdf::wdfcmreslist_t* m_resources_translated;  //{ +0x0028    +0x0028    +0x0028    +0x0028    } | .m_ResourcesTranslated
                                                                
        SDK_MAGIC_PROPERTIES( "FxPnpDeviceReleaseHardware.$", 0x30, true, 0xebeef1fc4a0ebd3b );                       
        SDK_FIXED_SIZE( pnp_device_release_hardware_t, 0x30 );                       
    };                                                          
};
#include "magic/pnp_device_release_hardware_t.end.hpp"
SDK_VERIFY( class fx::pnp_device_release_hardware_t, 0x30 );
