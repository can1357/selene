...
#include "magic/lookaside_list_from_pool_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    //
    class lookaside_list_from_pool_t                                 
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxLookasideListFromPool.m_ObjectFlagsByName.$", 0x2, true, 0xc2903df4b54ac506 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxLookasideListFromPool.$", 0xb8, true, 0x6bcc76d240529e78 );                       
        SDK_FIXED_SIZE( lookaside_list_from_pool_t, 0xb8 );                       
    };                                                               
};
#include "magic/lookaside_list_from_pool_t.end.hpp"
SDK_VERIFY( struct fx::lookaside_list_from_pool_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::lookaside_list_from_pool_t, 0xb8 );
