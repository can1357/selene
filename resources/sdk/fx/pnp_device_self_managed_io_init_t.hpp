...
#include "magic/pnp_device_self_managed_io_init_t.start.hpp"
namespace fx
{
    class pkg_pnp_t;

    // [class FxPnpDeviceSelfManagedIoInit]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class pnp_device_self_managed_io_init_t              
    {                                                    
        ...
        SDK_MAGIC_PROPERTIES( "FxPnpDeviceSelfManagedIoInit.$", 0x28, true, 0x7390946cd2e28346 );                
        SDK_FIXED_SIZE( pnp_device_self_managed_io_init_t, 0x28 );                
    };                                                   
};
#include "magic/pnp_device_self_managed_io_init_t.end.hpp"
SDK_VERIFY( class fx::pnp_device_self_managed_io_init_t, 0x28 );
