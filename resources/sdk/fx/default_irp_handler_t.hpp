...
#include "magic/default_irp_handler_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxDefaultIrpHandler.m_ObjectFlagsByName.$", 0x2, true, 0xaa9cd3c00b68bb08 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxDefaultIrpHandler.$", 0x78, true, 0xa56409aae575636 );                       
        SDK_FIXED_SIZE( default_irp_handler_t, 0x78 );                       
    };                                                               
};
#include "magic/default_irp_handler_t.end.hpp"
SDK_VERIFY( struct fx::default_irp_handler_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::default_irp_handler_t, 0x78 );
