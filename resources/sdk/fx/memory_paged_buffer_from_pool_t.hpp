...
#include "magic/memory_paged_buffer_from_pool_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    // [class FxMemoryPagedBufferFromPool]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class memory_paged_buffer_from_pool_t                            
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxMemoryPagedBufferFromPool.m_ObjectFlagsByName.$", 0x2, true, 0xc4e6defbc88fd025 );                                            
        ...
        _m24 void*                            m_pool;                  //{ +0x0078    +0x0078    +0x0078    +0x0078    } | .m_Pool
                                                                     
        SDK_MAGIC_PROPERTIES( "FxMemoryPagedBufferFromPool.$", 0x80, true, 0x258c725076755c90 );                       
        SDK_FIXED_SIZE( memory_paged_buffer_from_pool_t, 0x80 );                       
    };                                                               
};
#include "magic/memory_paged_buffer_from_pool_t.end.hpp"
SDK_VERIFY( struct fx::memory_paged_buffer_from_pool_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::memory_paged_buffer_from_pool_t, 0x80 );
