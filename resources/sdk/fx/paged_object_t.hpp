...
#include "magic/paged_object_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxPagedObject.m_ObjectFlagsByName.$", 0x2, true, 0x40716eee8faf691e );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxPagedObject.$", 0x70, true, 0x602a30c047e60365 );                       
        SDK_FIXED_SIZE( paged_object_t, 0x70 );                       
    };                                                               
};
#include "magic/paged_object_t.end.hpp"
SDK_VERIFY( struct fx::paged_object_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::paged_object_t, 0x70 );
