...
namespace fx
{
    ...
    {                                                                                       
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxRequest.m_ObjectFlagsByName.$", 0x2, true, 0xead5186d16793fda );                                                         
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxRequest.m_TargetFlagsByName.$", 0x1, true, 0xc5511a794e36fca9 );                                                         
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxRequest.m_VeriferFlagsByName.$", 0x2, true, 0x49e23fada07fdec );                                                                  
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxRequest.m_RequestBaseFlagsByName.$", 0x1, true, 0xa0de8d2313b7f1b2 );                                                         
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxRequest.m_RequestBaseStaticFlagsByName.$", 0x1, true, 0x6b4f1d52d9fefc9a );                                                        
        ...
        SDK_MAGIC_PROPERTIES( "FxRequest.$", 0x168, true, 0x8045a3329e2c15f0 );                                    
        SDK_FIXED_SIZE( request_t, 0x168 );                                                 
    };                                                                                      
};
#include "magic/request_t.end.hpp"
SDK_VERIFY( struct fx::request_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( struct fx::request_t::u4_m_target_flags_by_name_t, 0x1 );
SDK_VERIFY( struct fx::request_t::u8_m_verifer_flags_by_name_t, 0x2 );
SDK_VERIFY( struct fx::request_t::u12_m_request_base_flags_by_name_t, 0x1 );
SDK_VERIFY( struct fx::request_t::u16_m_request_base_static_flags_by_name_t, 0x1 );
SDK_VERIFY( class fx::request_t, 0x168 );
