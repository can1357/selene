...
#include "magic/memory_buffer_preallocated_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    //
    class memory_buffer_preallocated_t                               
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxMemoryBufferPreallocated.m_ObjectFlagsByName.$", 0x2, true, 0xa70dcc0acff73fd5 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxMemoryBufferPreallocated.$", 0x80, true, 0x3f07fcbc6683a518 );                       
        SDK_FIXED_SIZE( memory_buffer_preallocated_t, 0x80 );                       
    };                                                               
};
#include "magic/memory_buffer_preallocated_t.end.hpp"
SDK_VERIFY( struct fx::memory_buffer_preallocated_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::memory_buffer_preallocated_t, 0x80 );
