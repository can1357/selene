...
#include "magic/memory_buffer_from_lookaside_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    //
    class memory_buffer_from_lookaside_t                             
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxMemoryBufferFromLookaside.m_ObjectFlagsByName.$", 0x2, true, 0xdb0760e66b17a62b );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxMemoryBufferFromLookaside.$", 0x80, true, 0x3f4f93cb97e63478 );                       
        SDK_FIXED_SIZE( memory_buffer_from_lookaside_t, 0x80 );                       
    };                                                               
};
#include "magic/memory_buffer_from_lookaside_t.end.hpp"
SDK_VERIFY( struct fx::memory_buffer_from_lookaside_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::memory_buffer_from_lookaside_t, 0x80 );
