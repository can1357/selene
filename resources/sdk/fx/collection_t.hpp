...
#include "magic/collection_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxCollection.m_ObjectFlagsByName.$", 0x2, true, 0xebf5de9370b83190 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxCollection.$", 0x90, true, 0xe1a15e00de28127 );                       
        SDK_FIXED_SIZE( collection_t, 0x90 );                        
    };                                                               
};
#include "magic/collection_t.end.hpp"
SDK_VERIFY( struct fx::collection_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::collection_t, 0x90 );
