...
#include "request_output_buffer_t.hpp"
#include "request_system_buffer_t.hpp"
...
#include "magic/request_from_lookaside_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    //
    class request_from_lookaside_t                                                          
    {                                                                                       
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxRequestFromLookaside.m_ObjectFlagsByName.$", 0x2, true, 0x712cc3b50c397480 );                                                         
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxRequestFromLookaside.m_TargetFlagsByName.$", 0x1, true, 0xe8d35175251abfd9 );                                                         
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxRequestFromLookaside.m_VeriferFlagsByName.$", 0x2, true, 0x7e349e2d14f870db );                                                                  
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxRequestFromLookaside.m_RequestBaseFlagsByName.$", 0x1, true, 0x4d0616cd885c8238 );                                                         
        ...
        {                                                                                   
            ...
            SDK_MAGIC_PROPERTIES( "FxRequestFromLookaside.m_RequestBaseStaticFlagsByName.$", 0x1, true, 0xb22aaf90b0fc811e );                                                        
        ...
        _m075 class fx::io_queue_t*                     m_io_queue;                           //{ +0x00f8    +0x00f8    +0x00f8    +0x00f8    } | .m_IoQueue
        _m076 struct fx::request_system_buffer_t        m_system_buffer;                      //{ +0x0100    +0x0100    +0x0100    +0x0100    } | .m_SystemBuffer
        _m077 struct fx::request_output_buffer_t        m_output_buffer;                      //{ +0x0110    +0x0110    +0x0110    +0x0110    } | .m_OutputBuffer
        _m078 nt::list_entry_t                          m_owner_list_entry;                   //{ +0x0120    +0x0120    +0x0120    +0x0120    } | .m_OwnerListEntry
        _m079 nt::list_entry_t                          m_owner_list_entry2;                  //{ +0x0130    +0x0130    +0x0130    +0x0130    } | .m_OwnerListEntry2
        _m080 nt::list_entry_t                          m_forward_progress_list;              //{ +0x0140    +0x0140    +0x0140    +0x0140    } | .m_ForwardProgressList
        _m081 class fx::io_queue_t*                     m_forward_progress_queue;             //{ +0x0150    +0x0150    +0x0150    +0x0150    } | .m_ForwardProgressQueue
        _m082 void*                                     m_internal_context;                   //{ +0x0158    +0x0158    +0x0158    +0x0158    } | .m_InternalContext
        _m083 uint8_t                                   m_presented;                          //{ +0x0160    +0x0160    +0x0160    +0x0160    } | .m_Presented
        _m084 uint8_t                                   m_power_stop_state;                   //{ +0x0161    +0x0161    +0x0161    +0x0161    } | .m_PowerStopState
        _m085 uint8_t                                   m_reserved;                           //{ +0x0162    +0x0162    +0x0162    +0x0162    } | .m_Reserved
        _m086 uint8_t                                   m_forward_request_to_parent;          //{ +0x0163    +0x0163    +0x0163    +0x0163    } | .m_ForwardRequestToParent
                                                                                            
        SDK_MAGIC_PROPERTIES( "FxRequestFromLookaside.$", 0x168, true, 0x9014f17d3f2fc2d4 );                                    
        SDK_FIXED_SIZE( request_from_lookaside_t, 0x168 );                                    
    };                                                                                      
};
#include "magic/request_from_lookaside_t.end.hpp"
SDK_VERIFY( struct fx::request_from_lookaside_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( struct fx::request_from_lookaside_t::u4_m_target_flags_by_name_t, 0x1 );
SDK_VERIFY( struct fx::request_from_lookaside_t::u8_m_verifer_flags_by_name_t, 0x2 );
SDK_VERIFY( struct fx::request_from_lookaside_t::u12_m_request_base_flags_by_name_t, 0x1 );
SDK_VERIFY( struct fx::request_from_lookaside_t::u16_m_request_base_static_flags_by_name_t, 0x1 );
SDK_VERIFY( class fx::request_from_lookaside_t, 0x168 );
