...
#include "magic/string_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxString.m_ObjectFlagsByName.$", 0x2, true, 0x6334028835b4048f );                                            
        ...
        _m23 nt::unicode_view                 m_unicode_string;        //{ +0x0068    +0x0068    +0x0068    +0x0068    } | .m_UnicodeString
                                                                     
        SDK_MAGIC_PROPERTIES( "FxString.$", 0x78, true, 0x76880292e006487e );                       
        SDK_FIXED_SIZE( string_t, 0x78 );                            
    };                                                               
};
#include "magic/string_t.end.hpp"
SDK_VERIFY( struct fx::string_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::string_t, 0x78 );
