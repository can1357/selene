...
#include "magic/package_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxPackage.m_ObjectFlagsByName.$", 0x2, true, 0x62a4278c17968503 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxPackage.$", 0x78, true, 0xd516c75a6a84de9 );                       
        SDK_FIXED_SIZE( package_t, 0x78 );                           
    };                                                               
};
#include "magic/package_t.end.hpp"
SDK_VERIFY( struct fx::package_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::package_t, 0x78 );
