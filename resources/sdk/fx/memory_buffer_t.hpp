...
#include "magic/memory_buffer_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxMemoryBuffer.m_ObjectFlagsByName.$", 0x2, true, 0x593f01d0aec32b6d );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxMemoryBuffer.$", 0x78, true, 0x27226ab878e636cd );                       
        SDK_FIXED_SIZE( memory_buffer_t, 0x78 );                       
    };                                                               
};
#include "magic/memory_buffer_t.end.hpp"
SDK_VERIFY( struct fx::memory_buffer_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::memory_buffer_t, 0x78 );
