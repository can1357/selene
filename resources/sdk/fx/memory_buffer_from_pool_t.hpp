...
#include "magic/memory_buffer_from_pool_t.start.hpp"
namespace fx
{
    class device_t;
    class object_t;
    ...
    //
    class memory_buffer_from_pool_t                                  
    {                                                                
        ...
        {                                                            
            ...
            SDK_MAGIC_PROPERTIES( "FxMemoryBufferFromPool.m_ObjectFlagsByName.$", 0x2, true, 0xb220b93dd3629262 );                                            
        ...
        SDK_MAGIC_PROPERTIES( "FxMemoryBufferFromPool.$", 0x80, true, 0xfb87e7ce2204b101 );                       
        SDK_FIXED_SIZE( memory_buffer_from_pool_t, 0x80 );                       
    };                                                               
};
#include "magic/memory_buffer_from_pool_t.end.hpp"
SDK_VERIFY( struct fx::memory_buffer_from_pool_t::u0_m_object_flags_by_name_t, 0x2 );
SDK_VERIFY( class fx::memory_buffer_from_pool_t, 0x80 );
