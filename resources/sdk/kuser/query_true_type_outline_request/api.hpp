...
namespace kuser::query_true_type_outline_request
{
    // [Hff@QueryTrueTypeOutlineRequest]
    ...
    // [CaptureUsermodeParameters@QueryTrueTypeOutlineRequest]
    // Ldr = [win32kfull.sys, win32kbase.sys, win32k.sys]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    // win32kfull.sys .text:0x2d9c70, 0x13864 bytes
    // win32kfull.sys .text:0x13df40, 0x1596d bytes
    // win32kfull.sys .text:0x12f8b0, 0x1659e bytes
    // win32kfull.sys .text:0x13ee80, 0x1596d bytes
    //
    _m1(sdk::unknown_ptr) capture_usermode_parameters;
    
    // [CreateUsermodeParameters@QueryTrueTypeOutlineRequest]
    // Ldr = [win32kfull.sys, win32kbase.sys, win32k.sys]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    // win32kfull.sys .text:0x2da8f0, 0x13864 bytes
    // win32kfull.sys .text:0x13e930, 0x1596d bytes
    // win32kfull.sys .text:0x1302a0, 0x1659e bytes
    // win32kfull.sys .text:0x13f870, 0x1596d bytes
    //
    _m2(sdk::unknown_ptr) create_usermode_parameters;
    
    // [GetDrvType@QueryTrueTypeOutlineRequest]
    // Ldr = [win32kfull.sys, win32kbase.sys, win32k.sys]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    ...
    // [Zombied@QueryTrueTypeOutlineRequest]
    // Ldr = [win32kfull.sys, win32kbase.sys, win32k.sys]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
