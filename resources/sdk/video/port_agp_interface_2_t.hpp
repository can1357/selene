...
#include "magic/port_agp_interface_2_t.start.hpp"
namespace video
{
    // [struct _VIDEO_PORT_AGP_INTERFACE_2]
    // => WDK 10 (NV)
    //
    struct port_agp_interface_2_t                                           
    {                                                                       
        ...
        _m14 sdk::function<uint8_t(void*, uint32_t)>* agp_set_rate;           //{ +0x0068    } | .AgpSetRate
                                                                            
        SDK_NONVOL_PROPERTIES( "_VIDEO_PORT_AGP_INTERFACE_2.$", 0x0, false, 0x7316de44b804730b );                      
        SDK_FIXED_SIZE( port_agp_interface_2_t, 0x70 );                      
    };                                                                      
};
#include "magic/port_agp_interface_2_t.end.hpp"
SDK_VERIFY( struct video::port_agp_interface_2_t, 0x70 );
