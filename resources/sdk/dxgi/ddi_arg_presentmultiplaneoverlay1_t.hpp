...
#include "magic/ddi_arg_presentmultiplaneoverlay1_t.start.hpp"
namespace dxgi
{
    struct ddi_present_multiplane_overlay1_t;

    // [struct _DXGI_DDI_ARG_PRESENTMULTIPLANEOVERLAY1]
    // => WDK 10 (NV)
    //
    struct ddi_arg_presentmultiplaneoverlay1_t                                   
    {                                                                            
        // WDK 10                                                                
        //                                                                       
        ...
        SDK_NONVOL_PROPERTIES( "_DXGI_DDI_ARG_PRESENTMULTIPLANEOVERLAY1.$", 0x0, false, 0xa96b534c1011040b );                    
        SDK_FIXED_SIZE( ddi_arg_presentmultiplaneoverlay1_t, 0x28 );                    
    };                                                                           
};
#include "magic/ddi_arg_presentmultiplaneoverlay1_t.end.hpp"
SDK_VERIFY( struct dxgi::ddi_arg_presentmultiplaneoverlay1_t, 0x28 );
