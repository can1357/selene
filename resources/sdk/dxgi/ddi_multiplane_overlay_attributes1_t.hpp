...
#include "magic/ddi_multiplane_overlay_attributes1_t.start.hpp"
namespace dxgi
{
    // [struct DXGI_DDI_MULTIPLANE_OVERLAY_ATTRIBUTES1]
    // => WDK 10 (NV)
    //
    struct ddi_multiplane_overlay_attributes1_t                                      
    {                                                                                
        ...
        _m15 uint32_t                                        color_key;                //{ +0x0064    } | .ColorKey
                                                                                     
        SDK_NONVOL_PROPERTIES( "DXGI_DDI_MULTIPLANE_OVERLAY_ATTRIBUTES1.$", 0x0, false, 0x37a835a5607be535 );                        
        SDK_FIXED_SIZE( ddi_multiplane_overlay_attributes1_t, 0x68 );                        
    };                                                                               
};
#include "magic/ddi_multiplane_overlay_attributes1_t.end.hpp"
SDK_VERIFY( struct dxgi::ddi_multiplane_overlay_attributes1_t, 0x68 );
