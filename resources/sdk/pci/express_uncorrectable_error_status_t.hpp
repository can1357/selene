...
#include "magic/express_uncorrectable_error_status_t.start.hpp"
namespace pci
{
    // [union _PCI_EXPRESS_UNCORRECTABLE_ERROR_STATUS]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    union express_uncorrectable_error_status_t     
    {                                              
        ...
        SDK_NONVOL_PROPERTIES( "_PCI_EXPRESS_UNCORRECTABLE_ERROR_STATUS.$", 0x4, true, 0x262b81bd6b98b961 );                             
        SDK_FIXED_SIZE( express_uncorrectable_error_status_t, 0x4 );                             
    };                                             
};
#include "magic/express_uncorrectable_error_status_t.end.hpp"
SDK_VERIFY( union pci::express_uncorrectable_error_status_t, 0x4 );
