...
#include "magic/common_config_t.start.hpp"
namespace pci
{
    ...
    {                                                    
        ...
        _m15 sdk::array<uint8_t, 192>    device_specific;  //{ +0x0040    +0x0040    +0x0040    +0x0040    +0x0040    } | .DeviceSpecific
                                                         
        SDK_NONVOL_PROPERTIES( "_PCI_COMMON_CONFIG.$", 0x100, true, 0xca50f2281e801c45 );                
        SDK_FIXED_SIZE( common_config_t, 0x100 );                
    };                                                   
};
#include "magic/common_config_t.end.hpp"
SDK_VERIFY( struct pci::common_config_t, 0x100 );
