...
#include "magic/express_uncorrectable_error_severity_t.start.hpp"
namespace pci
{
    // [union _PCI_EXPRESS_UNCORRECTABLE_ERROR_SEVERITY]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    union express_uncorrectable_error_severity_t   
    {                                              
        ...
        SDK_NONVOL_PROPERTIES( "_PCI_EXPRESS_UNCORRECTABLE_ERROR_SEVERITY.$", 0x4, true, 0x4e807ca6fb6632ec );                             
        SDK_FIXED_SIZE( express_uncorrectable_error_severity_t, 0x4 );                             
    };                                             
};
#include "magic/express_uncorrectable_error_severity_t.end.hpp"
SDK_VERIFY( union pci::express_uncorrectable_error_severity_t, 0x4 );
