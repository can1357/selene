...
#include "magic/express_correctable_error_mask_t.start.hpp"
namespace pci
{
    // [union _PCI_EXPRESS_CORRECTABLE_ERROR_MASK]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    union express_correctable_error_mask_t     
    {                                          
        ...
        SDK_NONVOL_PROPERTIES( "_PCI_EXPRESS_CORRECTABLE_ERROR_MASK.$", 0x4, true, 0x9b4f40905cfd2da5 );                         
        SDK_FIXED_SIZE( express_correctable_error_mask_t, 0x4 );                         
    };                                         
};
#include "magic/express_correctable_error_mask_t.end.hpp"
SDK_VERIFY( union pci::express_correctable_error_mask_t, 0x4 );
