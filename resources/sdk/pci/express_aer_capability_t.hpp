...
#include "magic/express_aer_capability_t.start.hpp"
namespace pci
{
    // [struct _PCI_EXPRESS_AER_CAPABILITY]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct express_aer_capability_t                                                            
    {                                                                                          
        ...
        SDK_NONVOL_PROPERTIES( "_PCI_EXPRESS_AER_CAPABILITY.$", 0x4c, true, 0xc1469437ee11c1b6 );                                 
        SDK_FIXED_SIZE( express_aer_capability_t, 0x4c );                                      
    };                                                                                         
};
#include "magic/express_aer_capability_t.end.hpp"
SDK_VERIFY( struct pci::express_aer_capability_t, 0x4c );
