...
#include "magic/express_sec_uncorrectable_error_status_t.start.hpp"
namespace pci
{
    // [union _PCI_EXPRESS_SEC_UNCORRECTABLE_ERROR_STATUS]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    union express_sec_uncorrectable_error_status_t              
    {                                                           
        ...
        SDK_NONVOL_PROPERTIES( "_PCI_EXPRESS_SEC_UNCORRECTABLE_ERROR_STATUS.$", 0x4, true, 0xe3bf364c12c8c8ea );                                          
        SDK_FIXED_SIZE( express_sec_uncorrectable_error_status_t, 0x4 );                                          
    };                                                          
};
#include "magic/express_sec_uncorrectable_error_status_t.end.hpp"
SDK_VERIFY( union pci::express_sec_uncorrectable_error_status_t, 0x4 );
