...
#include "magic/express_dpc_rp_pio_severity_register_t.start.hpp"
namespace pci
{
    // [union _PCI_EXPRESS_DPC_RP_PIO_SEVERITY_REGISTER]
    // => WDK 10, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    union express_dpc_rp_pio_severity_register_t
    {                                           
        ...
        SDK_NONVOL_PROPERTIES( "_PCI_EXPRESS_DPC_RP_PIO_SEVERITY_REGISTER.$", 0x4, true, 0x76170a1a09979eb0 );           
        SDK_FIXED_SIZE( express_dpc_rp_pio_severity_register_t, 0x4 );           
    };                                          
};
#include "magic/express_dpc_rp_pio_severity_register_t.end.hpp"
SDK_VERIFY( union pci::express_dpc_rp_pio_severity_register_t, 0x4 );
