...
#include "magic/srbex_data_scsi_cdb32_t.start.hpp"
namespace stor::port
{
    // [struct _SRBEX_DATA_SCSI_CDB32]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct srbex_data_scsi_cdb32_t                                     
    {                                                                  
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                         
        //                                                             
        ...
        _m06 sdk::array<uint8_t, 32>          cdb;                       //{ +0x0018    +0x0018    +0x0018    +0x0018    } | .Cdb
                                                                       
        SDK_MAGIC_PROPERTIES( "_SRBEX_DATA_SCSI_CDB32.$", 0x38, true, 0x5ca2cd3199f61a93 );                         
        SDK_FIXED_SIZE( srbex_data_scsi_cdb32_t, 0x38 );                         
    };                                                                 
};
#include "magic/srbex_data_scsi_cdb32_t.end.hpp"
SDK_VERIFY( struct stor::port::srbex_data_scsi_cdb32_t, 0x38 );
