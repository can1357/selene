...
#include "magic/cdb12_t.start.hpp"
namespace stor::port
{
    // [struct _CDB12]
    ...
    {                                                   
        ...
        SDK_NONVOL_PROPERTIES( "_CDB12.$", 0xc, true, 0xc9697c37fa2d96ed );                    
        SDK_FIXED_SIZE( cdb12_t, 0xc );                    
    };                                                  
};
#include "magic/cdb12_t.end.hpp"
SDK_VERIFY( struct stor::port::cdb12_t, 0xc );
