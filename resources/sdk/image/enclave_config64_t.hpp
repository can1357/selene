...
#include "magic/enclave_config64_t.start.hpp"
namespace image
{
    // [struct _IMAGE_ENCLAVE_CONFIG64]
    // => Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct enclave_config64_t                                     
    {                                                             
        // Windows 10 v2004, Windows 11, Windows 10 v20H2                             
        //                                                        
        ...
        _m10 uint64_t                enclave_size;                  //{ +0x0040    +0x0040    +0x0040    } | .EnclaveSize
        _m11 uint32_t                number_of_threads;             //{ +0x0048    +0x0048    +0x0048    } | .NumberOfThreads
        _m12 uint32_t                enclave_flags;                 //{ +0x004c    +0x004c    +0x004c    } | .EnclaveFlags
                                                                  
        SDK_MAGIC_PROPERTIES( "_IMAGE_ENCLAVE_CONFIG64.$", 0x50, true, 0xacdf6d926097d58d );                             
        SDK_FIXED_SIZE( enclave_config64_t, 0x50 );                             
    };                                                            
};
#include "magic/enclave_config64_t.end.hpp"
SDK_VERIFY( struct image::enclave_config64_t, 0x50 );
