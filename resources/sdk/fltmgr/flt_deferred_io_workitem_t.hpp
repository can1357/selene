...
#include "magic/flt_deferred_io_workitem_t.start.hpp"
namespace fltmgr
{
    ...
    // [struct _FLT_DEFERRED_IO_WORKITEM]
    ...
    {                                                                    
        ...
        _m07 struct fltmgr::flt_instance_t*      instance;                 //{ +0x0060    +0x0060    +0x0060    +0x0060    } | .Instance
        _m08 struct fltmgr::flt_callback_data_t* callback_data;            //{ +0x0068    +0x0068    +0x0068    +0x0068    } | .CallbackData
                                                                         
        SDK_MAGIC_PROPERTIES( "_FLT_DEFERRED_IO_WORKITEM.$", 0x70, true, 0x5d78eed0c02a0acf );                        
        SDK_FIXED_SIZE( flt_deferred_io_workitem_t, 0x70 );                        
    };                                                                   
};
#include "magic/flt_deferred_io_workitem_t.end.hpp"
SDK_VERIFY( struct fltmgr::flt_deferred_io_workitem_t, 0x70 );
