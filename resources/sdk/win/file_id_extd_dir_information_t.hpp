...
#include "magic/file_id_extd_dir_information_t.start.hpp"
namespace win
{
    // [struct _FILE_ID_EXTD_DIR_INFORMATION]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct file_id_extd_dir_information_t                
    {                                                    
        ...
        _m13 sdk::array<wchar_t, 1>    file_name;          //{ +0x0058    +0x0058    +0x0058    +0x0058    +0x0058    } | .FileName
                                                         
        SDK_NONVOL_PROPERTIES( "_FILE_ID_EXTD_DIR_INFORMATION.$", 0x60, true, 0x86ea940b967922b3 );                  
        SDK_FIXED_SIZE( file_id_extd_dir_information_t, 0x60 );                  
    };                                                   
};
#include "magic/file_id_extd_dir_information_t.end.hpp"
SDK_VERIFY( struct win::file_id_extd_dir_information_t, 0x60 );
