...
#include "magic/c_read_m_interface_pointer_with_source_attributes_marshaling_stream_t.start.hpp"
namespace win
{
    ...
    //
    class c_read_m_interface_pointer_with_source_attributes_marshaling_stream_t
    {                                                                          
        ...
        SDK_MAGIC_PROPERTIES( "CReadMInterfacePointerWithSourceAttributesMarshalingStream.$", 0x40, true, 0x94437f688f987331 );                      
        SDK_FIXED_SIZE( c_read_m_interface_pointer_with_source_attributes_marshaling_stream_t, 0x40 );                      
    };                                                                         
};
#include "magic/c_read_m_interface_pointer_with_source_attributes_marshaling_stream_t.end.hpp"
SDK_VERIFY( class win::c_read_m_interface_pointer_with_source_attributes_marshaling_stream_t, 0x40 );
