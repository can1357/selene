...
#include "magic/file_directory_information_t.start.hpp"
namespace win
{
    ...
    {                                                 
        ...
        _m10 sdk::array<wchar_t, 1> file_name;          //{ +0x0040    +0x0040    +0x0040    +0x0040    +0x0040    } | .FileName
                                                      
        SDK_NONVOL_PROPERTIES( "_FILE_DIRECTORY_INFORMATION.$", 0x48, true, 0x47e1350a2c96376a );                  
        SDK_FIXED_SIZE( file_directory_information_t, 0x48 );                  
    };                                                
};
#include "magic/file_directory_information_t.end.hpp"
SDK_VERIFY( struct win::file_directory_information_t, 0x48 );
