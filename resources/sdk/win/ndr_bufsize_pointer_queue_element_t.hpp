...
#include "magic/ndr_bufsize_pointer_queue_element_t.start.hpp"
namespace win
{
    ...
    //
    class ndr_bufsize_pointer_queue_element_t                 
    {                                                         
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2         
        //                                                    
        ...
        SDK_MAGIC_PROPERTIES( "NDR_BUFSIZE_POINTER_QUEUE_ELEMENT.$", 0x30, true, 0x3be07b5599d3ae3c );         
        SDK_FIXED_SIZE( ndr_bufsize_pointer_queue_element_t, 0x30 );         
    };                                                        
};
#include "magic/ndr_bufsize_pointer_queue_element_t.end.hpp"
SDK_VERIFY( class win::ndr_bufsize_pointer_queue_element_t, 0x30 );
