...
#include "magic/c_ole32_debug_event_fire_t.start.hpp"
namespace win
{
    struct i_unknown_t;
    ...
    //
    class c_ole32_debug_event_fire_t                                   
    {                                                                  
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                 
        //                                                             
        ...
        SDK_MAGIC_PROPERTIES( "COle32DebugEventFire.$", 0x68, true, 0xaf9c42ed1e76cdc5 );                 
        SDK_FIXED_SIZE( c_ole32_debug_event_fire_t, 0x68 );                 
    };                                                                 
};
#include "magic/c_ole32_debug_event_fire_t.end.hpp"
SDK_VERIFY( class win::c_ole32_debug_event_fire_t, 0x68 );
