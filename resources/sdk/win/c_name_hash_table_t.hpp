...
#include "magic/c_name_hash_table_t.start.hpp"
namespace win
{
    class crw_lock_t;
    ...
    {                                                           
        ...
        SDK_MAGIC_PROPERTIES( "CNameHashTable.$", 0x28, true, 0xade28534d4e060b6 );              
        SDK_FIXED_SIZE( c_name_hash_table_t, 0x28 );              
    };                                                          
};
#include "magic/c_name_hash_table_t.end.hpp"
SDK_VERIFY( class win::c_name_hash_table_t, 0x28 );
