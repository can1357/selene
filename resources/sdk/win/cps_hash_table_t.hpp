...
#include "magic/cps_hash_table_t.start.hpp"
namespace win
{
    class crw_lock_t;
    ...
    {                                                           
        ...
        SDK_MAGIC_PROPERTIES( "CPSHashTable.$", 0x28, true, 0x60518045cda6792a );              
        SDK_FIXED_SIZE( cps_hash_table_t, 0x28 );               
    };                                                          
};
#include "magic/cps_hash_table_t.end.hpp"
SDK_VERIFY( class win::cps_hash_table_t, 0x28 );
