...
#include "magic/c_hash_table_t.start.hpp"
namespace win
{
    class crw_lock_t;
    ...
    {                                                           
        ...
        SDK_MAGIC_PROPERTIES( "CHashTable.$", 0x28, true, 0x98c53f05bacb4810 );              
        SDK_FIXED_SIZE( c_hash_table_t, 0x28 );                 
    };                                                          
};
#include "magic/c_hash_table_t.end.hpp"
SDK_VERIFY( class win::c_hash_table_t, 0x28 );
