...
#include "magic/vm_counters_t.start.hpp"
namespace win
{
    // [struct _VM_COUNTERS]
    ...
    {                                                 
        ...
        SDK_NONVOL_PROPERTIES( "_VM_COUNTERS.$", 0x58, true, 0xffc4105ea3cd8afc );                                
        SDK_FIXED_SIZE( vm_counters_t, 0x58 );                                
    };                                                
};
#include "magic/vm_counters_t.end.hpp"
SDK_VERIFY( struct win::vm_counters_t, 0x58 );
