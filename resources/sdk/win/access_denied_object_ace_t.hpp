...
#include "magic/access_denied_object_ace_t.start.hpp"
namespace win
{
    // [struct _ACCESS_DENIED_OBJECT_ACE]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct access_denied_object_ace_t                       
    {                                                       
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                      
        //                                                  
        ...
        SDK_MAGIC_PROPERTIES( "_ACCESS_DENIED_OBJECT_ACE.$", 0x30, true, 0xc102fcdfb9f9427e );                      
        SDK_FIXED_SIZE( access_denied_object_ace_t, 0x30 );                      
    };                                                      
};
#include "magic/access_denied_object_ace_t.end.hpp"
SDK_VERIFY( struct win::access_denied_object_ace_t, 0x30 );
