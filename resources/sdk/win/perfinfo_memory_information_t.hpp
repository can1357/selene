...
#include "magic/perfinfo_memory_information_t.start.hpp"
namespace win
{
    // [struct _PERFINFO_MEMORY_INFORMATION]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct perfinfo_memory_information_t                           
    {                                                              
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                              
        //                                                         
        ...
        SDK_MAGIC_PROPERTIES( "_PERFINFO_MEMORY_INFORMATION.$", 0xb0, true, 0xe34323e8fe405134 );                              
        SDK_FIXED_SIZE( perfinfo_memory_information_t, 0xb0 );                              
    };                                                             
};
#include "magic/perfinfo_memory_information_t.end.hpp"
SDK_VERIFY( struct win::perfinfo_memory_information_t, 0xb0 );
