...
#include "magic/modern_sta_state_t.start.hpp"
namespace win
{
    ...
    {                                                                                                    
        ...
        SDK_MAGIC_PROPERTIES( "ModernSTAState.$", 0xe8, true, 0x128584cf34bacf87 );                                                 
        SDK_FIXED_SIZE( modern_sta_state_t, 0xe8 );                                                      
    };                                                                                                   
};
#include "magic/modern_sta_state_t.end.hpp"
SDK_VERIFY( class win::modern_sta_state_t, 0xe8 );
