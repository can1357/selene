...
#include "magic/c_activatable_class_id_hash_table_t.start.hpp"
namespace win
{
    class crw_lock_t;
    ...
    //
    class c_activatable_class_id_hash_table_t                   
    {                                                           
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2              
        //                                                      
        ...
        SDK_MAGIC_PROPERTIES( "CActivatableClassIdHashTable.$", 0x28, true, 0x3a5ab7671f05d3da );              
        SDK_FIXED_SIZE( c_activatable_class_id_hash_table_t, 0x28 );              
    };                                                          
};
#include "magic/c_activatable_class_id_hash_table_t.end.hpp"
SDK_VERIFY( class win::c_activatable_class_id_hash_table_t, 0x28 );
