...
#include "magic/c_string_hash_table_t.start.hpp"
namespace win
{
    class crw_lock_t;
    ...
    {                                                           
        ...
        SDK_MAGIC_PROPERTIES( "CStringHashTable.$", 0x28, true, 0x4efdba9065e8a620 );              
        SDK_FIXED_SIZE( c_string_hash_table_t, 0x28 );              
    };                                                          
};
#include "magic/c_string_hash_table_t.end.hpp"
SDK_VERIFY( class win::c_string_hash_table_t, 0x28 );
