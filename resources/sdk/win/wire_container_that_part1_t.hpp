...
#include "magic/wire_container_that_part1_t.start.hpp"
namespace win
{
    // [struct WireContainerThatPart1]
    // => Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct wire_container_that_part1_t                         
    {                                                          
        // Windows 10 v2004, Windows 11, Windows 10 v20H2                                
        //                                                     
        ...
        _m18 uint32_t          unique;                           //{ +0x00cc    +0x00cc    +0x00cc    } | .unique
                                                               
        SDK_MAGIC_PROPERTIES( "WireContainerThatPart1.$", 0xd0, true, 0xf8046eca0ff81603 );                                
        SDK_FIXED_SIZE( wire_container_that_part1_t, 0xd0 );                                
    };                                                         
};
#include "magic/wire_container_that_part1_t.end.hpp"
SDK_VERIFY( struct win::wire_container_that_part1_t, 0xd0 );
