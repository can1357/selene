...
#include "magic/winrt_rtti_parameterized_delegate_v1_t.start.hpp"
namespace win
{
    struct winrt_rtti_t;
    ...
    //
    struct winrt_rtti_parameterized_delegate_v1_t                
    {                                                            
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2             
        //                                                       
        ...
        SDK_MAGIC_PROPERTIES( "WinrtRttiParameterizedDelegate_V1.$", 0x28, true, 0x23f565d087da7fa8 );             
        SDK_FIXED_SIZE( winrt_rtti_parameterized_delegate_v1_t, 0x28 );             
    };                                                           
};
#include "magic/winrt_rtti_parameterized_delegate_v1_t.end.hpp"
SDK_VERIFY( struct win::winrt_rtti_parameterized_delegate_v1_t, 0x28 );
