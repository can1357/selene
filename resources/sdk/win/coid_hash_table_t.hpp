...
#include "magic/coid_hash_table_t.start.hpp"
namespace win
{
    class crw_lock_t;
    ...
    {                                                           
        ...
        SDK_MAGIC_PROPERTIES( "COIDHashTable.$", 0x28, true, 0xfe035c0ec994754a );              
        SDK_FIXED_SIZE( coid_hash_table_t, 0x28 );              
    };                                                          
};
#include "magic/coid_hash_table_t.end.hpp"
SDK_VERIFY( class win::coid_hash_table_t, 0x28 );
