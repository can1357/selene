...
#include "magic/startupinfow_t.start.hpp"
namespace win
{
    // [struct _STARTUPINFOW]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct startupinfow_t               
    {                                   
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                  
        //                              
        _m00 uint32_t cb;                 //{ +0x0000    +0x0000    +0x0000    +0x0000    } | .cb
        _m01 wchar_t* lp_reserved;        //{ +0x0008    +0x0008    +0x0008    +0x0008    } | .lpReserved
        _m02 wchar_t* lp_desktop;         //{ +0x0010    +0x0010    +0x0010    +0x0010    } | .lpDesktop
        _m03 wchar_t* lp_title;           //{ +0x0018    +0x0018    +0x0018    +0x0018    } | .lpTitle
        ...
        SDK_MAGIC_PROPERTIES( "_STARTUPINFOW.$", 0x68, true, 0xf6dd42714543eeec );                  
        SDK_FIXED_SIZE( startupinfow_t, 0x68 );                  
    };                                  
};
#include "magic/startupinfow_t.end.hpp"
SDK_VERIFY( struct win::startupinfow_t, 0x68 );
