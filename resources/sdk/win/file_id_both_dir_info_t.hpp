...
#include "magic/file_id_both_dir_info_t.start.hpp"
namespace win
{
    // [struct _FILE_ID_BOTH_DIR_INFO]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct file_id_both_dir_info_t                     
    {                                                  
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                  
        //                                             
        ...
        _m11 char                    short_name_length;  //{ +0x0044    +0x0044    +0x0044    +0x0044    } | .ShortNameLength
        _m12 sdk::array<wchar_t, 12> short_name;         //{ +0x0046    +0x0046    +0x0046    +0x0046    } | .ShortName
        _m13 int64_t                 file_id;            //{ +0x0060    +0x0060    +0x0060    +0x0060    } | .FileId
        _m14 sdk::array<wchar_t, 1>  file_name;          //{ +0x0068    +0x0068    +0x0068    +0x0068    } | .FileName
                                                       
        SDK_MAGIC_PROPERTIES( "_FILE_ID_BOTH_DIR_INFO.$", 0x70, true, 0x8b5912835233d9c9 );                  
        SDK_FIXED_SIZE( file_id_both_dir_info_t, 0x70 );                  
    };                                                 
};
#include "magic/file_id_both_dir_info_t.end.hpp"
SDK_VERIFY( struct win::file_id_both_dir_info_t, 0x70 );
