...
#include "magic/containerthis_t.start.hpp"
namespace win
{
    ...
    {                                                                                     
        ...
        _m21 struct win::container_extent_array_t* extensions;                              //{ +0x00e0    +0x00e0    +0x00e0    } | .extensions
                                                                                          
        SDK_MAGIC_PROPERTIES( "CONTAINERTHIS.$", 0xe8, true, 0x34a5e99ccde87d77 );                                       
        SDK_FIXED_SIZE( containerthis_t, 0xe8 );                                          
    };                                                                                    
};
#include "magic/containerthis_t.end.hpp"
SDK_VERIFY( struct win::containerthis_t, 0xe8 );
