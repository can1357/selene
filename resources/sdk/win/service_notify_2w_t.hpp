...
#include "magic/service_notify_2w_t.start.hpp"
namespace win
{
    // [struct _SERVICE_NOTIFY_2W]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct service_notify_2w_t                                              
    {                                                                       
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                          
        //                                                                  
        ...
        _m06 wchar_t*                             psz_service_names;          //{ +0x0048    +0x0048    +0x0048    +0x0048    } | .pszServiceNames
                                                                            
        SDK_MAGIC_PROPERTIES( "_SERVICE_NOTIFY_2W.$", 0x50, true, 0xff395115111152da );                          
        SDK_FIXED_SIZE( service_notify_2w_t, 0x50 );                          
    };                                                                      
};
#include "magic/service_notify_2w_t.end.hpp"
SDK_VERIFY( struct win::service_notify_2w_t, 0x50 );
