...
#include "magic/exfat_statistics_t.start.hpp"
namespace win
{
    // [struct _EXFAT_STATISTICS]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct exfat_statistics_t                
    {                                        
        ...
        SDK_NONVOL_PROPERTIES( "_EXFAT_STATISTICS.$", 0x24, true, 0x4f560485e622043d );                       
        SDK_FIXED_SIZE( exfat_statistics_t, 0x24 );                       
    };                                       
};
#include "magic/exfat_statistics_t.end.hpp"
SDK_VERIFY( struct win::exfat_statistics_t, 0x24 );
