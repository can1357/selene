...
#include "magic/perfinfo_process_perfctr_t.start.hpp"
namespace win
{
    // [struct _PERFINFO_PROCESS_PERFCTR]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct perfinfo_process_perfctr_t                 
    {                                                 
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                                
        //                                            
        ...
        SDK_MAGIC_PROPERTIES( "_PERFINFO_PROCESS_PERFCTR.$", 0x68, true, 0x17186f7f724cbf14 );                                
        SDK_FIXED_SIZE( perfinfo_process_perfctr_t, 0x68 );                                
    };                                                
};
#include "magic/perfinfo_process_perfctr_t.end.hpp"
SDK_VERIFY( struct win::perfinfo_process_perfctr_t, 0x68 );
