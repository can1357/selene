...
#include "magic/cpid_hash_table_t.start.hpp"
namespace win
{
    class crw_lock_t;
    ...
    {                                                           
        ...
        SDK_MAGIC_PROPERTIES( "CPIDHashTable.$", 0x28, true, 0x8111a91b5a99fda7 );              
        SDK_FIXED_SIZE( cpid_hash_table_t, 0x28 );              
    };                                                          
};
#include "magic/cpid_hash_table_t.end.hpp"
SDK_VERIFY( class win::cpid_hash_table_t, 0x28 );
