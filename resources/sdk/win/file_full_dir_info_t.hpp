...
#include "magic/file_full_dir_info_t.start.hpp"
namespace win
{
    // [struct _FILE_FULL_DIR_INFO]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct file_full_dir_info_t                       
    {                                                 
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                  
        //                                            
        ...
        _m11 sdk::array<wchar_t, 1> file_name;          //{ +0x0044    +0x0044    +0x0044    +0x0044    } | .FileName
                                                      
        SDK_MAGIC_PROPERTIES( "_FILE_FULL_DIR_INFO.$", 0x48, true, 0x40efd4d054e9536c );                  
        SDK_FIXED_SIZE( file_full_dir_info_t, 0x48 );                  
    };                                                
};
#include "magic/file_full_dir_info_t.end.hpp"
SDK_VERIFY( struct win::file_full_dir_info_t, 0x48 );
