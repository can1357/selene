...
#include "magic/ldt_entry_t.start.hpp"
namespace win
{
    // [struct _LDT_ENTRY]
    ...
    {                                                    
        ...
        {                                                
            ...
            {                                            
                ...
                SDK_MAGIC_PROPERTIES( "_LDT_ENTRY.HighWord.Bytes.$", 0x4, true, 0xabb4b0d62d1a765b );                         
            ...
            {                                            
                ...
                SDK_MAGIC_PROPERTIES( "_LDT_ENTRY.HighWord.Bits.$", 0x4, true, 0xc123faa54b0d3f72 );                            
            ...
            SDK_MAGIC_PROPERTIES( "_LDT_ENTRY.HighWord.$", 0x4, true, 0x9babd3873c7ac056 );                
        ...
        SDK_MAGIC_PROPERTIES( "_LDT_ENTRY.$", 0x8, true, 0x3066c0c734760faa );          
        SDK_FIXED_SIZE( ldt_entry_t, 0x8 );              
    };                                                   
};
#include "magic/ldt_entry_t.end.hpp"
SDK_VERIFY( struct win::ldt_entry_t::u0_high_word_t::u4_bytes_t, 0x4 );
SDK_VERIFY( struct win::ldt_entry_t::u0_high_word_t::u8_bits_t, 0x4 );
SDK_VERIFY( union win::ldt_entry_t::u0_high_word_t, 0x4 );
SDK_VERIFY( struct win::ldt_entry_t, 0x8 );
