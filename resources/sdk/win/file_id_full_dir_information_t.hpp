...
#include "magic/file_id_full_dir_information_t.start.hpp"
namespace win
{
    // [struct _FILE_ID_FULL_DIR_INFORMATION]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct file_id_full_dir_information_t             
    {                                                 
        ...
        _m11 int64_t                file_id;            //{ +0x0048    +0x0048    +0x0048    +0x0048    +0x0048    } | .FileId
        _m12 sdk::array<wchar_t, 1> file_name;          //{ +0x0050    +0x0050    +0x0050    +0x0050    +0x0050    } | .FileName
                                                      
        SDK_NONVOL_PROPERTIES( "_FILE_ID_FULL_DIR_INFORMATION.$", 0x58, true, 0x522581d436d4adda );                  
        SDK_FIXED_SIZE( file_id_full_dir_information_t, 0x58 );                  
    };                                                
};
#include "magic/file_id_full_dir_information_t.end.hpp"
SDK_VERIFY( struct win::file_id_full_dir_information_t, 0x58 );
