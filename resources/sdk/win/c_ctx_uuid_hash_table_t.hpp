...
#include "magic/c_ctx_uuid_hash_table_t.start.hpp"
namespace win
{
    class crw_lock_t;
    ...
    {                                                           
        ...
        SDK_MAGIC_PROPERTIES( "CCtxUUIDHashTable.$", 0x28, true, 0x23229c333e99cd5c );              
        SDK_FIXED_SIZE( c_ctx_uuid_hash_table_t, 0x28 );              
    };                                                          
};
#include "magic/c_ctx_uuid_hash_table_t.end.hpp"
SDK_VERIFY( class win::c_ctx_uuid_hash_table_t, 0x28 );
