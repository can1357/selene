...
#include "magic/c_com_reg_catalog_t.start.hpp"
namespace win
{
    struct hkey_t;
    ...
    {                                                                     
        ...
        SDK_MAGIC_PROPERTIES( "CComRegCatalog.$", 0x28, true, 0xb1375e944e80653 );                       
        SDK_FIXED_SIZE( c_com_reg_catalog_t, 0x28 );                       
    };                                                                    
};
#include "magic/c_com_reg_catalog_t.end.hpp"
SDK_VERIFY( class win::c_com_reg_catalog_t, 0x28 );
