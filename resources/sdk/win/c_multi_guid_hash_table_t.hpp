...
#include "magic/c_multi_guid_hash_table_t.start.hpp"
namespace win
{
    class crw_lock_t;
    ...
    //
    class c_multi_guid_hash_table_t                             
    {                                                           
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2              
        //                                                      
        ...
        SDK_MAGIC_PROPERTIES( "CMultiGUIDHashTable.$", 0x28, true, 0x4ebda433d1887116 );              
        SDK_FIXED_SIZE( c_multi_guid_hash_table_t, 0x28 );              
    };                                                          
};
#include "magic/c_multi_guid_hash_table_t.end.hpp"
SDK_VERIFY( class win::c_multi_guid_hash_table_t, 0x28 );
