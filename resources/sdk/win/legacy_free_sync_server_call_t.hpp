...
#include "magic/legacy_free_sync_server_call_t.start.hpp"
namespace win
{
    class c_ctx_call_t;
    ...
    //
    class legacy_free_sync_server_call_t                                                          
    {                                                                                             
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                                    
        //                                                                                        
        ...
        SDK_MAGIC_PROPERTIES( "LegacyFreeSyncServerCall.$", 0xd8, true, 0x893f1422a8890468 );                                    
        SDK_DYNAMIC_SIZE( legacy_free_sync_server_call_t );                                       
    };                                                                                            
};
#include "magic/legacy_free_sync_server_call_t.end.hpp"
