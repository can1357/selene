...
#include "magic/c_base_m_interface_pointer_marshaling_stream_t.start.hpp"
namespace win
{
    // [class CBaseMInterfacePointerMarshalingStream]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class c_base_m_interface_pointer_marshaling_stream_t              
    {                                                                 
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                      
        //                                                            
        ...
        SDK_MAGIC_PROPERTIES( "CBaseMInterfacePointerMarshalingStream.$", 0x30, true, 0x143a50db0f087267 );                      
        SDK_FIXED_SIZE( c_base_m_interface_pointer_marshaling_stream_t, 0x30 );                      
    };                                                                
};
#include "magic/c_base_m_interface_pointer_marshaling_stream_t.end.hpp"
SDK_VERIFY( class win::c_base_m_interface_pointer_marshaling_stream_t, 0x30 );
