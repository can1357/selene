...
#include "magic/c_base_interface_data_marshaling_stream_t.start.hpp"
namespace win
{
    // [class CBaseInterfaceDataMarshalingStream]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class c_base_interface_data_marshaling_stream_t                   
    {                                                                 
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                      
        //                                                            
        ...
        SDK_MAGIC_PROPERTIES( "CBaseInterfaceDataMarshalingStream.$", 0x30, true, 0x3dd9b6b7bf981adf );                      
        SDK_FIXED_SIZE( c_base_interface_data_marshaling_stream_t, 0x30 );                      
    };                                                                
};
#include "magic/c_base_interface_data_marshaling_stream_t.end.hpp"
SDK_VERIFY( class win::c_base_interface_data_marshaling_stream_t, 0x30 );
