...
#include "magic/c_pointer_hash_table_t.start.hpp"
namespace win
{
    class crw_lock_t;
    ...
    {                                                           
        ...
        SDK_MAGIC_PROPERTIES( "CPointerHashTable.$", 0x28, true, 0xeced207275f41091 );              
        SDK_FIXED_SIZE( c_pointer_hash_table_t, 0x28 );              
    };                                                          
};
#include "magic/c_pointer_hash_table_t.end.hpp"
SDK_VERIFY( class win::c_pointer_hash_table_t, 0x28 );
