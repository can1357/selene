...
#include "magic/c_read_interface_data_from_internal_source_marshaling_stream_t.start.hpp"
namespace win
{
    // [class CReadInterfaceDataFromInternalSourceMarshalingStream]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class c_read_interface_data_from_internal_source_marshaling_stream_t
    {                                                                   
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                      
        //                                                            
        ...
        SDK_MAGIC_PROPERTIES( "CReadInterfaceDataFromInternalSourceMarshalingStream.$", 0x30, true, 0x1f68c7f371cefb6d );                      
        SDK_FIXED_SIZE( c_read_interface_data_from_internal_source_marshaling_stream_t, 0x30 );                      
    };                                                                  
};
#include "magic/c_read_interface_data_from_internal_source_marshaling_stream_t.end.hpp"
SDK_VERIFY( class win::c_read_interface_data_from_internal_source_marshaling_stream_t, 0x30 );
