...
#include "magic/winrt_rtti_parameterized_interface_v1_t.start.hpp"
namespace win
{
    struct winrt_rtti_t;
    ...
    //
    struct winrt_rtti_parameterized_interface_v1_t               
    {                                                            
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2             
        //                                                       
        ...
        SDK_MAGIC_PROPERTIES( "WinrtRttiParameterizedInterface_V1.$", 0x28, true, 0xc541c0d30db7abea );             
        SDK_FIXED_SIZE( winrt_rtti_parameterized_interface_v1_t, 0x28 );             
    };                                                           
};
#include "magic/winrt_rtti_parameterized_interface_v1_t.end.hpp"
SDK_VERIFY( struct win::winrt_rtti_parameterized_interface_v1_t, 0x28 );
