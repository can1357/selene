...
#include "magic/legacy_free_sync_client_call_t.start.hpp"
namespace win
{
    class oxid_entry_t;
    class c_std_identity_t;

    // [class LegacyFreeSyncClientCall]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    class legacy_free_sync_client_call_t                                                                              
    {                                                                                                                 
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                                                        
        //                                                                                                            
        ...
        SDK_MAGIC_PROPERTIES( "LegacyFreeSyncClientCall.$", 0xb0, true, 0x2dc1fc84e672fa9d );                                                        
        SDK_DYNAMIC_SIZE( legacy_free_sync_client_call_t );                                                           
    };                                                                                                                
};
#include "magic/legacy_free_sync_client_call_t.end.hpp"
