...
#include "magic/system_alarm_callback_object_ace_t.start.hpp"
namespace win
{
    // [struct _SYSTEM_ALARM_CALLBACK_OBJECT_ACE]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct system_alarm_callback_object_ace_t               
    {                                                       
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                      
        //                                                  
        ...
        SDK_MAGIC_PROPERTIES( "_SYSTEM_ALARM_CALLBACK_OBJECT_ACE.$", 0x30, true, 0xd60daf8d3b535266 );                      
        SDK_FIXED_SIZE( system_alarm_callback_object_ace_t, 0x30 );                      
    };                                                      
};
#include "magic/system_alarm_callback_object_ace_t.end.hpp"
SDK_VERIFY( struct win::system_alarm_callback_object_ace_t, 0x30 );
