...
#include "magic/ndr64_user_marshal_format_t.start.hpp"
namespace win
{
    // [struct _NDR64_USER_MARSHAL_FORMAT]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct ndr64_user_marshal_format_t                   
    {                                                    
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                                
        //                                               
        ...
        _m05 uint32_t    user_type_memory_size;            //{ +0x0008    +0x0008    +0x0008    +0x0008    } | .UserTypeMemorySize
        ...
        SDK_MAGIC_PROPERTIES( "_NDR64_USER_MARSHAL_FORMAT.$", 0x18, true, 0x159eb6024f8b0fc );                                
        SDK_FIXED_SIZE( ndr64_user_marshal_format_t, 0x18 );                                
    };                                                   
};
#include "magic/ndr64_user_marshal_format_t.end.hpp"
SDK_VERIFY( struct win::ndr64_user_marshal_format_t, 0x18 );
