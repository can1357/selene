...
namespace d3dk::mt
{
    // [struct D3DKMT_MULTIPLANE_OVERLAY_ATTRIBUTES]
    // => WDK 10 (NV)
    //
    ...
    {                                                                                
        ...
        SDK_NONVOL_PROPERTIES( "D3DKMT_MULTIPLANE_OVERLAY_ATTRIBUTES.$", 0x0, false, 0xd0bdc1d69a3f4579 );                        
        SDK_FIXED_SIZE( multiplane_overlay_attributes_t, 0x68 );                        
    };                                                                               
};
#include "magic/multiplane_overlay_attributes_t.end.hpp"
SDK_VERIFY( struct d3dk::mt::multiplane_overlay_attributes_t, 0x68 );
