...
namespace d3dk::mt
{
    // [struct D3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO]
    // => WDK 10 (NV)
    //
    ...
    {                                                    
        ...
        SDK_NONVOL_PROPERTIES( "D3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO.$", 0x0, false, 0x10ddae223577feaf );              
...
SDK_VERIFY( struct d3dk::mt::check_multiplane_overlay_support_return_info_t, 0x4 );
