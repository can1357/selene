...
#include "magic/wmi_perf_states_t.start.hpp"
namespace ppm
{
    // [struct PPM_WMI_PERF_STATES]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct wmi_perf_states_t                                                
    {                                                                       
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                   
        //                                                                  
        ...
        _m11 uint64_t                                    target_processors;   //{ +0x0028    +0x0028    +0x0028    +0x0028    } | .TargetProcessors
        ...
        SDK_MAGIC_PROPERTIES( "PPM_WMI_PERF_STATES.$", 0x90, true, 0xaf7f56e5d9c04264 );                   
        SDK_FIXED_SIZE( wmi_perf_states_t, 0x90 );                          
    };                                                                      
};
#include "magic/wmi_perf_states_t.end.hpp"
SDK_VERIFY( struct ppm::wmi_perf_states_t, 0x90 );
