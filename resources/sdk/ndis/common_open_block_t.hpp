...
#include "magic/common_open_block_t.start.hpp"
namespace ndis
{
    struct packet_t;
    struct request_t;
    ...
    {                                                                                                 
        ...
        //                                                                                            
        _m105 struct ndis::pktmon_component_context_t         pkt_mon_comp;                             //{ +0x0398    +0x0398    +0x0398    } | .PktMonComp
        _m106 struct ndis::pktmon_edge_context_t              pkt_mon_edge;                             //{ +0x03a8    +0x03a8    +0x03a8    } | .PktMonEdge
                                                                                                      
        // Windows 10 v1607                                                                           
        //                                                                                            
        _m107 struct ndis::queued_close_t                     qc;                                       //{ +0x0150    } | .QC
        _m108 initiate_offload_complete_handler_t             initiate_offload_complete_handler;        //{ +0x0248    } | .InitiateOffloadCompleteHandler
        _m109 terminate_offload_complete_handler_t            terminate_offload_complete_handler;       //{ +0x0250    } | .TerminateOffloadCompleteHandler
        _m110 update_offload_complete_handler_t               update_offload_complete_handler;          //{ +0x0258    } | .UpdateOffloadCompleteHandler
        _m111 invalidate_offload_complete_handler_t           invalidate_offload_complete_handler;      //{ +0x0260    } | .InvalidateOffloadCompleteHandler
        _m112 query_offload_complete_handler_t                query_offload_complete_handler;           //{ +0x0268    } | .QueryOffloadCompleteHandler
        _m113 indicate_offload_event_handler_t                indicate_offload_event_handler;           //{ +0x0270    } | .IndicateOffloadEventHandler
        _m114 tcp_offload_send_complete_handler_t             tcp_offload_send_complete_handler;        //{ +0x0278    } | .TcpOffloadSendCompleteHandler
        _m115 tcp_offload_receive_complete_handler_t          tcp_offload_receive_complete_handler;     //{ +0x0280    } | .TcpOffloadReceiveCompleteHandler
        _m116 tcp_offload_disconnect_complete_handler_t       tcp_offload_disconnect_complete_handler;  //{ +0x0288    } | .TcpOffloadDisconnectCompleteHandler
        _m117 tcp_offload_forward_complete_handler_t          tcp_offload_forward_complete_handler;     //{ +0x0290    } | .TcpOffloadForwardCompleteHandler
        _m118 sdk::function<void(void*, uint32_t, uint32_t)>* tcp_offload_event_handler;                //{ +0x0298    } | .TcpOffloadEventHandler
        _m119 tcp_offload_receive_indicate_handler_t          tcp_offload_receive_indicate_handler;     //{ +0x02a0    } | .TcpOffloadReceiveIndicateHandler
                                                                                                      
        SDK_MAGIC_PROPERTIES( "_NDIS_COMMON_OPEN_BLOCK.$", 0x3c0, true, 0x29e498637ee442f0 );                                        
        SDK_DYNAMIC_SIZE( common_open_block_t );                                                      
    };                                                                                                
};
#include "magic/common_open_block_t.end.hpp"
