...
#include "magic/wan_co_set_link_info_t.start.hpp"
namespace ndis
{
    // [struct _NDIS_WAN_CO_SET_LINK_INFO]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct wan_co_set_link_info_t           
    {                                       
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                      
        //                                  
        ...
        SDK_MAGIC_PROPERTIES( "_NDIS_WAN_CO_SET_LINK_INFO.$", 0x20, true, 0x878926c3a84d9939 );                      
        SDK_FIXED_SIZE( wan_co_set_link_info_t, 0x20 );                      
    };                                      
};
#include "magic/wan_co_set_link_info_t.end.hpp"
SDK_VERIFY( struct ndis::wan_co_set_link_info_t, 0x20 );
