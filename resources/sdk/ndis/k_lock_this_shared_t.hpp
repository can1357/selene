...
#include "magic/k_lock_this_shared_t.start.hpp"
namespace ndis
{
    ...
    {                                                 
        ...
        SDK_MAGIC_PROPERTIES( "KLockThisShared.$", 0x18, true, 0xe8e8923e9dbde194 );         
        SDK_FIXED_SIZE( k_lock_this_shared_t, 0x18 );         
    };                                                
};
#include "magic/k_lock_this_shared_t.end.hpp"
SDK_VERIFY( class ndis::k_lock_this_shared_t, 0x18 );
