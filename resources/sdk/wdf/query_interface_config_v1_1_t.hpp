...
#include "magic/query_interface_config_v1_1_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct query_interface_config_v1_1_t                                                              
    {                                                                                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_QUERY_INTERFACE_CONFIG_V1_1.$", 0x0, false, 0xc7d30dfdff703c0e );                                           
        SDK_FIXED_SIZE( query_interface_config_v1_1_t, 0x30 );                                           
    };                                                                                                
};
#include "magic/query_interface_config_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::query_interface_config_v1_1_t, 0x30 );
