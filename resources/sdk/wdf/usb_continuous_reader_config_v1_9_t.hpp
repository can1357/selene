...
#include "magic/usb_continuous_reader_config_v1_9_t.start.hpp"
namespace wdf
{
    struct wdfmemory_t;
    struct wdfusbpipe_t;
    struct object_attributes_v1_9_t;

    // [struct _WDF_USB_CONTINUOUS_READER_CONFIG_V1_9]
    // => Windows 10 v1607
    //
    struct usb_continuous_reader_config_v1_9_t                                                  
    {                                                                                           
        ...
        _m05 struct wdf::object_attributes_v1_9_t*    buffer_attributes;                          //{ +0x0028    } | .BufferAttributes
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_USB_CONTINUOUS_READER_CONFIG_V1_9.$", 0x0, false, 0xd7cb8860f347d855 );                                          
        SDK_FIXED_SIZE( usb_continuous_reader_config_v1_9_t, 0x48 );                                          
    };                                                                                          
};
#include "magic/usb_continuous_reader_config_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::usb_continuous_reader_config_v1_9_t, 0x48 );
