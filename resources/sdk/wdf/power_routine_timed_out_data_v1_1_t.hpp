...
#include "magic/power_routine_timed_out_data_v1_1_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct power_routine_timed_out_data_v1_1_t                        
    {                                                                 
        // Windows 10 v1607                                           
        //                                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_ROUTINE_TIMED_OUT_DATA_V1_1.$", 0x0, false, 0x7ff83c54d24eb194 );                   
        SDK_FIXED_SIZE( power_routine_timed_out_data_v1_1_t, 0x20 );                   
    };                                                                
};
#include "magic/power_routine_timed_out_data_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::power_routine_timed_out_data_v1_1_t, 0x20 );
