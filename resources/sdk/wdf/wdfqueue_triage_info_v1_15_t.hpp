...
#include "magic/wdfqueue_triage_info_v1_15_t.start.hpp"
namespace wdf
{
    ...
    {                                      
        ...
        SDK_MAGIC_PROPERTIES( "_WDFQUEUE_TRIAGE_INFO_V1_15.$", 0x0, false, 0xe335718493b30358 );                     
        SDK_FIXED_SIZE( wdfqueue_triage_info_v1_15_t, 0x1c );                     
    };                                     
};
#include "magic/wdfqueue_triage_info_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::wdfqueue_triage_info_v1_15_t, 0x1c );
