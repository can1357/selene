...
#include "class_version_v1_11_t.hpp"

#include "magic/class_library_info_v1_11_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct class_library_info_v1_11_t                                           
    {                                                                           
        ...
        _m01 struct wdf::class_version_v1_11_t      version;                      //{ +0x0004    } | .Version
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_CLASS_LIBRARY_INFO_V1_11.$", 0x0, false, 0x8e9b8fa1b6f8a1a1 );                            
        SDK_FIXED_SIZE( class_library_info_v1_11_t, 0x30 );                            
    };                                                                          
};
#include "magic/class_library_info_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::class_library_info_v1_11_t, 0x30 );
