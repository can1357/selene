...
#include "magic/io_queue_forward_progress_policy_v1_9_t.start.hpp"
namespace wdf
{
    struct wdfqueue_t;
    struct wdfrequest_t;
    ...
    // => Windows 10 v1607
    //
    struct io_queue_forward_progress_policy_v1_9_t                                                            
    {                                                                                                         
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY_V1_9.$", 0x0, false, 0xd326c7904dc10c9d );                                               
        SDK_FIXED_SIZE( io_queue_forward_progress_policy_v1_9_t, 0x28 );                                               
    };                                                                                                        
};
#include "magic/io_queue_forward_progress_policy_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::io_queue_forward_progress_policy_v1_9_t, 0x28 );
