...
#include "magic/io_queue_config_v1_9_t.start.hpp"
namespace wdf
{
    struct wdfqueue_t;
    struct wdfrequest_t;
    ...
    //
    struct io_queue_config_v1_9_t                                                                  
    {                                                                                              
        union u0_settings_t                                                                        
        {                                                                                          
            struct u4_parallel_t                                                                   
            {                                                                                      
                // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                                                                     
                //                                                                                 
                _m13 uint32_t number_of_presented_requests;                                          //{ +0x0000    +0x0000    +0x0000    +0x0000    } | .NumberOfPresentedRequests
                                                                                                   
                SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_9.Settings.Parallel.$", 0x4, true, 0x8e278523faa17763 );                                                                     
                SDK_FIXED_SIZE( u4_parallel_t, 0x4 );                                                                     
            };                                                                                     
                                                                                                   
            // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                                        
            //                                                                                     
            _m14 u4_parallel_t                             parallel;                                 //{ +0x0000    +0x0000    +0x0000    +0x0000    } | .Parallel
                                                                                                   
            SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_9.Settings.$", 0x4, true, 0x3357dbb0828e5e1a );                                        
        ...
        _m15 u0_settings_t                                          settings;                        //{ +0x0050    +0x0050    +0x0050    +0x0050    } | .Settings
                                                                                                   
        SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_9.$", 0x58, true, 0x7d225a5f75ebc705 );                               
        SDK_FIXED_SIZE( io_queue_config_v1_9_t, 0x58 );                                            
    };                                                                                             
};
#include "magic/io_queue_config_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::io_queue_config_v1_9_t::u0_settings_t::u4_parallel_t, 0x4 );
SDK_VERIFY( union wdf::io_queue_config_v1_9_t::u0_settings_t, 0x4 );
SDK_VERIFY( struct wdf::io_queue_config_v1_9_t, 0x58 );
