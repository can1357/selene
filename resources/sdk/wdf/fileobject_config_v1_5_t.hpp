...
#include "magic/fileobject_config_v1_5_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    struct wdfrequest_t;
    ...
    // => Windows 10 v1607
    //
    struct fileobject_config_v1_5_t                                   
    {                                                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_FILEOBJECT_CONFIG_V1_5.$", 0x0, false, 0xa765720d770fc93a );                           
        SDK_FIXED_SIZE( fileobject_config_v1_5_t, 0x28 );                           
    };                                                                
};
#include "magic/fileobject_config_v1_5_t.end.hpp"
SDK_VERIFY( struct wdf::fileobject_config_v1_5_t, 0x28 );
