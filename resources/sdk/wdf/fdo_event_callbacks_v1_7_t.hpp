...
#include "magic/fdo_event_callbacks_v1_7_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct fdo_event_callbacks_v1_7_t                                                                         
    {                                                                                                         
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_FDO_EVENT_CALLBACKS_V1_7.$", 0x0, false, 0xe49b5490eb3ad112 );                                               
        SDK_FIXED_SIZE( fdo_event_callbacks_v1_7_t, 0x20 );                                                   
    };                                                                                                        
};
#include "magic/fdo_event_callbacks_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::fdo_event_callbacks_v1_7_t, 0x20 );
