...
#include "magic/io_queue_forward_progress_policy_v1_11_t.start.hpp"
namespace wdf
{
    struct wdfqueue_t;
    struct wdfrequest_t;
    ...
    // => Windows 10 v1607
    //
    struct io_queue_forward_progress_policy_v1_11_t                                                           
    {                                                                                                         
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY_V1_11.$", 0x0, false, 0x4dee1e5b176203b1 );                                               
        SDK_FIXED_SIZE( io_queue_forward_progress_policy_v1_11_t, 0x28 );                                               
    };                                                                                                        
};
#include "magic/io_queue_forward_progress_policy_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::io_queue_forward_progress_policy_v1_11_t, 0x28 );
