...
#include "magic/power_routine_timed_out_data_v1_13_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct power_routine_timed_out_data_v1_13_t                       
    {                                                                 
        // Windows 10 v1607                                           
        //                                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_ROUTINE_TIMED_OUT_DATA_V1_13.$", 0x0, false, 0x2cafa107fa78f25a );                   
        SDK_FIXED_SIZE( power_routine_timed_out_data_v1_13_t, 0x20 );                   
    };                                                                
};
#include "magic/power_routine_timed_out_data_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::power_routine_timed_out_data_v1_13_t, 0x20 );
