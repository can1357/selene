...
#include "magic/io_target_open_params_v1_17_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct io_target_open_params_v1_17_t                                                    
    {                                                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_TARGET_OPEN_PARAMS_V1_17.$", 0x0, false, 0x13625bb870320dba );                              
        SDK_FIXED_SIZE( io_target_open_params_v1_17_t, 0x88 );                              
    };                                                                                      
};
#include "magic/io_target_open_params_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::io_target_open_params_v1_17_t, 0x88 );
