...
#include "magic/query_interface_config_v1_17_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct query_interface_config_v1_17_t                                                             
    {                                                                                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_QUERY_INTERFACE_CONFIG_V1_17.$", 0x0, false, 0x2e5311ea1f701604 );                                           
        SDK_FIXED_SIZE( query_interface_config_v1_17_t, 0x30 );                                           
    };                                                                                                
};
#include "magic/query_interface_config_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::query_interface_config_v1_17_t, 0x30 );
