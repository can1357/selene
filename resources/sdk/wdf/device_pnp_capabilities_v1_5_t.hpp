...
#include "magic/device_pnp_capabilities_v1_5_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_PNP_CAPABILITIES_V1_5]
    // => Windows 10 v1607
    //
    struct device_pnp_capabilities_v1_5_t              
    {                                                  
        // Windows 10 v1607                            
        //                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_PNP_CAPABILITIES_V1_5.$", 0x0, false, 0xdd040c19b9e431d3 );                    
        SDK_FIXED_SIZE( device_pnp_capabilities_v1_5_t, 0x30 );                    
    };                                                 
};
#include "magic/device_pnp_capabilities_v1_5_t.end.hpp"
SDK_VERIFY( struct wdf::device_pnp_capabilities_v1_5_t, 0x30 );
