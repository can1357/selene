...
#include "magic/child_retrieve_info_v1_15_t.start.hpp"
namespace wdf
{
    struct wdfchildlist_t;
    struct child_address_description_header_v1_15_t;
    struct child_identification_description_header_t;
    struct child_identification_description_header_v1_15_t;

    // [struct _WDF_CHILD_RETRIEVE_INFO_V1_15]
    // => Windows 10 v1607
    //
    struct child_retrieve_info_v1_15_t                                                                              
    {                                                                                                               
        using pwdf_child_identification_description_header_v1_15_t =    struct wdf::child_identification_description_header_v1_15_t*;                                                  
        using identification_description_t =                            pwdf_child_identification_description_header_v1_15_t ;                                                  
        using pwdf_child_address_description_header_v1_15_t =           struct wdf::child_address_description_header_v1_15_t*;                                                  
        ...
        _m02 pwdf_child_address_description_header_v1_15_t        address_description;                                //{ +0x0010    } | .AddressDescription
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_CHILD_RETRIEVE_INFO_V1_15.$", 0x0, false, 0x2d6a5d0eb6ced549 );                                                  
        SDK_FIXED_SIZE( child_retrieve_info_v1_15_t, 0x28 );                                                        
    };                                                                                                              
};
#include "magic/child_retrieve_info_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::child_retrieve_info_v1_15_t, 0x28 );
