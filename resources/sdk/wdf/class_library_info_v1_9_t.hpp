...
#include "magic/class_library_info_v1_9_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct class_library_info_v1_9_t                                            
    {                                                                           
        ...
        _m01 struct wdf::class_version_v1_9_t       version;                      //{ +0x0004    } | .Version
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_CLASS_LIBRARY_INFO_V1_9.$", 0x0, false, 0x91b7345cb14fc9fa );                            
        SDK_FIXED_SIZE( class_library_info_v1_9_t, 0x30 );                            
    };                                                                          
};
#include "magic/class_library_info_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::class_library_info_v1_9_t, 0x30 );
