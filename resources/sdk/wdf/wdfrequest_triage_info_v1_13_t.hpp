...
#include "magic/wdfrequest_triage_info_v1_13_t.start.hpp"
namespace wdf
{
    ...
    {                                         
        ...
        SDK_MAGIC_PROPERTIES( "_WDFREQUEST_TRIAGE_INFO_V1_13.$", 0x0, false, 0xad7f4ff632791894 );                        
        SDK_FIXED_SIZE( wdfrequest_triage_info_v1_13_t, 0x1c );                        
    };                                        
};
#include "magic/wdfrequest_triage_info_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::wdfrequest_triage_info_v1_13_t, 0x1c );
