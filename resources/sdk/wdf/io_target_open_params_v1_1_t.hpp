...
#include "magic/io_target_open_params_v1_1_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct io_target_open_params_v1_1_t                                                     
    {                                                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_TARGET_OPEN_PARAMS_V1_1.$", 0x0, false, 0x722674b1e92f6464 );                              
        SDK_FIXED_SIZE( io_target_open_params_v1_1_t, 0x78 );                               
    };                                                                                      
};
#include "magic/io_target_open_params_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::io_target_open_params_v1_1_t, 0x78 );
