...
#include "magic/child_list_config_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    {                                                                                                                   
        ...
        _m01 uint32_t                                               identification_description_size;                      //{ +0x0004    +0x0004    +0x0004    +0x0004    +0x0004    } | .IdentificationDescriptionSize
        _m02 uint32_t                                               address_description_size;                             //{ +0x0008    +0x0008    +0x0008    +0x0008    +0x0008    } | .AddressDescriptionSize
        _m03 pfn_wdf_child_list_create_device_t                     evt_child_list_create_device;                         //{ +0x0010    +0x0010    +0x0010    +0x0010    +0x0010    } | .EvtChildListCreateDevice
        _m04 pfn_wdf_child_list_scan_for_children_t                 evt_child_list_scan_for_children;                     //{ +0x0018    +0x0018    +0x0018    +0x0018    +0x0018    } | .EvtChildListScanForChildren
        _m05 evt_child_list_identification_description_copy_t       evt_child_list_identification_description_copy;       //{ +0x0020    +0x0020    +0x0020    +0x0020    +0x0020    } | .EvtChildListIdentificationDescriptionCopy
        _m06 evt_child_list_identification_description_duplicate_t  evt_child_list_identification_description_duplicate;  //{ +0x0028    +0x0028    +0x0028    +0x0028    +0x0028    } | .EvtChildListIdentificationDescriptionDuplicate
        _m07 evt_child_list_identification_description_cleanup_t    evt_child_list_identification_description_cleanup;    //{ +0x0030    +0x0030    +0x0030    +0x0030    +0x0030    } | .EvtChildListIdentificationDescriptionCleanup
        _m08 evt_child_list_identification_description_compare_t    evt_child_list_identification_description_compare;    //{ +0x0038    +0x0038    +0x0038    +0x0038    +0x0038    } | .EvtChildListIdentificationDescriptionCompare
        _m09 pfn_wdf_child_list_address_description_copy_t          evt_child_list_address_description_copy;              //{ +0x0040    +0x0040    +0x0040    +0x0040    +0x0040    } | .EvtChildListAddressDescriptionCopy
        _m10 evt_child_list_address_description_duplicate_t         evt_child_list_address_description_duplicate;         //{ +0x0048    +0x0048    +0x0048    +0x0048    +0x0048    } | .EvtChildListAddressDescriptionDuplicate
        _m11 evt_child_list_address_description_cleanup_t           evt_child_list_address_description_cleanup;           //{ +0x0050    +0x0050    +0x0050    +0x0050    +0x0050    } | .EvtChildListAddressDescriptionCleanup
        _m12 pfn_wdf_child_list_device_reenumerated_t               evt_child_list_device_reenumerated;                   //{ +0x0058    +0x0058    +0x0058    +0x0058    +0x0058    } | .EvtChildListDeviceReenumerated
                                                                                                                        
        SDK_NONVOL_PROPERTIES( "_WDF_CHILD_LIST_CONFIG.$", 0x60, true, 0x46ffd646bf4ce091 );                                                    
        SDK_FIXED_SIZE( child_list_config_t, 0x60 );                                                                    
    };                                                                                                                  
};
#include "magic/child_list_config_t.end.hpp"
SDK_VERIFY( struct wdf::child_list_config_t, 0x60 );
