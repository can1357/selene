...
#include "magic/class_bind_info_v1_15_t.start.hpp"
namespace wdf
{
    struct bind_info_t;
    ...
    // => Windows 10 v1607
    //
    struct class_bind_info_v1_15_t                                  
    {                                                               
        ...
        _m02 struct wdf::class_version_v1_15_t version;               //{ +0x0010    } | .Version
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_CLASS_BIND_INFO_V1_15.$", 0x0, false, 0x9156770ef2cfb4c1 );                     
        SDK_FIXED_SIZE( class_bind_info_v1_15_t, 0x50 );                     
    };                                                              
};
#include "magic/class_bind_info_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::class_bind_info_v1_15_t, 0x50 );
