...
#include "magic/device_pnp_capabilities_v1_11_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_PNP_CAPABILITIES_V1_11]
    // => Windows 10 v1607
    //
    struct device_pnp_capabilities_v1_11_t             
    {                                                  
        // Windows 10 v1607                            
        //                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_PNP_CAPABILITIES_V1_11.$", 0x0, false, 0xa3678bf9c26c9a9f );                    
        SDK_FIXED_SIZE( device_pnp_capabilities_v1_11_t, 0x30 );                    
    };                                                 
};
#include "magic/device_pnp_capabilities_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::device_pnp_capabilities_v1_11_t, 0x30 );
