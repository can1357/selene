...
#include "magic/request_parameters_v1_5_t.start.hpp"
namespace wdf
{
    // [struct _WDF_REQUEST_PARAMETERS_V1_5]
    // => Windows 10 v1607
    //
    struct request_parameters_v1_5_t                                                                  
    {                                                                                                 
        ...
        {                                                                                             
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_5.Parameters.Create.$", 0x0, false, 0x78214fc27cef5994 );                                                  
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_5.Parameters.Read.$", 0x0, false, 0xc1bf564355c72c11 );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_5.Parameters.Write.$", 0x0, false, 0x89bded6b66dd8dc9 );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_5.Parameters.DeviceIoControl.$", 0x0, false, 0x52c29202c12a47f4 );                                                      
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_5.Parameters.Others.$", 0x0, false, 0x906e1b9801bc2b13 );                                                 
            ...
            SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_5.Parameters.$", 0x0, false, 0xf89b7d79874f7118 );                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_5.$", 0x0, false, 0x4ca0cae00f1a571b );               
        SDK_FIXED_SIZE( request_parameters_v1_5_t, 0x28 );                                            
    };                                                                                                
};
#include "magic/request_parameters_v1_5_t.end.hpp"
SDK_VERIFY( struct wdf::request_parameters_v1_5_t::u0_parameters_t::u1_create_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_5_t::u0_parameters_t::u2_read_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_5_t::u0_parameters_t::u3_write_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_5_t::u0_parameters_t::u4_device_io_control_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_5_t::u0_parameters_t::u5_others_t, 0x20 );
SDK_VERIFY( union wdf::request_parameters_v1_5_t::u0_parameters_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_5_t, 0x28 );
