...
#include "magic/wdfrequest_triage_info_v1_17_t.start.hpp"
namespace wdf
{
    ...
    {                                         
        ...
        SDK_MAGIC_PROPERTIES( "_WDFREQUEST_TRIAGE_INFO_V1_17.$", 0x0, false, 0xf412577d42b3702a );                        
        SDK_FIXED_SIZE( wdfrequest_triage_info_v1_17_t, 0x1c );                        
    };                                        
};
#include "magic/wdfrequest_triage_info_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::wdfrequest_triage_info_v1_17_t, 0x1c );
