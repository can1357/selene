...
#include "magic/request_parameters_v1_1_t.start.hpp"
namespace wdf
{
    // [struct _WDF_REQUEST_PARAMETERS_V1_1]
    // => Windows 10 v1607
    //
    struct request_parameters_v1_1_t                                                                  
    {                                                                                                 
        ...
        {                                                                                             
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_1.Parameters.Create.$", 0x0, false, 0x98c44ba045102864 );                                                  
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_1.Parameters.Read.$", 0x0, false, 0x71f70ded44f2b453 );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_1.Parameters.Write.$", 0x0, false, 0xd62e5b6fc898635e );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_1.Parameters.DeviceIoControl.$", 0x0, false, 0x3603361530865340 );                                                      
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_1.Parameters.Others.$", 0x0, false, 0xe0df27507da3516a );                                                 
            ...
            SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_1.Parameters.$", 0x0, false, 0x25e76b0aeffac600 );                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_1.$", 0x0, false, 0x1da764c40108741d );               
        SDK_FIXED_SIZE( request_parameters_v1_1_t, 0x28 );                                            
    };                                                                                                
};
#include "magic/request_parameters_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::request_parameters_v1_1_t::u0_parameters_t::u1_create_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_1_t::u0_parameters_t::u2_read_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_1_t::u0_parameters_t::u3_write_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_1_t::u0_parameters_t::u4_device_io_control_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_1_t::u0_parameters_t::u5_others_t, 0x20 );
SDK_VERIFY( union wdf::request_parameters_v1_1_t::u0_parameters_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_1_t, 0x28 );
