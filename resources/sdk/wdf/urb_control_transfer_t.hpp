...
#include "magic/urb_control_transfer_t.start.hpp"
namespace wdf
{
    struct urb_t;
    ...
    {                                                          
        ...
        SDK_MAGIC_PROPERTIES( "_URB_CONTROL_TRANSFER.$", 0x88, true, 0x289fc4b3b2dba75c );                       
        SDK_FIXED_SIZE( urb_control_transfer_t, 0x88 );                       
    };                                                         
};
#include "magic/urb_control_transfer_t.end.hpp"
SDK_VERIFY( struct wdf::urb_control_transfer_t, 0x88 );
