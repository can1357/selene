...
#include "magic/timer_config_v1_15_t.start.hpp"
namespace wdf
{
    struct wdftimer_t;
    ...
    {                                                                                
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_TIMER_CONFIG_V1_15.$", 0x0, false, 0x40b9d1cb973e64aa );                          
        SDK_FIXED_SIZE( timer_config_v1_15_t, 0x28 );                                
    };                                                                               
};
#include "magic/timer_config_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::timer_config_v1_15_t, 0x28 );
