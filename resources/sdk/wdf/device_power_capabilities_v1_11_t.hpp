...
#include "magic/device_power_capabilities_v1_11_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_POWER_CAPABILITIES_V1_11]
    // => Windows 10 v1607
    //
    struct device_power_capabilities_v1_11_t                                    
    {                                                                           
        // Windows 10 v1607                                                     
        //                                                                      
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_POWER_CAPABILITIES_V1_11.$", 0x0, false, 0xe31ea45d8a91a3e9 );                      
        SDK_FIXED_SIZE( device_power_capabilities_v1_11_t, 0x50 );                      
    };                                                                          
};
#include "magic/device_power_capabilities_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::device_power_capabilities_v1_11_t, 0x50 );
