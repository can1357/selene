...
#include "magic/power_policy_event_callbacks_v1_7_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct power_policy_event_callbacks_v1_7_t                                                      
    {                                                                                               
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_POLICY_EVENT_CALLBACKS_V1_7.$", 0x0, false, 0x7d46f47b19af7884 );                                        
        SDK_FIXED_SIZE( power_policy_event_callbacks_v1_7_t, 0x40 );                                        
    };                                                                                              
};
#include "magic/power_policy_event_callbacks_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::power_policy_event_callbacks_v1_7_t, 0x40 );
