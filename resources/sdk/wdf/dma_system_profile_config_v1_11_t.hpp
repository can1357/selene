...
#include "magic/dma_system_profile_config_v1_11_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DMA_SYSTEM_PROFILE_CONFIG_V1_11]
    // => Windows 10 v1607
    //
    struct dma_system_profile_config_v1_11_t                           
    {                                                                  
        // Windows 10 v1607                                            
        //                                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DMA_SYSTEM_PROFILE_CONFIG_V1_11.$", 0x0, false, 0xe7b34ed2cdef1926 );                
        SDK_FIXED_SIZE( dma_system_profile_config_v1_11_t, 0x20 );                
    };                                                                 
};
#include "magic/dma_system_profile_config_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::dma_system_profile_config_v1_11_t, 0x20 );
