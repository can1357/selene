...
#include "magic/wdfcx_fileobject_config_v1_11_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    struct wdfrequest_t;
    ...
    // => Windows 10 v1607
    //
    struct wdfcx_fileobject_config_v1_11_t                              
    {                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDFCX_FILEOBJECT_CONFIG_V1_11.$", 0x0, false, 0x3d89e6f128b9a07c );                           
        SDK_FIXED_SIZE( wdfcx_fileobject_config_v1_11_t, 0x28 );                           
    };                                                                  
};
#include "magic/wdfcx_fileobject_config_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::wdfcx_fileobject_config_v1_11_t, 0x28 );
