...
#include "magic/fdo_event_callbacks_v1_0_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct fdo_event_callbacks_v1_0_t                                                                         
    {                                                                                                         
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_FDO_EVENT_CALLBACKS_V1_0.$", 0x0, false, 0xfb56d121c2dd6979 );                                               
        SDK_FIXED_SIZE( fdo_event_callbacks_v1_0_t, 0x20 );                                                   
    };                                                                                                        
};
#include "magic/fdo_event_callbacks_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::fdo_event_callbacks_v1_0_t, 0x20 );
