...
#include "magic/dma_system_profile_config_v1_13_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DMA_SYSTEM_PROFILE_CONFIG_V1_13]
    // => Windows 10 v1607
    //
    struct dma_system_profile_config_v1_13_t                           
    {                                                                  
        // Windows 10 v1607                                            
        //                                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DMA_SYSTEM_PROFILE_CONFIG_V1_13.$", 0x0, false, 0xc70dd3124a582208 );                
        SDK_FIXED_SIZE( dma_system_profile_config_v1_13_t, 0x20 );                
    };                                                                 
};
#include "magic/dma_system_profile_config_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::dma_system_profile_config_v1_13_t, 0x20 );
