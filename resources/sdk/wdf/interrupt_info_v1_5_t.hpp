...
#include "magic/interrupt_info_v1_5_t.start.hpp"
namespace wdf
{
    // [struct _WDF_INTERRUPT_INFO_V1_5]
    // => Windows 10 v1607
    //
    struct interrupt_info_v1_5_t                                 
    {                                                            
        // Windows 10 v1607                                      
        //                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_INFO_V1_5.$", 0x0, false, 0x8cf47883ce39f2ea );                     
        SDK_FIXED_SIZE( interrupt_info_v1_5_t, 0x38 );                     
    };                                                           
};
#include "magic/interrupt_info_v1_5_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_info_v1_5_t, 0x38 );
