...
#include "magic/pdo_event_callbacks_v1_17_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pdo_event_callbacks_v1_17_t                                                             
    {                                                                                              
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_PDO_EVENT_CALLBACKS_V1_17.$", 0x0, false, 0x325e036647cc6d19 );                                       
        SDK_FIXED_SIZE( pdo_event_callbacks_v1_17_t, 0x40 );                                       
    };                                                                                             
};
#include "magic/pdo_event_callbacks_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::pdo_event_callbacks_v1_17_t, 0x40 );
