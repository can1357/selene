...
#include "magic/driver_config_v1_11_t.start.hpp"
namespace wdf
{
    struct wdfdriver_t;
    ...
    {                                                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DRIVER_CONFIG_V1_11.$", 0x0, false, 0xe11234ca690bb9b0 );                      
        SDK_FIXED_SIZE( driver_config_v1_11_t, 0x20 );                            
    };                                                                            
};
#include "magic/driver_config_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::driver_config_v1_11_t, 0x20 );
