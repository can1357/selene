...
#include "magic/pdo_event_callbacks_v1_15_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pdo_event_callbacks_v1_15_t                                                             
    {                                                                                              
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_PDO_EVENT_CALLBACKS_V1_15.$", 0x0, false, 0x71834cd70c59f511 );                                       
        SDK_FIXED_SIZE( pdo_event_callbacks_v1_15_t, 0x40 );                                       
    };                                                                                             
};
#include "magic/pdo_event_callbacks_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::pdo_event_callbacks_v1_15_t, 0x40 );
