...
#include "magic/dma_enabler_config_v1_7_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct dma_enabler_config_v1_7_t                                                        
    {                                                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DMA_ENABLER_CONFIG_V1_7.$", 0x0, false, 0x370debc3988c873a );                                      
        SDK_FIXED_SIZE( dma_enabler_config_v1_7_t, 0x40 );                                      
    };                                                                                      
};
#include "magic/dma_enabler_config_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::dma_enabler_config_v1_7_t, 0x40 );
