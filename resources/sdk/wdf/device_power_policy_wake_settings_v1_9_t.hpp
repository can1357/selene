...
#include "magic/device_power_policy_wake_settings_v1_9_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_POWER_POLICY_WAKE_SETTINGS_V1_9]
    // => Windows 10 v1607
    //
    struct device_power_policy_wake_settings_v1_9_t                                                    
    {                                                                                                  
        // Windows 10 v1607                                                                            
        //                                                                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_POWER_POLICY_WAKE_SETTINGS_V1_9.$", 0x0, false, 0x7080bbb5af357116 );                                            
        SDK_FIXED_SIZE( device_power_policy_wake_settings_v1_9_t, 0x14 );                                            
    };                                                                                                 
};
#include "magic/device_power_policy_wake_settings_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::device_power_policy_wake_settings_v1_9_t, 0x14 );
