...
#include "magic/device_state_v1_11_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_STATE_V1_11]
    // => Windows 10 v1607
    //
    struct device_state_v1_11_t                       
    {                                                 
        // Windows 10 v1607                           
        //                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_STATE_V1_11.$", 0x0, false, 0xd7b001a24969205a );                   
        SDK_FIXED_SIZE( device_state_v1_11_t, 0x1c );                   
    };                                                
};
#include "magic/device_state_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::device_state_v1_11_t, 0x1c );
