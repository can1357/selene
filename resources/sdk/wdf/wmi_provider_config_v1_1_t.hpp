...
#include "magic/wmi_provider_config_v1_1_t.start.hpp"
namespace wdf
{
    ...
    {                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_PROVIDER_CONFIG_V1_1.$", 0x0, false, 0x15d0be0d7b2d8db3 );                                  
        SDK_FIXED_SIZE( wmi_provider_config_v1_1_t, 0x28 );                                  
    };                                                                                  
};
#include "magic/wmi_provider_config_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_provider_config_v1_1_t, 0x28 );
