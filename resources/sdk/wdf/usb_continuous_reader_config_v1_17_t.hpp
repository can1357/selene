...
#include "magic/usb_continuous_reader_config_v1_17_t.start.hpp"
namespace wdf
{
    struct wdfmemory_t;
    struct wdfusbpipe_t;
    ...
    // => Windows 10 v1607
    //
    struct usb_continuous_reader_config_v1_17_t                                                 
    {                                                                                           
        ...
        _m05 struct wdf::object_attributes_v1_17_t*   buffer_attributes;                          //{ +0x0028    } | .BufferAttributes
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_USB_CONTINUOUS_READER_CONFIG_V1_17.$", 0x0, false, 0xeb0566af7c4461e5 );                                          
        SDK_FIXED_SIZE( usb_continuous_reader_config_v1_17_t, 0x48 );                                          
    };                                                                                          
};
#include "magic/usb_continuous_reader_config_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::usb_continuous_reader_config_v1_17_t, 0x48 );
