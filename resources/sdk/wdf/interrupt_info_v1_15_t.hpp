...
#include "magic/interrupt_info_v1_15_t.start.hpp"
namespace wdf
{
    // [struct _WDF_INTERRUPT_INFO_V1_15]
    // => Windows 10 v1607
    //
    struct interrupt_info_v1_15_t                                
    {                                                            
        // Windows 10 v1607                                      
        //                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_INFO_V1_15.$", 0x0, false, 0x7a49f0f29f920792 );                     
        SDK_FIXED_SIZE( interrupt_info_v1_15_t, 0x40 );                     
    };                                                           
};
#include "magic/interrupt_info_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_info_v1_15_t, 0x40 );
