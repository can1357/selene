...
#include "magic/urb_control_get_interface_request_t.start.hpp"
namespace wdf
{
    struct urb_t;
    ...
    //
    struct urb_control_get_interface_request_t                 
    {                                                          
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                       
        //                                                     
        ...
        _m06 uint16_t                   interface;               //{ +0x0084    +0x0084    +0x0084    +0x0084    } | .Interface
                                                               
        SDK_MAGIC_PROPERTIES( "_URB_CONTROL_GET_INTERFACE_REQUEST.$", 0x88, true, 0x62df7aa2513bea21 );                       
        SDK_FIXED_SIZE( urb_control_get_interface_request_t, 0x88 );                       
    };                                                         
};
#include "magic/urb_control_get_interface_request_t.end.hpp"
SDK_VERIFY( struct wdf::urb_control_get_interface_request_t, 0x88 );
