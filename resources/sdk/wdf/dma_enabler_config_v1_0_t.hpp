...
#include "magic/dma_enabler_config_v1_0_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct dma_enabler_config_v1_0_t                                                        
    {                                                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DMA_ENABLER_CONFIG_V1_0.$", 0x0, false, 0x2a0d2dc6b34a516d );                                      
        SDK_FIXED_SIZE( dma_enabler_config_v1_0_t, 0x40 );                                      
    };                                                                                      
};
#include "magic/dma_enabler_config_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::dma_enabler_config_v1_0_t, 0x40 );
