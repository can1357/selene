...
#include "magic/power_framework_settings_v1_31_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;

    // [struct _WDF_POWER_FRAMEWORK_SETTINGS_V1_31]
    // => Windows 11
    //
    struct power_framework_settings_v1_31_t                                                              
    {                                                                                                    
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_FRAMEWORK_SETTINGS_V1_31.$", 0x0, false, 0x21492e9f9cf5b64f );                                           
        SDK_FIXED_SIZE( power_framework_settings_v1_31_t, 0x48 );                                           
    };                                                                                                   
};
#include "magic/power_framework_settings_v1_31_t.end.hpp"
SDK_VERIFY( struct wdf::power_framework_settings_v1_31_t, 0x48 );
