...
#include "magic/power_policy_event_callbacks_v1_9_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct power_policy_event_callbacks_v1_9_t                                                      
    {                                                                                               
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_POLICY_EVENT_CALLBACKS_V1_9.$", 0x0, false, 0x4d13fdf03c8931f5 );                                        
        SDK_FIXED_SIZE( power_policy_event_callbacks_v1_9_t, 0x40 );                                        
    };                                                                                              
};
#include "magic/power_policy_event_callbacks_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::power_policy_event_callbacks_v1_9_t, 0x40 );
