...
#include "magic/usb_continuous_reader_config_v1_13_t.start.hpp"
namespace wdf
{
    struct wdfmemory_t;
    struct wdfusbpipe_t;
    ...
    // => Windows 10 v1607
    //
    struct usb_continuous_reader_config_v1_13_t                                                 
    {                                                                                           
        ...
        _m05 struct wdf::object_attributes_v1_13_t*   buffer_attributes;                          //{ +0x0028    } | .BufferAttributes
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_USB_CONTINUOUS_READER_CONFIG_V1_13.$", 0x0, false, 0x951ac8f85928f810 );                                          
        SDK_FIXED_SIZE( usb_continuous_reader_config_v1_13_t, 0x48 );                                          
    };                                                                                          
};
#include "magic/usb_continuous_reader_config_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::usb_continuous_reader_config_v1_13_t, 0x48 );
