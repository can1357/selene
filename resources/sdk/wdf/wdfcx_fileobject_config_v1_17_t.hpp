...
#include "magic/wdfcx_fileobject_config_v1_17_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    struct wdfrequest_t;
    ...
    // => Windows 10 v1607
    //
    struct wdfcx_fileobject_config_v1_17_t                              
    {                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDFCX_FILEOBJECT_CONFIG_V1_17.$", 0x0, false, 0x76b50185043f9bb5 );                           
        SDK_FIXED_SIZE( wdfcx_fileobject_config_v1_17_t, 0x28 );                           
    };                                                                  
};
#include "magic/wdfcx_fileobject_config_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::wdfcx_fileobject_config_v1_17_t, 0x28 );
