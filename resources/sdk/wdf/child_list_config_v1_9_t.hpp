...
#include "magic/child_list_config_v1_9_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct child_list_config_v1_9_t                                                                                     
    {                                                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_CHILD_LIST_CONFIG_V1_9.$", 0x0, false, 0xdd5b135cb5d07271 );                                                    
        SDK_FIXED_SIZE( child_list_config_v1_9_t, 0x60 );                                                               
    };                                                                                                                  
};
#include "magic/child_list_config_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::child_list_config_v1_9_t, 0x60 );
