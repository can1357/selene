...
#include "magic/wdfobject_triage_info_v1_13_t.start.hpp"
namespace wdf
{
    ...
    {                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDFOBJECT_TRIAGE_INFO_V1_13.$", 0x0, false, 0x4ad391d0d1a08e59 );                  
        SDK_FIXED_SIZE( wdfobject_triage_info_v1_13_t, 0x1c );                  
    };                                  
};
#include "magic/wdfobject_triage_info_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::wdfobject_triage_info_v1_13_t, 0x1c );
