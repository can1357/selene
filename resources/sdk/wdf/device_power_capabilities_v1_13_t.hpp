...
#include "magic/device_power_capabilities_v1_13_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_POWER_CAPABILITIES_V1_13]
    // => Windows 10 v1607
    //
    struct device_power_capabilities_v1_13_t                                    
    {                                                                           
        // Windows 10 v1607                                                     
        //                                                                      
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_POWER_CAPABILITIES_V1_13.$", 0x0, false, 0x610daeaef3b64e05 );                      
        SDK_FIXED_SIZE( device_power_capabilities_v1_13_t, 0x50 );                      
    };                                                                          
};
#include "magic/device_power_capabilities_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::device_power_capabilities_v1_13_t, 0x50 );
