...
#include "magic/wdfqueue_triage_info_v1_13_t.start.hpp"
namespace wdf
{
    ...
    {                                      
        ...
        SDK_MAGIC_PROPERTIES( "_WDFQUEUE_TRIAGE_INFO_V1_13.$", 0x0, false, 0x356d3e08f9c54d69 );                     
        SDK_FIXED_SIZE( wdfqueue_triage_info_v1_13_t, 0x1c );                     
    };                                     
};
#include "magic/wdfqueue_triage_info_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::wdfqueue_triage_info_v1_13_t, 0x1c );
