...
#include "magic/pnppower_event_callbacks_v1_17_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pnppower_event_callbacks_v1_17_t                                                             
    {                                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_PNPPOWER_EVENT_CALLBACKS_V1_17.$", 0x0, false, 0x310b3d946aa5c72a );                                            
        SDK_FIXED_SIZE( pnppower_event_callbacks_v1_17_t, 0x90 );                                            
    };                                                                                                  
};
#include "magic/pnppower_event_callbacks_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::pnppower_event_callbacks_v1_17_t, 0x90 );
