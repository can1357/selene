...
#include "magic/interrupt_config_v1_1_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct interrupt_config_v1_1_t                              
    {                                                           
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_CONFIG_V1_1.$", 0x0, false, 0xe85b961184432840 );                        
        SDK_FIXED_SIZE( interrupt_config_v1_1_t, 0x38 );                        
    };                                                          
};
#include "magic/interrupt_config_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_config_v1_1_t, 0x38 );
