...
#include "magic/interrupt_config_v1_11_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    //
    struct interrupt_config_v1_11_t                                                  
    {                                                                                
        ...
        _m09 evt_interrupt_work_item_t                 evt_interrupt_work_item;        //{ +0x0038    +0x0038    +0x0038    +0x0038    } | .EvtInterruptWorkItem
        _m10 struct cm::partial_resource_descriptor_t* interrupt_raw;                  //{ +0x0040    +0x0040    +0x0040    +0x0040    } | .InterruptRaw
        _m11 struct cm::partial_resource_descriptor_t* interrupt_translated;           //{ +0x0048    +0x0048    +0x0048    +0x0048    } | .InterruptTranslated
        _m12 struct wdf::wdfwaitlock_t*                wait_lock;                      //{ +0x0050    +0x0050    +0x0050    +0x0050    } | .WaitLock
        _m13 uint8_t                                   passive_handling;               //{ +0x0058    +0x0058    +0x0058    +0x0058    } | .PassiveHandling
        _m14 enum wdf::tri_state_t                     report_inactive_on_power_down;  //{ +0x005c    +0x005c    +0x005c    +0x005c    } | .ReportInactiveOnPowerDown
                                                                                     
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_CONFIG_V1_11.$", 0x60, true, 0x3e6a834c9701283c );                              
        SDK_FIXED_SIZE( interrupt_config_v1_11_t, 0x60 );                              
    };                                                                               
};
#include "magic/interrupt_config_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_config_v1_11_t, 0x60 );
