...
#include "magic/interrupt_info_v1_11_t.start.hpp"
namespace wdf
{
    // [struct _WDF_INTERRUPT_INFO_V1_11]
    // => Windows 10 v1607
    //
    struct interrupt_info_v1_11_t                                
    {                                                            
        // Windows 10 v1607                                      
        //                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_INFO_V1_11.$", 0x0, false, 0xa2a1f1c0bc743bb3 );                     
        SDK_FIXED_SIZE( interrupt_info_v1_11_t, 0x40 );                     
    };                                                           
};
#include "magic/interrupt_info_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_info_v1_11_t, 0x40 );
