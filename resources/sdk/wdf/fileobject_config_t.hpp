...
#include "magic/fileobject_config_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    struct wdfrequest_t;
    ...
    {                                                                 
        ...
        _m01 pfn_wdf_device_file_create_t  evt_device_file_create;      //{ +0x0008    +0x0008    +0x0008    +0x0008    +0x0008    } | .EvtDeviceFileCreate
        ...
        SDK_NONVOL_PROPERTIES( "_WDF_FILEOBJECT_CONFIG.$", 0x28, true, 0x8960adfb5d736e0a );                           
        SDK_FIXED_SIZE( fileobject_config_t, 0x28 );                           
    };                                                                
};
#include "magic/fileobject_config_t.end.hpp"
SDK_VERIFY( struct wdf::fileobject_config_t, 0x28 );
