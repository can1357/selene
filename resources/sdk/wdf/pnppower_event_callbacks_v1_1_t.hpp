...
#include "magic/pnppower_event_callbacks_v1_1_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pnppower_event_callbacks_v1_1_t                                                              
    {                                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_PNPPOWER_EVENT_CALLBACKS_V1_1.$", 0x0, false, 0x1387d5b8f88d9e24 );                                            
        SDK_FIXED_SIZE( pnppower_event_callbacks_v1_1_t, 0x88 );                                            
    };                                                                                                  
};
#include "magic/pnppower_event_callbacks_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::pnppower_event_callbacks_v1_1_t, 0x88 );
