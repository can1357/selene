...
#include "magic/io_queue_config_v1_1_t.start.hpp"
namespace wdf
{
    struct wdfqueue_t;
    struct wdfrequest_t;
    ...
    {                                                                          
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_1.$", 0x0, false, 0x8786a1cd5dda11ba );                               
        SDK_FIXED_SIZE( io_queue_config_v1_1_t, 0x50 );                               
    };                                                                         
};
#include "magic/io_queue_config_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::io_queue_config_v1_1_t, 0x50 );
