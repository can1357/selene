...
#include "magic/device_power_policy_wake_settings_v1_15_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_POWER_POLICY_WAKE_SETTINGS_V1_15]
    // => Windows 10 v1607
    //
    struct device_power_policy_wake_settings_v1_15_t                                                   
    {                                                                                                  
        // Windows 10 v1607                                                                            
        //                                                                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_POWER_POLICY_WAKE_SETTINGS_V1_15.$", 0x0, false, 0xd1e47ea378af7e02 );                                            
        SDK_FIXED_SIZE( device_power_policy_wake_settings_v1_15_t, 0x14 );                                            
    };                                                                                                 
};
#include "magic/device_power_policy_wake_settings_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::device_power_policy_wake_settings_v1_15_t, 0x14 );
