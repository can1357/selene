...
#include "magic/io_target_open_params_v1_13_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct io_target_open_params_v1_13_t                                                    
    {                                                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_TARGET_OPEN_PARAMS_V1_13.$", 0x0, false, 0xc25bcefefdd83006 );                              
        SDK_FIXED_SIZE( io_target_open_params_v1_13_t, 0x88 );                              
    };                                                                                      
};
#include "magic/io_target_open_params_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::io_target_open_params_v1_13_t, 0x88 );
