...
#include "magic/class_bind_info_v1_13_t.start.hpp"
namespace wdf
{
    struct bind_info_t;
    ...
    // => Windows 10 v1607
    //
    struct class_bind_info_v1_13_t                                  
    {                                                               
        ...
        _m02 struct wdf::class_version_v1_13_t version;               //{ +0x0010    } | .Version
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_CLASS_BIND_INFO_V1_13.$", 0x0, false, 0x75130f57f85aad22 );                     
        SDK_FIXED_SIZE( class_bind_info_v1_13_t, 0x50 );                     
    };                                                              
};
#include "magic/class_bind_info_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::class_bind_info_v1_13_t, 0x50 );
