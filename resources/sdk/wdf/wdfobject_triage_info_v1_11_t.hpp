...
#include "magic/wdfobject_triage_info_v1_11_t.start.hpp"
namespace wdf
{
    ...
    {                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDFOBJECT_TRIAGE_INFO_V1_11.$", 0x0, false, 0x2ee32288ee7748a5 );                  
        SDK_FIXED_SIZE( wdfobject_triage_info_v1_11_t, 0x1c );                  
    };                                  
};
#include "magic/wdfobject_triage_info_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::wdfobject_triage_info_v1_11_t, 0x1c );
