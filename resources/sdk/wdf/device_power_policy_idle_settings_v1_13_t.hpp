...
#include "magic/device_power_policy_idle_settings_v1_13_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_POWER_POLICY_IDLE_SETTINGS_V1_13]
    // => Windows 10 v1607
    //
    struct device_power_policy_idle_settings_v1_13_t                                           
    {                                                                                          
        // Windows 10 v1607                                                                    
        //                                                                                     
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_POWER_POLICY_IDLE_SETTINGS_V1_13.$", 0x0, false, 0x2afc9cb074e8fead );                                    
        SDK_FIXED_SIZE( device_power_policy_idle_settings_v1_13_t, 0x24 );                                    
    };                                                                                         
};
#include "magic/device_power_policy_idle_settings_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::device_power_policy_idle_settings_v1_13_t, 0x24 );
