...
#include "magic/fdo_event_callbacks_v1_1_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct fdo_event_callbacks_v1_1_t                                                                         
    {                                                                                                         
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_FDO_EVENT_CALLBACKS_V1_1.$", 0x0, false, 0xe4e8b96f3585edc5 );                                               
        SDK_FIXED_SIZE( fdo_event_callbacks_v1_1_t, 0x20 );                                                   
    };                                                                                                        
};
#include "magic/fdo_event_callbacks_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::fdo_event_callbacks_v1_1_t, 0x20 );
