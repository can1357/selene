...
#include "magic/usb_bus_interface_usbdi_v0_t.start.hpp"
namespace wdf
{
    struct urb_t;
    ...
    //
    struct usb_bus_interface_usbdi_v0_t                                      
    {                                                                        
        ...
        SDK_MAGIC_PROPERTIES( "_USB_BUS_INTERFACE_USBDI_V0.$", 0x40, true, 0x7c33f44213b20b71 );                      
        SDK_FIXED_SIZE( usb_bus_interface_usbdi_v0_t, 0x40 );                      
    };                                                                       
};
#include "magic/usb_bus_interface_usbdi_v0_t.end.hpp"
SDK_VERIFY( struct wdf::usb_bus_interface_usbdi_v0_t, 0x40 );
