...
#include "magic/request_parameters_v1_13_t.start.hpp"
namespace wdf
{
    // [struct _WDF_REQUEST_PARAMETERS_V1_13]
    // => Windows 10 v1607
    //
    struct request_parameters_v1_13_t                                                                 
    {                                                                                                 
        ...
        {                                                                                             
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_13.Parameters.Create.$", 0x0, false, 0xf084513ac26926f0 );                                                  
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_13.Parameters.Read.$", 0x0, false, 0x4072002d22a1f64b );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_13.Parameters.Write.$", 0x0, false, 0xac34ff8539bec216 );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_13.Parameters.DeviceIoControl.$", 0x0, false, 0x82c034e491e4bf52 );                                                      
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_13.Parameters.Others.$", 0x0, false, 0x18399e26d6ad3850 );                                                 
            ...
            SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_13.Parameters.$", 0x0, false, 0xe294a752fd9774e7 );                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_13.$", 0x0, false, 0x50337bb8dc3d0fe5 );               
        SDK_FIXED_SIZE( request_parameters_v1_13_t, 0x28 );                                           
    };                                                                                                
};
#include "magic/request_parameters_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::request_parameters_v1_13_t::u0_parameters_t::u1_create_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_13_t::u0_parameters_t::u2_read_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_13_t::u0_parameters_t::u3_write_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_13_t::u0_parameters_t::u4_device_io_control_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_13_t::u0_parameters_t::u5_others_t, 0x20 );
SDK_VERIFY( union wdf::request_parameters_v1_13_t::u0_parameters_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_13_t, 0x28 );
