...
#include "magic/wdfcx_fileobject_config_v1_15_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    struct wdfrequest_t;
    ...
    // => Windows 10 v1607
    //
    struct wdfcx_fileobject_config_v1_15_t                              
    {                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDFCX_FILEOBJECT_CONFIG_V1_15.$", 0x0, false, 0x650b062387db26ad );                           
        SDK_FIXED_SIZE( wdfcx_fileobject_config_v1_15_t, 0x28 );                           
    };                                                                  
};
#include "magic/wdfcx_fileobject_config_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::wdfcx_fileobject_config_v1_15_t, 0x28 );
