...
#include "magic/power_policy_event_callbacks_v1_13_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct power_policy_event_callbacks_v1_13_t                                                     
    {                                                                                               
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_POLICY_EVENT_CALLBACKS_V1_13.$", 0x0, false, 0xe1bca20785cea61f );                                        
        SDK_FIXED_SIZE( power_policy_event_callbacks_v1_13_t, 0x40 );                                        
    };                                                                                              
};
#include "magic/power_policy_event_callbacks_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::power_policy_event_callbacks_v1_13_t, 0x40 );
