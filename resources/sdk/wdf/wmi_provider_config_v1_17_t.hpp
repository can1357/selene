...
#include "magic/wmi_provider_config_v1_17_t.start.hpp"
namespace wdf
{
    ...
    {                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_PROVIDER_CONFIG_V1_17.$", 0x0, false, 0x1e7dcc3b54656d03 );                                  
        SDK_FIXED_SIZE( wmi_provider_config_v1_17_t, 0x28 );                                  
    };                                                                                  
};
#include "magic/wmi_provider_config_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_provider_config_v1_17_t, 0x28 );
