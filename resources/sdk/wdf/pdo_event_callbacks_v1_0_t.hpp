...
#include "magic/pdo_event_callbacks_v1_0_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pdo_event_callbacks_v1_0_t                                                              
    {                                                                                              
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_PDO_EVENT_CALLBACKS_V1_0.$", 0x0, false, 0xe98c3b40d147aefb );                                       
        SDK_FIXED_SIZE( pdo_event_callbacks_v1_0_t, 0x38 );                                        
    };                                                                                             
};
#include "magic/pdo_event_callbacks_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::pdo_event_callbacks_v1_0_t, 0x38 );
