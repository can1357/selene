...
#include "magic/object_attributes_v1_15_t.start.hpp"
namespace wdf
{
    ...
    {                                                                      
        ...
        _m07 pcwdf_object_context_type_info_v1_15_t  context_type_info;      //{ +0x0030    } | .ContextTypeInfo
                                                                           
        SDK_MAGIC_PROPERTIES( "_WDF_OBJECT_ATTRIBUTES_V1_15.$", 0x0, false, 0x4ee2202d8609e81a );                      
        SDK_FIXED_SIZE( object_attributes_v1_15_t, 0x38 );                      
    };                                                                     
};
#include "magic/object_attributes_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::object_attributes_v1_15_t, 0x38 );
