...
#include "magic/usb_pipe_information_v1_13_t.start.hpp"
namespace wdf
{
    // [struct _WDF_USB_PIPE_INFORMATION_V1_13]
    // => Windows 10 v1607
    //
    struct usb_pipe_information_v1_13_t                      
    {                                                        
        // Windows 10 v1607                                  
        //                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_USB_PIPE_INFORMATION_V1_13.$", 0x0, false, 0xed136cfa1e104b7e );                      
        SDK_FIXED_SIZE( usb_pipe_information_v1_13_t, 0x14 );                      
    };                                                       
};
#include "magic/usb_pipe_information_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::usb_pipe_information_v1_13_t, 0x14 );
