...
#include "magic/request_parameters_v1_15_t.start.hpp"
namespace wdf
{
    // [struct _WDF_REQUEST_PARAMETERS_V1_15]
    // => Windows 10 v1607
    //
    struct request_parameters_v1_15_t                                                                 
    {                                                                                                 
        ...
        {                                                                                             
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_15.Parameters.Create.$", 0x0, false, 0x12b2e37b0ef7b461 );                                                  
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_15.Parameters.Read.$", 0x0, false, 0x9733f4894f7da58c );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_15.Parameters.Write.$", 0x0, false, 0xbdc70d98359ef4fb );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_15.Parameters.DeviceIoControl.$", 0x0, false, 0xbd59d4a0e83781aa );                                                      
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_15.Parameters.Others.$", 0x0, false, 0xf1ce4104d02eeb28 );                                                 
            ...
            SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_15.Parameters.$", 0x0, false, 0xf4b4f682f617089d );                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_15.$", 0x0, false, 0x74fbfc3ab419bebf );               
        SDK_FIXED_SIZE( request_parameters_v1_15_t, 0x28 );                                           
    };                                                                                                
};
#include "magic/request_parameters_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::request_parameters_v1_15_t::u0_parameters_t::u1_create_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_15_t::u0_parameters_t::u2_read_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_15_t::u0_parameters_t::u3_write_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_15_t::u0_parameters_t::u4_device_io_control_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_15_t::u0_parameters_t::u5_others_t, 0x20 );
SDK_VERIFY( union wdf::request_parameters_v1_15_t::u0_parameters_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_15_t, 0x28 );
