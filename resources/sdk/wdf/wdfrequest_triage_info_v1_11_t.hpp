...
#include "magic/wdfrequest_triage_info_v1_11_t.start.hpp"
namespace wdf
{
    ...
    {                                         
        ...
        SDK_MAGIC_PROPERTIES( "_WDFREQUEST_TRIAGE_INFO_V1_11.$", 0x0, false, 0x6ac16bd7105fd792 );                        
        SDK_FIXED_SIZE( wdfrequest_triage_info_v1_11_t, 0x1c );                        
    };                                        
};
#include "magic/wdfrequest_triage_info_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::wdfrequest_triage_info_v1_11_t, 0x1c );
