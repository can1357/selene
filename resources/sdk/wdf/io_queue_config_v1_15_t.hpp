...
#include "magic/io_queue_config_v1_15_t.start.hpp"
namespace wdf
{
    struct wdfqueue_t;
    struct wdfdriver_t;
    ...
    // => Windows 10 v1607
    //
    struct io_queue_config_v1_15_t                                                                 
    {                                                                                              
        union u0_settings_t                                                                        
        {                                                                                          
            ...
            {                                                                                      
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_15.Settings.Parallel.$", 0x0, false, 0xb870117c6e210ffc );                                                                     
            ...
            SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_15.Settings.$", 0x0, false, 0x91f099af7f8ea783 );                                        
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_15.$", 0x0, false, 0x4c16c0ff836d5a7e );                               
        SDK_FIXED_SIZE( io_queue_config_v1_15_t, 0x60 );                                           
    };                                                                                             
};
#include "magic/io_queue_config_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::io_queue_config_v1_15_t::u0_settings_t::u1_parallel_t, 0x4 );
SDK_VERIFY( union wdf::io_queue_config_v1_15_t::u0_settings_t, 0x4 );
SDK_VERIFY( struct wdf::io_queue_config_v1_15_t, 0x60 );
