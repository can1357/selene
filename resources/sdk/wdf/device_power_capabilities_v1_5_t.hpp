...
#include "magic/device_power_capabilities_v1_5_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_POWER_CAPABILITIES_V1_5]
    // => Windows 10 v1607
    //
    struct device_power_capabilities_v1_5_t                                     
    {                                                                           
        // Windows 10 v1607                                                     
        //                                                                      
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_POWER_CAPABILITIES_V1_5.$", 0x0, false, 0xf73e995fa8d1b9a3 );                      
        SDK_FIXED_SIZE( device_power_capabilities_v1_5_t, 0x50 );                      
    };                                                                          
};
#include "magic/device_power_capabilities_v1_5_t.end.hpp"
SDK_VERIFY( struct wdf::device_power_capabilities_v1_5_t, 0x50 );
