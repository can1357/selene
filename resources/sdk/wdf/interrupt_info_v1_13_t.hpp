...
#include "magic/interrupt_info_v1_13_t.start.hpp"
namespace wdf
{
    // [struct _WDF_INTERRUPT_INFO_V1_13]
    // => Windows 10 v1607
    //
    struct interrupt_info_v1_13_t                                
    {                                                            
        // Windows 10 v1607                                      
        //                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_INFO_V1_13.$", 0x0, false, 0xb1b1ac0ec364c2a2 );                     
        SDK_FIXED_SIZE( interrupt_info_v1_13_t, 0x40 );                     
    };                                                           
};
#include "magic/interrupt_info_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_info_v1_13_t, 0x40 );
