...
#include "magic/request_parameters_v1_7_t.start.hpp"
namespace wdf
{
    // [struct _WDF_REQUEST_PARAMETERS_V1_7]
    // => Windows 10 v1607
    //
    struct request_parameters_v1_7_t                                                                  
    {                                                                                                 
        ...
        {                                                                                             
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_7.Parameters.Create.$", 0x0, false, 0x3e1f849fb0e89456 );                                                  
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_7.Parameters.Read.$", 0x0, false, 0xab4103ff08898c0f );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_7.Parameters.Write.$", 0x0, false, 0xdfe3d74c4bb3109 );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_7.Parameters.DeviceIoControl.$", 0x0, false, 0x768e1faff48ab17b );                                                      
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_7.Parameters.Others.$", 0x0, false, 0xde8228d32bed766a );                                                 
            ...
            SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_7.Parameters.$", 0x0, false, 0xe74f70e51a30af2f );                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_7.$", 0x0, false, 0x9a3f652ac0ec0938 );               
        SDK_FIXED_SIZE( request_parameters_v1_7_t, 0x28 );                                            
    };                                                                                                
};
#include "magic/request_parameters_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::request_parameters_v1_7_t::u0_parameters_t::u1_create_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_7_t::u0_parameters_t::u2_read_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_7_t::u0_parameters_t::u3_write_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_7_t::u0_parameters_t::u4_device_io_control_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_7_t::u0_parameters_t::u5_others_t, 0x20 );
SDK_VERIFY( union wdf::request_parameters_v1_7_t::u0_parameters_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_7_t, 0x28 );
