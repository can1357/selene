...
#include "magic/request_parameters_v1_17_t.start.hpp"
namespace wdf
{
    // [struct _WDF_REQUEST_PARAMETERS_V1_17]
    // => Windows 10 v1607
    //
    struct request_parameters_v1_17_t                                                                 
    {                                                                                                 
        ...
        {                                                                                             
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_17.Parameters.Create.$", 0x0, false, 0x2083f829f736dd40 );                                                  
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_17.Parameters.Read.$", 0x0, false, 0xdc3d6629f60a1a30 );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_17.Parameters.Write.$", 0x0, false, 0x17ad8ac5a09d668a );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_17.Parameters.DeviceIoControl.$", 0x0, false, 0x51816c83b2d84c5f );                                                      
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_17.Parameters.Others.$", 0x0, false, 0x416f2bb19f8ce183 );                                                 
            ...
            SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_17.Parameters.$", 0x0, false, 0xdd5795881f9986d8 );                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_17.$", 0x0, false, 0x58f3e1d97360a787 );               
        SDK_FIXED_SIZE( request_parameters_v1_17_t, 0x28 );                                           
    };                                                                                                
};
#include "magic/request_parameters_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::request_parameters_v1_17_t::u0_parameters_t::u1_create_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_17_t::u0_parameters_t::u2_read_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_17_t::u0_parameters_t::u3_write_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_17_t::u0_parameters_t::u4_device_io_control_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_17_t::u0_parameters_t::u5_others_t, 0x20 );
SDK_VERIFY( union wdf::request_parameters_v1_17_t::u0_parameters_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_17_t, 0x28 );
