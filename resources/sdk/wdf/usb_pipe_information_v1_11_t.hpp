...
#include "magic/usb_pipe_information_v1_11_t.start.hpp"
namespace wdf
{
    // [struct _WDF_USB_PIPE_INFORMATION_V1_11]
    // => Windows 10 v1607
    //
    struct usb_pipe_information_v1_11_t                      
    {                                                        
        // Windows 10 v1607                                  
        //                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_USB_PIPE_INFORMATION_V1_11.$", 0x0, false, 0xb862f55e0da6070b );                      
        SDK_FIXED_SIZE( usb_pipe_information_v1_11_t, 0x14 );                      
    };                                                       
};
#include "magic/usb_pipe_information_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::usb_pipe_information_v1_11_t, 0x14 );
