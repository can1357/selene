...
#include "magic/timer_config_v1_13_t.start.hpp"
namespace wdf
{
    struct wdftimer_t;
    ...
    {                                                                                
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_TIMER_CONFIG_V1_13.$", 0x0, false, 0x36b9d1681d31fc59 );                          
        SDK_FIXED_SIZE( timer_config_v1_13_t, 0x28 );                                
    };                                                                               
};
#include "magic/timer_config_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::timer_config_v1_13_t, 0x28 );
