...
#include "magic/driver_config_v1_15_t.start.hpp"
namespace wdf
{
    struct wdfdriver_t;
    ...
    {                                                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DRIVER_CONFIG_V1_15.$", 0x0, false, 0x6ef9a2986981bdbe );                      
        SDK_FIXED_SIZE( driver_config_v1_15_t, 0x20 );                            
    };                                                                            
};
#include "magic/driver_config_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::driver_config_v1_15_t, 0x20 );
