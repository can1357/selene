...
#include "magic/dma_enabler_config_v1_11_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct dma_enabler_config_v1_11_t                                                       
    {                                                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DMA_ENABLER_CONFIG_V1_11.$", 0x0, false, 0x8b035f00c430df7d );                                      
        SDK_FIXED_SIZE( dma_enabler_config_v1_11_t, 0x50 );                                      
    };                                                                                      
};
#include "magic/dma_enabler_config_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::dma_enabler_config_v1_11_t, 0x50 );
