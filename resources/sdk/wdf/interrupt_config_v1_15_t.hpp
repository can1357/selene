...
#include "magic/interrupt_config_v1_15_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct interrupt_config_v1_15_t                                                  
    {                                                                                
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_CONFIG_V1_15.$", 0x0, false, 0x715f4cf1855e792 );                              
        SDK_FIXED_SIZE( interrupt_config_v1_15_t, 0x68 );                              
    };                                                                               
};
#include "magic/interrupt_config_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_config_v1_15_t, 0x68 );
