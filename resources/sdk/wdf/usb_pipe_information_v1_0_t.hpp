...
#include "magic/usb_pipe_information_v1_0_t.start.hpp"
namespace wdf
{
    // [struct _WDF_USB_PIPE_INFORMATION_V1_0]
    // => Windows 10 v1607
    //
    struct usb_pipe_information_v1_0_t                       
    {                                                        
        // Windows 10 v1607                                  
        //                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_USB_PIPE_INFORMATION_V1_0.$", 0x0, false, 0x90be4e9ddaad8432 );                      
        SDK_FIXED_SIZE( usb_pipe_information_v1_0_t, 0x14 );                      
    };                                                       
};
#include "magic/usb_pipe_information_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::usb_pipe_information_v1_0_t, 0x14 );
