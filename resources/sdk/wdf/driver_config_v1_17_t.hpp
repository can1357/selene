...
#include "magic/driver_config_v1_17_t.start.hpp"
namespace wdf
{
    struct wdfdriver_t;
    ...
    {                                                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DRIVER_CONFIG_V1_17.$", 0x0, false, 0xac1222382e7c33e8 );                      
        SDK_FIXED_SIZE( driver_config_v1_17_t, 0x20 );                            
    };                                                                            
};
#include "magic/driver_config_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::driver_config_v1_17_t, 0x20 );
