...
#include "magic/child_list_config_v1_0_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct child_list_config_v1_0_t                                                                                     
    {                                                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_CHILD_LIST_CONFIG_V1_0.$", 0x0, false, 0x28e8197d7a33f0a3 );                                                    
        SDK_FIXED_SIZE( child_list_config_v1_0_t, 0x60 );                                                               
    };                                                                                                                  
};
#include "magic/child_list_config_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::child_list_config_v1_0_t, 0x60 );
