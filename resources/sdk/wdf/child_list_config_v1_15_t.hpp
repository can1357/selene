...
#include "magic/child_list_config_v1_15_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct child_list_config_v1_15_t                                                                                    
    {                                                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_CHILD_LIST_CONFIG_V1_15.$", 0x0, false, 0x44193a0278965520 );                                                    
        SDK_FIXED_SIZE( child_list_config_v1_15_t, 0x60 );                                                              
    };                                                                                                                  
};
#include "magic/child_list_config_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::child_list_config_v1_15_t, 0x60 );
