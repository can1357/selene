...
#include "magic/driver_config_v1_13_t.start.hpp"
namespace wdf
{
    struct wdfdriver_t;
    ...
    {                                                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DRIVER_CONFIG_V1_13.$", 0x0, false, 0xe5e78613df4274e );                      
        SDK_FIXED_SIZE( driver_config_v1_13_t, 0x20 );                            
    };                                                                            
};
#include "magic/driver_config_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::driver_config_v1_13_t, 0x20 );
