...
#include "magic/query_interface_config_v1_5_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct query_interface_config_v1_5_t                                                              
    {                                                                                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_QUERY_INTERFACE_CONFIG_V1_5.$", 0x0, false, 0x7d4f3daec00718e );                                           
        SDK_FIXED_SIZE( query_interface_config_v1_5_t, 0x30 );                                           
    };                                                                                                
};
#include "magic/query_interface_config_v1_5_t.end.hpp"
SDK_VERIFY( struct wdf::query_interface_config_v1_5_t, 0x30 );
