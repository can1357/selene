...
#include "magic/device_pnp_capabilities_v1_9_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_PNP_CAPABILITIES_V1_9]
    // => Windows 10 v1607
    //
    struct device_pnp_capabilities_v1_9_t              
    {                                                  
        // Windows 10 v1607                            
        //                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_PNP_CAPABILITIES_V1_9.$", 0x0, false, 0x19f1560eecd0b5d3 );                    
        SDK_FIXED_SIZE( device_pnp_capabilities_v1_9_t, 0x30 );                    
    };                                                 
};
#include "magic/device_pnp_capabilities_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::device_pnp_capabilities_v1_9_t, 0x30 );
