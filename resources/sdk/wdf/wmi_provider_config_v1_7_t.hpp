...
#include "magic/wmi_provider_config_v1_7_t.start.hpp"
namespace wdf
{
    ...
    {                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_PROVIDER_CONFIG_V1_7.$", 0x0, false, 0x8966d3b06a2d9bb2 );                                  
        SDK_FIXED_SIZE( wmi_provider_config_v1_7_t, 0x28 );                                  
    };                                                                                  
};
#include "magic/wmi_provider_config_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_provider_config_v1_7_t, 0x28 );
