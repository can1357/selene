...
#include "magic/power_routine_timed_out_data_v1_7_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct power_routine_timed_out_data_v1_7_t                        
    {                                                                 
        // Windows 10 v1607                                           
        //                                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_ROUTINE_TIMED_OUT_DATA_V1_7.$", 0x0, false, 0x4d096a651c2701ad );                   
        SDK_FIXED_SIZE( power_routine_timed_out_data_v1_7_t, 0x20 );                   
    };                                                                
};
#include "magic/power_routine_timed_out_data_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::power_routine_timed_out_data_v1_7_t, 0x20 );
