...
#include "magic/io_target_open_params_v1_15_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct io_target_open_params_v1_15_t                                                    
    {                                                                                       
        ...
        _m17 nt::unicode_view                                 file_name;                      //{ +0x0078    } | .FileName
                                                                                            
        SDK_MAGIC_PROPERTIES( "_WDF_IO_TARGET_OPEN_PARAMS_V1_15.$", 0x0, false, 0x9d2a8df02398ca93 );                              
        SDK_FIXED_SIZE( io_target_open_params_v1_15_t, 0x88 );                              
    };                                                                                      
};
#include "magic/io_target_open_params_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::io_target_open_params_v1_15_t, 0x88 );
