...
#include "magic/io_queue_config_v1_13_t.start.hpp"
namespace wdf
{
    struct wdfqueue_t;
    struct wdfdriver_t;
    ...
    // => Windows 10 v1607
    //
    struct io_queue_config_v1_13_t                                                                 
    {                                                                                              
        union u0_settings_t                                                                        
        {                                                                                          
            ...
            {                                                                                      
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_13.Settings.Parallel.$", 0x0, false, 0x7291be37ce77e103 );                                                                     
            ...
            SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_13.Settings.$", 0x0, false, 0xf7cbaa8f540f89d3 );                                        
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_13.$", 0x0, false, 0x44920971cb0c8bf1 );                               
        SDK_FIXED_SIZE( io_queue_config_v1_13_t, 0x60 );                                           
    };                                                                                             
};
#include "magic/io_queue_config_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::io_queue_config_v1_13_t::u0_settings_t::u1_parallel_t, 0x4 );
SDK_VERIFY( union wdf::io_queue_config_v1_13_t::u0_settings_t, 0x4 );
SDK_VERIFY( struct wdf::io_queue_config_v1_13_t, 0x60 );
