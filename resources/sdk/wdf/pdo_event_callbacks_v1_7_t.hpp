...
#include "magic/pdo_event_callbacks_v1_7_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pdo_event_callbacks_v1_7_t                                                              
    {                                                                                              
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_PDO_EVENT_CALLBACKS_V1_7.$", 0x0, false, 0xfe5b384335bb832e );                                       
        SDK_FIXED_SIZE( pdo_event_callbacks_v1_7_t, 0x38 );                                        
    };                                                                                             
};
#include "magic/pdo_event_callbacks_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::pdo_event_callbacks_v1_7_t, 0x38 );
