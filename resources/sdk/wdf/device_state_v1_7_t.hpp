...
#include "magic/device_state_v1_7_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_STATE_V1_7]
    // => Windows 10 v1607
    //
    struct device_state_v1_7_t                        
    {                                                 
        // Windows 10 v1607                           
        //                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_STATE_V1_7.$", 0x0, false, 0x10f691dc3998d39d );                   
        SDK_FIXED_SIZE( device_state_v1_7_t, 0x1c );                   
    };                                                
};
#include "magic/device_state_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::device_state_v1_7_t, 0x1c );
