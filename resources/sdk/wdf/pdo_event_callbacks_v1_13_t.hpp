...
#include "magic/pdo_event_callbacks_v1_13_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pdo_event_callbacks_v1_13_t                                                             
    {                                                                                              
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_PDO_EVENT_CALLBACKS_V1_13.$", 0x0, false, 0x2e2887d29d79f836 );                                       
        SDK_FIXED_SIZE( pdo_event_callbacks_v1_13_t, 0x40 );                                       
    };                                                                                             
};
#include "magic/pdo_event_callbacks_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::pdo_event_callbacks_v1_13_t, 0x40 );
