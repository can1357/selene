...
#include "magic/wmi_instance_config_v1_1_t.start.hpp"
namespace wdf
{
    struct wdfwmiinstance_t;
    struct wdfwmiprovider_t;
    struct wmi_provider_config_v1_1_t;

    // [struct _WDF_WMI_INSTANCE_CONFIG_V1_1]
    // => Windows 10 v1607
    //
    struct wmi_instance_config_v1_1_t                                                
    {                                                                                
        ...
        _m02 struct wdf::wmi_provider_config_v1_1_t* provider_config;                  //{ +0x0010    } | .ProviderConfig
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_INSTANCE_CONFIG_V1_1.$", 0x0, false, 0x694f2fd5d0341f32 );                                
        SDK_FIXED_SIZE( wmi_instance_config_v1_1_t, 0x40 );                                
    };                                                                               
};
#include "magic/wmi_instance_config_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_instance_config_v1_1_t, 0x40 );
