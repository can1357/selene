...
#include "magic/device_state_v1_5_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_STATE_V1_5]
    // => Windows 10 v1607
    //
    struct device_state_v1_5_t                        
    {                                                 
        // Windows 10 v1607                           
        //                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_STATE_V1_5.$", 0x0, false, 0xb4a87541c4a780e5 );                   
        SDK_FIXED_SIZE( device_state_v1_5_t, 0x1c );                   
    };                                                
};
#include "magic/device_state_v1_5_t.end.hpp"
SDK_VERIFY( struct wdf::device_state_v1_5_t, 0x1c );
