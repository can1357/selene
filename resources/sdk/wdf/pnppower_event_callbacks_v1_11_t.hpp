...
#include "magic/pnppower_event_callbacks_v1_11_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pnppower_event_callbacks_v1_11_t                                                             
    {                                                                                                   
        ...
        _m17 pfn_wdf_device_usage_notification_ex_t         evt_device_usage_notification_ex;             //{ +0x0088    } | .EvtDeviceUsageNotificationEx
                                                                                                        
        SDK_MAGIC_PROPERTIES( "_WDF_PNPPOWER_EVENT_CALLBACKS_V1_11.$", 0x0, false, 0x8538703c2992f7ce );                                            
        SDK_FIXED_SIZE( pnppower_event_callbacks_v1_11_t, 0x90 );                                            
    };                                                                                                  
};
#include "magic/pnppower_event_callbacks_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::pnppower_event_callbacks_v1_11_t, 0x90 );
