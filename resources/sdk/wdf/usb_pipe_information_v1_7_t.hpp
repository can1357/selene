...
#include "magic/usb_pipe_information_v1_7_t.start.hpp"
namespace wdf
{
    // [struct _WDF_USB_PIPE_INFORMATION_V1_7]
    // => Windows 10 v1607
    //
    struct usb_pipe_information_v1_7_t                       
    {                                                        
        // Windows 10 v1607                                  
        //                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_USB_PIPE_INFORMATION_V1_7.$", 0x0, false, 0x7e53e6de8479a9a1 );                      
        SDK_FIXED_SIZE( usb_pipe_information_v1_7_t, 0x14 );                      
    };                                                       
};
#include "magic/usb_pipe_information_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::usb_pipe_information_v1_7_t, 0x14 );
