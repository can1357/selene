...
#include "magic/interrupt_config_v1_17_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct interrupt_config_v1_17_t                                                  
    {                                                                                
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_CONFIG_V1_17.$", 0x0, false, 0x228885ca2c77dd52 );                              
        SDK_FIXED_SIZE( interrupt_config_v1_17_t, 0x68 );                              
    };                                                                               
};
#include "magic/interrupt_config_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_config_v1_17_t, 0x68 );
