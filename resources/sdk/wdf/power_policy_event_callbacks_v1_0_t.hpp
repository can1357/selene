...
#include "magic/power_policy_event_callbacks_v1_0_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct power_policy_event_callbacks_v1_0_t                                                
    {                                                                                         
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_POLICY_EVENT_CALLBACKS_V1_0.$", 0x0, false, 0x6b173b2cd902efb4 );                                  
        SDK_FIXED_SIZE( power_policy_event_callbacks_v1_0_t, 0x38 );                                  
    };                                                                                        
};
#include "magic/power_policy_event_callbacks_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::power_policy_event_callbacks_v1_0_t, 0x38 );
