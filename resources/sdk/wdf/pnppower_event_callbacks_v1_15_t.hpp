...
#include "magic/pnppower_event_callbacks_v1_15_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pnppower_event_callbacks_v1_15_t                                                             
    {                                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_PNPPOWER_EVENT_CALLBACKS_V1_15.$", 0x0, false, 0xbe813b2f33959ce3 );                                            
        SDK_FIXED_SIZE( pnppower_event_callbacks_v1_15_t, 0x90 );                                            
    };                                                                                                  
};
#include "magic/pnppower_event_callbacks_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::pnppower_event_callbacks_v1_15_t, 0x90 );
