...
#include "magic/device_power_capabilities_v1_0_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_POWER_CAPABILITIES_V1_0]
    // => Windows 10 v1607
    //
    struct device_power_capabilities_v1_0_t                                     
    {                                                                           
        // Windows 10 v1607                                                     
        //                                                                      
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_POWER_CAPABILITIES_V1_0.$", 0x0, false, 0x84ff8c1497ac551f );                      
        SDK_FIXED_SIZE( device_power_capabilities_v1_0_t, 0x50 );                      
    };                                                                          
};
#include "magic/device_power_capabilities_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::device_power_capabilities_v1_0_t, 0x50 );
