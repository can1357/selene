...
#include "magic/dma_enabler_config_v1_1_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct dma_enabler_config_v1_1_t                                                        
    {                                                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DMA_ENABLER_CONFIG_V1_1.$", 0x0, false, 0x68f3d8f5bd2be322 );                                      
        SDK_FIXED_SIZE( dma_enabler_config_v1_1_t, 0x40 );                                      
    };                                                                                      
};
#include "magic/dma_enabler_config_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::dma_enabler_config_v1_1_t, 0x40 );
