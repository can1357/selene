...
#include "magic/interrupt_config_v1_0_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct interrupt_config_v1_0_t                              
    {                                                           
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_CONFIG_V1_0.$", 0x0, false, 0x233477d0b7bba4b4 );                        
        SDK_FIXED_SIZE( interrupt_config_v1_0_t, 0x38 );                        
    };                                                          
};
#include "magic/interrupt_config_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_config_v1_0_t, 0x38 );
