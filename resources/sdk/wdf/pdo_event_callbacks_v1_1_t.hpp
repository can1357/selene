...
#include "magic/pdo_event_callbacks_v1_1_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pdo_event_callbacks_v1_1_t                                                              
    {                                                                                              
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_PDO_EVENT_CALLBACKS_V1_1.$", 0x0, false, 0xd4d0ff678cf5b59b );                                       
        SDK_FIXED_SIZE( pdo_event_callbacks_v1_1_t, 0x38 );                                        
    };                                                                                             
};
#include "magic/pdo_event_callbacks_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::pdo_event_callbacks_v1_1_t, 0x38 );
