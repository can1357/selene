...
#include "magic/fileobject_config_v1_0_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    struct wdfrequest_t;
    ...
    // => Windows 10 v1607
    //
    struct fileobject_config_v1_0_t                                   
    {                                                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_FILEOBJECT_CONFIG_V1_0.$", 0x0, false, 0xa2e821f197ecab6e );                           
        SDK_FIXED_SIZE( fileobject_config_v1_0_t, 0x28 );                           
    };                                                                
};
#include "magic/fileobject_config_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::fileobject_config_v1_0_t, 0x28 );
