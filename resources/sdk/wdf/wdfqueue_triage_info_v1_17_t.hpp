...
#include "magic/wdfqueue_triage_info_v1_17_t.start.hpp"
namespace wdf
{
    ...
    {                                      
        ...
        SDK_MAGIC_PROPERTIES( "_WDFQUEUE_TRIAGE_INFO_V1_17.$", 0x0, false, 0x62fe377a63be502 );                     
        SDK_FIXED_SIZE( wdfqueue_triage_info_v1_17_t, 0x1c );                     
    };                                     
};
#include "magic/wdfqueue_triage_info_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::wdfqueue_triage_info_v1_17_t, 0x1c );
