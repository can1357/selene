...
#include "magic/device_power_policy_idle_settings_v1_1_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_POWER_POLICY_IDLE_SETTINGS_V1_1]
    // => Windows 10 v1607
    //
    struct device_power_policy_idle_settings_v1_1_t                                      
    {                                                                                    
        // Windows 10 v1607                                                              
        //                                                                               
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_POWER_POLICY_IDLE_SETTINGS_V1_1.$", 0x0, false, 0x93d95d50de84ad16 );                              
        SDK_FIXED_SIZE( device_power_policy_idle_settings_v1_1_t, 0x18 );                              
    };                                                                                   
};
#include "magic/device_power_policy_idle_settings_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::device_power_policy_idle_settings_v1_1_t, 0x18 );
