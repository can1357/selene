...
#include "magic/power_policy_event_callbacks_v1_11_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct power_policy_event_callbacks_v1_11_t                                                     
    {                                                                                               
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_POLICY_EVENT_CALLBACKS_V1_11.$", 0x0, false, 0x3db64438226f199c );                                        
        SDK_FIXED_SIZE( power_policy_event_callbacks_v1_11_t, 0x40 );                                        
    };                                                                                              
};
#include "magic/power_policy_event_callbacks_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::power_policy_event_callbacks_v1_11_t, 0x40 );
