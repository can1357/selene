...
#include "magic/device_pnp_capabilities_v1_1_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_PNP_CAPABILITIES_V1_1]
    // => Windows 10 v1607
    //
    struct device_pnp_capabilities_v1_1_t              
    {                                                  
        // Windows 10 v1607                            
        //                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_PNP_CAPABILITIES_V1_1.$", 0x0, false, 0x4821cebc5a4bb25 );                    
        SDK_FIXED_SIZE( device_pnp_capabilities_v1_1_t, 0x30 );                    
    };                                                 
};
#include "magic/device_pnp_capabilities_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::device_pnp_capabilities_v1_1_t, 0x30 );
