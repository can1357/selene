...
#include "magic/wmi_provider_config_v1_15_t.start.hpp"
namespace wdf
{
    ...
    {                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_PROVIDER_CONFIG_V1_15.$", 0x0, false, 0x9842242ae691dfe );                                  
        SDK_FIXED_SIZE( wmi_provider_config_v1_15_t, 0x28 );                                  
    };                                                                                  
};
#include "magic/wmi_provider_config_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_provider_config_v1_15_t, 0x28 );
