...
#include "magic/wmi_provider_config_v1_0_t.start.hpp"
namespace wdf
{
    ...
    {                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_PROVIDER_CONFIG_V1_0.$", 0x0, false, 0x8c2019b406514f39 );                                  
        SDK_FIXED_SIZE( wmi_provider_config_v1_0_t, 0x28 );                                  
    };                                                                                  
};
#include "magic/wmi_provider_config_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_provider_config_v1_0_t, 0x28 );
