...
#include "magic/pnppower_event_callbacks_v1_7_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct pnppower_event_callbacks_v1_7_t                                                              
    {                                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_PNPPOWER_EVENT_CALLBACKS_V1_7.$", 0x0, false, 0x5f49bbc66c24e2fa );                                            
        SDK_FIXED_SIZE( pnppower_event_callbacks_v1_7_t, 0x88 );                                            
    };                                                                                                  
};
#include "magic/pnppower_event_callbacks_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::pnppower_event_callbacks_v1_7_t, 0x88 );
