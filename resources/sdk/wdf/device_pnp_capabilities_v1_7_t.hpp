...
#include "magic/device_pnp_capabilities_v1_7_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_PNP_CAPABILITIES_V1_7]
    // => Windows 10 v1607
    //
    struct device_pnp_capabilities_v1_7_t              
    {                                                  
        // Windows 10 v1607                            
        //                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_PNP_CAPABILITIES_V1_7.$", 0x0, false, 0x46ba82b64a988fa8 );                    
        SDK_FIXED_SIZE( device_pnp_capabilities_v1_7_t, 0x30 );                    
    };                                                 
};
#include "magic/device_pnp_capabilities_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::device_pnp_capabilities_v1_7_t, 0x30 );
