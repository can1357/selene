...
#include "magic/device_state_v1_17_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_STATE_V1_17]
    // => Windows 10 v1607
    //
    struct device_state_v1_17_t                       
    {                                                 
        // Windows 10 v1607                           
        //                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_STATE_V1_17.$", 0x0, false, 0x5634f83c7226dff2 );                   
        SDK_FIXED_SIZE( device_state_v1_17_t, 0x1c );                   
    };                                                
};
#include "magic/device_state_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::device_state_v1_17_t, 0x1c );
