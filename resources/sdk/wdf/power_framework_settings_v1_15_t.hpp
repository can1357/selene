...
#include "magic/power_framework_settings_v1_15_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct power_framework_settings_v1_15_t                                                              
    {                                                                                                    
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_FRAMEWORK_SETTINGS_V1_15.$", 0x0, false, 0x1130bbaa8c55eb5c );                                           
        SDK_FIXED_SIZE( power_framework_settings_v1_15_t, 0x48 );                                           
    };                                                                                                   
};
#include "magic/power_framework_settings_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::power_framework_settings_v1_15_t, 0x48 );
