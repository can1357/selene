...
#include "magic/device_power_capabilities_v1_15_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_POWER_CAPABILITIES_V1_15]
    // => Windows 10 v1607
    //
    struct device_power_capabilities_v1_15_t                                    
    {                                                                           
        // Windows 10 v1607                                                     
        //                                                                      
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_POWER_CAPABILITIES_V1_15.$", 0x0, false, 0x3e77547d09a71ac );                      
        SDK_FIXED_SIZE( device_power_capabilities_v1_15_t, 0x50 );                      
    };                                                                          
};
#include "magic/device_power_capabilities_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::device_power_capabilities_v1_15_t, 0x50 );
