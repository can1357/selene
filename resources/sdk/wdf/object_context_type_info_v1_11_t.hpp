...
#include "magic/object_context_type_info_v1_11_t.start.hpp"
namespace wdf
{
    ...
    {                                                                                   
        ...
        _m03 pcwdf_object_context_type_info_v1_11_t  unique_type;                         //{ +0x0018    } | .UniqueType
        _m04 pfn_get_unique_context_type_t           evt_driver_get_unique_context_type;  //{ +0x0020    } | .EvtDriverGetUniqueContextType
                                                                                        
        SDK_MAGIC_PROPERTIES( "_WDF_OBJECT_CONTEXT_TYPE_INFO_V1_11.$", 0x0, false, 0xf8496fab1bda35f7 );                                   
        SDK_FIXED_SIZE( object_context_type_info_v1_11_t, 0x28 );                                   
    };                                                                                  
};
#include "magic/object_context_type_info_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::object_context_type_info_v1_11_t, 0x28 );
