...
#include "magic/driver_globals_v1_9_t.start.hpp"
namespace wdf
{
    struct wdfdriver_t;
    ...
    {                                                        
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DRIVER_GLOBALS_V1_9.$", 0x0, false, 0x26e2aff74a34acec );                       
        SDK_FIXED_SIZE( driver_globals_v1_9_t, 0x38 );                       
    };                                                       
};
#include "magic/driver_globals_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::driver_globals_v1_9_t, 0x38 );
