...
#include "magic/child_retrieve_info_v1_11_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct child_retrieve_info_v1_11_t                                                                              
    {                                                                                                               
        using pwdf_child_identification_description_header_v1_11_t =    struct wdf::child_identification_description_header_v1_11_t*;                                                  
        using identification_description_t =                            pwdf_child_identification_description_header_v1_11_t ;                                                  
        using pwdf_child_address_description_header_v1_11_t =           struct wdf::child_address_description_header_v1_11_t*;                                                  
        ...
        _m02 pwdf_child_address_description_header_v1_11_t        address_description;                                //{ +0x0010    } | .AddressDescription
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_CHILD_RETRIEVE_INFO_V1_11.$", 0x0, false, 0xd4dfab50f7ee8f99 );                                                  
        SDK_FIXED_SIZE( child_retrieve_info_v1_11_t, 0x28 );                                                        
    };                                                                                                              
};
#include "magic/child_retrieve_info_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::child_retrieve_info_v1_11_t, 0x28 );
