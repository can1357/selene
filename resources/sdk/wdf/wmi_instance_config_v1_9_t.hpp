...
#include "magic/wmi_instance_config_v1_9_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct wmi_instance_config_v1_9_t                                                
    {                                                                                
        ...
        _m02 struct wdf::wmi_provider_config_v1_9_t* provider_config;                  //{ +0x0010    } | .ProviderConfig
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_INSTANCE_CONFIG_V1_9.$", 0x0, false, 0x3dc31cb91a7bbfa8 );                                
        SDK_FIXED_SIZE( wmi_instance_config_v1_9_t, 0x40 );                                
    };                                                                               
};
#include "magic/wmi_instance_config_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_instance_config_v1_9_t, 0x40 );
