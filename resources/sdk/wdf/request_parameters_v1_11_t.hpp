...
#include "magic/request_parameters_v1_11_t.start.hpp"
namespace wdf
{
    // [struct _WDF_REQUEST_PARAMETERS_V1_11]
    // => Windows 10 v1607
    //
    struct request_parameters_v1_11_t                                                                 
    {                                                                                                 
        ...
        {                                                                                             
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_11.Parameters.Create.$", 0x0, false, 0x63cb81d45e3fcd7e );                                                  
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_11.Parameters.Read.$", 0x0, false, 0x1bc7c22b6fdc7040 );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_11.Parameters.Write.$", 0x0, false, 0x6823c02dd4c1f98d );                                               
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_11.Parameters.DeviceIoControl.$", 0x0, false, 0xe7f3512ad137920 );                                                      
            ...
            {                                                                                         
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_11.Parameters.Others.$", 0x0, false, 0xf2598451f26b09a3 );                                                 
            ...
            SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_11.Parameters.$", 0x0, false, 0xd21c0b303555ce78 );                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_REQUEST_PARAMETERS_V1_11.$", 0x0, false, 0x1cb8fd29682aef93 );               
        SDK_FIXED_SIZE( request_parameters_v1_11_t, 0x28 );                                           
    };                                                                                                
};
#include "magic/request_parameters_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::request_parameters_v1_11_t::u0_parameters_t::u1_create_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_11_t::u0_parameters_t::u2_read_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_11_t::u0_parameters_t::u3_write_t, 0x18 );
SDK_VERIFY( struct wdf::request_parameters_v1_11_t::u0_parameters_t::u4_device_io_control_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_11_t::u0_parameters_t::u5_others_t, 0x20 );
SDK_VERIFY( union wdf::request_parameters_v1_11_t::u0_parameters_t, 0x20 );
SDK_VERIFY( struct wdf::request_parameters_v1_11_t, 0x28 );
