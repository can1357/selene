...
#include "magic/driver_config_v1_5_t.start.hpp"
namespace wdf
{
    struct wdfdriver_t;
    ...
    {                                                                             
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DRIVER_CONFIG_V1_5.$", 0x0, false, 0x920bc9b0bb4a0956 );                      
        SDK_FIXED_SIZE( driver_config_v1_5_t, 0x20 );                             
    };                                                                            
};
#include "magic/driver_config_v1_5_t.end.hpp"
SDK_VERIFY( struct wdf::driver_config_v1_5_t, 0x20 );
