...
#include "magic/class_bind_info_v1_11_t.start.hpp"
namespace wdf
{
    struct bind_info_t;
    ...
    // => Windows 10 v1607
    //
    struct class_bind_info_v1_11_t                                  
    {                                                               
        ...
        _m02 struct wdf::class_version_v1_11_t version;               //{ +0x0010    } | .Version
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_CLASS_BIND_INFO_V1_11.$", 0x0, false, 0xd876bd233c2fa4c5 );                     
        SDK_FIXED_SIZE( class_bind_info_v1_11_t, 0x50 );                     
    };                                                              
};
#include "magic/class_bind_info_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::class_bind_info_v1_11_t, 0x50 );
