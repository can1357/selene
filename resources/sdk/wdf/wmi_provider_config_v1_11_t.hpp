...
#include "magic/wmi_provider_config_v1_11_t.start.hpp"
namespace wdf
{
    ...
    {                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_PROVIDER_CONFIG_V1_11.$", 0x0, false, 0x3696f6f729861b8a );                                  
        SDK_FIXED_SIZE( wmi_provider_config_v1_11_t, 0x28 );                                  
    };                                                                                  
};
#include "magic/wmi_provider_config_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_provider_config_v1_11_t, 0x28 );
