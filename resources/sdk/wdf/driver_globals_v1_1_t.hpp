...
#include "magic/driver_globals_v1_1_t.start.hpp"
namespace wdf
{
    struct wdfdriver_t;
    ...
    {                                                        
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DRIVER_GLOBALS_V1_1.$", 0x0, false, 0xdf98118902fc347c );                       
        SDK_FIXED_SIZE( driver_globals_v1_1_t, 0x38 );                       
    };                                                       
};
#include "magic/driver_globals_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::driver_globals_v1_1_t, 0x38 );
