...
#include "magic/device_state_v1_9_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_STATE_V1_9]
    // => Windows 10 v1607
    //
    struct device_state_v1_9_t                        
    {                                                 
        // Windows 10 v1607                           
        //                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_STATE_V1_9.$", 0x0, false, 0xfdc17f93b9b8b39e );                   
        SDK_FIXED_SIZE( device_state_v1_9_t, 0x1c );                   
    };                                                
};
#include "magic/device_state_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::device_state_v1_9_t, 0x1c );
