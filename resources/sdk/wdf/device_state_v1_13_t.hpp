...
#include "magic/device_state_v1_13_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_STATE_V1_13]
    // => Windows 10 v1607
    //
    struct device_state_v1_13_t                       
    {                                                 
        // Windows 10 v1607                           
        //                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_STATE_V1_13.$", 0x0, false, 0x488f18c5578c553 );                   
        SDK_FIXED_SIZE( device_state_v1_13_t, 0x1c );                   
    };                                                
};
#include "magic/device_state_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::device_state_v1_13_t, 0x1c );
