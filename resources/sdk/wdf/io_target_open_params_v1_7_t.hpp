...
#include "magic/io_target_open_params_v1_7_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct io_target_open_params_v1_7_t                                                     
    {                                                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_TARGET_OPEN_PARAMS_V1_7.$", 0x0, false, 0xc342392544a3512d );                              
        SDK_FIXED_SIZE( io_target_open_params_v1_7_t, 0x78 );                               
    };                                                                                      
};
#include "magic/io_target_open_params_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::io_target_open_params_v1_7_t, 0x78 );
