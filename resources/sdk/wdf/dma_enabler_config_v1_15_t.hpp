...
#include "magic/dma_enabler_config_v1_15_t.start.hpp"
namespace wdf
{
    ...
    // => Windows 10 v1607
    //
    struct dma_enabler_config_v1_15_t                                                       
    {                                                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DMA_ENABLER_CONFIG_V1_15.$", 0x0, false, 0x88e06099842e24b0 );                                      
        SDK_FIXED_SIZE( dma_enabler_config_v1_15_t, 0x50 );                                      
    };                                                                                      
};
#include "magic/dma_enabler_config_v1_15_t.end.hpp"
SDK_VERIFY( struct wdf::dma_enabler_config_v1_15_t, 0x50 );
