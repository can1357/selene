...
#include "magic/power_routine_timed_out_data_v1_5_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct power_routine_timed_out_data_v1_5_t                        
    {                                                                 
        // Windows 10 v1607                                           
        //                                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_POWER_ROUTINE_TIMED_OUT_DATA_V1_5.$", 0x0, false, 0x363af465dd19673b );                   
        SDK_FIXED_SIZE( power_routine_timed_out_data_v1_5_t, 0x20 );                   
    };                                                                
};
#include "magic/power_routine_timed_out_data_v1_5_t.end.hpp"
SDK_VERIFY( struct wdf::power_routine_timed_out_data_v1_5_t, 0x20 );
