...
#include "magic/device_power_capabilities_v1_7_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_POWER_CAPABILITIES_V1_7]
    // => Windows 10 v1607
    //
    struct device_power_capabilities_v1_7_t                                     
    {                                                                           
        // Windows 10 v1607                                                     
        //                                                                      
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_POWER_CAPABILITIES_V1_7.$", 0x0, false, 0x1fdc6afd81df1d3d );                      
        SDK_FIXED_SIZE( device_power_capabilities_v1_7_t, 0x50 );                      
    };                                                                          
};
#include "magic/device_power_capabilities_v1_7_t.end.hpp"
SDK_VERIFY( struct wdf::device_power_capabilities_v1_7_t, 0x50 );
