...
#include "magic/wmi_instance_config_v1_5_t.start.hpp"
namespace wdf
{
    struct wdfwmiinstance_t;
    struct wdfwmiprovider_t;
    struct wmi_provider_config_v1_5_t;

    // [struct _WDF_WMI_INSTANCE_CONFIG_V1_5]
    // => Windows 10 v1607
    //
    struct wmi_instance_config_v1_5_t                                                
    {                                                                                
        ...
        _m02 struct wdf::wmi_provider_config_v1_5_t* provider_config;                  //{ +0x0010    } | .ProviderConfig
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_INSTANCE_CONFIG_V1_5.$", 0x0, false, 0x2ae7c27c26386a4e );                                
        SDK_FIXED_SIZE( wmi_instance_config_v1_5_t, 0x40 );                                
    };                                                                               
};
#include "magic/wmi_instance_config_v1_5_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_instance_config_v1_5_t, 0x40 );
