...
#include "magic/usb_pipe_information_v1_1_t.start.hpp"
namespace wdf
{
    // [struct _WDF_USB_PIPE_INFORMATION_V1_1]
    // => Windows 10 v1607
    //
    struct usb_pipe_information_v1_1_t                       
    {                                                        
        // Windows 10 v1607                                  
        //                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_USB_PIPE_INFORMATION_V1_1.$", 0x0, false, 0xd892248e85c9892 );                      
        SDK_FIXED_SIZE( usb_pipe_information_v1_1_t, 0x14 );                      
    };                                                       
};
#include "magic/usb_pipe_information_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::usb_pipe_information_v1_1_t, 0x14 );
