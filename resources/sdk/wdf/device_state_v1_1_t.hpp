...
#include "magic/device_state_v1_1_t.start.hpp"
namespace wdf
{
    // [struct _WDF_DEVICE_STATE_V1_1]
    // => Windows 10 v1607
    //
    struct device_state_v1_1_t                        
    {                                                 
        // Windows 10 v1607                           
        //                                            
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_DEVICE_STATE_V1_1.$", 0x0, false, 0x2fa302d9270d1af0 );                   
        SDK_FIXED_SIZE( device_state_v1_1_t, 0x1c );                   
    };                                                
};
#include "magic/device_state_v1_1_t.end.hpp"
SDK_VERIFY( struct wdf::device_state_v1_1_t, 0x1c );
