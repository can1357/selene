...
#include "magic/fileobject_config_v1_17_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    struct wdfrequest_t;
    ...
    // => Windows 10 v1607
    //
    struct fileobject_config_v1_17_t                                  
    {                                                                 
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_FILEOBJECT_CONFIG_V1_17.$", 0x0, false, 0xdcf7d33fe07271fe );                           
        SDK_FIXED_SIZE( fileobject_config_v1_17_t, 0x28 );                           
    };                                                                
};
#include "magic/fileobject_config_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::fileobject_config_v1_17_t, 0x28 );
