...
#include "magic/wmi_provider_config_v1_13_t.start.hpp"
namespace wdf
{
    ...
    {                                                                                   
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_PROVIDER_CONFIG_V1_13.$", 0x0, false, 0x33f2b198a6fac212 );                                  
        SDK_FIXED_SIZE( wmi_provider_config_v1_13_t, 0x28 );                                  
    };                                                                                  
};
#include "magic/wmi_provider_config_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_provider_config_v1_13_t, 0x28 );
