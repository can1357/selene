...
#include "magic/interrupt_config_v1_13_t.start.hpp"
namespace wdf
{
    struct wdfdevice_t;
    ...
    // => Windows 10 v1607
    //
    struct interrupt_config_v1_13_t                                                  
    {                                                                                
        ...
        _m09 evt_interrupt_work_item_t                 evt_interrupt_work_item;        //{ +0x0038    } | .EvtInterruptWorkItem
        _m10 struct cm::partial_resource_descriptor_t* interrupt_raw;                  //{ +0x0040    } | .InterruptRaw
        _m11 struct cm::partial_resource_descriptor_t* interrupt_translated;           //{ +0x0048    } | .InterruptTranslated
        _m12 struct wdf::wdfwaitlock_t*                wait_lock;                      //{ +0x0050    } | .WaitLock
        _m13 uint8_t                                   passive_handling;               //{ +0x0058    } | .PassiveHandling
        _m14 enum wdf::tri_state_t                     report_inactive_on_power_down;  //{ +0x005c    } | .ReportInactiveOnPowerDown
        _m15 uint8_t                                   can_wake_device;                //{ +0x0060    } | .CanWakeDevice
                                                                                     
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_CONFIG_V1_13.$", 0x0, false, 0x8b9e76bee89a3d1c );                              
        SDK_FIXED_SIZE( interrupt_config_v1_13_t, 0x68 );                              
    };                                                                               
};
#include "magic/interrupt_config_v1_13_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_config_v1_13_t, 0x68 );
