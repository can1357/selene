...
#include "magic/interrupt_info_v1_9_t.start.hpp"
namespace wdf
{
    // [struct _WDF_INTERRUPT_INFO_V1_9]
    // => Windows 10 v1607
    //
    struct interrupt_info_v1_9_t                                 
    {                                                            
        // Windows 10 v1607                                      
        //                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_INFO_V1_9.$", 0x0, false, 0xe575af70ca6a0163 );                     
        SDK_FIXED_SIZE( interrupt_info_v1_9_t, 0x40 );                     
    };                                                           
};
#include "magic/interrupt_info_v1_9_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_info_v1_9_t, 0x40 );
