...
#include "magic/io_queue_config_v1_0_t.start.hpp"
namespace wdf
{
    struct wdfqueue_t;
    struct wdfrequest_t;
    ...
    {                                                                          
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_0.$", 0x0, false, 0x863512b0bf2ae4f8 );                               
        SDK_FIXED_SIZE( io_queue_config_v1_0_t, 0x50 );                               
    };                                                                         
};
#include "magic/io_queue_config_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::io_queue_config_v1_0_t, 0x50 );
