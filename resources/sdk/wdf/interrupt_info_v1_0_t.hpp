...
#include "magic/interrupt_info_v1_0_t.start.hpp"
namespace wdf
{
    // [struct _WDF_INTERRUPT_INFO_V1_0]
    // => Windows 10 v1607
    //
    struct interrupt_info_v1_0_t                                 
    {                                                            
        // Windows 10 v1607                                      
        //                                                       
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_INTERRUPT_INFO_V1_0.$", 0x0, false, 0xa51c0394143b5d59 );                     
        SDK_FIXED_SIZE( interrupt_info_v1_0_t, 0x38 );                     
    };                                                           
};
#include "magic/interrupt_info_v1_0_t.end.hpp"
SDK_VERIFY( struct wdf::interrupt_info_v1_0_t, 0x38 );
