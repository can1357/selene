...
#include "magic/wmi_instance_config_v1_17_t.start.hpp"
namespace wdf
{
    struct wdfwmiinstance_t;
    struct wdfwmiprovider_t;
    struct wmi_provider_config_v1_17_t;

    // [struct _WDF_WMI_INSTANCE_CONFIG_V1_17]
    // => Windows 10 v1607
    //
    struct wmi_instance_config_v1_17_t                                                
    {                                                                                 
        ...
        _m02 struct wdf::wmi_provider_config_v1_17_t* provider_config;                  //{ +0x0010    } | .ProviderConfig
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_WMI_INSTANCE_CONFIG_V1_17.$", 0x0, false, 0x6775a66c283d2641 );                                
        SDK_FIXED_SIZE( wmi_instance_config_v1_17_t, 0x40 );                                
    };                                                                                
};
#include "magic/wmi_instance_config_v1_17_t.end.hpp"
SDK_VERIFY( struct wdf::wmi_instance_config_v1_17_t, 0x40 );
