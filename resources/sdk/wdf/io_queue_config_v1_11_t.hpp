...
#include "magic/io_queue_config_v1_11_t.start.hpp"
namespace wdf
{
    struct wdfqueue_t;
    struct wdfdriver_t;
    ...
    // => Windows 10 v1607
    //
    struct io_queue_config_v1_11_t                                                                 
    {                                                                                              
        union u0_settings_t                                                                        
        {                                                                                          
            ...
            {                                                                                      
                ...
                SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_11.Settings.Parallel.$", 0x0, false, 0x4788184baf8bc9d1 );                                                                     
            ...
            SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_11.Settings.$", 0x0, false, 0x96a6db4605a8e34e );                                        
        ...
        SDK_MAGIC_PROPERTIES( "_WDF_IO_QUEUE_CONFIG_V1_11.$", 0x0, false, 0xfc9be106f0fbf5f0 );                               
        SDK_FIXED_SIZE( io_queue_config_v1_11_t, 0x60 );                                           
    };                                                                                             
};
#include "magic/io_queue_config_v1_11_t.end.hpp"
SDK_VERIFY( struct wdf::io_queue_config_v1_11_t::u0_settings_t::u1_parallel_t, 0x4 );
SDK_VERIFY( union wdf::io_queue_config_v1_11_t::u0_settings_t, 0x4 );
SDK_VERIFY( struct wdf::io_queue_config_v1_11_t, 0x60 );
