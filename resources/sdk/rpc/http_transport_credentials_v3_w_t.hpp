...
#include "magic/http_transport_credentials_v3_w_t.start.hpp"
namespace rpc
{
    // [struct _RPC_HTTP_TRANSPORT_CREDENTIALS_V3_W]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct http_transport_credentials_v3_w_t         
    {                                                
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                              
        //                                           
        ...
        SDK_MAGIC_PROPERTIES( "_RPC_HTTP_TRANSPORT_CREDENTIALS_V3_W.$", 0x40, true, 0x17cabcfff4932f8e );                              
        SDK_FIXED_SIZE( http_transport_credentials_v3_w_t, 0x40 );                              
    };                                               
};
#include "magic/http_transport_credentials_v3_w_t.end.hpp"
SDK_VERIFY( struct rpc::http_transport_credentials_v3_w_t, 0x40 );
