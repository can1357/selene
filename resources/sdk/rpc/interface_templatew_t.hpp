...
#include "magic/interface_templatew_t.start.hpp"
namespace rpc
{
    // [struct RPC_INTERFACE_TEMPLATEW]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct interface_templatew_t                                       
    {                                                                  
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                    
        //                                                             
        ...
        _m09 uint16_t*                             annotation;           //{ +0x0040    +0x0040    +0x0040    +0x0040    } | .Annotation
        _m10 void*                                 security_descriptor;  //{ +0x0048    +0x0048    +0x0048    +0x0048    } | .SecurityDescriptor
                                                                       
        SDK_MAGIC_PROPERTIES( "RPC_INTERFACE_TEMPLATEW.$", 0x50, true, 0x151a7c96a1c9fea8 );                    
        SDK_FIXED_SIZE( interface_templatew_t, 0x50 );                    
    };                                                                 
};
#include "magic/interface_templatew_t.end.hpp"
SDK_VERIFY( struct rpc::interface_templatew_t, 0x50 );
