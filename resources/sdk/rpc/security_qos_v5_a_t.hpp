...
#include "magic/security_qos_v5_a_t.start.hpp"
namespace rpc
{
    ...
    {                                                                                  
        ...
        SDK_MAGIC_PROPERTIES( "_RPC_SECURITY_QOS_V5_A.$", 0x38, true, 0x53c178036a7cef92 );                              
        SDK_FIXED_SIZE( security_qos_v5_a_t, 0x38 );                                   
    };                                                                                 
};
#include "magic/security_qos_v5_a_t.end.hpp"
SDK_VERIFY( struct rpc::security_qos_v5_a_t, 0x38 );
