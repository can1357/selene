...
#include "magic/security_qos_v4_a_t.start.hpp"
namespace rpc
{
    ...
    {                                                                                  
        ...
        SDK_MAGIC_PROPERTIES( "_RPC_SECURITY_QOS_V4_A.$", 0x30, true, 0x11235333a58d5221 );                              
        SDK_FIXED_SIZE( security_qos_v4_a_t, 0x30 );                                   
    };                                                                                 
};
#include "magic/security_qos_v4_a_t.end.hpp"
SDK_VERIFY( struct rpc::security_qos_v4_a_t, 0x30 );
