...
#include "magic/http_transport_credentials_v2_a_t.start.hpp"
namespace rpc
{
    // [struct _RPC_HTTP_TRANSPORT_CREDENTIALS_V2_A]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct http_transport_credentials_v2_a_t                                    
    {                                                                           
        // Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2                              
        //                                                                      
        ...
        _m06 struct sec::winnt_auth_identity_a_t* proxy_credentials;              //{ +0x0028    +0x0028    +0x0028    +0x0028    } | .ProxyCredentials
        ...
        SDK_MAGIC_PROPERTIES( "_RPC_HTTP_TRANSPORT_CREDENTIALS_V2_A.$", 0x40, true, 0x7fb242305bd1c9ed );                              
        SDK_FIXED_SIZE( http_transport_credentials_v2_a_t, 0x40 );                              
    };                                                                          
};
#include "magic/http_transport_credentials_v2_a_t.end.hpp"
SDK_VERIFY( struct rpc::http_transport_credentials_v2_a_t, 0x40 );
