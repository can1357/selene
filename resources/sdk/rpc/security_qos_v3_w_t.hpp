...
#include "magic/security_qos_v3_w_t.start.hpp"
namespace rpc
{
    ...
    {                                                                                  
        ...
        SDK_MAGIC_PROPERTIES( "_RPC_SECURITY_QOS_V3_W.$", 0x28, true, 0xc89a629ed1655910 );                              
        SDK_FIXED_SIZE( security_qos_v3_w_t, 0x28 );                                   
    };                                                                                 
};
#include "magic/security_qos_v3_w_t.end.hpp"
SDK_VERIFY( struct rpc::security_qos_v3_w_t, 0x28 );
