...
#include "magic/security_qos_v4_w_t.start.hpp"
namespace rpc
{
    ...
    {                                                                                  
        ...
        SDK_MAGIC_PROPERTIES( "_RPC_SECURITY_QOS_V4_W.$", 0x30, true, 0xfd2b3d52595d519 );                              
        SDK_FIXED_SIZE( security_qos_v4_w_t, 0x30 );                                   
    };                                                                                 
};
#include "magic/security_qos_v4_w_t.end.hpp"
SDK_VERIFY( struct rpc::security_qos_v4_w_t, 0x30 );
