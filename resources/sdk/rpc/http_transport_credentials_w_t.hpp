...
#include "magic/http_transport_credentials_w_t.start.hpp"
namespace rpc
{
    ...
    {                                                                        
        ...
        SDK_MAGIC_PROPERTIES( "_RPC_HTTP_TRANSPORT_CREDENTIALS_W.$", 0x28, true, 0x3fbcfd62925e9fc );                           
        SDK_FIXED_SIZE( http_transport_credentials_w_t, 0x28 );                           
    };                                                                       
};
#include "magic/http_transport_credentials_w_t.end.hpp"
SDK_VERIFY( struct rpc::http_transport_credentials_w_t, 0x28 );
