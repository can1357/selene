...
#include "../rtl/time_zone_information_t.hpp"

#include "magic/logfile_header_t.start.hpp"
namespace trace
{
    // [struct _TRACE_LOGFILE_HEADER]
    // => Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2
    //
    struct logfile_header_t                                           
    {                                                                 
        ...
        {                                                             
            ...
            SDK_MAGIC_PROPERTIES( "_TRACE_LOGFILE_HEADER.VersionDetail.$", 0x4, true, 0x8881feb274d951bd );                                       
        ...
        _m19 wchar_t*                            logger_name;           //{ +0x0038    +0x0038    +0x0038    +0x0038    } | .LoggerName
        _m20 wchar_t*                            log_file_name;         //{ +0x0040    +0x0040    +0x0040    +0x0040    } | .LogFileName
        _m21 struct rtl::time_zone_information_t time_zone;             //{ +0x0048    +0x0048    +0x0048    +0x0048    } | .TimeZone
        ...
        SDK_MAGIC_PROPERTIES( "_TRACE_LOGFILE_HEADER.$", 0x118, true, 0x4196fc8cb2b1dae9 );                     
        SDK_FIXED_SIZE( logfile_header_t, 0x118 );                     
    };                                                                
};
#include "magic/logfile_header_t.end.hpp"
SDK_VERIFY( struct trace::logfile_header_t::u0_version_detail_t, 0x4 );
SDK_VERIFY( struct trace::logfile_header_t, 0x118 );
