...
#include "magic/pic_params_h264_mvc_t.start.hpp"
namespace dxva
{
    // [struct _DXVA_PicParams_H264_MVC]
    // => WDK 10 (NV)
    //
    struct pic_params_h264_mvc_t                                                                   
    {                                                                                              
        // WDK 10                                                                                  
        //                                                                                         
        ...
        _m051 uint8_t                                       num_views_minus1;                        //{ +0x00e6    } | .num_views_minus1
        _m052 sdk::array<uint16_t, 16>                      view_id;                                 //{ +0x00e7    } | .view_id
        _m053 sdk::array<uint8_t, 16>                       num_anchor_refs_l0;                      //{ +0x0107    } | .num_anchor_refs_l0
        _m054 sdk::array<sdk::array<uint16_t, 16>, 16>      anchor_ref_l0;                           //{ +0x0117    } | .anchor_ref_l0
        _m055 sdk::array<uint8_t, 16>                       num_anchor_refs_l1;                      //{ +0x0317    } | .num_anchor_refs_l1
        _m056 sdk::array<sdk::array<uint16_t, 16>, 16>      anchor_ref_l1;                           //{ +0x0327    } | .anchor_ref_l1
        _m057 sdk::array<uint8_t, 16>                       num_non_anchor_refs_l0;                  //{ +0x0527    } | .num_non_anchor_refs_l0
        _m058 sdk::array<sdk::array<uint16_t, 16>, 16>      non_anchor_ref_l0;                       //{ +0x0537    } | .non_anchor_ref_l0
        _m059 sdk::array<uint8_t, 16>                       num_non_anchor_refs_l1;                  //{ +0x0737    } | .num_non_anchor_refs_l1
        _m060 sdk::array<sdk::array<uint16_t, 16>, 16>      non_anchor_ref_l1;                       //{ +0x0747    } | .non_anchor_ref_l1
        _m061 uint16_t                                      curr_view_id;                            //{ +0x0947    } | .curr_view_id
        _m062 uint8_t                                       anchor_pic_flag;                         //{ +0x0949    } | .anchor_pic_flag
        _m063 uint8_t                                       inter_view_flag;                         //{ +0x094a    } | .inter_view_flag
        _m064 sdk::array<uint16_t, 16>                      view_id_list;                            //{ +0x094b    } | .ViewIDList
                                                                                                   
        SDK_NONVOL_PROPERTIES( "_DXVA_PicParams_H264_MVC.$", 0x0, false, 0x76c999b61a089c65 );                                       
        SDK_FIXED_SIZE( pic_params_h264_mvc_t, 0x96b );                                            
    };                                                                                             
};
#include "magic/pic_params_h264_mvc_t.end.hpp"
SDK_VERIFY( struct dxva::pic_params_h264_mvc_t, 0x96b );
