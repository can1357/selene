...
#include "magic/fsrtl_per_file_context_t.start.hpp"
namespace nt
{
    // [struct _FSRTL_PER_FILE_CONTEXT]
    // => WDK 10, Windows 10 v1607, Windows 10 v2004, Windows 11, Windows 10 v20H2 (NV)
    //
    struct fsrtl_per_file_context_t                    
    {                                                  
        ...
        SDK_NONVOL_PROPERTIES( "_FSRTL_PER_FILE_CONTEXT.$", 0x28, true, 0xa62d45f1ae85542d );              
        SDK_FIXED_SIZE( fsrtl_per_file_context_t, 0x28 );              
    };                                                 
};
#include "magic/fsrtl_per_file_context_t.end.hpp"
SDK_VERIFY( struct nt::fsrtl_per_file_context_t, 0x28 );
