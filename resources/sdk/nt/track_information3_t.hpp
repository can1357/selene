...
#include "magic/track_information3_t.start.hpp"
namespace nt
{
    // [struct _TRACK_INFORMATION3]
    // => WDK 10 (NV)
    //
    struct track_information3_t                            
    {                                                      
        // WDK 10                                          
        //                                                 
        ...
        _m21 sdk::array<uint8_t, 4> read_compatibility_lba;  //{ +0x0024    } | .ReadCompatibilityLba
                                                           
        SDK_NONVOL_PROPERTIES( "_TRACK_INFORMATION3.$", 0x0, false, 0xdd9258fe3ecccb38 );                       
        SDK_FIXED_SIZE( track_information3_t, 0x28 );                       
    };                                                     
};
#include "magic/track_information3_t.end.hpp"
SDK_VERIFY( struct nt::track_information3_t, 0x28 );
