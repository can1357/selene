...
#include "magic/mipi_dsi_caps_t.start.hpp"
namespace nt
{
    // [struct _MIPI_DSI_CAPS]
    // => WDK 10 (NV)
    //
    struct mipi_dsi_caps_t                              
    {                                                   
        // WDK 10                                       
        //                                              
        ...
        SDK_NONVOL_PROPERTIES( "_MIPI_DSI_CAPS.$", 0x0, false, 0x8ded275302c63105 );                                  
        SDK_FIXED_SIZE( mipi_dsi_caps_t, 0x14 );                                  
    };                                                  
};
#include "magic/mipi_dsi_caps_t.end.hpp"
SDK_VERIFY( struct nt::mipi_dsi_caps_t, 0x14 );
