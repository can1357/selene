...
#include "magic/ata_pass_through_direct32_t.start.hpp"
namespace nt
{
    // [struct _ATA_PASS_THROUGH_DIRECT32]
    // => WDK 10 (NV)
    //
    struct ata_pass_through_direct32_t                   
    {                                                    
        // WDK 10                                        
        //                                               
        ...
        _m09 void __ptr32*          data_buffer;           //{ +0x0014    } | .DataBuffer
        ...
        SDK_NONVOL_PROPERTIES( "_ATA_PASS_THROUGH_DIRECT32.$", 0x0, false, 0x78bd2cc39044c13a );                     
        SDK_FIXED_SIZE( ata_pass_through_direct32_t, 0x28 );                     
    };                                                   
};
#include "magic/ata_pass_through_direct32_t.end.hpp"
SDK_VERIFY( struct nt::ata_pass_through_direct32_t, 0x28 );
