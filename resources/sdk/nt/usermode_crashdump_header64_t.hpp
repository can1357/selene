...
#include "magic/usermode_crashdump_header64_t.start.hpp"
namespace nt
{
    // [struct _USERMODE_CRASHDUMP_HEADER64]
    // => WDK 10 (NV)
    //
    struct usermode_crashdump_header64_t   
    {                                      
        // WDK 10                          
        //                                 
        ...
        SDK_NONVOL_PROPERTIES( "_USERMODE_CRASHDUMP_HEADER64.$", 0x0, false, 0x30facdd133b8e886 );                     
        SDK_FIXED_SIZE( usermode_crashdump_header64_t, 0x60 );                     
    };                                     
};
#include "magic/usermode_crashdump_header64_t.end.hpp"
SDK_VERIFY( struct nt::usermode_crashdump_header64_t, 0x60 );
