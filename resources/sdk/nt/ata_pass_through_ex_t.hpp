...
#include "magic/ata_pass_through_ex_t.start.hpp"
namespace nt
{
    // [struct _ATA_PASS_THROUGH_EX]
    // => WDK 10 (NV)
    //
    struct ata_pass_through_ex_t                         
    {                                                    
        // WDK 10                                        
        //                                               
        ...
        _m09 uint64_t               data_buffer_offset;    //{ +0x0018    } | .DataBufferOffset
        ...
        SDK_NONVOL_PROPERTIES( "_ATA_PASS_THROUGH_EX.$", 0x0, false, 0x167f3ff4263e5d3c );                     
        SDK_FIXED_SIZE( ata_pass_through_ex_t, 0x30 );                     
    };                                                   
};
#include "magic/ata_pass_through_ex_t.end.hpp"
SDK_VERIFY( struct nt::ata_pass_through_ex_t, 0x30 );
