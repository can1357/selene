...
namespace dxgi { struct ddi_arg_offerresources1_t;                         }
...
namespace dxgi { struct ddi_arg_reclaimresources1_t;                       }
...
#include "magic/dxgi1_6_1_ddi_base_functions_t.start.hpp"
namespace nt
{
    ...
    // => WDK 10 (NV)
    //
    struct dxgi1_6_1_ddi_base_functions_t                                                                         
    {                                                                                                             
        ...
        using pfn_offer_resources1_t =                             sdk::function<sdk::hresult(struct dxgi::ddi_arg_offerresources1_t*)>*;                                                 
        ...
        using pfn_present1_t =                                     sdk::function<sdk::hresult(struct nt::dxgi1_6_1_ddi_arg_present_t*)>*;                                                 
        ...
        using pfn_present_multiplane_overlay1_t =                  sdk::function<sdk::hresult(struct nt::dxgi1_6_1_ddi_arg_presentmultiplaneoverlay_t*)>*;                                                 
        using pfn_reclaim_resources1_t =                           sdk::function<sdk::hresult(struct dxgi::ddi_arg_reclaimresources1_t*)>*;                                                 
        ...
        _m09 pfn_offer_resources1_t                              pfn_offer_resources1;                              //{ +0x0048    } | .pfnOfferResources1
        ...
        _m21 pfn_reclaim_resources1_t                            pfn_reclaim_resources1;                            //{ +0x00a8    } | .pfnReclaimResources1
                                                                                                                  
        SDK_NONVOL_PROPERTIES( "DXGI1_6_1_DDI_BASE_FUNCTIONS.$", 0x0, false, 0x7dd6e18eee37d6e5 );                                                 
        SDK_FIXED_SIZE( dxgi1_6_1_ddi_base_functions_t, 0xb0 );                                                   
    };                                                                                                            
};
#include "magic/dxgi1_6_1_ddi_base_functions_t.end.hpp"
SDK_VERIFY( struct nt::dxgi1_6_1_ddi_base_functions_t, 0xb0 );
