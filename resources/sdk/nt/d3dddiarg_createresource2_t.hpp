...
#include "../d3d/ddi/resourceflags2_t.hpp"

namespace d3d::ddi { struct surfaceinfo_t; }

#include "magic/d3dddiarg_createresource2_t.start.hpp"
namespace nt
{
    // [struct _D3DDDIARG_CREATERESOURCE2]
    // => WDK 10 (NV)
    //
    struct d3dddiarg_createresource2_t                                 
    {                                                                  
        // WDK 10                                                      
        //                                                             
        ...
        _m13 struct d3d::ddi::resourceflags2_t     flags2;               //{ +0x0040    } | .Flags2
                                                                       
        SDK_NONVOL_PROPERTIES( "_D3DDDIARG_CREATERESOURCE2.$", 0x0, false, 0x1275468215c25daa );                    
        SDK_FIXED_SIZE( d3dddiarg_createresource2_t, 0x48 );                    
    };                                                                 
};
#include "magic/d3dddiarg_createresource2_t.end.hpp"
SDK_VERIFY( struct nt::d3dddiarg_createresource2_t, 0x48 );
