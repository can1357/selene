...
#include "magic/general_lookaside_t.start.hpp"
namespace nt
{
    ...
    {                                                            
        ...
        SDK_NONVOL_PROPERTIES( "_GENERAL_LOOKASIDE.$", 0x80, true, 0xaf7e7aff8973d37f );                     
        SDK_FIXED_SIZE( general_lookaside_t, 0x80 );                     
    };                                                           
};
#include "magic/general_lookaside_t.end.hpp"
SDK_VERIFY( struct nt::general_lookaside_t, 0x80 );
