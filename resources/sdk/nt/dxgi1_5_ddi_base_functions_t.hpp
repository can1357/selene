...
#include "magic/dxgi1_5_ddi_base_functions_t.start.hpp"
namespace nt
{
    // [struct DXGI1_5_DDI_BASE_FUNCTIONS]
    // => WDK 10 (NV)
    //
    struct dxgi1_5_ddi_base_functions_t                                                                           
    {                                                                                                             
        ...
        SDK_NONVOL_PROPERTIES( "DXGI1_5_DDI_BASE_FUNCTIONS.$", 0x0, false, 0x60e7830358ea5bca );                                                 
        SDK_FIXED_SIZE( dxgi1_5_ddi_base_functions_t, 0xb0 );                                                     
    };                                                                                                            
};
#include "magic/dxgi1_5_ddi_base_functions_t.end.hpp"
SDK_VERIFY( struct nt::dxgi1_5_ddi_base_functions_t, 0xb0 );
